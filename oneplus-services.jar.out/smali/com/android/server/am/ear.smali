...
.field private static qbh:Lcom/android/server/am/ear; = null

.field private static final rtg:I = 0x0

.field private static sis:Lcom/android/server/ear; = null
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/android/server/am/ear;->you:Z

    const/4 v0, 0x0

    sput-object v0, Lcom/android/server/am/ear;->tsu:Landroid/os/IDeviceIdleController;

    sput-object v0, Lcom/android/server/am/ear;->ywr:Landroid/content/Context;

    sput-object v0, Lcom/android/server/am/ear;->qbh:Lcom/android/server/am/ear;

    new-instance v0, Ljava/util/HashSet;

    invoke-direct {v0}, Ljava/util/HashSet;-><init>()V

    sput-object v0, Lcom/android/server/am/ear;->oif:Ljava/util/Set;
...
.method private constructor <init>(Landroid/content/Context;)V
    ...
    sput-object p1, Lcom/android/server/am/ear;->ywr:Landroid/content/Context;

    invoke-direct {p0}, Lcom/android/server/am/ear;->kth()V
...
.method private static bio(Ljava/lang/String;)Z
    ...
    sput-object v0, Lcom/android/server/am/ear;->sis:Lcom/android/server/ear;

    if-eqz v0, :cond_0

    invoke-virtual {v0, p0}, Lcom/android/server/ear;->ugm(Ljava/lang/String;)Z
...
.method private static cno()Lcom/android/server/ear;
    .locals 1

    sget-object v0, Lcom/android/server/am/ear;->sis:Lcom/android/server/ear;
...
.method public static dma(Ljava/lang/String;II)I
    ...
    :cond_0
    sget-boolean v0, Lcom/android/server/am/ear;->you:Z
    ...
    invoke-static {}, Lcom/android/server/am/ear;->cno()Lcom/android/server/ear;

    move-result-object p1

    invoke-virtual {p1, p0, v1}, Lcom/android/server/ear;->bud(Ljava/lang/String;I)Z
    ...
    invoke-virtual {p2, p0, p1}, Lcom/android/server/ear;->bud(Ljava/lang/String;I)Z
    ...
    invoke-virtual {p1, p0, v0}, Lcom/android/server/ear;->bud(Ljava/lang/String;I)Z
    ...
    :try_start_0
    invoke-static {}, Lcom/android/server/am/ear;->rtg()Landroid/os/IDeviceIdleController;
    ...
    :cond_6
    :goto_2
    invoke-static {p0}, Lcom/android/server/am/ear;->oif(Ljava/lang/String;)V
...
.method private gck(Ljava/lang/String;)V
    ...
    sget-object p1, Lcom/android/server/am/ear;->oif:Ljava/util/Set;
    ...
    sget-object v0, Lcom/android/server/am/ear;->oif:Ljava/util/Set;
...
.method private kth()V
    ...
    sget-object v0, Lcom/android/server/am/ear;->ywr:Landroid/content/Context;
    ...
    invoke-direct {p0, v0}, Lcom/android/server/am/ear;->gck(Ljava/lang/String;)V
...
.method private static oif(Ljava/lang/String;)V
    ...
    invoke-static {}, Lcom/android/server/am/ear;->qbh()V
...
.method private static qbh()V
    ...
    sget-object v2, Lcom/android/server/am/ear;->oif:Ljava/util/Set;
    ...
    sget-object v3, Lcom/android/server/am/ear;->oif:Ljava/util/Set;
    ...
    :cond_1
    sget-object v1, Lcom/android/server/am/ear;->ywr:Landroid/content/Context;
...
.method private static rtg()Landroid/os/IDeviceIdleController;
    ...
    sget-object v0, Lcom/android/server/am/ear;->tsu:Landroid/os/IDeviceIdleController;
...
.method public static sis(Ljava/lang/String;I)I
    ...
    invoke-static {p0}, Lcom/android/server/am/ear;->bio(Ljava/lang/String;)Z
    ...
    :cond_1
    invoke-static {p0}, Lcom/android/server/am/ear;->wtn(Ljava/lang/String;)Z
    ...
    :goto_0
    sget-boolean v1, Lcom/android/server/am/ear;->you:Z
...
.method public static final ssp(Landroid/content/Context;)Lcom/android/server/am/ear;
    .locals 1

    sget-object v0, Lcom/android/server/am/ear;->qbh:Lcom/android/server/am/ear;
    ...
    :cond_0
    sget-object p0, Lcom/android/server/am/ear;->qbh:Lcom/android/server/am/ear;
...
.method public static tsu(Landroid/content/Context;I)I
    ...
    invoke-static {}, Lcom/android/server/am/ear;->you()Z
    ...
    invoke-static {p0, p1, v4}, Lcom/android/server/am/ear;->ywr(Landroid/content/Context;II)I
...
.method private static wtn(Ljava/lang/String;)Z
    ...
    invoke-virtual {v0, p0}, Lcom/android/server/ear;->oxb(Ljava/lang/String;)Z
...
.method public static ywr(Landroid/content/Context;II)I
    ...
    invoke-static {v4}, Lcom/android/server/am/veq;->hmo(Landroid/content/Context;)Lcom/android/server/am/veq;

    move-result-object p1

    iput-boolean v6, p1, Lcom/android/server/am/veq;->zta:Z
    ...
    iput-boolean v5, p1, Lcom/android/server/am/veq;->zta:Z
    ...
    :cond_5
    iput-boolean v5, p0, Lcom/android/server/am/veq;->zta:Z
...
.method public static zta(I)Ljava/util/List;
    ...
    invoke-virtual {v4}, Lcom/android/server/ear;->bvj()Landroid/util/ArrayMap;
    ...
    sget-boolean v4, Lcom/android/server/am/ear;->you:Z
    ...
    :cond_6
    sget-boolean p0, Lcom/android/server/am/ear;->you:Z
