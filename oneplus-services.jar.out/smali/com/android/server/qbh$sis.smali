.class Lcom/android/server/qbh$sis;
...
# direct methods
.method public constructor <init>(Lcom/android/server/qbh;Landroid/os/Handler;)V
    .locals 0

    iput-object p1, p0, Lcom/android/server/qbh$sis;->zta:Lcom/android/server/qbh;
...
.method public onChange(ZLandroid/net/Uri;)V
    ...
    iget-object v0, p0, Lcom/android/server/qbh$sis;->zta:Lcom/android/server/qbh;

    invoke-static {v0}, Lcom/android/server/qbh;->lqr(Lcom/android/server/qbh;)Landroid/content/ContentResolver;
    ...
    invoke-static {v0, p1}, Lcom/android/server/qbh;->wtn(Lcom/android/server/qbh;I)I

    iget-object p1, p0, Lcom/android/server/qbh$sis;->zta:Lcom/android/server/qbh;
    ...
    invoke-static {p1}, Lcom/android/server/qbh;->e(Lcom/android/server/qbh;)Lnet/oneplus/odm/OpDeviceManagerInjector;
    ...
    iget-object v4, p0, Lcom/android/server/qbh$sis;->zta:Lcom/android/server/qbh;

    invoke-static {v4}, Lcom/android/server/qbh;->bio(Lcom/android/server/qbh;)I
    ...
    invoke-static {v4}, Lcom/android/server/qbh;->e(Lcom/android/server/qbh;)Lnet/oneplus/odm/OpDeviceManagerInjector;

    move-result-object v4

    iget-object v5, p0, Lcom/android/server/qbh$sis;->zta:Lcom/android/server/qbh;

    invoke-static {v5}, Lcom/android/server/qbh;->i(Lcom/android/server/qbh;)Landroid/content/Context;
    ...
    invoke-virtual {p1}, Lcom/android/server/qbh;->kth()V
    ...
    invoke-static {v0, v3, v4}, Lcom/android/server/qbh;->o(Lcom/android/server/qbh;J)J

    new-instance v0, Ljava/lang/StringBuilder;

    invoke-direct {v0}, Ljava/lang/StringBuilder;-><init>()V

    iget-object v7, p0, Lcom/android/server/qbh$sis;->zta:Lcom/android/server/qbh;

    invoke-static {v7}, Lcom/android/server/qbh;->n(Lcom/android/server/qbh;)J
    ...
    invoke-static {v7}, Lcom/android/server/qbh;->i(Lcom/android/server/qbh;)Landroid/content/Context;
    ...
    invoke-static {p1, v6}, Lcom/android/server/qbh;->p(Lcom/android/server/qbh;Z)Z
    ...
    invoke-static {p1, v3, v4}, Lcom/android/server/qbh;->o(Lcom/android/server/qbh;J)J

    new-instance p1, Ljava/lang/StringBuilder;

    invoke-direct {p1}, Ljava/lang/StringBuilder;-><init>()V

    iget-object p2, p0, Lcom/android/server/qbh$sis;->zta:Lcom/android/server/qbh;

    invoke-static {p2}, Lcom/android/server/qbh;->n(Lcom/android/server/qbh;)J
    ...
    invoke-static {p2}, Lcom/android/server/qbh;->i(Lcom/android/server/qbh;)Landroid/content/Context;
    ...
    iget-object p0, p0, Lcom/android/server/qbh$sis;->zta:Lcom/android/server/qbh;
