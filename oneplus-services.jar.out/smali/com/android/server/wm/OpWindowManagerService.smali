...
.method public createScreenRotationAnimation(Lcom/android/server/wm/WindowManagerService;Lcom/android/server/wm/DisplayContent;II)Lcom/android/server/wm/IScreenRotationAnimation;
    ...
    :cond_0
    new-instance p0, Lcom/android/server/wm/m;
    ...
    invoke-direct/range {v2 .. v8}, Lcom/android/server/wm/m;-><init>(Landroid/content/Context;Lcom/android/server/wm/DisplayContent;ZZLcom/android/server/wm/WindowManagerService;I)V
...
.method public getTaskPkgList(I)Ljava/util/List;
    ...
    new-instance v2, Lcom/android/server/wm/cjf;

    invoke-direct {v2, v0}, Lcom/android/server/wm/cjf;-><init>(Ljava/util/List;)V
...
.method public notifySplitScreenModeChange(Z)V
    ...
    new-instance v0, Lcom/android/server/wm/ire;

    invoke-direct {v0, p0}, Lcom/android/server/wm/ire;-><init>(Lcom/android/server/wm/OpWindowManagerService;)V
...
.method public notifyWindowStateChange(Landroid/os/Bundle;)V
    ...
    invoke-direct {v1, p0, p1}, Lcom/android/server/wm/ear;-><init>(Lcom/android/server/wm/OpWindowManagerService;Landroid/os/Bundle;)V
