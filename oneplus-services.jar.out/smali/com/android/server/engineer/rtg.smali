...
# static fields
.field private static final bio:Z = true

.field private static final gck:Z

.field private static igw:Z

.field private static final kth:Ljava/lang/String;

.field private static final wtn:Ljava/lang/String;


# instance fields
.field cno:Landroid/content/BroadcastReceiver;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/server/engineer/rtg;->kth:Ljava/lang/String;

    const/4 v0, 0x0

    sput-boolean v0, Lcom/android/server/engineer/rtg;->igw:Z
    ...
    sput-object v1, Lcom/android/server/engineer/rtg;->wtn:Ljava/lang/String;
    ...
    sget-object v1, Lcom/android/server/engineer/rtg;->wtn:Ljava/lang/String;
    ...
    :cond_0
    sput-boolean v0, Lcom/android/server/engineer/rtg;->gck:Z
...
.method public constructor <init>(Lcom/android/server/engineer/OneplusEngineerService;Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcom/android/server/engineer/rtg;->cno:Landroid/content/BroadcastReceiver;
    ...
    iget-object p0, p0, Lcom/android/server/engineer/rtg;->cno:Landroid/content/BroadcastReceiver;
...
.method private bio(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    sget-object p0, Lcom/android/server/engineer/rtg;->kth:Ljava/lang/String;
...
.method private bvj()Ljava/util/List;
    .locals 2
    ...
    sget-object v0, Lcom/android/server/engineer/rtg;->kth:Ljava/lang/String;
...
.method private cjf(Landroid/os/ShellCommand;)Landroid/content/Intent;
    .locals 7
...
.method private dma()Ljava/lang/String;
    ...
    invoke-direct {p0, v0}, Lcom/android/server/engineer/rtg;->zgw(Landroid/net/wifi/WifiManager;)Ljava/lang/StringBuffer;
    ...
    invoke-virtual {p0, v3}, Lcom/android/server/engineer/rtg;->ywr(I)I
...
.method private fto(Ljava/io/PrintWriter;)V
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
    ...
    sget-object p1, Lcom/android/server/engineer/rtg;->kth:Ljava/lang/String;
    ...
    const-string p0, "/mnt/vendor/persist/engineermode/wifi_monitor"

    const-string p1, "0;0;0"

    invoke-static {p0, p1}, Lcom/android/server/engineer/ssp;->vdw(Ljava/lang/String;Ljava/lang/String;)Z

    const/4 p0, 0x0

    sput-boolean p0, Lcom/android/server/engineer/rtg;->igw:Z

    :goto_0
    sget-boolean p0, Lcom/android/server/engineer/rtg;->igw:Z
...
.method private gck(Ljava/lang/String;Ljava/io/PrintWriter;)V
    ...
    :cond_5
    invoke-static {p0}, Lcom/android/server/engineer/ssp;->les(Ljava/util/ArrayList;)Ljava/lang/String;
...
.method private gwm(Ljava/lang/String;Ljava/io/PrintWriter;)V
    .locals 20
    ...
    :pswitch_0
    sget-object v3, Lcom/android/server/engineer/rtg;->kth:Ljava/lang/String;
    ...
    invoke-direct {v0, v0}, Lcom/android/server/engineer/rtg;->cjf(Landroid/os/ShellCommand;)Landroid/content/Intent;
    ...
    sget-object v5, Lcom/android/server/engineer/rtg;->kth:Ljava/lang/String;
    ...
    sget-object v1, Lcom/android/server/engineer/rtg;->kth:Ljava/lang/String;
    ...
    invoke-static {v0}, Lcom/android/server/engineer/ssp;->cjf(Ljava/lang/String;)Z
    ...
    :goto_7
    sget-boolean v0, Lcom/android/server/engineer/rtg;->igw:Z
    ...
    invoke-direct {v0, v4, v1, v3}, Lcom/android/server/engineer/rtg;->ire(Landroid/content/Context;Landroid/content/Intent;I)I
    ...
    invoke-direct {v0, v3, v1, v4}, Lcom/android/server/engineer/rtg;->ire(Landroid/content/Context;Landroid/content/Intent;I)I
    ...
    invoke-direct {v0, v1, v3, v4}, Lcom/android/server/engineer/rtg;->ire(Landroid/content/Context;Landroid/content/Intent;I)I
...
.method private hmo(Ljava/io/PrintWriter;Ljava/lang/String;Ljava/lang/String;)V
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
    ...
    const-string p1, "/mnt/vendor/persist/engineermode/wifi_monitor"

    invoke-static {p1, p0}, Lcom/android/server/engineer/ssp;->vdw(Ljava/lang/String;Ljava/lang/String;)Z
...
.method private ibl(Ljava/lang/String;Ljava/io/PrintWriter;)V
    .locals 5
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
    ...
    :pswitch_1
    invoke-direct {p0, v2}, Lcom/android/server/engineer/rtg;->ear(B)I
    ...
    sput-boolean v2, Lcom/android/server/engineer/rtg;->igw:Z
...
.method private ire(Landroid/content/Context;Landroid/content/Intent;I)I
    .locals 12
...
.method private obl(Ljava/lang/String;Ljava/io/PrintWriter;)V
    ...
    :try_start_3
    invoke-static {p1, p0}, Lcom/android/server/engineer/ssp;->cgv(IB)Z
...
.method private oif()Ljava/lang/String;
    ...
    :goto_0
    invoke-direct {p0}, Lcom/android/server/engineer/rtg;->bvj()Ljava/util/List;
    ...
    :try_start_0
    iget-object v6, p0, Lcom/android/server/engineer/rtg;->you:Landroid/content/Context;
    ...
    sget-object v7, Lcom/android/server/engineer/rtg;->kth:Ljava/lang/String;
    ...
    :try_start_1
    invoke-virtual {v6, v8}, Landroid/telephony/TelephonyManager;->getImei(I)Ljava/lang/String;
    ...
    :goto_5
    invoke-direct {p0}, Lcom/android/server/engineer/rtg;->oxb()Z
...
.method private ugm(Ljava/lang/String;Ljava/io/PrintWriter;)V
    .locals 10
    ...
    :sswitch_7
    const-string v1, "--query_sd_card_detect"
    ...
    :pswitch_1
    invoke-direct {p0}, Lcom/android/server/engineer/rtg;->oif()Ljava/lang/String;
    ...
    :pswitch_8
    const-string p0, "/proc/simholder/sim_holder_detect"

    invoke-static {p0, v3}, Lcom/android/server/engineer/ssp;->hmo(Ljava/lang/String;I)I

    move-result p0

    if-ne p0, v5, :cond_7

    const-string p0, "OK: 1"
    ...
    invoke-static {p0, v5}, Lcom/android/server/engineer/ssp;->hmo(Ljava/lang/String;I)I
    ...
    invoke-static {p1, v4}, Lcom/android/server/engineer/ssp;->hmo(Ljava/lang/String;I)I
    ...
    invoke-virtual {v2, v1, v4}, Landroid/content/Context;->startServiceAsUser(Landroid/content/Intent;Landroid/os/UserHandle;)Landroid/content/ComponentName;
    ...
    .sparse-switch
        ...
        -0x17160e05 -> :sswitch_a
        -0xc9159d0 -> :sswitch_9
        -0x862ee63 -> :sswitch_8
        0x168f33bb -> :sswitch_7
...
.method private vdb(Ljava/lang/String;Ljava/io/PrintWriter;)V
    .locals 6
    ...
    invoke-static {p0}, Lcom/android/server/engineer/ssp;->veq([B)Z
...
.method private wtn(Ljava/io/PrintWriter;)V
    ...
    :goto_0
    const-string v2, "init.svc.keyboxxml"
    ...
    sget-boolean v1, Lcom/android/server/engineer/rtg;->gck:Z

    if-eqz v1, :cond_2

    const-string v1, "chmodkeyboxxmldir"
    ...
    :goto_1
    const-string v2, "init.svc.chmodkeyboxxmldir"
    ...
    :cond_2
    :goto_2
    invoke-static {}, Lcom/android/server/engineer/ssp;->oxb()Z
    ...
    invoke-static {}, Lcom/android/server/engineer/ssp;->obl()Z
    ...
    const-string v4, "start KmInstallKeyboxLemonadev"

    invoke-static {v1, v4}, Landroid/util/Slog;->i(Ljava/lang/String;Ljava/lang/String;)I

    const-string v1, "KmInstallKeyboxLemonadev"

    goto :goto_3

    :cond_3
    invoke-static {}, Lcom/android/server/engineer/ssp;->zgw()Z
    ...
    const-string v4, "start KmInstallKeyboxLemonadet"

    invoke-static {v1, v4}, Landroid/util/Slog;->i(Ljava/lang/String;Ljava/lang/String;)I

    const-string v1, "KmInstallKeyboxLemonadet"

    goto :goto_3

    :cond_4
    invoke-static {}, Lcom/android/server/engineer/ssp;->gwm()Z
    ...
    const-string v4, "start KmInstallKeyboxLemonade"

    invoke-static {v1, v4}, Landroid/util/Slog;->i(Ljava/lang/String;Ljava/lang/String;)I

    const-string v1, "KmInstallKeyboxLemonade"

    goto :goto_3

    :cond_5
    invoke-static {}, Lcom/android/server/engineer/ssp;->ugm()Z
    ...
    const-string v4, "start KmInstallKeyboxLemonadep"

    invoke-static {v1, v4}, Landroid/util/Slog;->i(Ljava/lang/String;Ljava/lang/String;)I

    const-string v1, "KmInstallKeyboxLemonadep"

    goto :goto_3

    :cond_6
    invoke-static {}, Lcom/android/server/engineer/ssp;->vdb()Z
    ...
    const-string v4, "start KmInstallKeyboxLemonadept"

    invoke-static {v1, v4}, Landroid/util/Slog;->i(Ljava/lang/String;Ljava/lang/String;)I

    const-string v1, "KmInstallKeyboxLemonadept"
    ...
    iput-object v1, p0, Lcom/android/server/engineer/rtg;->ssp:Ljava/lang/String;
    ...
    const-string v1, "KmInstallKeybox18827"
    ...
    const-string v4, "KmInstallKeybox"

    invoke-virtual {v1, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-object v4, p0, Lcom/android/server/engineer/rtg;->ssp:Ljava/lang/String;
    ...
    const-string v1, "init.svc.KmInstallKeyboxLemonadev"

    invoke-static {v1}, Landroid/os/SystemProperties;->get(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v1

    sget-object v4, Lcom/android/server/engineer/rtg;->kth:Ljava/lang/String;

    new-instance v5, Ljava/lang/StringBuilder;

    invoke-direct {v5}, Ljava/lang/StringBuilder;-><init>()V

    const-string v8, "serviceStatus KmInstallKeyboxLemonadev: "
    ...
    const-string v1, "init.svc.KmInstallKeyboxLemonadet"
    ...
    const-string v8, "serviceStatus KmInstallKeyboxLemonadet: "
    ...
    const-string v1, "init.svc.KmInstallKeyboxLemonade"
    ...
    const-string v8, "serviceStatus KmInstallKeyboxLemonade: "
    ...
    const-string v1, "init.svc.KmInstallKeyboxLemonadep"
    ...
    const-string v8, "serviceStatus KmInstallKeyboxLemonadep: "
    ...
    const-string v1, "init.svc.KmInstallKeyboxLemonadept"
    ...
    const-string v8, "serviceStatus KmInstallKeyboxLemonadept: "

    goto :goto_5

    :cond_e
    iget-object v1, p0, Lcom/android/server/engineer/rtg;->ssp:Ljava/lang/String;
    ...
    const-string v1, "init.svc.KmInstallKeybox18827"
    ...
    const-string v4, "init.svc.KmInstallKeybox"
...
.method private zgw(Landroid/net/wifi/WifiManager;)Ljava/lang/StringBuffer;
    .locals 4
...
.method public onCommand(Ljava/lang/String;)I
    ...
    :sswitch_16
    const-string v7, "--query_sd_card_detect"
    ...
    invoke-static {v4, v13}, Lcom/android/server/engineer/ssp;->hmo(Ljava/lang/String;I)I
    ...
    invoke-static {v4, v5}, Lcom/android/server/engineer/ssp;->hmo(Ljava/lang/String;I)I
    ...
    invoke-direct {v1, v2}, Lcom/android/server/engineer/rtg;->fto(Ljava/io/PrintWriter;)V
    :try_end_14
    ...
    invoke-direct {v1, v4, v2, v3}, Lcom/android/server/engineer/rtg;->hmo(Ljava/io/PrintWriter;Ljava/lang/String;Ljava/lang/String;)V
    :try_end_16
    ...
    invoke-direct {v1, v2, v3}, Lcom/android/server/engineer/rtg;->ibl(Ljava/lang/String;Ljava/io/PrintWriter;)V
    :try_end_1e
    ...
    :goto_16
    invoke-direct {v1, v2, v3}, Lcom/android/server/engineer/rtg;->gwm(Ljava/lang/String;Ljava/io/PrintWriter;)V
    ...
    invoke-direct {v1, v2, v3}, Lcom/android/server/engineer/rtg;->vdb(Ljava/lang/String;Ljava/io/PrintWriter;)V
    ...
    invoke-direct {v1, v2, v3}, Lcom/android/server/engineer/rtg;->ugm(Ljava/lang/String;Ljava/io/PrintWriter;)V
    :try_end_1f
    ...
    .sparse-switch
        ...
        -0x3397a030 -> :sswitch_2e
        -0x2a7530aa -> :sswitch_2d
        -0x28c3f196 -> :sswitch_2c
        -0x226aaa21 -> :sswitch_2b
        -0x20dab99e -> :sswitch_2a
        -0x194d63e8 -> :sswitch_29
        -0x17160e05 -> :sswitch_28
        -0x1290a56d -> :sswitch_27
        -0x10075aa1 -> :sswitch_26
        -0xde8b811 -> :sswitch_25
        -0xc9159d0 -> :sswitch_24
        -0x862ee63 -> :sswitch_23
        -0x71598f3 -> :sswitch_22
        -0x5815fca -> :sswitch_21
        -0x1cd6367 -> :sswitch_20
        -0x4d2d5c -> :sswitch_1f
        0xb7c6 -> :sswitch_1e
        0x15f0f5 -> :sswitch_1d
        0x160409 -> :sswitch_1c
        0x161b7c -> :sswitch_1b
        0x1dbb813 -> :sswitch_1a
        0x7ff1006 -> :sswitch_19
        0x816af5d -> :sswitch_18
        0xf240492 -> :sswitch_17
        0x168f33bb -> :sswitch_16
...
.method public ywr(I)I
    ...
    invoke-direct {p0, v0}, Lcom/android/server/engineer/rtg;->qbh(I)I
