...
.implements Lcom/oneplus/settings/ui/ColorTemperatureSeekBarPreference$OPColorModeSeekBarChangeListener;
...
.field private mColorPreference:Lcom/oneplus/settings/ui/OPColorPreference;

.field private mColorTempPreference:Lcom/oneplus/settings/ui/ColorTemperatureSeekBarPreference;
...
.method static constructor <clinit>()V
    ...
    :goto_0
    sput v0, Lcom/android/settings/DisplaySettings;->DEFAULT_COLOR_PROGRESS:I
...
.method static synthetic access$100(Lcom/android/settings/DisplaySettings;)V
    ...
    invoke-direct {p0}, Lcom/android/settings/DisplaySettings;->updateColorTempPreference()V
...
.method static synthetic access$702(Lcom/android/settings/DisplaySettings;J)J
    .locals 0
...
.method private updateColorTempPreference()V
    .locals 8

    iget-object v0, p0, Lcom/android/settings/DisplaySettings;->mColorTempPreference:Lcom/oneplus/settings/ui/ColorTemperatureSeekBarPreference;
    ...
    :cond_6
    iget-object p0, p0, Lcom/android/settings/DisplaySettings;->mColorTempPreference:Lcom/oneplus/settings/ui/ColorTemperatureSeekBarPreference;

    invoke-virtual {p0, v1}, Lcom/oneplus/settings/ui/ColorTemperatureSeekBarPreference;->setEnabled(Z)V
    ...
    invoke-virtual {p0, v2}, Lcom/oneplus/settings/ui/ColorTemperatureSeekBarPreference;->setEnabled(Z)V
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    const-string v0, "color_displays"

    invoke-virtual {p0, v0}, Lcom/android/settings/core/InstrumentedPreferenceFragment;->findPreference(Ljava/lang/CharSequence;)Landroidx/preference/Preference;

    move-result-object v0

    check-cast v0, Lcom/oneplus/settings/ui/OPColorPreference;

    iput-object v0, p0, Lcom/android/settings/DisplaySettings;->mColorPreference:Lcom/oneplus/settings/ui/OPColorPreference;

    const-string v0, "color_temperature_displays"

    invoke-virtual {p0, v0}, Lcom/android/settings/core/InstrumentedPreferenceFragment;->findPreference(Ljava/lang/CharSequence;)Landroidx/preference/Preference;

    move-result-object v0

    check-cast v0, Lcom/oneplus/settings/ui/ColorTemperatureSeekBarPreference;

    iput-object v0, p0, Lcom/android/settings/DisplaySettings;->mColorTempPreference:Lcom/oneplus/settings/ui/ColorTemperatureSeekBarPreference;

    invoke-virtual {v0, p0}, Lcom/oneplus/settings/ui/ColorTemperatureSeekBarPreference;->setOPColorModeSeekBarChangeListener(Lcom/oneplus/settings/ui/ColorTemperatureSeekBarPreference$OPColorModeSeekBarChangeListener;)V
    ...
    iget-object v0, p0, Lcom/android/settings/DisplaySettings;->mColorPreference:Lcom/oneplus/settings/ui/OPColorPreference;
    ...
    sget v2, Lcom/android/settings/R$string;->op_display_advanced_settings_summary_8:I
...
.method public onProgressChanged(Landroid/widget/SeekBar;IZ)V
    ...
    iput p2, p0, Lcom/android/settings/DisplaySettings;->mScreenColorModeValue:I
...
.method public onResume()V
    ...
    sget v1, Lcom/android/settings/DisplaySettings;->DEFAULT_COLOR_PROGRESS:I
    ...
    iput v0, p0, Lcom/android/settings/DisplaySettings;->mScreenColorModeValue:I
...
.method public onStopTrackingTouch(Landroid/widget/SeekBar;)V
    ...
    iget p1, p0, Lcom/android/settings/DisplaySettings;->mScreenColorModeValue:I

    invoke-virtual {p0, p1}, Lcom/android/settings/DisplaySettings;->onSaveScreenColorModeValue(I)V
