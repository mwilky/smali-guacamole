...
.method protected makeStatusBarView(Lcom/android/internal/statusbar/RegisterStatusBarResult;)V
    ...
    sget v1, Lcom/android/systemui/R$color;->op_quick_settings_scrim_color:I
    ...
    invoke-virtual {v1, p1}, Lcom/android/systemui/statusbar/phone/ScrimController;->setScrimColor(I)V
...
.method public start()V
    ...
    invoke-static {v0}, Lcom/android/mwilky/Renovate;->setContinuousHorizon(Landroid/content/Context;)V
...
.method public registerObserver()V
    ...
    const-string v1, "tweaks_qs_outline_color"
...
.method public onContentChanged(Ljava/lang/String;)V
    ...
    :cond_mwilky36
    const-string v0, "tweaks_unlock_lockscreen_scrim_color"
    ...
    invoke-virtual {p0}, Lcom/android/systemui/statusbar/phone/StatusBar;->updateNotificationColorsThemeChange()V
    ...
    :cond_mwilky94
    const-string v0, "tweaks_continuous_horizon"
    
    invoke-virtual {v0, p1}, Ljava/lang/String;->equals(Ljava/lang/Object;)Z

    move-result v0

    if-eqz v0, :cond_mwilky95
    ...
    :cond_mwilky95
    const-string v0, "tweaks_continuous_horizon_vibrate"
    
    invoke-virtual {v0, p1}, Ljava/lang/String;->equals(Ljava/lang/Object;)Z

    move-result v0

    if-eqz v0, :cond_mwilky96
    ...
    :cond_102
    const-string v0, "tweaks_qs_outline_color"
...
.method updateNotificationColors()V
	.locals 2
    ...
    invoke-virtual {v0, v1}, Lcom/android/systemui/statusbar/phone/NotificationPanelViewController;->updateNotificationViews(Ljava/lang/String;)V
...
.method updateNotificationColorsThemeChange()V
	.locals 2
