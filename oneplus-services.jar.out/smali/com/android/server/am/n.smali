...
.field private static dma:Lcom/android/server/am/n; = null
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/server/am/n;->vju:Ljava/util/HashSet;

    new-instance v0, Ljava/util/HashSet;

    invoke-direct {v0}, Ljava/util/HashSet;-><init>()V

    sput-object v0, Lcom/android/server/am/n;->bud:Ljava/util/HashSet;

    new-instance v0, Ljava/util/HashSet;

    invoke-direct {v0}, Ljava/util/HashSet;-><init>()V

    sput-object v0, Lcom/android/server/am/n;->les:Ljava/util/HashSet;
...
.method private constructor <init>(Landroid/content/Context;)V
    ...
    iput v0, p0, Lcom/android/server/am/n;->igw:I

    iput-object p1, p0, Lcom/android/server/am/n;->zta:Landroid/content/Context;

    invoke-virtual {p1}, Landroid/content/Context;->getPackageManager()Landroid/content/pm/PackageManager;

    move-result-object p1

    iput-object p1, p0, Lcom/android/server/am/n;->you:Landroid/content/pm/PackageManager;

    invoke-direct {p0}, Lcom/android/server/am/n;->dma()V

    invoke-direct {p0}, Lcom/android/server/am/n;->qbh()V

    invoke-direct {p0}, Lcom/android/server/am/n;->ywr()V

    const-string p1, ""

    iput-object p1, p0, Lcom/android/server/am/n;->kth:Ljava/lang/String;

    iput-object p1, p0, Lcom/android/server/am/n;->bio:Ljava/lang/String;
...
.method private synthetic bvj()V
    ...
    iget-object v1, p0, Lcom/android/server/am/n;->you:Landroid/content/pm/PackageManager;
    ...
    sget-object v3, Lcom/android/server/am/n;->vju:Ljava/util/HashSet;

    monitor-enter v3

    :try_start_0
    sget-object v4, Lcom/android/server/am/n;->vju:Ljava/util/HashSet;
    ...
    sget-object v3, Lcom/android/server/am/n;->bud:Ljava/util/HashSet;

    monitor-enter v3

    :try_start_1
    sget-object v4, Lcom/android/server/am/n;->bud:Ljava/util/HashSet;
    ...
    iget-object p0, p0, Lcom/android/server/am/n;->you:Landroid/content/pm/PackageManager;
    ...
    sget-object v1, Lcom/android/server/am/n;->les:Ljava/util/HashSet;

    monitor-enter v1

    :try_start_2
    sget-object v2, Lcom/android/server/am/n;->les:Ljava/util/HashSet;
...
.method private dma()V
    ...
    sput p0, Lcom/android/server/am/n;->fto:I

    const-wide/16 v0, 0xbb8

    sput-wide v0, Lcom/android/server/am/n;->lqr:J

    const/4 p0, 0x1

    sput-boolean p0, Lcom/android/server/am/n;->veq:Z

    new-instance p0, Ljava/util/ArrayList;

    invoke-direct {p0}, Ljava/util/ArrayList;-><init>()V

    sput-object p0, Lcom/android/server/am/n;->cgv:Ljava/util/List;
...
.method public static gck(Landroid/content/Context;)Lcom/android/server/am/n;
    .locals 1

    sget-object v0, Lcom/android/server/am/n;->dma:Lcom/android/server/am/n;

    if-nez v0, :cond_0

    new-instance v0, Lcom/android/server/am/n;

    invoke-direct {v0, p0}, Lcom/android/server/am/n;-><init>(Landroid/content/Context;)V

    sput-object v0, Lcom/android/server/am/n;->dma:Lcom/android/server/am/n;

    :cond_0
    sget-object p0, Lcom/android/server/am/n;->dma:Lcom/android/server/am/n;
...
.method private kth(Ljava/lang/String;)Z
    ...
    iget-wide v2, p0, Lcom/android/server/am/n;->gck:J

    sub-long/2addr v0, v2

    sget-wide v2, Lcom/android/server/am/n;->lqr:J
    ...
    iget-object v0, p0, Lcom/android/server/am/n;->wtn:Ljava/lang/String;
    ...
    iget p1, p0, Lcom/android/server/am/n;->igw:I

    sget v0, Lcom/android/server/am/n;->fto:I

    if-lt p1, v0, :cond_0

    invoke-virtual {p0}, Lcom/android/server/am/n;->igw()V
...
.method public static oif(Ljava/lang/String;)Z
    ...
    sget-object v0, Lcom/android/server/am/n;->les:Ljava/util/HashSet;
...
.method private qbh()V
    ...
    iput-object v1, v0, Lcom/android/server/am/n;->tsu:Ljava/util/List;
    ...
    iput-object v1, v0, Lcom/android/server/am/n;->rtg:Ljava/util/List;
    ...
    iput-object v1, v0, Lcom/android/server/am/n;->ssp:Ljava/util/List;
    ...
    iput-object v1, v0, Lcom/android/server/am/n;->cno:Ljava/util/List;

    sget-object v1, Lcom/android/server/am/veq;->t:Landroid/os/Handler;

    new-instance v2, Lcom/android/server/am/kth;

    invoke-direct {v2, v0}, Lcom/android/server/am/kth;-><init>(Lcom/android/server/am/n;)V
...
.method public static sis(Ljava/lang/String;)V
    ...
    sget-object v0, Lcom/android/server/am/n;->bud:Ljava/util/HashSet;

    monitor-enter v0

    :try_start_0
    sget-object v1, Lcom/android/server/am/n;->bud:Ljava/util/HashSet;
...
.method private tsu(Ljava/lang/String;Landroid/content/Intent;)Z
    ...
    iget-object v0, p0, Lcom/android/server/am/n;->tsu:Ljava/util/List;

    monitor-enter v0

    :try_start_0
    iget-object p0, p0, Lcom/android/server/am/n;->tsu:Ljava/util/List;
...
.method private ywr()V
    ...
    :try_start_0
    iget-object v1, p0, Lcom/android/server/am/n;->tsu:Ljava/util/List;
...
.method private zgw(Ljava/lang/String;)V
    ...
    iget v0, p0, Lcom/android/server/am/n;->igw:I
    ...
    iput-wide v2, p0, Lcom/android/server/am/n;->gck:J

    iput-object p1, p0, Lcom/android/server/am/n;->wtn:Ljava/lang/String;

    iput v1, p0, Lcom/android/server/am/n;->igw:I

    return-void

    :cond_0
    iget-wide v4, p0, Lcom/android/server/am/n;->gck:J
    ...
    iput p1, p0, Lcom/android/server/am/n;->igw:I
...
.method public static zta(Ljava/lang/String;)V
    ...
    sget-object v0, Lcom/android/server/am/n;->vju:Ljava/util/HashSet;

    monitor-enter v0

    :try_start_0
    sget-object v1, Lcom/android/server/am/n;->vju:Ljava/util/HashSet;
...
.method protected bio(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lcom/android/server/am/ServiceRecord;ILandroid/content/Intent;Lcom/android/server/am/StartAppRecorder$zta;)V
    ...
    iget-boolean v0, p0, Lcom/android/server/am/n;->sis:Z

    if-eqz v0, :cond_0

    invoke-direct {p0, p1, p6}, Lcom/android/server/am/n;->tsu(Ljava/lang/String;Landroid/content/Intent;)Z
    ...
    :cond_0
    invoke-static {}, Lcom/android/server/am/veq;->ire()Lcom/android/server/am/veq;

    move-result-object p6

    invoke-virtual {p6, p5}, Lcom/android/server/am/veq;->d(I)Z
    ...
    invoke-static {p5}, Lcom/android/server/am/n;->oif(Ljava/lang/String;)Z
    ...
    :cond_2
    sget-object p5, Lcom/android/server/am/n;->vju:Ljava/util/HashSet;

    monitor-enter p5

    :try_start_0
    sget-object p6, Lcom/android/server/am/n;->vju:Ljava/util/HashSet;
    ...
    sget-object p6, Lcom/android/server/am/n;->bud:Ljava/util/HashSet;

    monitor-enter p6

    :try_start_1
    sget-object p5, Lcom/android/server/am/n;->bud:Ljava/util/HashSet;
    ...
    iget-object p5, p0, Lcom/android/server/am/n;->kth:Ljava/lang/String;

    monitor-enter p5

    :try_start_2
    iget-object p6, p0, Lcom/android/server/am/n;->kth:Ljava/lang/String;
    ...
    iget-object p6, p0, Lcom/android/server/am/n;->bio:Ljava/lang/String;

    monitor-enter p6

    :try_start_3
    iget-object p5, p0, Lcom/android/server/am/n;->bio:Ljava/lang/String;
    ...
    sget-boolean p4, Lcom/android/server/am/n;->veq:Z

    if-eqz p4, :cond_8

    sget-object p4, Lcom/android/server/am/n;->cgv:Ljava/util/List;
    ...
    invoke-virtual {p4, p1}, Lcom/android/server/am/veq;->lqr(Ljava/lang/String;)I
    ...
    invoke-virtual {p5, p4}, Lcom/android/server/am/veq;->fto(I)I
    ...
    invoke-direct {p0, p1}, Lcom/android/server/am/n;->kth(Ljava/lang/String;)Z
...
.method protected cno(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lcom/android/server/am/ProcessRecord;ILjava/lang/String;Lcom/android/server/am/StartAppRecorder$zta;)V
    ...
    iget-object v0, p0, Lcom/android/server/am/n;->cno:Ljava/util/List;
    ...
    invoke-virtual {v0, p2, p3}, Lcom/android/server/am/veq;->e(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-virtual {p0, p2}, Lcom/android/server/am/veq;->m(Ljava/lang/String;)V
    ...
    iget-object p0, p0, Lcom/android/server/am/n;->ssp:Ljava/util/List;
...
.method protected gwm(Ljava/lang/String;)V
    ...
    iget-object v0, p0, Lcom/android/server/am/n;->kth:Ljava/lang/String;
...
.method public synthetic ibl()V
    ...
    invoke-direct {p0}, Lcom/android/server/am/n;->bvj()V
...
.method protected igw()V
    ...
    iput-object v0, p0, Lcom/android/server/am/n;->wtn:Ljava/lang/String;
...
.method protected obl(Ljava/util/List;)V
    ...
    iget-object v2, p0, Lcom/android/server/am/n;->tsu:Ljava/util/List;
...
.method protected oxb(Z)V
    ...
    iput-boolean p1, p0, Lcom/android/server/am/n;->sis:Z
...
.method protected rtg(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lcom/android/server/am/StartAppRecorder$zta;)V
    ...
    iget-object v0, p0, Lcom/android/server/am/n;->rtg:Ljava/util/List;
    ...
    invoke-virtual {v0, p4}, Lcom/android/server/am/veq;->fto(I)I
...
.method protected ssp(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ILcom/android/server/am/StartAppRecorder$zta;)V
    ...
    invoke-virtual {v0, p4}, Lcom/android/server/am/veq;->d(I)Z
    ...
    invoke-virtual {p4, p2, p3}, Lcom/android/server/am/veq;->e(Ljava/lang/String;Ljava/lang/String;)Z
...
.method protected ugm(Ljava/lang/String;)V
    ...
    iget-object v0, p0, Lcom/android/server/am/n;->bio:Ljava/lang/String;
...
.method protected vdb(Lcom/android/server/am/StartAppSpecialUidsPolicy$StartType;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    sget-boolean v0, Lcom/android/server/am/n;->veq:Z

    if-eqz v0, :cond_2

    sget-object v0, Lcom/android/server/am/n;->cgv:Ljava/util/List;
    ...
    invoke-virtual {v0, p2}, Lcom/android/server/am/veq;->lqr(Ljava/lang/String;)I
    ...
    invoke-virtual {v1, v0}, Lcom/android/server/am/veq;->fto(I)I
    ...
    invoke-direct {p0, p1}, Lcom/android/server/am/n;->zgw(Ljava/lang/String;)V
...
.method protected wtn()V
    ...
    sget-boolean v1, Lcom/android/server/am/n;->veq:Z
    ...
    sget v1, Lcom/android/server/am/n;->fto:I
    ...
    sget-wide v1, Lcom/android/server/am/n;->lqr:J
    ...
    sget-object v1, Lcom/android/server/am/n;->cgv:Ljava/util/List;
    ...
    iget-boolean v1, p0, Lcom/android/server/am/n;->sis:Z
    ...
    sget-object v2, Lcom/android/server/am/n;->vju:Ljava/util/HashSet;
    ...
    sget-object v2, Lcom/android/server/am/n;->bud:Ljava/util/HashSet;
    ...
    invoke-static {v3}, Lcom/android/server/am/veq;->i(Ljava/lang/String;)V
    ...
    iget-object v1, p0, Lcom/android/server/am/n;->rtg:Ljava/util/List;
    ...
    iget-object v1, p0, Lcom/android/server/am/n;->ssp:Ljava/util/List;
    ...
    iget-object v1, p0, Lcom/android/server/am/n;->cno:Ljava/util/List;
    ...
    iget-object v1, p0, Lcom/android/server/am/n;->kth:Ljava/lang/String;
    ...
    iget-object p0, p0, Lcom/android/server/am/n;->bio:Ljava/lang/String;
