...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/server/pm/bio$zta;
    }
.end annotation
...
.field private kth:Lcom/android/server/pm/cno;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/server/pm/bio;->igw:Ljava/util/List;
    ...
    sget-object v0, Lcom/android/server/pm/bio;->igw:Ljava/util/List;
    ...
    sget-object v1, Lcom/android/server/pm/bio;->igw:Ljava/util/List;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/server/pm/bio;->zta:Ljava/io/File;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lcom/android/server/pm/bio;->you:Ljava/util/ArrayList;

    new-instance v0, Lcom/android/server/pm/cno;

    invoke-direct {v0}, Lcom/android/server/pm/cno;-><init>()V

    iput-object v0, p0, Lcom/android/server/pm/bio;->kth:Lcom/android/server/pm/cno;
...
.method private rtg()V
    ...
    iget-object v6, p0, Lcom/android/server/pm/bio;->you:Ljava/util/ArrayList;
    ...
    iget-object v10, p0, Lcom/android/server/pm/bio;->you:Ljava/util/ArrayList;

    invoke-virtual {v10, v8}, Ljava/util/ArrayList;->get(I)Ljava/lang/Object;

    move-result-object v10

    check-cast v10, Lcom/android/server/pm/bio$zta;

    iget-object v10, v10, Lcom/android/server/pm/bio$zta;->zta:Ljava/lang/String;
    ...
    iget v10, v10, Lcom/android/server/pm/bio$zta;->you:I
...
.method private sis()V
    ...
    :cond_6
    :goto_2
    iget-object v8, p0, Lcom/android/server/pm/bio;->you:Ljava/util/ArrayList;

    new-instance v10, Lcom/android/server/pm/bio$zta;

    invoke-direct {v10, v7, v9}, Lcom/android/server/pm/bio$zta;-><init>(Ljava/lang/String;I)V
...
.method private tsu(Ljava/lang/String;)V
    ...
    iget-object v0, p0, Lcom/android/server/pm/bio;->you:Ljava/util/ArrayList;
    ...
    check-cast v1, Lcom/android/server/pm/bio$zta;

    if-eqz v1, :cond_0

    iget-object v2, v1, Lcom/android/server/pm/bio$zta;->zta:Ljava/lang/String;
    ...
    iget-object p0, p0, Lcom/android/server/pm/bio;->you:Ljava/util/ArrayList;
...
.method private you(Ljava/lang/String;I)V
    ...
    iput p2, v1, Lcom/android/server/pm/bio$zta;->you:I
    ...
    new-instance v0, Lcom/android/server/pm/bio$zta;

    invoke-direct {v0, p1, p2}, Lcom/android/server/pm/bio$zta;-><init>(Ljava/lang/String;I)V
...
.method private zta(Ljava/lang/String;)I
    ...
    check-cast v0, Lcom/android/server/pm/bio$zta;

    if-eqz v0, :cond_0

    iget-object v1, v0, Lcom/android/server/pm/bio$zta;->zta:Ljava/lang/String;
    ...
    iget p0, v0, Lcom/android/server/pm/bio$zta;->you:I
...
.method public addForInitLI(Lcom/android/server/pm/PackageManagerService;Lcom/android/server/pm/parsing/pkg/ParsedPackage;Lcom/android/server/pm/PackageSetting;Ljava/io/File;Ljava/lang/String;Ljava/lang/String;JZ)Z
    ...
    invoke-virtual {p0, v0}, Lcom/android/server/pm/bio;->isReserveApp(Ljava/lang/String;)Z
    ...
    invoke-virtual {p0, v0}, Lcom/android/server/pm/bio;->checkAppHasDeleted(Ljava/lang/String;)Z
    ...
    invoke-direct {p0, v0}, Lcom/android/server/pm/bio;->zta(Ljava/lang/String;)I
    ...
    invoke-direct {p0, v0, v1}, Lcom/android/server/pm/bio;->you(Ljava/lang/String;I)V

    invoke-direct {p0}, Lcom/android/server/pm/bio;->rtg()V
    ...
    invoke-direct {p0, p9}, Lcom/android/server/pm/bio;->zta(Ljava/lang/String;)I
    ...
    :cond_5
    iget-object p4, p0, Lcom/android/server/pm/bio;->rtg:Lcom/android/server/pm/PackageManagerService$PmsInner;
    ...
    invoke-direct {p0, p1}, Lcom/android/server/pm/bio;->tsu(Ljava/lang/String;)V
...
.method public checkAppHasDeleted(Ljava/lang/String;)Z
    ...
    iget-object v0, v0, Lcom/android/server/pm/bio$zta;->zta:Ljava/lang/String;
...
.method public cleanUp(Ljava/io/File;)Z
    ...
    iget-object p0, p0, Lcom/android/server/pm/bio;->zta:Ljava/io/File;
...
.method public cleanUpResourcesLI(Ljava/io/File;Landroid/content/pm/PackageParser$PackageLite;)V
    ...
    invoke-virtual {p0, p1}, Lcom/android/server/pm/bio;->isReserveApp(Ljava/lang/String;)Z
    ...
    invoke-direct {p0, p1, p2}, Lcom/android/server/pm/bio;->you(Ljava/lang/String;I)V
...
.method public collectReserveApps(I)V
    ...
    iget-object v1, v0, Lcom/android/server/pm/bio;->rtg:Lcom/android/server/pm/PackageManagerService$PmsInner;

    const/4 v3, 0x0

    const-wide/16 v5, 0x0

    iget-object v7, v0, Lcom/android/server/pm/bio;->ssp:Lcom/android/server/pm/parsing/PackageParser2;

    iget-object v8, v0, Lcom/android/server/pm/bio;->cno:Ljava/util/concurrent/ExecutorService;
    ...
    iget-object v10, v0, Lcom/android/server/pm/bio;->rtg:Lcom/android/server/pm/PackageManagerService$PmsInner;

    const/4 v12, 0x0

    const-wide/16 v14, 0x0

    iget-object v1, v0, Lcom/android/server/pm/bio;->ssp:Lcom/android/server/pm/parsing/PackageParser2;

    iget-object v2, v0, Lcom/android/server/pm/bio;->cno:Ljava/util/concurrent/ExecutorService;
    ...
    iget-object v2, v0, Lcom/android/server/pm/bio;->rtg:Lcom/android/server/pm/PackageManagerService$PmsInner;

    const/16 v18, 0x0

    const-wide/16 v20, 0x0

    iget-object v3, v0, Lcom/android/server/pm/bio;->ssp:Lcom/android/server/pm/parsing/PackageParser2;

    iget-object v4, v0, Lcom/android/server/pm/bio;->cno:Ljava/util/concurrent/ExecutorService;
    ...
    :cond_2
    iget-object v0, v0, Lcom/android/server/pm/bio;->kth:Lcom/android/server/pm/cno;

    move/from16 v1, p1

    invoke-virtual {v0, v1}, Lcom/android/server/pm/cno;->zta(I)V
...
.method public initInstance(Lcom/android/server/pm/PackageManagerService$PmsInner;Lcom/android/server/pm/parsing/PackageParser2;Ljava/util/concurrent/ExecutorService;)V
    ...
    iput-object v0, p0, Lcom/android/server/pm/bio;->sis:Landroid/content/pm/PackageManagerInternal;
    ...
    iput-object v0, p0, Lcom/android/server/pm/bio;->tsu:Lcom/android/server/pm/permission/PermissionManagerServiceInternal;

    iput-object p1, p0, Lcom/android/server/pm/bio;->rtg:Lcom/android/server/pm/PackageManagerService$PmsInner;

    iput-object p2, p0, Lcom/android/server/pm/bio;->ssp:Lcom/android/server/pm/parsing/PackageParser2;

    iput-object p3, p0, Lcom/android/server/pm/bio;->cno:Ljava/util/concurrent/ExecutorService;

    invoke-direct {p0}, Lcom/android/server/pm/bio;->sis()V
...
.method public isReserveApp(Ljava/lang/String;)Z
    ...
    iget-object p0, p0, Lcom/android/server/pm/bio;->kth:Lcom/android/server/pm/cno;

    invoke-virtual {p0, p1}, Lcom/android/server/pm/cno;->you(Ljava/lang/String;)Z
...
.method public pruneNonExistReserveApps(Ljava/util/Collection;Landroid/util/ArrayMap;)V
    ...
    invoke-virtual {p0, v1}, Lcom/android/server/pm/bio;->isReserveApp(Ljava/lang/String;)Z
    ...
    iget-object v1, p0, Lcom/android/server/pm/bio;->tsu:Lcom/android/server/pm/permission/PermissionManagerServiceInternal;
...
.method public systemReady(Z)V
    ...
    iget-object p1, p0, Lcom/android/server/pm/bio;->tsu:Lcom/android/server/pm/permission/PermissionManagerServiceInternal;
    ...
    iget-object v3, p0, Lcom/android/server/pm/bio;->sis:Landroid/content/pm/PackageManagerInternal;
    ...
    iget-object v4, p0, Lcom/android/server/pm/bio;->sis:Landroid/content/pm/PackageManagerInternal;
    ...
    iget-object v3, p0, Lcom/android/server/pm/bio;->tsu:Lcom/android/server/pm/permission/PermissionManagerServiceInternal;
