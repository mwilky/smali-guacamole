...
.method public expandScreenDecor(Lcom/android/server/wm/WindowState;Lcom/android/server/wm/WindowState;)V
    ...
    sget-boolean v2, Lcom/android/server/wm/OpScreenCompat;->mIsIgnoreCameraNotch:Z

    if-nez v2, :cond_5

    iget-boolean v2, v1, Lcom/android/server/wm/WindowState;->mIsNotchUnLimited:Z
    ...
    iget-object v7, v6, Lcom/android/server/wm/ActivityRecord;->mChildren:Lcom/android/server/wm/WindowList;
    ...
    iget-object v9, v6, Lcom/android/server/wm/ActivityRecord;->mChildren:Lcom/android/server/wm/WindowList;
    ...
    sget-boolean v10, Lcom/android/server/wm/OpScreenCompat;->mIsIgnoreCameraNotch:Z

    if-nez v10, :cond_8

    iget-boolean v10, v9, Lcom/android/server/wm/WindowState;->mIsNotchUnLimited:Z

    if-nez v10, :cond_7

    invoke-virtual {v9}, Lcom/android/server/wm/WindowState;->isLetterboxedAppWindow()Z
    ...
    :cond_b
    :goto_6
    iget-object v2, p0, Lcom/android/server/wm/OpScreenCompat;->mOpScreenDecor:Lcom/android/server/wm/p;

    iget-boolean v2, v2, Lcom/android/server/wm/p;->ywr:Z
    ...
    sget-boolean v6, Lcom/android/server/wm/OpScreenCompat;->mIsIgnoreCameraNotch:Z
    ...
    iget-boolean v0, v3, Lcom/android/server/wm/WindowState;->mIsNotchUnLimited:Z
    ...
    invoke-virtual {p0, v4}, Lcom/android/server/wm/p;->ssp(Z)V
...
.method public getScreenExpandOffset(Lcom/android/server/wm/WindowState;)I
    ...
    iget-boolean v0, v0, Lcom/android/server/wm/p;->ywr:Z
...
.method public onConfigurationChanged()V
    ...
    invoke-virtual {p0}, Lcom/android/server/wm/p;->igw()V
