.class Lcom/oneplus/android/server/rtg/zta;
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/oneplus/android/server/rtg/zta;->you:Z

    const/4 v0, 0x0

    sput-object v0, Lcom/oneplus/android/server/rtg/zta;->sis:Ljava/lang/String;
    ...
    sput-object v0, Lcom/oneplus/android/server/rtg/zta;->zgw:[Ljava/lang/String;

    new-instance v0, Ljava/util/HashSet;

    invoke-direct {v0}, Ljava/util/HashSet;-><init>()V

    sput-object v0, Lcom/oneplus/android/server/rtg/zta;->obl:Ljava/util/HashSet;
...
.method public static cno(Landroid/content/Context;Ljava/lang/String;)V
    ...
    invoke-static {}, Lcom/oneplus/android/server/rtg/zta;->bio()Z
    ...
    :cond_0
    sget-boolean v0, Lcom/oneplus/android/server/rtg/zta;->you:Z
    ...
    invoke-static {p0, p1}, Lcom/oneplus/android/server/rtg/zta;->sis(Landroid/content/Context;Ljava/lang/String;)V
...
.method public static kth(Landroid/content/Context;Ljava/lang/String;I)V
    ...
    sget-object v0, Lcom/oneplus/android/server/rtg/zta;->zgw:[Ljava/lang/String;

    array-length v0, v0

    if-ge p2, v0, :cond_4

    invoke-static {p1}, Lcom/oneplus/android/server/rtg/zta;->tsu(Ljava/lang/String;)Z
    ...
    :goto_1
    invoke-static {p0, p1, p2}, Lcom/oneplus/android/server/rtg/zta;->zta(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)V
...
.method public static rtg(Landroid/content/Context;Ljava/lang/String;)V
    ...
    :cond_0
    sget-object v0, Lcom/oneplus/android/server/rtg/zta;->sis:Ljava/lang/String;
    ...
    invoke-static {p0, p1, v0}, Lcom/oneplus/android/server/rtg/zta;->you(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)V
    ...
    sget-object v2, Lcom/oneplus/android/server/rtg/zta;->sis:Ljava/lang/String;
    ...
    sget-boolean p0, Lcom/oneplus/android/server/rtg/zta;->you:Z
    ...
    :cond_2
    sput-object p1, Lcom/oneplus/android/server/rtg/zta;->sis:Ljava/lang/String;
...
.method private static sis(Landroid/content/Context;Ljava/lang/String;)V
    ...
    sget-object v0, Lcom/oneplus/android/server/rtg/zta;->obl:Ljava/util/HashSet;

    monitor-enter v0

    :try_start_0
    sget-object v1, Lcom/oneplus/android/server/rtg/zta;->obl:Ljava/util/HashSet;
    ...
    invoke-static {p0, p1, v1}, Lcom/oneplus/android/server/rtg/zta;->you(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)V
