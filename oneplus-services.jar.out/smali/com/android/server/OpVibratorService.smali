...
.field private mInGlobalDarkMode:Z
...
.field private mToBeWeakenOnce:Z
...
.field private sLinearMotorVibrateService:Lyou/zta/you/you/zta/zta;
...
.method public constructor <init>()V
    ...
    iput-object v2, p0, Lcom/android/server/OpVibratorService;->imPkg:Ljava/lang/String;

    const-string v2, "/sys/class/leds/vibrator/vmax_mv"

    iput-object v2, p0, Lcom/android/server/OpVibratorService;->mVibratorIntensityPath:Ljava/lang/String;

    iput-boolean v1, p0, Lcom/android/server/OpVibratorService;->mInGlobalDarkMode:Z

    iput-boolean v1, p0, Lcom/android/server/OpVibratorService;->mToBeWeakenOnce:Z

    const/4 v1, 0x0

    iput-object v1, p0, Lcom/android/server/OpVibratorService;->sLinearMotorVibrateService:Lyou/zta/you/you/zta/zta;
...
.method private adjustForDarkMode(I)I
    .locals 5

    iget-boolean v0, p0, Lcom/android/server/OpVibratorService;->mInGlobalDarkMode:Z

    const/4 v1, 0x0

    if-eqz v0, :cond_2

    iget-boolean v0, p0, Lcom/android/server/OpVibratorService;->mToBeWeakenOnce:Z
    ...
    const-string v4, "Adjust For DarkMode from "
    ...
    const-string v3, "Skip Adjust For DarkMode. Keep ["
    ...
    iget-boolean v3, p0, Lcom/android/server/OpVibratorService;->mInGlobalDarkMode:Z

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Z)Ljava/lang/StringBuilder;

    const-string v3, ", ToBeWeakenOnce? "

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-boolean v3, p0, Lcom/android/server/OpVibratorService;->mToBeWeakenOnce:Z
...
.method private getLinearMotorVibrateService()Lyou/zta/you/you/zta/zta;
    .locals 3

    iget-object v0, p0, Lcom/android/server/OpVibratorService;->sLinearMotorVibrateService:Lyou/zta/you/you/zta/zta;

    if-nez v0, :cond_0

    :try_start_0
    invoke-static {}, Lyou/zta/you/you/zta/zta;->ywr()Lyou/zta/you/you/zta/zta;

    move-result-object v0

    iput-object v0, p0, Lcom/android/server/OpVibratorService;->sLinearMotorVibrateService:Lyou/zta/you/you/zta/zta;
    :try_end_0
    ...
    :cond_0
    :goto_0
    iget-object p0, p0, Lcom/android/server/OpVibratorService;->sLinearMotorVibrateService:Lyou/zta/you/you/zta/zta;
...
.method public markWeakenFlagForDarkMode(Landroid/os/VibrationAttributes;)V
    .locals 3
    ...
    iput-boolean v0, p0, Lcom/android/server/OpVibratorService;->mToBeWeakenOnce:Z
    ...
    invoke-virtual {p1}, Landroid/os/VibrationAttributes;->toString()Ljava/lang/String;

    move-result-object p1

    invoke-virtual {v1, p1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    const-string p1, ", toBeWeaken(Not Alarm)? "

    invoke-virtual {v1, p1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-boolean p0, p0, Lcom/android/server/OpVibratorService;->mToBeWeakenOnce:Z
...
.method public setGlobalDarkMode(Z)V
    .locals 0

    iput-boolean p1, p0, Lcom/android/server/OpVibratorService;->mInGlobalDarkMode:Z
...
.method public turnOffLinearMotorVibrator()V
    ...
    :try_start_0
    invoke-direct {p0}, Lcom/android/server/OpVibratorService;->getLinearMotorVibrateService()Lyou/zta/you/you/zta/zta;
    ...
    invoke-interface {p0}, Lyou/zta/you/you/zta/zta;->l1()V
    :try_end_0
...
.method public turnOnLinearmotorVibrator(IJI)V
    ...
    invoke-interface {p0, p2, p1, p3}, Lyou/zta/you/you/zta/zta;->Q(ISS)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public vibrate(ILandroid/os/VibrationEffect;Ljava/lang/String;Ljava/lang/String;)Landroid/os/VibrationEffect;
    ...
    :cond_19
    iget v5, v0, Lcom/android/server/OpVibratorService;->intensityStrengthType:I

    invoke-direct {v0, v5}, Lcom/android/server/OpVibratorService;->adjustForDarkMode(I)I
    ...
    iget v4, v0, Lcom/android/server/OpVibratorService;->intensityEffectType:I

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    const-string v4, ", intensityStrengthType = "

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget v0, v0, Lcom/android/server/OpVibratorService;->intensityStrengthType:I
