...
.method static constructor <clinit>()V
    ...
    sput-boolean v1, Lcom/oneplus/server/zta;->q:Z
    ...
    sput-object v1, Lcom/oneplus/server/zta;->z:[[C
...
.method private constructor <init>()V
    ...
    const-string v3, "oneplus_screen_refresh_rate"

    invoke-static {v3}, Landroid/provider/Settings$Global;->getUriFor(Ljava/lang/String;)Landroid/net/Uri;

    move-result-object v3

    iput-object v3, p0, Lcom/oneplus/server/zta;->ivd:Landroid/net/Uri;
    ...
    iput-object v3, p0, Lcom/oneplus/server/zta;->a:Landroid/net/Uri;

    iput v0, p0, Lcom/oneplus/server/zta;->c:I

    const-string v3, ""

    iput-object v3, p0, Lcom/oneplus/server/zta;->d:Ljava/lang/String;

    iput-boolean v0, p0, Lcom/oneplus/server/zta;->e:Z

    new-instance v3, Lcom/oneplus/server/zta$zta;

    invoke-direct {v3, p0}, Lcom/oneplus/server/zta$zta;-><init>(Lcom/oneplus/server/zta;)V

    iput-object v3, p0, Lcom/oneplus/server/zta;->f:Lcom/android/server/wm/OpWindowManagerService$zta;
    ...
    iput-object v2, p0, Lcom/oneplus/server/zta;->j:Ljava/util/HashSet;

    new-instance v2, Ljava/util/HashSet;

    invoke-direct {v2}, Ljava/util/HashSet;-><init>()V

    iput-object v2, p0, Lcom/oneplus/server/zta;->k:Ljava/util/HashSet;

    new-instance v2, Lcom/oneplus/server/zta$sis;

    invoke-direct {v2, p0}, Lcom/oneplus/server/zta$sis;-><init>(Lcom/oneplus/server/zta;)V

    iput-object v2, p0, Lcom/oneplus/server/zta;->l:Landroid/content/BroadcastReceiver;

    invoke-direct {p0}, Lcom/oneplus/server/zta;->F()V

    :goto_0
    sget-object v2, Lcom/oneplus/server/zta;->z:[[C
    ...
    invoke-static {v2, v3}, Lcom/oneplus/server/zta;->g([CI)Ljava/lang/String;

    move-result-object v2

    iget-object v3, p0, Lcom/oneplus/server/zta;->j:Ljava/util/HashSet;
    ...
    iget-object v3, p0, Lcom/oneplus/server/zta;->lqr:Ljava/util/HashMap;
...
.method private A(Lorg/json/JSONArray;)V
    ...
    invoke-direct {p0, p1, v0}, Lcom/oneplus/server/zta;->x(ZLjava/lang/String;)V
    ...
    invoke-direct {p0, v5, v4}, Lcom/oneplus/server/zta;->E(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {p0, v4, v5}, Lcom/oneplus/server/zta;->x(ZLjava/lang/String;)V
    ...
    invoke-direct {p0, v4, v6}, Lcom/oneplus/server/zta;->x(ZLjava/lang/String;)V
    ...
    invoke-direct {p0, v4}, Lcom/oneplus/server/zta;->J(Z)V
    ...
    invoke-direct {p0, v6, v4}, Lcom/oneplus/server/zta;->x(ZLjava/lang/String;)V
    ...
    invoke-direct {p0, v4}, Lcom/oneplus/server/zta;->L(I)V
    ...
    invoke-direct {p0, v3, v4}, Lcom/oneplus/server/zta;->x(ZLjava/lang/String;)V
    :try_end_18
    ...
    invoke-direct {p0}, Lcom/oneplus/server/zta;->I()V
    :try_end_1a
    ...
    invoke-direct {p0, v0, p1}, Lcom/oneplus/server/zta;->x(ZLjava/lang/String;)V
...
.method private C(I)V
    ...
    invoke-direct {p0}, Lcom/oneplus/server/zta;->r()V
...
.method private E(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {p0, v1, v2}, Lcom/oneplus/server/zta;->x(ZLjava/lang/String;)V
...
.method private I()V
    ...
    invoke-direct {p0, v2, v3}, Lcom/oneplus/server/zta;->x(ZLjava/lang/String;)V
    ...
    :try_start_4
    invoke-direct {p0, v1}, Lcom/oneplus/server/zta;->Q(Z)V
...
.method private O(I)V
    ...
    invoke-direct {p0, v0, v1}, Lcom/oneplus/server/zta;->x(ZLjava/lang/String;)V
...
.method private P()V
    ...
    invoke-direct {p0, v0}, Lcom/oneplus/server/zta;->Q(Z)V
...
.method private Q(Z)V
    ...
    invoke-direct {p0}, Lcom/oneplus/server/zta;->v()Z
    ...
    :cond_0
    invoke-direct {p0}, Lcom/oneplus/server/zta;->h()I
    ...
    invoke-direct {p0, p1, v1}, Lcom/oneplus/server/zta;->x(ZLjava/lang/String;)V
...
.method static synthetic bvj(Lcom/oneplus/server/zta;I)V
    ...
    invoke-direct {p0, p1}, Lcom/oneplus/server/zta;->C(I)V
...
.method private c()V
    ...
    invoke-direct {p0, v0}, Lcom/oneplus/server/zta;->D(I)V
...
.method private static g([CI)Ljava/lang/String;
    .locals 4
...
.method private j(I)V
    ...
    invoke-direct {p0, v0}, Lcom/oneplus/server/zta;->O(I)V
...
.method static synthetic les(Lcom/oneplus/server/zta;Lorg/json/JSONArray;)V
    ...
    invoke-direct {p0, p1}, Lcom/oneplus/server/zta;->A(Lorg/json/JSONArray;)V
...
.method public static q()Lcom/oneplus/server/zta;
    .locals 1
...
.method static synthetic qbh(Lcom/oneplus/server/zta;)V
    ...
    invoke-direct {p0}, Lcom/oneplus/server/zta;->P()V
...
.method static synthetic vju(Lcom/oneplus/server/zta;ZLjava/lang/String;)V
    ...
    invoke-direct {p0, p1, p2}, Lcom/oneplus/server/zta;->x(ZLjava/lang/String;)V
...
.method public B(Ljava/lang/String;)V
    ...
    invoke-direct {p0, v1, p1}, Lcom/oneplus/server/zta;->x(ZLjava/lang/String;)V

    iget-boolean p1, p0, Lcom/oneplus/server/zta;->ssp:Z

    if-eqz p1, :cond_1

    invoke-direct {p0, v2}, Lcom/oneplus/server/zta;->O(I)V
...
.method public R(Ljava/lang/String;FD)V
    .locals 0
    ...
    invoke-direct {p0, p2}, Lcom/oneplus/server/zta;->O(I)V
...
.method public i(Ljava/lang/String;I)V
    ...
    :cond_1
    invoke-direct/range {p0 .. p0}, Lcom/oneplus/server/zta;->v()Z
    ...
    invoke-direct {v0, v9}, Lcom/oneplus/server/zta;->j(I)V
    ...
    invoke-direct {v0, v10, v11}, Lcom/oneplus/server/zta;->k(D)D
    ...
    :goto_0
    invoke-direct {v0, v10, v11, v1, v2}, Lcom/oneplus/server/zta;->l(DD)I
    ...
    invoke-direct/range {v1 .. v7}, Lcom/oneplus/server/zta;->p(DDD)D
    ...
    invoke-direct/range {v1 .. v6}, Lcom/oneplus/server/zta;->o(DDI)D
    ...
    invoke-direct/range {v1 .. v8}, Lcom/oneplus/server/zta;->H(IIDDI)V
...
.method public t(Ljava/io/PrintWriter;[Ljava/lang/String;)Z
    .locals 6
    ...
    :cond_a
    invoke-direct {p0, p1}, Lcom/oneplus/server/zta;->y(Ljava/io/PrintWriter;)V
    :try_end_14
    .catch Ljava/lang/Exception; {:try_start_14 .. :try_end_14} :catch_0
...
.method public u(Landroid/content/Context;)V
    ...
    invoke-direct {p0}, Lcom/oneplus/server/zta;->z()V
