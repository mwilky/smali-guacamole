...
.field private bud:Lcom/android/server/wm/m$zta;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/server/wm/m;->q:Landroid/view/animation/Interpolator;
...
.method public constructor <init>(Landroid/content/Context;Lcom/android/server/wm/DisplayContent;ZZLcom/android/server/wm/WindowManagerService;I)V
    ...
    iput-object v5, v1, Lcom/android/server/wm/m;->zta:Landroid/util/BoostFramework;

    const/4 v6, 0x0

    iput-boolean v6, v1, Lcom/android/server/wm/m;->you:Z

    const/16 v7, 0x9

    new-array v7, v7, [F

    iput-object v7, v1, Lcom/android/server/wm/m;->rtg:[F

    new-instance v7, Landroid/view/animation/Transformation;

    invoke-direct {v7}, Landroid/view/animation/Transformation;-><init>()V

    iput-object v7, v1, Lcom/android/server/wm/m;->ssp:Landroid/view/animation/Transformation;

    new-instance v7, Landroid/view/animation/Transformation;

    invoke-direct {v7}, Landroid/view/animation/Transformation;-><init>()V

    iput-object v7, v1, Lcom/android/server/wm/m;->cno:Landroid/view/animation/Transformation;

    new-instance v7, Landroid/view/animation/Transformation;

    invoke-direct {v7}, Landroid/view/animation/Transformation;-><init>()V

    iput-object v7, v1, Lcom/android/server/wm/m;->kth:Landroid/view/animation/Transformation;

    new-instance v7, Landroid/graphics/Matrix;

    invoke-direct {v7}, Landroid/graphics/Matrix;-><init>()V

    iput-object v7, v1, Lcom/android/server/wm/m;->bio:Landroid/graphics/Matrix;

    iput-boolean v6, v1, Lcom/android/server/wm/m;->oif:Z

    new-instance v7, Landroid/graphics/Rect;

    invoke-direct {v7}, Landroid/graphics/Rect;-><init>()V

    iput-object v7, v1, Lcom/android/server/wm/m;->obl:Landroid/graphics/Rect;

    new-instance v7, Landroid/graphics/Rect;

    invoke-direct {v7}, Landroid/graphics/Rect;-><init>()V

    iput-object v7, v1, Lcom/android/server/wm/m;->oxb:Landroid/graphics/Rect;

    const/4 v7, 0x1

    iput-boolean v7, v1, Lcom/android/server/wm/m;->vdw:Z

    iput-boolean v6, v1, Lcom/android/server/wm/m;->qeg:Z

    iput-boolean v6, v1, Lcom/android/server/wm/m;->ivd:Z

    iput-boolean v6, v1, Lcom/android/server/wm/m;->a:Z

    iput-boolean v6, v1, Lcom/android/server/wm/m;->b:Z

    iput-boolean v6, v1, Lcom/android/server/wm/m;->c:Z

    iput-boolean v6, v1, Lcom/android/server/wm/m;->d:Z

    invoke-static {}, Lcom/android/server/policy/OpPhoneWindowManagerInjector;->isGestureButtonEnabled()Z

    move-result v8

    iput-boolean v8, v1, Lcom/android/server/wm/m;->e:Z
    ...
    iput-object v8, v1, Lcom/android/server/wm/m;->h:Landroid/view/animation/Interpolator;

    move-object/from16 v8, p5

    iput-object v8, v1, Lcom/android/server/wm/m;->igw:Lcom/android/server/wm/WindowManagerService;

    iput-object v0, v1, Lcom/android/server/wm/m;->sis:Landroid/content/Context;

    iput-object v2, v1, Lcom/android/server/wm/m;->tsu:Lcom/android/server/wm/DisplayContent;

    iget-object v8, v1, Lcom/android/server/wm/m;->obl:Landroid/graphics/Rect;

    invoke-virtual {v2, v8}, Lcom/android/server/wm/DisplayContent;->getBounds(Landroid/graphics/Rect;)V

    iput v4, v1, Lcom/android/server/wm/m;->f:I
    ...
    iput-object v0, v1, Lcom/android/server/wm/m;->g:Landroid/view/animation/Interpolator;

    new-instance v0, Landroid/view/animation/LinearInterpolator;

    invoke-direct {v0}, Landroid/view/animation/LinearInterpolator;-><init>()V

    iput-object v0, v1, Lcom/android/server/wm/m;->i:Landroid/view/animation/Interpolator;

    new-instance v0, Landroid/util/BoostFramework;

    invoke-direct {v0}, Landroid/util/BoostFramework;-><init>()V

    iput-object v0, v1, Lcom/android/server/wm/m;->zta:Landroid/util/BoostFramework;
    ...
    iput-object v10, v1, Lcom/android/server/wm/m;->j:Landroid/view/DisplayInfo;

    if-eqz p3, :cond_0

    iput-boolean v7, v1, Lcom/android/server/wm/m;->vju:Z
    ...
    :cond_1
    iput v10, v1, Lcom/android/server/wm/m;->bvj:I

    iput v12, v1, Lcom/android/server/wm/m;->ibl:I

    goto :goto_2

    :cond_2
    :goto_1
    iput v12, v1, Lcom/android/server/wm/m;->bvj:I

    iput v10, v1, Lcom/android/server/wm/m;->ibl:I
    ...
    :pswitch_0
    iput-boolean v6, v1, Lcom/android/server/wm/m;->vdw:Z

    goto :goto_3

    :cond_3
    iput-boolean v7, v1, Lcom/android/server/wm/m;->a:Z
    ...
    :goto_3
    iget-boolean v14, v1, Lcom/android/server/wm/m;->a:Z
    ...
    iput-boolean v7, v1, Lcom/android/server/wm/m;->ivd:Z
    ...
    iput-boolean v7, v1, Lcom/android/server/wm/m;->qeg:Z
    ...
    iput-boolean v7, v1, Lcom/android/server/wm/m;->d:Z
    ...
    iput-boolean v7, v1, Lcom/android/server/wm/m;->b:Z
    ...
    iput-boolean v7, v1, Lcom/android/server/wm/m;->c:Z
    ...
    invoke-static {}, Lcom/android/server/wm/k;->zta()Lcom/android/server/wm/ActivityRecord;
    ...
    invoke-static {}, Lcom/android/server/wm/k;->you()Lcom/android/server/wm/ActivityRecord;
    ...
    iget-boolean v9, v1, Lcom/android/server/wm/m;->qeg:Z
    ...
    iget-boolean v9, v1, Lcom/android/server/wm/m;->ivd:Z
    ...
    iget-boolean v9, v1, Lcom/android/server/wm/m;->d:Z
    ...
    iget-boolean v9, v1, Lcom/android/server/wm/m;->vdw:Z
    ...
    iget-boolean v9, v1, Lcom/android/server/wm/m;->a:Z
    ...
    iget-boolean v9, v1, Lcom/android/server/wm/m;->b:Z
    ...
    iget-boolean v9, v1, Lcom/android/server/wm/m;->c:Z
    ...
    :cond_10
    iput v8, v1, Lcom/android/server/wm/m;->gwm:I

    iput v10, v1, Lcom/android/server/wm/m;->ugm:I

    iput v12, v1, Lcom/android/server/wm/m;->vdb:I

    new-instance v4, Lcom/android/server/wm/m$zta;

    invoke-direct {v4, v1}, Lcom/android/server/wm/m$zta;-><init>(Lcom/android/server/wm/m;)V

    iput-object v4, v1, Lcom/android/server/wm/m;->bud:Lcom/android/server/wm/m$zta;

    iget-object v4, v1, Lcom/android/server/wm/m;->igw:Lcom/android/server/wm/WindowManagerService;
    ...
    iput-object v5, v1, Lcom/android/server/wm/m;->dma:Landroid/view/SurfaceControl;

    iget-boolean v5, v1, Lcom/android/server/wm/m;->qeg:Z

    if-nez v5, :cond_12

    iget-boolean v5, v1, Lcom/android/server/wm/m;->a:Z
    ...
    iget v9, v1, Lcom/android/server/wm/m;->bvj:I

    iget v10, v1, Lcom/android/server/wm/m;->ibl:I
    ...
    :goto_a
    iput-object v5, v1, Lcom/android/server/wm/m;->gck:Landroid/view/SurfaceControl;

    goto :goto_c

    :cond_12
    :goto_b
    iput-boolean v7, v1, Lcom/android/server/wm/m;->oif:Z
    ...
    iput-object v5, v1, Lcom/android/server/wm/m;->wtn:Landroid/view/SurfaceControl;
    ...
    iput-object v3, v1, Lcom/android/server/wm/m;->ywr:Landroid/view/SurfaceControl;

    iget-object v3, v1, Lcom/android/server/wm/m;->igw:Lcom/android/server/wm/WindowManagerService;
    ...
    iget-object v5, v1, Lcom/android/server/wm/m;->gck:Landroid/view/SurfaceControl;
    ...
    iget-object v5, v1, Lcom/android/server/wm/m;->igw:Lcom/android/server/wm/WindowManagerService;
    ...
    iput v0, v1, Lcom/android/server/wm/m;->les:F

    iget-object v0, v1, Lcom/android/server/wm/m;->gck:Landroid/view/SurfaceControl;
    ...
    :goto_d
    iget-object v0, v1, Lcom/android/server/wm/m;->ywr:Landroid/view/SurfaceControl;
    ...
    iget-object v0, v1, Lcom/android/server/wm/m;->dma:Landroid/view/SurfaceControl;
    ...
    iget v5, v1, Lcom/android/server/wm/m;->les:F
    ...
    iget v6, v1, Lcom/android/server/wm/m;->les:F
    ...
    iget-object v2, v1, Lcom/android/server/wm/m;->gck:Landroid/view/SurfaceControl;
    ...
    :cond_15
    invoke-virtual {v1, v4, v8}, Lcom/android/server/wm/m;->setRotation(Landroid/view/SurfaceControl$Transaction;I)V
...
.method static synthetic bio(Lcom/android/server/wm/m;)Landroid/view/SurfaceControl;
    .locals 0

    iget-object p0, p0, Lcom/android/server/wm/m;->dma:Landroid/view/SurfaceControl;

    return-object p0
.end method

.method static synthetic bvj(Lcom/android/server/wm/m;)Z
    .locals 0

    iget-boolean p0, p0, Lcom/android/server/wm/m;->oif:Z

    return p0
.end method

.method static synthetic cno(Lcom/android/server/wm/m;)F
    .locals 0

    iget p0, p0, Lcom/android/server/wm/m;->les:F

    return p0
.end method

.method static synthetic dma(Lcom/android/server/wm/m;)I
    .locals 0

    iget p0, p0, Lcom/android/server/wm/m;->bvj:I

    return p0
.end method

.method static synthetic gck(Lcom/android/server/wm/m;)I
    .locals 0

    iget p0, p0, Lcom/android/server/wm/m;->ibl:I
...
.method private gwm(Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Point;)Landroid/view/animation/Animation;
    ...
    :cond_0
    new-instance p2, Lcom/android/server/wm/w/zta;

    iget-object p3, p0, Lcom/android/server/wm/m;->igw:Lcom/android/server/wm/WindowManagerService;

    invoke-virtual {p3}, Lcom/android/server/wm/WindowManagerService;->getTransitionAnimationScaleLocked()F

    move-result p3

    invoke-direct {p2, v4, p1, p3}, Lcom/android/server/wm/w/zta;-><init>(Landroid/graphics/Rect;Landroid/graphics/Rect;F)V

    iget-object p1, p0, Lcom/android/server/wm/m;->i:Landroid/view/animation/Interpolator;
    ...
    iget-object p0, p0, Lcom/android/server/wm/m;->igw:Lcom/android/server/wm/WindowManagerService;
...
.method private ibl(Landroid/graphics/Rect;I)Landroid/graphics/Point;
    ...
    iget p2, p0, Lcom/android/server/wm/m;->vdb:I
    ...
    iget p0, p0, Lcom/android/server/wm/m;->ugm:I
    ...
    iget v1, p0, Lcom/android/server/wm/m;->vdb:I
...
.method static synthetic igw(Lcom/android/server/wm/m;)Lcom/android/server/wm/DisplayContent;
    .locals 0

    iget-object p0, p0, Lcom/android/server/wm/m;->tsu:Lcom/android/server/wm/DisplayContent;

    return-object p0
.end method

.method static synthetic kth(Lcom/android/server/wm/m;)F
    .locals 0

    iget p0, p0, Lcom/android/server/wm/m;->irq:F
...
.method private obl(Landroid/view/SurfaceControl$Transaction;Landroid/graphics/Matrix;F)V
    ...
    iget-object v0, p0, Lcom/android/server/wm/m;->ywr:Landroid/view/SurfaceControl;
    ...
    :cond_0
    iget-object v0, p0, Lcom/android/server/wm/m;->rtg:[F

    invoke-virtual {p2, v0}, Landroid/graphics/Matrix;->getValues([F)V

    iget-object p2, p0, Lcom/android/server/wm/m;->rtg:[F
    ...
    iget-boolean v1, p0, Lcom/android/server/wm/m;->vju:Z

    if-eqz v1, :cond_1

    iget-object v1, p0, Lcom/android/server/wm/m;->tsu:Lcom/android/server/wm/DisplayContent;

    iget-object v2, p0, Lcom/android/server/wm/m;->oxb:Landroid/graphics/Rect;

    invoke-virtual {v1, v2}, Lcom/android/server/wm/DisplayContent;->getBounds(Landroid/graphics/Rect;)V

    iget-object v1, p0, Lcom/android/server/wm/m;->oxb:Landroid/graphics/Rect;
    ...
    :cond_1
    iget-object v1, p0, Lcom/android/server/wm/m;->ywr:Landroid/view/SurfaceControl;
    ...
    iget-object v3, p0, Lcom/android/server/wm/m;->ywr:Landroid/view/SurfaceControl;
    ...
    iget-object p2, p0, Lcom/android/server/wm/m;->ywr:Landroid/view/SurfaceControl;
    ...
    iget-object p0, p0, Lcom/android/server/wm/m;->ywr:Landroid/view/SurfaceControl;
...
.method static synthetic oif(Lcom/android/server/wm/m;)Landroid/view/SurfaceControl;
    .locals 0

    iget-object p0, p0, Lcom/android/server/wm/m;->wtn:Landroid/view/SurfaceControl;
...
.method private oxb(Landroid/view/SurfaceControl$Transaction;JFIIII)Z
    ...
    iget-object v6, v1, Lcom/android/server/wm/m;->gck:Landroid/view/SurfaceControl;

    if-eqz v6, :cond_21

    iget-object v6, v1, Lcom/android/server/wm/m;->ywr:Landroid/view/SurfaceControl;
    ...
    :cond_0
    iget-boolean v6, v1, Lcom/android/server/wm/m;->fto:Z
    ...
    :cond_1
    iput-boolean v12, v1, Lcom/android/server/wm/m;->fto:Z

    iget v6, v1, Lcom/android/server/wm/m;->zgw:I

    iget v7, v1, Lcom/android/server/wm/m;->gwm:I
    ...
    iget-object v7, v1, Lcom/android/server/wm/m;->sis:Landroid/content/Context;
    ...
    iput-object v4, v1, Lcom/android/server/wm/m;->cjf:Landroid/view/animation/Animation;

    iget-object v4, v1, Lcom/android/server/wm/m;->sis:Landroid/content/Context;

    invoke-static {v4, v5}, Landroid/view/animation/AnimationUtils;->loadAnimation(Landroid/content/Context;I)Landroid/view/animation/Animation;

    move-result-object v4

    iput-object v4, v1, Lcom/android/server/wm/m;->ear:Landroid/view/animation/Animation;
    ...
    iput-object v4, v1, Lcom/android/server/wm/m;->ire:Landroid/view/animation/Animation;
    ...
    :cond_3
    iget-boolean v12, v1, Lcom/android/server/wm/m;->a:Z
    ...
    :cond_4
    iget-boolean v12, v1, Lcom/android/server/wm/m;->c:Z
    ...
    :cond_5
    iget-boolean v5, v1, Lcom/android/server/wm/m;->b:Z
    ...
    :cond_7
    iget-boolean v5, v1, Lcom/android/server/wm/m;->ivd:Z

    if-eqz v5, :cond_a

    iget-boolean v5, v1, Lcom/android/server/wm/m;->e:Z

    if-eqz v5, :cond_9

    iget-boolean v5, v1, Lcom/android/server/wm/m;->d:Z

    if-eqz v5, :cond_8

    iget-object v5, v1, Lcom/android/server/wm/m;->sis:Landroid/content/Context;
    ...
    :cond_a
    iget-boolean v4, v1, Lcom/android/server/wm/m;->vdw:Z
    ...
    iget v5, v1, Lcom/android/server/wm/m;->zgw:I
    ...
    iget v5, v1, Lcom/android/server/wm/m;->gwm:I
    ...
    :cond_17
    iget-object v4, v1, Lcom/android/server/wm/m;->ear:Landroid/view/animation/Animation;

    iget v7, v1, Lcom/android/server/wm/m;->ugm:I

    iget v8, v1, Lcom/android/server/wm/m;->vdb:I
    ...
    iget-object v4, v1, Lcom/android/server/wm/m;->cjf:Landroid/view/animation/Animation;
    ...
    iget-object v5, v1, Lcom/android/server/wm/m;->tsu:Lcom/android/server/wm/DisplayContent;
    ...
    iget-object v4, v1, Lcom/android/server/wm/m;->tsu:Lcom/android/server/wm/DisplayContent;
    ...
    iget-object v6, v1, Lcom/android/server/wm/m;->tsu:Lcom/android/server/wm/DisplayContent;
    ...
    invoke-direct {v1, v4, v11}, Lcom/android/server/wm/m;->ibl(Landroid/graphics/Rect;I)Landroid/graphics/Point;

    move-result-object v5

    iget-boolean v6, v1, Lcom/android/server/wm/m;->qeg:Z
    ...
    iget-object v9, v1, Lcom/android/server/wm/m;->j:Landroid/view/DisplayInfo;
    ...
    invoke-direct {v1, v6, v8, v4, v5}, Lcom/android/server/wm/m;->gwm(Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Point;)Landroid/view/animation/Animation;
    ...
    iget-object v1, v1, Lcom/android/server/wm/m;->ear:Landroid/view/animation/Animation;
    ...
    :goto_b
    iget-object v5, v1, Lcom/android/server/wm/m;->ear:Landroid/view/animation/Animation;
    ...
    iget v5, v1, Lcom/android/server/wm/m;->ugm:I

    iget v6, v1, Lcom/android/server/wm/m;->vdb:I
    ...
    invoke-direct {v1, v4}, Lcom/android/server/wm/m;->ugm(Landroid/graphics/Rect;)Landroid/view/animation/Animation;

    move-result-object v4

    iput-object v4, v1, Lcom/android/server/wm/m;->hmo:Landroid/view/animation/Animation;

    invoke-virtual {v4, v2, v3}, Landroid/view/animation/Animation;->restrictDuration(J)V

    iget-object v4, v1, Lcom/android/server/wm/m;->hmo:Landroid/view/animation/Animation;

    invoke-virtual {v4, v0}, Landroid/view/animation/Animation;->scaleCurrentDuration(F)V

    iput-boolean v5, v1, Lcom/android/server/wm/m;->lqr:Z

    iput-boolean v5, v1, Lcom/android/server/wm/m;->veq:Z

    const-wide/16 v4, -0x1

    iput-wide v4, v1, Lcom/android/server/wm/m;->cgv:J

    if-eqz v15, :cond_1e

    iget-object v4, v1, Lcom/android/server/wm/m;->ire:Landroid/view/animation/Animation;

    invoke-virtual {v4, v2, v3}, Landroid/view/animation/Animation;->restrictDuration(J)V

    iget-object v2, v1, Lcom/android/server/wm/m;->ire:Landroid/view/animation/Animation;
    ...
    iget-object v0, v1, Lcom/android/server/wm/m;->qbh:Lcom/android/server/wm/BlackFrame;
    ...
    iget-object v2, v1, Lcom/android/server/wm/m;->igw:Lcom/android/server/wm/WindowManagerService;

    iget-object v3, v2, Lcom/android/server/wm/WindowManagerService;->mTransactionFactory:Ljava/util/function/Supplier;

    const v7, 0x1eab90

    iget-object v8, v1, Lcom/android/server/wm/m;->tsu:Lcom/android/server/wm/DisplayContent;

    const/4 v9, 0x0

    iget-object v10, v1, Lcom/android/server/wm/m;->wtn:Landroid/view/SurfaceControl;
    ...
    iput-object v0, v1, Lcom/android/server/wm/m;->qbh:Lcom/android/server/wm/BlackFrame;
    :try_end_0
    ...
    :cond_1f
    :goto_10
    iget-object v0, v1, Lcom/android/server/wm/m;->bud:Lcom/android/server/wm/m$zta;

    if-eqz v15, :cond_20

    invoke-virtual {v0}, Lcom/android/server/wm/m$zta;->bio()V

    goto :goto_11

    :cond_20
    invoke-virtual {v0}, Lcom/android/server/wm/m$zta;->gck()V
...
.method static synthetic qbh(Lcom/android/server/wm/m;)Landroid/view/animation/Animation;
    .locals 0

    iget-object p0, p0, Lcom/android/server/wm/m;->ire:Landroid/view/animation/Animation;

    return-object p0
.end method

.method static synthetic rtg(Lcom/android/server/wm/m;)Landroid/view/animation/Animation;
    .locals 0

    iget-object p0, p0, Lcom/android/server/wm/m;->hmo:Landroid/view/animation/Animation;

    return-object p0
.end method

.method static synthetic sis(Lcom/android/server/wm/m;)Landroid/view/animation/Animation;
    .locals 0

    iget-object p0, p0, Lcom/android/server/wm/m;->cjf:Landroid/view/animation/Animation;

    return-object p0
.end method

.method static synthetic ssp(Lcom/android/server/wm/m;)Landroid/content/Context;
    .locals 0

    iget-object p0, p0, Lcom/android/server/wm/m;->sis:Landroid/content/Context;

    return-object p0
.end method

.method static synthetic tsu(Lcom/android/server/wm/m;)Landroid/view/SurfaceControl;
    .locals 0
...
.method private vdb(IZLandroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Point;)Landroid/view/animation/Animation;
    ...
    new-instance v8, Lcom/android/server/wm/w/you;
    ...
    iget-object v6, v0, Lcom/android/server/wm/m;->g:Landroid/view/animation/Interpolator;
    ...
    invoke-direct/range {v1 .. v8}, Lcom/android/server/wm/w/you;-><init>(IIIIIILandroid/view/animation/Interpolator;)V

    sget-object v1, Lcom/android/server/wm/m;->q:Landroid/view/animation/Interpolator;
    ...
    iget-object v4, v0, Lcom/android/server/wm/m;->g:Landroid/view/animation/Interpolator;
    ...
    new-instance v1, Lcom/android/server/wm/w/sis;

    add-int/2addr v12, v15

    invoke-direct {v1, v15, v12, v11, v10}, Lcom/android/server/wm/w/sis;-><init>(IIII)V

    iget-object v2, v0, Lcom/android/server/wm/m;->h:Landroid/view/animation/Interpolator;
    ...
    iget-object v0, v0, Lcom/android/server/wm/m;->g:Landroid/view/animation/Interpolator;
...
.method static synthetic wtn(Lcom/android/server/wm/m;)Landroid/view/animation/Animation;
    .locals 0

    iget-object p0, p0, Lcom/android/server/wm/m;->ear:Landroid/view/animation/Animation;

    return-object p0
.end method

.method static synthetic you(Lcom/android/server/wm/m;)Lcom/android/server/wm/BlackFrame;
    .locals 0

    iget-object p0, p0, Lcom/android/server/wm/m;->qbh:Lcom/android/server/wm/BlackFrame;

    return-object p0
.end method

.method static synthetic ywr(Lcom/android/server/wm/m;)Landroid/view/SurfaceControl;
    .locals 0

    iget-object p0, p0, Lcom/android/server/wm/m;->gck:Landroid/view/SurfaceControl;
...
.method private zgw(Landroid/view/SurfaceControl$Transaction;Landroid/graphics/Matrix;FLandroid/graphics/Rect;)V
    ...
    iget-object v0, p0, Lcom/android/server/wm/m;->gck:Landroid/view/SurfaceControl;
    ...
    :cond_1
    iget-object v1, p0, Lcom/android/server/wm/m;->gck:Landroid/view/SurfaceControl;

    invoke-virtual {p1, v1, v0, p2}, Landroid/view/SurfaceControl$Transaction;->setPosition(Landroid/view/SurfaceControl;FF)Landroid/view/SurfaceControl$Transaction;

    iget-object v3, p0, Lcom/android/server/wm/m;->gck:Landroid/view/SurfaceControl;
    ...
    iget-object p2, p0, Lcom/android/server/wm/m;->gck:Landroid/view/SurfaceControl;
...
.method static synthetic zta(Lcom/android/server/wm/m;)Lcom/android/server/wm/WindowManagerService;
    .locals 0
...
.method public dismiss(Landroid/view/SurfaceControl$Transaction;JFIIII)Z
    ...
    :cond_0
    iget-boolean v0, p0, Lcom/android/server/wm/m;->fto:Z

    const/4 v2, 0x1

    if-nez v0, :cond_2

    iget-object v0, p0, Lcom/android/server/wm/m;->tsu:Lcom/android/server/wm/DisplayContent;

    invoke-virtual {v0}, Lcom/android/server/wm/DisplayContent;->getDisplay()Landroid/view/Display;

    move-result-object v0

    iget-object v3, p0, Lcom/android/server/wm/m;->tsu:Lcom/android/server/wm/DisplayContent;
    ...
    iput v0, p0, Lcom/android/server/wm/m;->irq:F

    invoke-direct/range {p0 .. p8}, Lcom/android/server/wm/m;->oxb(Landroid/view/SurfaceControl$Transaction;JFIIII)Z

    iget-object p1, p0, Lcom/android/server/wm/m;->zta:Landroid/util/BoostFramework;

    if-eqz p1, :cond_1

    iget-boolean p2, p0, Lcom/android/server/wm/m;->you:Z
    ...
    iput-boolean v2, p0, Lcom/android/server/wm/m;->you:Z
    ...
    :cond_2
    iget-boolean p1, p0, Lcom/android/server/wm/m;->fto:Z
    ...
    :cond_3
    iput-boolean v2, p0, Lcom/android/server/wm/m;->veq:Z
...
.method public dumpDebug(Landroid/util/proto/ProtoOutputStream;J)V
    ...
    iget-boolean p0, p0, Lcom/android/server/wm/m;->lqr:Z
...
.method public getEnterTransformation()Landroid/view/animation/Transformation;
    ...
    iget-object p0, p0, Lcom/android/server/wm/m;->kth:Landroid/view/animation/Transformation;
...
.method public isAnimating()Z
    ...
    iget-object p0, p0, Lcom/android/server/wm/m;->bud:Lcom/android/server/wm/m$zta;

    if-eqz p0, :cond_0

    invoke-virtual {p0}, Lcom/android/server/wm/m$zta;->tsu()Z
...
.method public isRotating()Z
    ...
    iget v0, p0, Lcom/android/server/wm/m;->zgw:I

    iget p0, p0, Lcom/android/server/wm/m;->gwm:I
...
.method public kill()V
    ...
    iget-object v0, p0, Lcom/android/server/wm/m;->bud:Lcom/android/server/wm/m$zta;

    const/4 v1, 0x0

    if-eqz v0, :cond_0

    invoke-virtual {v0}, Lcom/android/server/wm/m$zta;->zta()V

    iput-object v1, p0, Lcom/android/server/wm/m;->bud:Lcom/android/server/wm/m$zta;
    ...
    iget-object v5, p0, Lcom/android/server/wm/m;->gck:Landroid/view/SurfaceControl;
    ...
    :cond_1
    iget-object v0, p0, Lcom/android/server/wm/m;->igw:Lcom/android/server/wm/WindowManagerService;
    ...
    :cond_2
    iput-object v1, p0, Lcom/android/server/wm/m;->gck:Landroid/view/SurfaceControl;

    iget-object v5, p0, Lcom/android/server/wm/m;->wtn:Landroid/view/SurfaceControl;
    ...
    :cond_3
    iput-object v1, p0, Lcom/android/server/wm/m;->wtn:Landroid/view/SurfaceControl;

    :cond_4
    iget-object v5, p0, Lcom/android/server/wm/m;->dma:Landroid/view/SurfaceControl;
    ...
    :cond_5
    iput-object v1, p0, Lcom/android/server/wm/m;->dma:Landroid/view/SurfaceControl;
    ...
    iget-object v2, p0, Lcom/android/server/wm/m;->ywr:Landroid/view/SurfaceControl;
    ...
    :cond_9
    iput-object v1, p0, Lcom/android/server/wm/m;->ywr:Landroid/view/SurfaceControl;

    invoke-virtual {v0}, Landroid/view/SurfaceControl$Transaction;->apply()V

    :cond_a
    iget-object v0, p0, Lcom/android/server/wm/m;->qbh:Lcom/android/server/wm/BlackFrame;

    if-eqz v0, :cond_b

    invoke-virtual {v0}, Lcom/android/server/wm/BlackFrame;->kill()V

    iput-object v1, p0, Lcom/android/server/wm/m;->qbh:Lcom/android/server/wm/BlackFrame;

    :cond_b
    iget-object v0, p0, Lcom/android/server/wm/m;->cjf:Landroid/view/animation/Animation;

    if-eqz v0, :cond_c

    invoke-virtual {v0}, Landroid/view/animation/Animation;->cancel()V

    iput-object v1, p0, Lcom/android/server/wm/m;->cjf:Landroid/view/animation/Animation;

    :cond_c
    iget-object v0, p0, Lcom/android/server/wm/m;->ear:Landroid/view/animation/Animation;

    if-eqz v0, :cond_d

    invoke-virtual {v0}, Landroid/view/animation/Animation;->cancel()V

    iput-object v1, p0, Lcom/android/server/wm/m;->ear:Landroid/view/animation/Animation;

    :cond_d
    iget-object v0, p0, Lcom/android/server/wm/m;->ire:Landroid/view/animation/Animation;

    if-eqz v0, :cond_e

    invoke-virtual {v0}, Landroid/view/animation/Animation;->cancel()V

    iput-object v1, p0, Lcom/android/server/wm/m;->ire:Landroid/view/animation/Animation;

    :cond_e
    iget-object v0, p0, Lcom/android/server/wm/m;->hmo:Landroid/view/animation/Animation;

    if-eqz v0, :cond_f

    invoke-virtual {v0}, Landroid/view/animation/Animation;->cancel()V

    iput-object v1, p0, Lcom/android/server/wm/m;->hmo:Landroid/view/animation/Animation;

    :cond_f
    iget-object v0, p0, Lcom/android/server/wm/m;->zta:Landroid/util/BoostFramework;

    const/4 v1, 0x0

    if-eqz v0, :cond_10

    iget-boolean v2, p0, Lcom/android/server/wm/m;->you:Z

    if-eqz v2, :cond_10

    invoke-virtual {v0}, Landroid/util/BoostFramework;->perfLockRelease()I

    iput-boolean v1, p0, Lcom/android/server/wm/m;->you:Z
...
.method public printTo(Ljava/lang/String;Ljava/io/PrintWriter;)V
    ...
    iget v0, p0, Lcom/android/server/wm/m;->bvj:I
    ...
    iget v0, p0, Lcom/android/server/wm/m;->ibl:I
    ...
    iget v0, p0, Lcom/android/server/wm/m;->gwm:I
    ...
    iget v0, p0, Lcom/android/server/wm/m;->ugm:I
    ...
    iget v0, p0, Lcom/android/server/wm/m;->vdb:I
    ...
    iget-boolean v0, p0, Lcom/android/server/wm/m;->lqr:Z
    ...
    iget-boolean v0, p0, Lcom/android/server/wm/m;->veq:Z
    ...
    iget-wide v0, p0, Lcom/android/server/wm/m;->cgv:J
    ...
    iget-object v1, p0, Lcom/android/server/wm/m;->ssp:Landroid/view/animation/Transformation;
    ...
    iget-object v1, p0, Lcom/android/server/wm/m;->ear:Landroid/view/animation/Animation;

    invoke-virtual {p2, v1}, Ljava/io/PrintWriter;->print(Ljava/lang/Object;)V

    invoke-virtual {p2, v0}, Ljava/io/PrintWriter;->print(Ljava/lang/String;)V

    iget-object v0, p0, Lcom/android/server/wm/m;->cno:Landroid/view/animation/Transformation;
    ...
    iget-object v0, p0, Lcom/android/server/wm/m;->kth:Landroid/view/animation/Transformation;
    ...
    iget-object v0, p0, Lcom/android/server/wm/m;->bio:Landroid/graphics/Matrix;
    ...
    iget-boolean v0, p0, Lcom/android/server/wm/m;->vju:Z
    ...
    iget-object v0, p0, Lcom/android/server/wm/m;->obl:Landroid/graphics/Rect;
    ...
    iget-object v0, p0, Lcom/android/server/wm/m;->oxb:Landroid/graphics/Rect;
    ...
    iget-boolean v0, p0, Lcom/android/server/wm/m;->vdw:Z
    ...
    iget-boolean v0, p0, Lcom/android/server/wm/m;->qeg:Z
    ...
    iget-boolean v0, p0, Lcom/android/server/wm/m;->ivd:Z
    ...
    iget-boolean v0, p0, Lcom/android/server/wm/m;->d:Z
    ...
    iget-boolean v0, p0, Lcom/android/server/wm/m;->a:Z
    ...
    iget-boolean v0, p0, Lcom/android/server/wm/m;->b:Z
    ...
    iget-boolean p0, p0, Lcom/android/server/wm/m;->c:Z
...
.method public setRotation(Landroid/view/SurfaceControl$Transaction;I)V
    ...
    iput p2, p0, Lcom/android/server/wm/m;->zgw:I
    ...
    iget v1, p0, Lcom/android/server/wm/m;->ibl:I

    iget-object v2, p0, Lcom/android/server/wm/m;->bio:Landroid/graphics/Matrix;
    ...
    iget-object p2, p0, Lcom/android/server/wm/m;->bio:Landroid/graphics/Matrix;

    const/high16 v0, 0x3f800000    # 1.0f

    const/4 v1, 0x0

    invoke-direct {p0, p1, p2, v0, v1}, Lcom/android/server/wm/m;->zgw(Landroid/view/SurfaceControl$Transaction;Landroid/graphics/Matrix;FLandroid/graphics/Rect;)V

    iget-object p2, p0, Lcom/android/server/wm/m;->bio:Landroid/graphics/Matrix;

    invoke-direct {p0, p1, p2, v0}, Lcom/android/server/wm/m;->obl(Landroid/view/SurfaceControl$Transaction;Landroid/graphics/Matrix;F)V
