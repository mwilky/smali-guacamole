...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lcom/android/server/policy/DeviceKeyHandler$bio;
    }
.end annotation


# static fields
.field private static final A:Ljava/lang/String; = "OpenTorch"

.field private static final B:Ljava/lang/String; = "FrontCamera"

.field private static final C:Ljava/lang/String; = "TakeVideo"

.field private static final D:Ljava/lang/String; = "OpenShelf"

.field private static final E:Ljava/lang/String; = "OpenApp"

.field private static final F:Ljava/lang/String; = "OpenShortcut"

.field private static final G:Ljava/lang/String; = "/proc/touchpanel/gesture_enable"

.field private static final H:Ljava/lang/String; = "/proc/touchpanel/coordinate"

.field private static final I:Ljava/lang/String; = "/proc/touchpanel/gesture_switch"

.field private static final J:J = 0x4bL

.field private static final K:J = 0x96L

.field private static final L:Landroid/media/AudioAttributes;
...
.field private static final P:Ljava/lang/String; = "op_doze_always_on"

.field private static final k:Ljava/lang/String; = "DeviceKeyHandler"

.field private static final l:Z

.field private static final m:Ljava/lang/String; = "1"

.field private static final n:Ljava/lang/String; = "7"

.field private static final o:Ljava/lang/String; = "5"
...
.field private static final s:Ljava/lang/String; = "15"

.field private static final t:Ljava/lang/String; = "16"

.field private static final u:Ljava/lang/String; = "6"

.field private static final v:Ljava/lang/String; = "2"

.field private static final w:Ljava/lang/String; = "14"

.field private static final x:Ljava/lang/String; = "12"

.field private static final y:Ljava/lang/String; = "13"

.field private static final z:Ljava/lang/String; = "OpenCamera"
...
.field private fto:Lcom/android/server/policy/DeviceKeyHandler$bio;
...
.field h:Landroid/hardware/SensorEventListener;

.field private hmo:Landroid/os/HandlerThread;

.field i:Landroid/hardware/SensorEventListener;
...
.field private irq:Lcom/android/server/policy/DeviceKeyHandler$cno;

.field private ivd:Landroid/telecom/TelecomManager;

.field private final j:Landroid/hardware/camera2/CameraManager$TorchCallback;
...
.field private rtg:Lcom/android/server/policy/DeviceKeyHandler$kth;
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/android/server/policy/DeviceKeyHandler;->l:Z
    ...
    sput-object v0, Lcom/android/server/policy/DeviceKeyHandler;->L:Landroid/media/AudioAttributes;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-boolean v0, p0, Lcom/android/server/policy/DeviceKeyHandler;->e:Z

    iput-boolean v0, p0, Lcom/android/server/policy/DeviceKeyHandler;->f:Z

    new-instance v2, Lcom/android/server/policy/DeviceKeyHandler$zta;

    invoke-direct {v2, p0}, Lcom/android/server/policy/DeviceKeyHandler$zta;-><init>(Lcom/android/server/policy/DeviceKeyHandler;)V

    iput-object v2, p0, Lcom/android/server/policy/DeviceKeyHandler;->g:Ljava/lang/Runnable;
    ...
    iput-object v2, p0, Lcom/android/server/policy/DeviceKeyHandler;->h:Landroid/hardware/SensorEventListener;
    ...
    iput-object v2, p0, Lcom/android/server/policy/DeviceKeyHandler;->i:Landroid/hardware/SensorEventListener;

    new-instance v2, Lcom/android/server/policy/DeviceKeyHandler$ssp;

    invoke-direct {v2, p0}, Lcom/android/server/policy/DeviceKeyHandler$ssp;-><init>(Lcom/android/server/policy/DeviceKeyHandler;)V

    iput-object v2, p0, Lcom/android/server/policy/DeviceKeyHandler;->j:Landroid/hardware/camera2/CameraManager$TorchCallback;
    ...
    new-instance v2, Lcom/android/server/policy/DeviceKeyHandler$kth;

    const/4 v3, 0x0

    invoke-direct {v2, p0, v3}, Lcom/android/server/policy/DeviceKeyHandler$kth;-><init>(Lcom/android/server/policy/DeviceKeyHandler;Lcom/android/server/policy/DeviceKeyHandler$zta;)V

    iput-object v2, p0, Lcom/android/server/policy/DeviceKeyHandler;->rtg:Lcom/android/server/policy/DeviceKeyHandler$kth;
    ...
    new-instance v0, Lcom/android/server/policy/DeviceKeyHandler$bio;

    iget-object v1, p0, Lcom/android/server/policy/DeviceKeyHandler;->rtg:Lcom/android/server/policy/DeviceKeyHandler$kth;

    invoke-direct {v0, p0, v1}, Lcom/android/server/policy/DeviceKeyHandler$bio;-><init>(Lcom/android/server/policy/DeviceKeyHandler;Landroid/os/Handler;)V

    iput-object v0, p0, Lcom/android/server/policy/DeviceKeyHandler;->fto:Lcom/android/server/policy/DeviceKeyHandler$bio;
    ...
    invoke-virtual {p0}, Lcom/android/server/policy/DeviceKeyHandler;->h()V
...
.method static synthetic bvj(Lcom/android/server/policy/DeviceKeyHandler;)Z
    .locals 0

    iget-boolean p0, p0, Lcom/android/server/policy/DeviceKeyHandler;->bud:Z
...
.method private c()V
    ...
    invoke-direct {p0, v0}, Lcom/android/server/policy/DeviceKeyHandler;->d(Z)V
...
.method private cjf(I)V
    ...
    :cond_0
    sget-boolean p0, Lcom/android/server/policy/DeviceKeyHandler;->l:Z
...
.method static synthetic cno()Z
    ...
    sget-boolean v0, Lcom/android/server/policy/DeviceKeyHandler;->l:Z
...
.method private d(Z)V
    ...
    invoke-direct {p0, p1}, Lcom/android/server/policy/DeviceKeyHandler;->f(Z)V
...
.method private e()V
    ...
    invoke-direct {p0, v0}, Lcom/android/server/policy/DeviceKeyHandler;->f(Z)V
...
.method private ear()V
    ...
    iget-object v3, p0, Lcom/android/server/policy/DeviceKeyHandler;->i:Landroid/hardware/SensorEventListener;
...
.method private f(Z)V
    ...
    :goto_0
    sget-object p1, Lcom/android/server/policy/DeviceKeyHandler;->L:Landroid/media/AudioAttributes;
...
.method private fto(Ljava/lang/String;)I
    .locals 3
...
.method private g()V
    ...
    invoke-virtual {p0}, Lcom/android/server/policy/DeviceKeyHandler;->bud()Z
    ...
    iget-boolean v4, p0, Lcom/android/server/policy/DeviceKeyHandler;->f:Z
    ...
    invoke-direct {p0, v2}, Lcom/android/server/policy/DeviceKeyHandler;->obl(Ljava/lang/String;)V

    iget-object v2, p0, Lcom/android/server/policy/DeviceKeyHandler;->rtg:Lcom/android/server/policy/DeviceKeyHandler$kth;

    invoke-virtual {v2, v8, v0}, Landroid/os/Handler;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;

    move-result-object v2

    iget-object v4, p0, Lcom/android/server/policy/DeviceKeyHandler;->rtg:Lcom/android/server/policy/DeviceKeyHandler$kth;
    ...
    :cond_c
    invoke-direct {p0, v0}, Lcom/android/server/policy/DeviceKeyHandler;->q(Ljava/lang/String;)V
    ...
    :cond_e
    invoke-direct {p0, v0}, Lcom/android/server/policy/DeviceKeyHandler;->obl(Ljava/lang/String;)V
    ...
    invoke-direct {p0}, Lcom/android/server/policy/DeviceKeyHandler;->c()V
    ...
    :goto_2
    invoke-direct {p0, v2}, Lcom/android/server/policy/DeviceKeyHandler;->cjf(I)V
    ...
    check-cast v0, Lcom/android/server/policy/DeviceKeyHandler$cno;
    ...
    invoke-virtual {v0}, Lcom/android/server/policy/DeviceKeyHandler$cno;->toString()Ljava/lang/String;
    ...
    invoke-virtual {v0}, Lcom/android/server/policy/DeviceKeyHandler$cno;->zta()Ljava/lang/String;
    ...
    :pswitch_0
    invoke-direct {p0, v1}, Lcom/android/server/policy/DeviceKeyHandler;->obl(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v0, v9}, Lcom/android/server/policy/DeviceKeyHandler;->o(Lcom/android/server/policy/DeviceKeyHandler$cno;Z)Z

    move-result v1

    if-eqz v1, :cond_16

    iput-object v0, p0, Lcom/android/server/policy/DeviceKeyHandler;->irq:Lcom/android/server/policy/DeviceKeyHandler$cno;

    goto :goto_5

    :cond_15
    invoke-virtual {p0, v0, v3}, Lcom/android/server/policy/DeviceKeyHandler;->o(Lcom/android/server/policy/DeviceKeyHandler$cno;Z)Z
    ...
    new-instance v1, Lcom/android/server/policy/DeviceKeyHandler$6;

    invoke-direct {v1, p0}, Lcom/android/server/policy/DeviceKeyHandler$6;-><init>(Lcom/android/server/policy/DeviceKeyHandler;)V
    ...
    invoke-direct {p0, v1}, Lcom/android/server/policy/DeviceKeyHandler;->fto(Ljava/lang/String;)I
    ...
    invoke-virtual {p0, v0}, Lcom/android/server/policy/DeviceKeyHandler;->j(Z)Z
...
.method static synthetic gck(Lcom/android/server/policy/DeviceKeyHandler;Ljava/lang/String;)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/android/server/policy/DeviceKeyHandler;->q(Ljava/lang/String;)V

    return-void
.end method

.method static synthetic gwm(Lcom/android/server/policy/DeviceKeyHandler;)Z
    .locals 0

    iget-boolean p0, p0, Lcom/android/server/policy/DeviceKeyHandler;->les:Z

    return p0
.end method

.method private hmo()Ljava/lang/String;
    .locals 8
...
.method private i()V
    ...
    invoke-direct {p0}, Lcom/android/server/policy/DeviceKeyHandler;->g()V

    goto :goto_0

    :cond_0
    invoke-direct {p0}, Lcom/android/server/policy/DeviceKeyHandler;->ear()V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    sget-boolean v1, Lcom/android/server/policy/DeviceKeyHandler;->l:Z
    ...
    :cond_2
    invoke-direct {p0}, Lcom/android/server/policy/DeviceKeyHandler;->oxb()V
...
.method static synthetic ibl(Lcom/android/server/policy/DeviceKeyHandler;)I
    .locals 0

    iget p0, p0, Lcom/android/server/policy/DeviceKeyHandler;->dma:I

    return p0
.end method

.method static synthetic igw(Lcom/android/server/policy/DeviceKeyHandler;Z)Z
    .locals 0
...
.method static synthetic kth(Lcom/android/server/policy/DeviceKeyHandler;)Ljava/lang/Object;
    .locals 0
...
.method private l(Ljava/lang/String;IZ)Z
    .locals 2
...
.method private lqr(Landroid/content/Context;)Ljava/lang/String;
    .locals 3
...
.method private m(Z)Z
    ...
    invoke-direct {p0, p1}, Lcom/android/server/policy/DeviceKeyHandler;->lqr(Landroid/content/Context;)Ljava/lang/String;
...
.method private n(Ljava/lang/String;Ljava/lang/String;IZ)Z
    .locals 9
...
.method private obl(Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1}, Lcom/android/server/policy/DeviceKeyHandler;->vju(Ljava/lang/String;)Z
...
.method static synthetic oif(Lcom/android/server/policy/DeviceKeyHandler;)Z
    .locals 0
...
.method private q(Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1}, Lcom/android/server/policy/DeviceKeyHandler;->obl(Ljava/lang/String;)V
...
.method static synthetic qbh(Lcom/android/server/policy/DeviceKeyHandler;)V
    .locals 0

    invoke-direct {p0}, Lcom/android/server/policy/DeviceKeyHandler;->r()V
...
.method private r()V
    ...
    :goto_0
    iput-boolean v1, p0, Lcom/android/server/policy/DeviceKeyHandler;->e:Z
    ...
    const-string v5, ", opAlwaysOn= "

    invoke-virtual {v1, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-boolean v5, p0, Lcom/android/server/policy/DeviceKeyHandler;->e:Z
    ...
    const-string v5, "DeviceKeyHandler"

    invoke-static {v5, v1}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    iget-boolean v1, p0, Lcom/android/server/policy/DeviceKeyHandler;->e:Z
    ...
    iget v6, p0, Lcom/android/server/policy/DeviceKeyHandler;->dma:I

    or-int/lit16 v6, v6, 0x800

    iput v6, p0, Lcom/android/server/policy/DeviceKeyHandler;->dma:I
    ...
    invoke-static {v1, v5}, Lcom/android/server/policy/DeviceKeyHandler;->veq(II)I
    ...
    invoke-static {v1, v4}, Lcom/android/server/policy/DeviceKeyHandler;->veq(II)I
    ...
    invoke-static {v1, v6}, Lcom/android/server/policy/DeviceKeyHandler;->veq(II)I
    ...
    invoke-static {v1, v2}, Lcom/android/server/policy/DeviceKeyHandler;->veq(II)I
    ...
    :cond_c
    invoke-virtual {p0, v0}, Lcom/android/server/policy/DeviceKeyHandler;->les(Landroid/content/ContentResolver;)V
...
.method static synthetic rtg(Lcom/android/server/policy/DeviceKeyHandler;Lcom/android/server/policy/DeviceKeyHandler$cno;)Lcom/android/server/policy/DeviceKeyHandler$cno;
    .locals 0

    iput-object p1, p0, Lcom/android/server/policy/DeviceKeyHandler;->irq:Lcom/android/server/policy/DeviceKeyHandler$cno;

    return-object p1
.end method

.method static synthetic sis(Lcom/android/server/policy/DeviceKeyHandler;)Landroid/hardware/SensorManager;
    .locals 0

    iget-object p0, p0, Lcom/android/server/policy/DeviceKeyHandler;->ssp:Landroid/hardware/SensorManager;

    return-object p0
.end method

.method static synthetic ssp(Lcom/android/server/policy/DeviceKeyHandler;)Landroid/os/Handler;
    .locals 0
...
.method static synthetic tsu(Lcom/android/server/policy/DeviceKeyHandler;)Lcom/android/server/policy/DeviceKeyHandler$cno;
    .locals 0

    iget-object p0, p0, Lcom/android/server/policy/DeviceKeyHandler;->irq:Lcom/android/server/policy/DeviceKeyHandler$cno;

    return-object p0
.end method

.method static synthetic ugm(Lcom/android/server/policy/DeviceKeyHandler;Z)Z
    .locals 0

    iput-boolean p1, p0, Lcom/android/server/policy/DeviceKeyHandler;->les:Z

    return p1
.end method

.method static synthetic vdb(Lcom/android/server/policy/DeviceKeyHandler;)Z
    .locals 0

    iget-boolean p0, p0, Lcom/android/server/policy/DeviceKeyHandler;->c:Z

    return p0
.end method

.method public static veq(II)I
    .locals 1
...
.method private vju(Ljava/lang/String;)Z
    .locals 2
...
.method static synthetic wtn(Lcom/android/server/policy/DeviceKeyHandler;)V
    .locals 0
...
.method static synthetic you(Lcom/android/server/policy/DeviceKeyHandler;)Landroid/hardware/Sensor;
    .locals 0

    iget-object p0, p0, Lcom/android/server/policy/DeviceKeyHandler;->cno:Landroid/hardware/Sensor;
...
.method static synthetic zgw(Lcom/android/server/policy/DeviceKeyHandler;)Z
    .locals 0

    iget-boolean p0, p0, Lcom/android/server/policy/DeviceKeyHandler;->qeg:Z
...
.method a()V
    ...
    const-string v2, "onStartedWakingUp unregister pocket"

    invoke-static {v0, v2}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    iget-object v0, p0, Lcom/android/server/policy/DeviceKeyHandler;->ire:Landroid/os/Handler;

    iget-object v2, p0, Lcom/android/server/policy/DeviceKeyHandler;->g:Ljava/lang/Runnable;

    invoke-virtual {v0, v2}, Landroid/os/Handler;->removeCallbacks(Ljava/lang/Runnable;)V

    iget-object v0, p0, Lcom/android/server/policy/DeviceKeyHandler;->ssp:Landroid/hardware/SensorManager;

    iget-object v2, p0, Lcom/android/server/policy/DeviceKeyHandler;->h:Landroid/hardware/SensorEventListener;

    invoke-virtual {v0, v2}, Landroid/hardware/SensorManager;->unregisterListener(Landroid/hardware/SensorEventListener;)V

    :cond_0
    iput-boolean v1, p0, Lcom/android/server/policy/DeviceKeyHandler;->f:Z
...
.method b(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_0
    new-instance v0, Lcom/android/server/policy/DeviceKeyHandler$cno;

    const/4 v1, 0x0

    invoke-direct {v0, p0, v1}, Lcom/android/server/policy/DeviceKeyHandler$cno;-><init>(Lcom/android/server/policy/DeviceKeyHandler;Lcom/android/server/policy/DeviceKeyHandler$zta;)V
    ...
    invoke-virtual {v0, p2}, Lcom/android/server/policy/DeviceKeyHandler$cno;->rtg(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, p2}, Lcom/android/server/policy/DeviceKeyHandler$cno;->ssp(Ljava/lang/String;)V
    ...
    :goto_0
    invoke-virtual {v0, p2}, Lcom/android/server/policy/DeviceKeyHandler$cno;->kth(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, p2}, Lcom/android/server/policy/DeviceKeyHandler$cno;->cno(Ljava/lang/String;)V
...
.method public cgv(Landroid/view/KeyEvent;)Z
    .locals 3
    ...
    iget-object p1, p0, Lcom/android/server/policy/DeviceKeyHandler;->rtg:Lcom/android/server/policy/DeviceKeyHandler$kth;
    ...
    invoke-direct {p0}, Lcom/android/server/policy/DeviceKeyHandler;->i()V

    goto :goto_1

    :cond_2
    iget-object p0, p0, Lcom/android/server/policy/DeviceKeyHandler;->rtg:Lcom/android/server/policy/DeviceKeyHandler$kth;
...
.method public h()V
    ...
    iget-object v1, p0, Lcom/android/server/policy/DeviceKeyHandler;->j:Landroid/hardware/camera2/CameraManager$TorchCallback;
...
.method public irq()V
    ...
    new-instance v1, Lcom/android/server/policy/DeviceKeyHandler$sis;

    invoke-direct {v1, p0}, Lcom/android/server/policy/DeviceKeyHandler$sis;-><init>(Lcom/android/server/policy/DeviceKeyHandler;)V
...
.method ivd()V
    ...
    iget-boolean v1, p0, Lcom/android/server/policy/DeviceKeyHandler;->d:Z
    ...
    const-string v1, "onScreenTurningOn unregister pocket"

    invoke-static {v0, v1}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    iget-object v0, p0, Lcom/android/server/policy/DeviceKeyHandler;->ire:Landroid/os/Handler;

    iget-object v1, p0, Lcom/android/server/policy/DeviceKeyHandler;->g:Ljava/lang/Runnable;

    invoke-virtual {v0, v1}, Landroid/os/Handler;->removeCallbacks(Ljava/lang/Runnable;)V

    iget-object v0, p0, Lcom/android/server/policy/DeviceKeyHandler;->ssp:Landroid/hardware/SensorManager;

    iget-object v1, p0, Lcom/android/server/policy/DeviceKeyHandler;->h:Landroid/hardware/SensorEventListener;
...
.method public j(Z)Z
    ...
    :try_start_1
    invoke-direct {p0}, Lcom/android/server/policy/DeviceKeyHandler;->hmo()Ljava/lang/String;
...
.method k(Lcom/android/server/policy/keyguard/KeyguardServiceDelegate;)V
    .locals 0
...
.method les(Landroid/content/ContentResolver;)V
    .locals 6
    ...
    invoke-virtual {p0, v1, v0}, Lcom/android/server/policy/DeviceKeyHandler;->b(Ljava/lang/String;Ljava/lang/String;)V

    const-string v0, "2"

    invoke-virtual {p0, v0, v2}, Lcom/android/server/policy/DeviceKeyHandler;->b(Ljava/lang/String;Ljava/lang/String;)V

    const-string v0, "14"

    invoke-virtual {p0, v0, v3}, Lcom/android/server/policy/DeviceKeyHandler;->b(Ljava/lang/String;Ljava/lang/String;)V

    const-string v0, "13"

    invoke-virtual {p0, v0, v4}, Lcom/android/server/policy/DeviceKeyHandler;->b(Ljava/lang/String;Ljava/lang/String;)V

    const-string v0, "12"

    invoke-virtual {p0, v0, p1}, Lcom/android/server/policy/DeviceKeyHandler;->b(Ljava/lang/String;Ljava/lang/String;)V

    return-void
.end method

.method o(Lcom/android/server/policy/DeviceKeyHandler$cno;Z)Z
    .locals 4

    invoke-virtual {p1}, Lcom/android/server/policy/DeviceKeyHandler$cno;->zta()Ljava/lang/String;
    ...
    iget-object v3, p1, Lcom/android/server/policy/DeviceKeyHandler$cno;->you:Ljava/lang/String;
    ...
    invoke-direct {p0, p2}, Lcom/android/server/policy/DeviceKeyHandler;->m(Z)Z
    ...
    invoke-virtual {p1}, Lcom/android/server/policy/DeviceKeyHandler$cno;->you()Ljava/lang/String;

    move-result-object v0

    invoke-virtual {p1}, Lcom/android/server/policy/DeviceKeyHandler$cno;->tsu()I

    move-result p1

    invoke-direct {p0, v0, p1, p2}, Lcom/android/server/policy/DeviceKeyHandler;->l(Ljava/lang/String;IZ)Z
    ...
    invoke-virtual {p1}, Lcom/android/server/policy/DeviceKeyHandler$cno;->sis()Ljava/lang/String;
    ...
    invoke-direct {p0, v0, v1, p1, p2}, Lcom/android/server/policy/DeviceKeyHandler;->n(Ljava/lang/String;Ljava/lang/String;IZ)Z
...
.method public p()V
    ...
    iget-object v1, p0, Lcom/android/server/policy/DeviceKeyHandler;->fto:Lcom/android/server/policy/DeviceKeyHandler$bio;

    invoke-virtual {v1}, Lcom/android/server/policy/DeviceKeyHandler$bio;->zta()V
...
.method qeg()V
    ...
    :cond_1
    iput-boolean v2, p0, Lcom/android/server/policy/DeviceKeyHandler;->les:Z

    iget-object v0, p0, Lcom/android/server/policy/DeviceKeyHandler;->ssp:Landroid/hardware/SensorManager;

    iget-object v3, p0, Lcom/android/server/policy/DeviceKeyHandler;->h:Landroid/hardware/SensorEventListener;
    ...
    :cond_2
    :goto_0
    iput-boolean v2, p0, Lcom/android/server/policy/DeviceKeyHandler;->b:Z
