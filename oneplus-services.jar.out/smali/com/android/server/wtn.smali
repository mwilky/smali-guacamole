...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/android/server/wtn;->you:Z

    new-instance v0, Ljava/util/HashSet;

    invoke-direct {v0}, Ljava/util/HashSet;-><init>()V

    sput-object v0, Lcom/android/server/wtn;->sis:Ljava/util/Set;

    const/4 v1, 0x0

    sput-boolean v1, Lcom/android/server/wtn;->rtg:Z

    const-string v1, "com.oppo.qetest"

    invoke-interface {v0, v1}, Ljava/util/Set;->add(Ljava/lang/Object;)Z

    sget-object v0, Lcom/android/server/wtn;->sis:Ljava/util/Set;
    ...
    sget-object v1, Lcom/android/server/wtn;->sis:Ljava/util/Set;
...
.method static tsu(Ljava/util/List;)V
    ...
    sget-object v2, Lcom/android/server/wtn;->sis:Ljava/util/Set;
...
.method public static you(Landroid/content/Context;)V
    ...
    sget-boolean v0, Lcom/android/server/wtn;->rtg:Z

    if-nez v0, :cond_0

    const/4 v0, 0x1

    sput-boolean v0, Lcom/android/server/wtn;->rtg:Z

    sput-object p0, Lcom/android/server/wtn;->tsu:Landroid/content/Context;
