.class public Lcom/android/server/am/veq;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/server/am/veq$rtg;,
        Lcom/android/server/am/veq$ssp;
    }
.end annotation


# static fields
.field protected static final a:Ljava/lang/String; = "SmartPowerControl: whitelist app"

.field protected static final b:Ljava/lang/String; = "SmartPowerControl: battery optimizing app"

.field protected static final c:Ljava/lang/String; = "StartAppControl: default pass"

.field protected static final d:Ljava/lang/String; = "StartAppControl: default block"

.field protected static final e:Ljava/lang/String; = "ConfigManager: not running"

.field protected static final f:Ljava/lang/String; = "ConfigManager: not foreground"

.field protected static final g:Ljava/lang/String; = "ConfigManager: always"

.field protected static final h:Ljava/lang/String; = "ConfigManager: always"

.field private static final i:Ljava/lang/String; = "Theme.Translucent.NoTitleBar"

.field private static final irq:Ljava/lang/String; = "gsm.sim.operator.iso-country"

.field protected static final ivd:Ljava/lang/String; = "StartAppControl: callee is a system app"
...
.field public static final les:Ljava/lang/String; = "StartAppControl"

.field private static final m:I = 0x3

.field private static final n:J = 0x1f4L

.field protected static o:Z = false

.field private static p:Lcom/android/server/am/veq; = null

.field private static q:Landroid/os/HandlerThread; = null

.field private static final qeg:Ljava/lang/String; = "AppBoot"

.field private static r:Z = false

.field public static s:Z = false

.field protected static t:Landroid/os/Handler; = null

.field private static u:Lcom/android/server/pm/PackageManagerService; = null

.field private static final v:Ljava/lang/String; = "com.haha.action.test"

.field private static final vdw:Ljava/lang/String; = "android.intent.action.SIM_STATE_CHANGED"

.field private static final w:I = 0x0

.field private static final x:I = 0x55d4a80

.field private static final y:I = 0x5f5e100


# instance fields
.field private bio:Lcom/android/server/ear;

.field private bud:Landroid/content/BroadcastReceiver;

.field private bvj:Lcom/android/server/am/n;
...
.field private gwm:Lcom/android/server/am/c;
...
.field private ibl:Lcom/android/server/am/k;
...
.field private obl:Lcom/android/server/am/veq$rtg;
...
.field private ugm:Lcom/android/server/am/p;
...
.method static constructor <clinit>()V
    ...
    sput-boolean v1, Lcom/android/server/am/veq;->j:Z

    sget-boolean v1, Landroid/os/Build;->DEBUG_ONEPLUS:Z

    sput-boolean v1, Lcom/android/server/am/veq;->o:Z

    const/4 v1, 0x0

    sput-object v1, Lcom/android/server/am/veq;->q:Landroid/os/HandlerThread;

    sput-boolean v2, Lcom/android/server/am/veq;->r:Z

    sput-boolean v0, Lcom/android/server/am/veq;->s:Z
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcom/android/server/am/veq;->veq:Ljava/util/HashSet;

    new-instance v0, Ljava/util/HashSet;

    invoke-direct {v0}, Ljava/util/HashSet;-><init>()V

    iput-object v0, p0, Lcom/android/server/am/veq;->cgv:Ljava/util/HashSet;

    new-instance v0, Lcom/android/server/am/veq$zta;

    invoke-direct {v0, p0}, Lcom/android/server/am/veq$zta;-><init>(Lcom/android/server/am/veq;)V

    iput-object v0, p0, Lcom/android/server/am/veq;->vju:Landroid/content/BroadcastReceiver;

    new-instance v0, Lcom/android/server/am/veq$sis;

    invoke-direct {v0, p0}, Lcom/android/server/am/veq$sis;-><init>(Lcom/android/server/am/veq;)V

    iput-object v0, p0, Lcom/android/server/am/veq;->bud:Landroid/content/BroadcastReceiver;

    iput-object p1, p0, Lcom/android/server/am/veq;->gck:Landroid/content/Context;

    new-instance p1, Ljava/util/ArrayList;

    invoke-direct {p1}, Ljava/util/ArrayList;-><init>()V

    iput-object p1, p0, Lcom/android/server/am/veq;->cjf:Ljava/util/List;

    new-instance p1, Ljava/util/ArrayList;

    invoke-direct {p1}, Ljava/util/ArrayList;-><init>()V

    iput-object p1, p0, Lcom/android/server/am/veq;->hmo:Ljava/util/List;

    new-instance p1, Ljava/util/ArrayList;

    invoke-direct {p1}, Ljava/util/ArrayList;-><init>()V

    iput-object p1, p0, Lcom/android/server/am/veq;->fto:Ljava/util/List;

    new-instance p1, Ljava/util/ArrayList;

    invoke-direct {p1}, Ljava/util/ArrayList;-><init>()V

    iput-object p1, p0, Lcom/android/server/am/veq;->lqr:Ljava/util/List;

    new-instance p1, Ljava/util/HashMap;

    invoke-direct {p1}, Ljava/util/HashMap;-><init>()V

    iput-object p1, p0, Lcom/android/server/am/veq;->ear:Ljava/util/Map;

    new-instance p1, Ljava/util/ArrayList;

    invoke-direct {p1}, Ljava/util/ArrayList;-><init>()V

    iput-object p1, p0, Lcom/android/server/am/veq;->ire:Ljava/util/List;

    const-wide/16 v0, 0x1f4

    iput-wide v0, p0, Lcom/android/server/am/veq;->vdb:J
    ...
    iput-object p1, p0, Lcom/android/server/am/veq;->oxb:Ljava/util/Set;

    iget-object p1, p0, Lcom/android/server/am/veq;->gck:Landroid/content/Context;
    ...
    iput-object p1, p0, Lcom/android/server/am/veq;->kth:Landroid/app/ActivityManager;

    invoke-direct {p0}, Lcom/android/server/am/veq;->bud()V

    return-void
.end method

.method static synthetic bio(Lcom/android/server/am/veq;Ljava/lang/String;)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/android/server/am/veq;->q(Ljava/lang/String;)V
...
.method private bud()V
    ...
    iget-object v0, p0, Lcom/android/server/am/veq;->veq:Ljava/util/HashSet;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Lcom/android/server/am/veq;->veq:Ljava/util/HashSet;

    const-string v2, "com.igexin.sdk.PushActivityTask"
    ...
    iget-object v1, p0, Lcom/android/server/am/veq;->cgv:Ljava/util/HashSet;

    monitor-enter v1

    :try_start_1
    iget-object p0, p0, Lcom/android/server/am/veq;->cgv:Ljava/util/HashSet;
...
.method static synthetic bvj(Lcom/android/server/am/veq;)Lcom/android/server/am/StartAppSpecialUidsPolicy;
    .locals 0

    iget-object p0, p0, Lcom/android/server/am/veq;->oif:Lcom/android/server/am/StartAppSpecialUidsPolicy;
...
.method private cgv(Ljava/lang/Integer;ILcom/android/server/am/StartAppRecorder$zta;)Ljava/lang/Boolean;
    ...
    invoke-virtual {p0, p2}, Lcom/android/server/am/veq;->d(I)Z
    ...
    :goto_1
    iget-object p0, p0, Lcom/android/server/am/veq;->ywr:Lcom/android/server/am/StartAppRecorder;
    ...
    iget-object p1, p0, Lcom/android/server/am/veq;->ywr:Lcom/android/server/am/StartAppRecorder;
    ...
    iget-object p0, p0, Lcom/android/server/am/veq;->oxb:Ljava/util/Set;
    ...
    invoke-virtual {p0, p2}, Lcom/android/server/am/veq;->c(I)Z
...
.method private cjf()V
    ...
    iget-object v1, p0, Lcom/android/server/am/veq;->cjf:Ljava/util/List;
    ...
    invoke-static {v0}, Lcom/android/server/am/veq;->i(Ljava/lang/String;)V
    ...
    iget-object v1, p0, Lcom/android/server/am/veq;->ear:Ljava/util/Map;
    ...
    iget-object v1, p0, Lcom/android/server/am/veq;->hmo:Ljava/util/List;
    ...
    iget-object v1, p0, Lcom/android/server/am/veq;->fto:Ljava/util/List;
    ...
    iget-object v1, p0, Lcom/android/server/am/veq;->lqr:Ljava/util/List;
    ...
    const-string v1, "dump # mReceiverCallerWhiteListO2:"
    ...
    invoke-static {p0}, Lcom/android/server/am/veq;->i(Ljava/lang/String;)V

    return-void
.end method

.method static synthetic cno(Lcom/android/server/am/veq;)Lcom/android/server/am/ActivityManagerService;
    .locals 0

    iget-object p0, p0, Lcom/android/server/am/veq;->cno:Lcom/android/server/am/ActivityManagerService;
...
.method static synthetic dma(Lcom/android/server/am/veq;)Z
    ...
    iget-boolean p0, p0, Lcom/android/server/am/veq;->tsu:Z
...
.method private ear(Ljava/lang/String;)Ljava/util/List;
    ...
    iget-object v0, p0, Lcom/android/server/am/veq;->qbh:Lcom/android/server/am/StartAppConfigManager;
...
.method private synthetic f(Lorg/json/JSONArray;)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/android/server/am/veq;->o(Lorg/json/JSONArray;)V
...
.method static synthetic gck(II)I
    ...
    invoke-static {p0, p1}, Lcom/android/server/am/veq;->zgw(II)I
...
.method static synthetic gwm(Lcom/android/server/am/veq;)Lcom/android/server/am/StartAppConfigManager;
    .locals 0

    iget-object p0, p0, Lcom/android/server/am/veq;->qbh:Lcom/android/server/am/StartAppConfigManager;

    return-object p0
.end method

.method private h(Landroid/content/pm/ActivityInfo;I)Z
    .locals 3

    iget-boolean p2, p0, Lcom/android/server/am/veq;->ssp:Z

    const/4 v0, 0x1

    if-eqz p2, :cond_2

    iget-object p2, p0, Lcom/android/server/am/veq;->fto:Ljava/util/List;
    ...
    :try_start_0
    iget-object v1, p0, Lcom/android/server/am/veq;->gck:Landroid/content/Context;
    ...
    iget-object p2, p0, Lcom/android/server/am/veq;->veq:Ljava/util/HashSet;
    ...
    invoke-static {p2}, Lcom/android/server/am/veq;->i(Ljava/lang/String;)V
    ...
    iget-object p0, p0, Lcom/android/server/am/veq;->ugm:Lcom/android/server/am/p;

    iget p1, p1, Landroid/content/pm/ApplicationInfo;->uid:I

    invoke-virtual {p0, p1}, Lcom/android/server/am/p;->rtg(I)V
...
.method public static hmo(Landroid/content/Context;)Lcom/android/server/am/veq;
    .locals 1

    sget-object v0, Lcom/android/server/am/veq;->p:Lcom/android/server/am/veq;
    ...
    sput-object v0, Lcom/android/server/am/veq;->p:Lcom/android/server/am/veq;

    :cond_0
    sget-object p0, Lcom/android/server/am/veq;->p:Lcom/android/server/am/veq;
...
.method protected static i(Ljava/lang/String;)V
    ...
    invoke-static {v0, p0}, Lcom/android/server/am/veq;->j(Ljava/lang/String;Ljava/lang/String;)V

    return-void
.end method

.method static synthetic ibl(Lcom/android/server/am/veq;)Lcom/android/server/am/n;
    .locals 0

    iget-object p0, p0, Lcom/android/server/am/veq;->bvj:Lcom/android/server/am/n;

    return-object p0
.end method

.method static synthetic igw(Lcom/android/server/am/veq;I)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/android/server/am/veq;->zta(I)V

    return-void
.end method

.method protected static ire()Lcom/android/server/am/veq;
    .locals 1
...
.method private ivd(Lcom/android/server/am/ProcessRecord;)Z
    .locals 2
    ...
    invoke-virtual {p0, v0}, Lcom/android/server/am/veq;->b(Ljava/lang/String;)Z
...
.method protected static j(Ljava/lang/String;Ljava/lang/String;)V
    ...
    sget-boolean v0, Lcom/android/server/am/veq;->o:Z
...
.method private k()V
    ...
    sput-object v0, Lcom/android/server/am/veq;->q:Landroid/os/HandlerThread;

    invoke-virtual {v0}, Landroid/os/HandlerThread;->start()V

    new-instance v0, Lcom/android/server/am/veq$ssp;

    sget-object v1, Lcom/android/server/am/veq;->q:Landroid/os/HandlerThread;

    invoke-virtual {v1}, Landroid/os/HandlerThread;->getLooper()Landroid/os/Looper;

    move-result-object v1

    invoke-direct {v0, p0, v1}, Lcom/android/server/am/veq$ssp;-><init>(Lcom/android/server/am/veq;Landroid/os/Looper;)V

    sput-object v0, Lcom/android/server/am/veq;->t:Landroid/os/Handler;
    ...
    sget-boolean v1, Lcom/android/server/am/veq;->j:Z

    if-eqz v1, :cond_0

    const/4 v1, 0x1

    iput-boolean v1, p0, Lcom/android/server/am/veq;->zta:Z

    iput-boolean v1, p0, Lcom/android/server/am/veq;->you:Z

    iput-boolean v1, p0, Lcom/android/server/am/veq;->sis:Z

    iput-boolean v1, p0, Lcom/android/server/am/veq;->tsu:Z

    iput-boolean v1, p0, Lcom/android/server/am/veq;->rtg:Z

    iput-boolean v1, p0, Lcom/android/server/am/veq;->ssp:Z
    ...
    invoke-direct {p0}, Lcom/android/server/am/veq;->l()V

    :goto_0
    invoke-direct {p0}, Lcom/android/server/am/veq;->vju()V

    iget-object v1, p0, Lcom/android/server/am/veq;->gck:Landroid/content/Context;

    iget-object v2, p0, Lcom/android/server/am/veq;->vju:Landroid/content/BroadcastReceiver;

    invoke-virtual {v1, v2, v0}, Landroid/content/Context;->registerReceiver(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;)Landroid/content/Intent;

    invoke-direct {p0}, Lcom/android/server/am/veq;->n()V

    new-instance v0, Lcom/oneplus/config/ConfigObserver;

    iget-object v1, p0, Lcom/android/server/am/veq;->gck:Landroid/content/Context;

    sget-object v2, Lcom/android/server/am/veq;->t:Landroid/os/Handler;

    new-instance v3, Lcom/android/server/am/veq$you;

    invoke-direct {v3, p0}, Lcom/android/server/am/veq$you;-><init>(Lcom/android/server/am/veq;)V

    const-string v4, "AppBoot"

    invoke-direct {v0, v1, v2, v3, v4}, Lcom/oneplus/config/ConfigObserver;-><init>(Landroid/content/Context;Landroid/os/Handler;Lcom/oneplus/config/ConfigObserver$ConfigUpdater;Ljava/lang/String;)V

    iput-object v0, p0, Lcom/android/server/am/veq;->zgw:Lcom/oneplus/config/ConfigObserver;
    ...
    sget-object v1, Lcom/android/server/am/veq;->t:Landroid/os/Handler;

    new-instance v2, Lcom/android/server/am/tsu;

    invoke-direct {v2, p0, v0}, Lcom/android/server/am/tsu;-><init>(Lcom/android/server/am/veq;Lorg/json/JSONArray;)V
...
.method static synthetic kth(Lcom/android/server/am/veq;)Landroid/app/ActivityManager;
    .locals 0

    iget-object p0, p0, Lcom/android/server/am/veq;->kth:Landroid/app/ActivityManager;
...
.method private l()V
    ...
    iget-boolean v0, p0, Lcom/android/server/am/veq;->zta:Z
    ...
    iput-boolean v3, p0, Lcom/android/server/am/veq;->zta:Z

    iput-boolean v3, p0, Lcom/android/server/am/veq;->you:Z

    iput-boolean v4, p0, Lcom/android/server/am/veq;->sis:Z

    iput-boolean v4, p0, Lcom/android/server/am/veq;->tsu:Z

    iput-boolean v3, p0, Lcom/android/server/am/veq;->rtg:Z

    iput-boolean v3, p0, Lcom/android/server/am/veq;->ssp:Z
    ...
    :cond_1
    iput-boolean v4, p0, Lcom/android/server/am/veq;->zta:Z

    :goto_0
    iput-boolean v4, p0, Lcom/android/server/am/veq;->you:Z

    iput-boolean v4, p0, Lcom/android/server/am/veq;->sis:Z

    iput-boolean v4, p0, Lcom/android/server/am/veq;->tsu:Z

    iput-boolean v4, p0, Lcom/android/server/am/veq;->rtg:Z

    iput-boolean v4, p0, Lcom/android/server/am/veq;->ssp:Z
    ...
    iget-boolean v0, p0, Lcom/android/server/am/veq;->you:Z
    ...
    iget-boolean p0, p0, Lcom/android/server/am/veq;->sis:Z
...
.method private n()V
    ...
    iget-object v0, p0, Lcom/android/server/am/veq;->gck:Landroid/content/Context;
    ...
    iget-object p0, p0, Lcom/android/server/am/veq;->bud:Landroid/content/BroadcastReceiver;
...
.method private o(Lorg/json/JSONArray;)V
    ...
    :sswitch_0
    const-string v5, "receiver_caller_whitelist"
    ...
    iget-object v3, p0, Lcom/android/server/am/veq;->lqr:Ljava/util/List;
    ...
    :try_start_1
    iget-object v4, p0, Lcom/android/server/am/veq;->lqr:Ljava/util/List;
    ...
    iget-object v6, p0, Lcom/android/server/am/veq;->lqr:Ljava/util/List;
    ...
    sget-boolean v4, Lcom/android/server/am/n;->veq:Z

    invoke-virtual {v2, v3, v4}, Lorg/json/JSONObject;->optBoolean(Ljava/lang/String;Z)Z

    move-result v3

    sput-boolean v3, Lcom/android/server/am/n;->veq:Z

    const-string v3, "times"

    sget v4, Lcom/android/server/am/n;->fto:I

    invoke-virtual {v2, v3, v4}, Lorg/json/JSONObject;->optInt(Ljava/lang/String;I)I

    move-result v3

    sput v3, Lcom/android/server/am/n;->fto:I

    const-string v3, "duration"

    sget-wide v4, Lcom/android/server/am/n;->lqr:J

    invoke-virtual {v2, v3, v4, v5}, Lorg/json/JSONObject;->optLong(Ljava/lang/String;J)J

    move-result-wide v3

    sput-wide v3, Lcom/android/server/am/n;->lqr:J
    ...
    sget-object v3, Lcom/android/server/am/n;->cgv:Ljava/util/List;
    ...
    sget-object v5, Lcom/android/server/am/n;->cgv:Ljava/util/List;
    ...
    sget-wide v4, Lcom/android/server/am/k;->wtn:J

    invoke-virtual {v2, v3, v4, v5}, Lorg/json/JSONObject;->optLong(Ljava/lang/String;J)J

    move-result-wide v3

    sput-wide v3, Lcom/android/server/am/k;->wtn:J

    const-string v3, "max_count"

    sget v4, Lcom/android/server/am/k;->gck:I

    invoke-virtual {v2, v3, v4}, Lorg/json/JSONObject;->optInt(Ljava/lang/String;I)I

    move-result v3

    sput v3, Lcom/android/server/am/k;->gck:I

    const-string v3, "threshold_adj"

    sget v4, Lcom/android/server/am/k;->dma:I

    invoke-virtual {v2, v3, v4}, Lorg/json/JSONObject;->optInt(Ljava/lang/String;I)I

    move-result v3

    sput v3, Lcom/android/server/am/k;->dma:I
    ...
    iget-object v3, p0, Lcom/android/server/am/veq;->ibl:Lcom/android/server/am/k;

    iget-object v3, v3, Lcom/android/server/am/k;->you:Ljava/util/ArrayList;
    ...
    :try_start_3
    iget-object v4, p0, Lcom/android/server/am/veq;->ibl:Lcom/android/server/am/k;

    iget-object v4, v4, Lcom/android/server/am/k;->you:Ljava/util/ArrayList;
    ...
    iget-object v6, p0, Lcom/android/server/am/veq;->ibl:Lcom/android/server/am/k;

    iget-object v6, v6, Lcom/android/server/am/k;->you:Ljava/util/ArrayList;
    ...
    iget-object v4, p0, Lcom/android/server/am/veq;->fto:Ljava/util/List;
    ...
    :try_start_5
    iget-object v5, p0, Lcom/android/server/am/veq;->fto:Ljava/util/List;
    ...
    iget-object v7, p0, Lcom/android/server/am/veq;->fto:Ljava/util/List;
    ...
    iget-wide v4, p0, Lcom/android/server/am/veq;->vdb:J

    invoke-virtual {v2, v3, v4, v5}, Lorg/json/JSONObject;->optLong(Ljava/lang/String;J)J

    move-result-wide v2

    iput-wide v2, p0, Lcom/android/server/am/veq;->vdb:J
    ...
    iget-object v3, p0, Lcom/android/server/am/veq;->cgv:Ljava/util/HashSet;
    ...
    :try_start_7
    iget-object v4, p0, Lcom/android/server/am/veq;->cgv:Ljava/util/HashSet;
    ...
    iget-object v6, p0, Lcom/android/server/am/veq;->cgv:Ljava/util/HashSet;
    ...
    iget-object v3, p0, Lcom/android/server/am/veq;->veq:Ljava/util/HashSet;
    ...
    :try_start_9
    iget-object v4, p0, Lcom/android/server/am/veq;->veq:Ljava/util/HashSet;
    ...
    iget-object v6, p0, Lcom/android/server/am/veq;->veq:Ljava/util/HashSet;
    ...
    iget-object v3, p0, Lcom/android/server/am/veq;->hmo:Ljava/util/List;
    ...
    :try_start_b
    iget-object v4, p0, Lcom/android/server/am/veq;->hmo:Ljava/util/List;
    ...
    iget-object v6, p0, Lcom/android/server/am/veq;->hmo:Ljava/util/List;
    ...
    iget-object v3, p0, Lcom/android/server/am/veq;->cjf:Ljava/util/List;
    ...
    :try_start_d
    iget-object v4, p0, Lcom/android/server/am/veq;->cjf:Ljava/util/List;
    ...
    iget-object v6, p0, Lcom/android/server/am/veq;->cjf:Ljava/util/List;
    ...
    iget-object v3, p0, Lcom/android/server/am/veq;->qbh:Lcom/android/server/am/StartAppConfigManager;
    ...
    iget-object v7, p0, Lcom/android/server/am/veq;->qbh:Lcom/android/server/am/StartAppConfigManager;
    ...
    iget-boolean v4, p0, Lcom/android/server/am/veq;->zta:Z
    ...
    iget-boolean v4, p0, Lcom/android/server/am/veq;->you:Z
    ...
    iget-boolean v4, p0, Lcom/android/server/am/veq;->tsu:Z

    invoke-virtual {v2, v3, v4}, Lorg/json/JSONObject;->optBoolean(Ljava/lang/String;Z)Z

    move-result v3

    iput-boolean v3, p0, Lcom/android/server/am/veq;->tsu:Z

    const-string v3, "service_restart_control"

    iget-boolean v4, p0, Lcom/android/server/am/veq;->sis:Z

    invoke-virtual {v2, v3, v4}, Lorg/json/JSONObject;->optBoolean(Ljava/lang/String;Z)Z

    move-result v3

    iput-boolean v3, p0, Lcom/android/server/am/veq;->sis:Z

    const-string v3, "debug"

    sget-boolean v4, Lcom/android/server/am/veq;->o:Z

    invoke-virtual {v2, v3, v4}, Lorg/json/JSONObject;->optBoolean(Ljava/lang/String;Z)Z

    move-result v3

    sput-boolean v3, Lcom/android/server/am/veq;->o:Z

    const-string v3, "one_pixel_control"

    iget-boolean v4, p0, Lcom/android/server/am/veq;->rtg:Z
    ...
    iget-boolean v4, p0, Lcom/android/server/am/veq;->ssp:Z
    ...
    sget-boolean v4, Lcom/android/server/am/veq;->s:Z

    invoke-virtual {v2, v3, v4}, Lorg/json/JSONObject;->optBoolean(Ljava/lang/String;Z)Z

    move-result v2

    sput-boolean v2, Lcom/android/server/am/veq;->s:Z
    :try_end_e
    ...
    :sswitch_data_0
    .sparse-switch
        -0x7f9d4285 -> :sswitch_9
        -0x61f93926 -> :sswitch_8
        -0x5336d7cc -> :sswitch_7
        -0x50c07cbe -> :sswitch_6
        -0x327e5af3 -> :sswitch_5
        -0x1c0912a1 -> :sswitch_4
        0xb5595f5 -> :sswitch_3
        0x2d35843f -> :sswitch_2
        0x32d3638b -> :sswitch_1
        0x659da4e3 -> :sswitch_0
    .end sparse-switch
...
.method static synthetic oif(Lcom/android/server/am/veq;)V
    .locals 0

    invoke-direct {p0}, Lcom/android/server/am/veq;->cjf()V
...
.method private p(Lcom/android/server/pm/parsing/pkg/AndroidPackage;)V
    .locals 5
    ...
    invoke-static {v2}, Lcom/android/server/am/veq;->i(Ljava/lang/String;)V
    ...
    invoke-static {v2}, Lcom/android/server/am/n;->sis(Ljava/lang/String;)V
    ...
    invoke-static {v2}, Lcom/android/server/am/n;->you(Ljava/lang/String;)V
    ...
    invoke-static {v1}, Lcom/android/server/am/veq;->i(Ljava/lang/String;)V
    ...
    invoke-static {v1}, Lcom/android/server/am/n;->zta(Ljava/lang/String;)V
...
.method private q(Ljava/lang/String;)V
    ...
    :cond_0
    sget-object v0, Lcom/android/server/am/veq;->u:Lcom/android/server/pm/PackageManagerService;
    ...
    invoke-direct {p0, p1}, Lcom/android/server/am/veq;->p(Lcom/android/server/pm/parsing/pkg/AndroidPackage;)V

    :cond_1
    return-void
.end method

.method static synthetic qbh(Lcom/android/server/am/veq;)Z
    .locals 0

    iget-boolean p0, p0, Lcom/android/server/am/veq;->ssp:Z

    return p0
.end method

.method static synthetic rtg(Lcom/android/server/am/veq;I)I
    .locals 0

    invoke-direct {p0, p1}, Lcom/android/server/am/veq;->obl(I)I
...
.method static synthetic sis(Lcom/android/server/am/veq;)Z
    .locals 0
...
.method static synthetic ssp(Lcom/android/server/am/veq;I)I
    .locals 0

    invoke-direct {p0, p1}, Lcom/android/server/am/veq;->oxb(I)I
...
.method static synthetic tsu(Lcom/android/server/am/veq;)V
    .locals 0
...
.method static synthetic ugm(Lcom/android/server/am/veq;)Ljava/util/HashSet;
    .locals 0

    iget-object p0, p0, Lcom/android/server/am/veq;->veq:Ljava/util/HashSet;
...
.method private vdb(Ljava/lang/String;ILcom/android/server/am/StartAppRecorder$zta;)V
    ...
    invoke-virtual {p0, p1}, Lcom/android/server/am/veq;->irq(Ljava/lang/String;)Z
    ...
    :cond_0
    invoke-virtual {p0, p1}, Lcom/android/server/am/veq;->les(Ljava/lang/String;)Z
...
.method private vju()V
    ...
    iget-object v0, p0, Lcom/android/server/am/veq;->bio:Lcom/android/server/ear;
    ...
    iput-object v0, p0, Lcom/android/server/am/veq;->bio:Lcom/android/server/ear;
    ...
    iput-object v0, p0, Lcom/android/server/am/veq;->igw:Lcom/android/server/am/AppRecordManagerService;

    invoke-static {}, Lcom/android/server/am/StartAppConfigManager;->tsu()Lcom/android/server/am/StartAppConfigManager;

    move-result-object v0

    iput-object v0, p0, Lcom/android/server/am/veq;->qbh:Lcom/android/server/am/StartAppConfigManager;
    ...
    iput-object v0, p0, Lcom/android/server/am/veq;->oif:Lcom/android/server/am/StartAppSpecialUidsPolicy;

    iget-object v0, p0, Lcom/android/server/am/veq;->gck:Landroid/content/Context;

    invoke-static {v0}, Lcom/android/server/am/n;->gck(Landroid/content/Context;)Lcom/android/server/am/n;

    move-result-object v0

    iput-object v0, p0, Lcom/android/server/am/veq;->bvj:Lcom/android/server/am/n;

    iget-object v0, p0, Lcom/android/server/am/veq;->cno:Lcom/android/server/am/ActivityManagerService;

    invoke-static {v0}, Lcom/android/server/am/k;->zta(Lcom/android/server/am/ActivityManagerService;)Lcom/android/server/am/k;

    move-result-object v0

    iput-object v0, p0, Lcom/android/server/am/veq;->ibl:Lcom/android/server/am/k;

    iget-object v0, p0, Lcom/android/server/am/veq;->gck:Landroid/content/Context;

    invoke-static {v0}, Lcom/android/server/am/c;->zgw(Landroid/content/Context;)Lcom/android/server/am/c;

    move-result-object v0

    iput-object v0, p0, Lcom/android/server/am/veq;->gwm:Lcom/android/server/am/c;

    iget-object v0, p0, Lcom/android/server/am/veq;->gck:Landroid/content/Context;

    invoke-static {v0}, Lcom/android/server/am/p;->you(Landroid/content/Context;)Lcom/android/server/am/p;

    move-result-object v0

    iput-object v0, p0, Lcom/android/server/am/veq;->ugm:Lcom/android/server/am/p;

    invoke-static {}, Lcom/android/server/OnePlusUtil$you;->tsu()Lcom/android/server/OnePlusUtil$you;

    move-result-object v0

    iput-object v0, p0, Lcom/android/server/am/veq;->wtn:Lcom/android/server/OnePlusUtil$you;

    iget-object v0, p0, Lcom/android/server/am/veq;->gck:Landroid/content/Context;

    iget-object v1, p0, Lcom/android/server/am/veq;->bvj:Lcom/android/server/am/n;

    invoke-static {v0, v1}, Lcom/android/server/am/StartAppRecorder;->zta(Landroid/content/Context;Lcom/android/server/am/n;)Lcom/android/server/am/StartAppRecorder;

    move-result-object v0

    iput-object v0, p0, Lcom/android/server/am/veq;->ywr:Lcom/android/server/am/StartAppRecorder;

    new-instance v0, Lcom/android/server/am/veq$rtg;

    const/4 v1, 0x0

    invoke-direct {v0, p0, v1}, Lcom/android/server/am/veq$rtg;-><init>(Lcom/android/server/am/veq;Lcom/android/server/am/veq$zta;)V

    iput-object v0, p0, Lcom/android/server/am/veq;->obl:Lcom/android/server/am/veq$rtg;
    ...
    invoke-static {v1, v0}, Lcom/android/server/am/AppRecordManager;->vdb(Lcom/android/server/am/AppRecordManager$ListenerType;Lcom/android/server/am/ibl;)V
    ...
    iget-object v1, p0, Lcom/android/server/am/veq;->obl:Lcom/android/server/am/veq$rtg;
    ...
    :try_start_0
    invoke-static {}, Lcom/android/server/am/gwm;->zta()V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0

    const/4 v0, 0x1

    iput-boolean v0, p0, Lcom/android/server/am/veq;->dma:Z
...
.method static synthetic wtn(Lcom/android/server/am/veq;Lorg/json/JSONArray;)V
    .locals 0
...
.method static synthetic you(Lcom/android/server/am/veq;)Z
    .locals 0

    iget-boolean p0, p0, Lcom/android/server/am/veq;->you:Z

    return p0
.end method

.method static synthetic ywr(Lcom/android/server/am/veq;)Z
    .locals 0

    iget-boolean p0, p0, Lcom/android/server/am/veq;->rtg:Z
...
.method protected a(I)Z
    ...
    iget-object p0, p0, Lcom/android/server/am/veq;->igw:Lcom/android/server/am/AppRecordManagerService;
...
.method public activityFinished(Landroid/content/pm/ActivityInfo;)V
    ...
    iget-object v2, p0, Lcom/android/server/am/veq;->ugm:Lcom/android/server/am/p;

    invoke-virtual {v2, v0}, Lcom/android/server/am/p;->tsu(I)Z
    ...
    invoke-static {p1}, Lcom/android/server/am/veq;->i(Ljava/lang/String;)V

    sget-object p1, Lcom/android/server/am/veq;->t:Landroid/os/Handler;

    const/4 v2, 0x1

    invoke-static {v0, v2}, Lcom/android/server/am/veq;->zgw(II)I
    ...
    sget-object v0, Lcom/android/server/am/veq;->t:Landroid/os/Handler;

    iget-wide v1, p0, Lcom/android/server/am/veq;->vdb:J
...
.method public addAccessibilityService(Landroid/content/ComponentName;)V
    ...
    iget-object v0, p0, Lcom/android/server/am/veq;->oif:Lcom/android/server/am/StartAppSpecialUidsPolicy;
    ...
    invoke-virtual {p0, p1}, Lcom/android/server/am/veq;->lqr(Ljava/lang/String;)I
...
.method public appBecomeVisible(I)V
    ...
    iget-boolean v0, p0, Lcom/android/server/am/veq;->dma:Z
    ...
    invoke-virtual {p0, p1}, Lcom/android/server/am/p;->zta(I)V
...
.method protected b(Ljava/lang/String;)Z
    ...
    iget-object v0, p0, Lcom/android/server/am/veq;->lqr:Ljava/util/List;
...
.method public canActivityGo(Ljava/lang/String;ILandroid/content/Intent;Landroid/content/pm/ActivityInfo;)Z
    ...
    iget-boolean v2, v0, Lcom/android/server/am/veq;->zta:Z

    const/4 v3, 0x1

    if-eqz v2, :cond_a

    iget-boolean v2, v0, Lcom/android/server/am/veq;->dma:Z
    ...
    iget-object v0, v0, Lcom/android/server/am/veq;->ywr:Lcom/android/server/am/StartAppRecorder;
    ...
    :cond_1
    invoke-virtual {v0, v2}, Lcom/android/server/am/veq;->b(Ljava/lang/String;)Z
    ...
    iget-object v1, v0, Lcom/android/server/am/veq;->oif:Lcom/android/server/am/StartAppSpecialUidsPolicy;
    ...
    :cond_2
    iget-object v4, v0, Lcom/android/server/am/veq;->qbh:Lcom/android/server/am/StartAppConfigManager;
    ...
    invoke-direct {v0, v4, v14, v12}, Lcom/android/server/am/veq;->cgv(Ljava/lang/Integer;ILcom/android/server/am/StartAppRecorder$zta;)Ljava/lang/Boolean;
    ...
    :cond_3
    iget-object v4, v0, Lcom/android/server/am/veq;->oif:Lcom/android/server/am/StartAppSpecialUidsPolicy;
    ...
    sget-object v4, Lcom/android/server/am/veq$tsu;->zta:[I
    ...
    iget-object v4, v0, Lcom/android/server/am/veq;->bvj:Lcom/android/server/am/n;
    ...
    invoke-virtual/range {v4 .. v9}, Lcom/android/server/am/n;->rtg(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lcom/android/server/am/StartAppRecorder$zta;)V

    sget-object v2, Lcom/android/server/am/veq$tsu;->zta:[I
    ...
    invoke-virtual {v0, v14}, Lcom/android/server/am/veq;->d(I)Z

    move-result v2

    if-eqz v2, :cond_5

    invoke-direct {v0, v1, v14}, Lcom/android/server/am/veq;->h(Landroid/content/pm/ActivityInfo;I)Z
    ...
    iget-object v1, v0, Lcom/android/server/am/veq;->ywr:Lcom/android/server/am/StartAppRecorder;

    invoke-virtual {v1, v12}, Lcom/android/server/am/StartAppRecorder;->you(Lcom/android/server/am/StartAppRecorder$zta;)V

    iget-object v0, v0, Lcom/android/server/am/veq;->oif:Lcom/android/server/am/StartAppSpecialUidsPolicy;
    ...
    iget-object v1, v0, Lcom/android/server/am/veq;->oxb:Ljava/util/Set;
...
.method public canInstrumentationGo(Landroid/content/ComponentName;I)Z
    ...
    iget-boolean v1, v0, Lcom/android/server/am/veq;->zta:Z

    const/4 v8, 0x1

    if-eqz v1, :cond_d

    iget-boolean v1, v0, Lcom/android/server/am/veq;->dma:Z
    ...
    :cond_0
    iget-object v1, v0, Lcom/android/server/am/veq;->igw:Lcom/android/server/am/AppRecordManagerService;
    ...
    invoke-virtual {v0, v15, v4}, Lcom/android/server/am/veq;->veq(Ljava/lang/String;I)I
    ...
    :cond_2
    invoke-virtual {v0, v15}, Lcom/android/server/am/veq;->b(Ljava/lang/String;)Z
    ...
    invoke-virtual {v0, v6}, Lcom/android/server/am/veq;->d(I)Z
    ...
    :cond_3
    iget-object v9, v0, Lcom/android/server/am/veq;->qbh:Lcom/android/server/am/StartAppConfigManager;
    ...
    invoke-direct {v0, v9, v6, v7}, Lcom/android/server/am/veq;->cgv(Ljava/lang/Integer;ILcom/android/server/am/StartAppRecorder$zta;)Ljava/lang/Boolean;
    ...
    sget-object v1, Lcom/android/server/am/veq$tsu;->zta:[I
    ...
    invoke-direct {v0, v15, v13, v11}, Lcom/android/server/am/veq;->vdb(Ljava/lang/String;ILcom/android/server/am/StartAppRecorder$zta;)V
    ...
    invoke-direct {v0, v1, v13, v11}, Lcom/android/server/am/veq;->cgv(Ljava/lang/Integer;ILcom/android/server/am/StartAppRecorder$zta;)Ljava/lang/Boolean;
    ...
    invoke-virtual {v0, v13}, Lcom/android/server/am/veq;->d(I)Z

    move-result v1

    if-eqz v1, :cond_9

    iget-object v0, v0, Lcom/android/server/am/veq;->oxb:Ljava/util/Set;
...
.method public canJobSchedulerGo(Ljava/lang/Object;)Z
    ...
    invoke-direct {v1, v3}, Lcom/android/server/am/vdb;-><init>(Ljava/lang/Object;)V

    :try_start_0
    invoke-virtual {v1}, Lcom/android/server/am/vdb;->sis()Ljava/lang/String;

    move-result-object v9

    invoke-virtual {v1}, Lcom/android/server/am/vdb;->you()Landroid/content/ComponentName;
    ...
    invoke-virtual {v1}, Lcom/android/server/am/vdb;->zta()I
    ...
    invoke-virtual {v1}, Lcom/android/server/am/vdb;->tsu()I
    ...
    invoke-virtual {v0, v9}, Lcom/android/server/am/veq;->b(Ljava/lang/String;)Z
    ...
    :cond_1
    invoke-virtual {v0, v10, v1}, Lcom/android/server/am/veq;->veq(Ljava/lang/String;I)I
    ...
    :cond_2
    iget-object v3, v0, Lcom/android/server/am/veq;->qbh:Lcom/android/server/am/StartAppConfigManager;
    ...
    invoke-direct {v0, v15, v13, v11}, Lcom/android/server/am/veq;->cgv(Ljava/lang/Integer;ILcom/android/server/am/StartAppRecorder$zta;)Ljava/lang/Boolean;
    ...
    :cond_3
    iget-object v3, v0, Lcom/android/server/am/veq;->oif:Lcom/android/server/am/StartAppSpecialUidsPolicy;
    ...
    sget-object v3, Lcom/android/server/am/veq$tsu;->zta:[I
    ...
    invoke-direct {v0, v10, v13, v11}, Lcom/android/server/am/veq;->vdb(Ljava/lang/String;ILcom/android/server/am/StartAppRecorder$zta;)V
    ...
    invoke-direct {v0, v3, v13, v11}, Lcom/android/server/am/veq;->cgv(Ljava/lang/Integer;ILcom/android/server/am/StartAppRecorder$zta;)Ljava/lang/Boolean;
    ...
    :cond_5
    invoke-virtual {v0, v1}, Lcom/android/server/am/veq;->d(I)Z
...
.method public canNotificationListenerServiceGo(Landroid/content/ComponentName;)Z
    ...
    invoke-virtual {p0, v0}, Lcom/android/server/am/veq;->lqr(Ljava/lang/String;)I
    ...
    invoke-virtual {p0, p1}, Lcom/android/server/am/veq;->d(I)Z

    move-result v0

    if-eqz v0, :cond_1

    iget-object v0, p0, Lcom/android/server/am/veq;->oxb:Ljava/util/Set;
    ...
    :cond_3
    iget-object v2, p0, Lcom/android/server/am/veq;->qbh:Lcom/android/server/am/StartAppConfigManager;
    ...
    invoke-direct {p0, v2, p1, v8}, Lcom/android/server/am/veq;->cgv(Ljava/lang/Integer;ILcom/android/server/am/StartAppRecorder$zta;)Ljava/lang/Boolean;
    ...
    :cond_4
    invoke-direct {p0, v0, p1, v8}, Lcom/android/server/am/veq;->vdb(Ljava/lang/String;ILcom/android/server/am/StartAppRecorder$zta;)V

    sget-object v0, Lcom/android/server/am/veq$tsu;->zta:[I
    ...
    invoke-direct {p0, v0, p1, v8}, Lcom/android/server/am/veq;->cgv(Ljava/lang/Integer;ILcom/android/server/am/StartAppRecorder$zta;)Ljava/lang/Boolean;
    ...
    :cond_9
    iget-object v0, p0, Lcom/android/server/am/veq;->ywr:Lcom/android/server/am/StartAppRecorder;
...
.method public canProcGo(Lcom/android/server/am/ProcessRecord;Ljava/lang/String;)Z
    ...
    invoke-virtual {p0, v3}, Lcom/android/server/am/veq;->d(I)Z
    ...
    :cond_3
    const-string v3, "added application"
    ...
    :cond_4
    iget-object p2, p0, Lcom/android/server/am/veq;->bio:Lcom/android/server/ear;

    invoke-virtual {p2, v0}, Lcom/android/server/ear;->cjf(Ljava/lang/String;)Z
    ...
    :cond_5
    invoke-direct {p0, p1}, Lcom/android/server/am/veq;->ivd(Lcom/android/server/am/ProcessRecord;)Z
    ...
    :cond_6
    iget-object p2, p0, Lcom/android/server/am/veq;->ire:Ljava/util/List;
    ...
    iget-object p1, p0, Lcom/android/server/am/veq;->ire:Ljava/util/List;
    ...
    :cond_7
    iget-object p2, p0, Lcom/android/server/am/veq;->oxb:Ljava/util/Set;
...
.method public canProviderGo(Ljava/lang/String;ILjava/lang/String;Lcom/android/server/am/ContentProviderRecord;)Z
    ...
    iget-boolean v2, v0, Lcom/android/server/am/veq;->you:Z
    ...
    iget-object v2, v0, Lcom/android/server/am/veq;->igw:Lcom/android/server/am/AppRecordManagerService;
    ...
    :cond_3
    invoke-virtual {v0, v14}, Lcom/android/server/am/veq;->b(Ljava/lang/String;)Z
    ...
    iget-object v2, v0, Lcom/android/server/am/veq;->oxb:Ljava/util/Set;
    ...
    :cond_4
    iget-object v8, v0, Lcom/android/server/am/veq;->qbh:Lcom/android/server/am/StartAppConfigManager;
    ...
    invoke-direct {v0, v11, v1, v6}, Lcom/android/server/am/veq;->cgv(Ljava/lang/Integer;ILcom/android/server/am/StartAppRecorder$zta;)Ljava/lang/Boolean;
    ...
    :cond_5
    iget-object v5, v0, Lcom/android/server/am/veq;->oif:Lcom/android/server/am/StartAppSpecialUidsPolicy;
    ...
    invoke-direct {v0, v14, v1, v10}, Lcom/android/server/am/veq;->vdb(Ljava/lang/String;ILcom/android/server/am/StartAppRecorder$zta;)V
    ...
    invoke-direct {v0, v4, v1, v10}, Lcom/android/server/am/veq;->cgv(Ljava/lang/Integer;ILcom/android/server/am/StartAppRecorder$zta;)Ljava/lang/Boolean;
    ...
    invoke-virtual/range {v4 .. v9}, Lcom/android/server/am/n;->ssp(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ILcom/android/server/am/StartAppRecorder$zta;)V
    ...
    :cond_9
    iget-object v2, v0, Lcom/android/server/am/veq;->ywr:Lcom/android/server/am/StartAppRecorder;
...
.method public canReceiverGo(Lcom/android/server/am/BroadcastRecord;Lcom/android/server/am/ProcessRecord;)Z
    ...
    :cond_3
    invoke-virtual {v0, v3}, Lcom/android/server/am/veq;->lqr(Ljava/lang/String;)I
    ...
    :cond_5
    invoke-virtual {v0, v3}, Lcom/android/server/am/veq;->b(Ljava/lang/String;)Z
    ...
    invoke-virtual {v0, v7}, Lcom/android/server/am/veq;->d(I)Z
    ...
    :cond_6
    iget-object v10, v0, Lcom/android/server/am/veq;->qbh:Lcom/android/server/am/StartAppConfigManager;
    ...
    invoke-direct {v0, v6, v7, v8}, Lcom/android/server/am/veq;->cgv(Ljava/lang/Integer;ILcom/android/server/am/StartAppRecorder$zta;)Ljava/lang/Boolean;
    ...
    :cond_7
    iget-object v10, v0, Lcom/android/server/am/veq;->oif:Lcom/android/server/am/StartAppSpecialUidsPolicy;
    ...
    sget-object v10, Lcom/android/server/am/veq$tsu;->zta:[I
    ...
    invoke-direct {v0, v3, v7, v8}, Lcom/android/server/am/veq;->vdb(Ljava/lang/String;ILcom/android/server/am/StartAppRecorder$zta;)V
    ...
    invoke-direct {v0, v2, v7, v8}, Lcom/android/server/am/veq;->cgv(Ljava/lang/Integer;ILcom/android/server/am/StartAppRecorder$zta;)Ljava/lang/Boolean;
    ...
    :cond_9
    iget-object v2, v0, Lcom/android/server/am/veq;->bvj:Lcom/android/server/am/n;
    ...
    invoke-virtual/range {v1 .. v8}, Lcom/android/server/am/n;->cno(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lcom/android/server/am/ProcessRecord;ILjava/lang/String;Lcom/android/server/am/StartAppRecorder$zta;)V
...
.method public canScheduleServiceRestart(Lcom/android/server/am/ProcessRecord;)Z
    ...
    iget-boolean v0, p0, Lcom/android/server/am/veq;->sis:Z
    ...
    :cond_1
    iget-object p1, p0, Lcom/android/server/am/veq;->cjf:Ljava/util/List;
    ...
    :cond_2
    iget-object p1, p0, Lcom/android/server/am/veq;->bio:Lcom/android/server/ear;

    invoke-virtual {p1, v6}, Lcom/android/server/ear;->cjf(Ljava/lang/String;)Z
    ...
    :cond_3
    iget-object v4, p0, Lcom/android/server/am/veq;->qbh:Lcom/android/server/am/StartAppConfigManager;
    ...
    invoke-direct {p0, p1, v2, v3}, Lcom/android/server/am/veq;->cgv(Ljava/lang/Integer;ILcom/android/server/am/StartAppRecorder$zta;)Ljava/lang/Boolean;
...
.method public canServiceGo(Ljava/lang/String;ILandroid/content/Intent;Lcom/android/server/am/ServiceRecord;)Z
    ...
    :cond_2
    invoke-virtual {v0, v11}, Lcom/android/server/am/veq;->b(Ljava/lang/String;)Z
    ...
    invoke-virtual {v0, v15}, Lcom/android/server/am/veq;->d(I)Z
    ...
    :cond_3
    iget-object v2, v0, Lcom/android/server/am/veq;->qbh:Lcom/android/server/am/StartAppConfigManager;
    ...
    invoke-direct {v0, v7, v15, v13}, Lcom/android/server/am/veq;->cgv(Ljava/lang/Integer;ILcom/android/server/am/StartAppRecorder$zta;)Ljava/lang/Boolean;
    ...
    invoke-direct {v0, v11, v15, v13}, Lcom/android/server/am/veq;->vdb(Ljava/lang/String;ILcom/android/server/am/StartAppRecorder$zta;)V
    ...
    invoke-direct {v0, v1, v15, v13}, Lcom/android/server/am/veq;->cgv(Ljava/lang/Integer;ILcom/android/server/am/StartAppRecorder$zta;)Ljava/lang/Boolean;
    ...
    :cond_6
    iget-object v1, v0, Lcom/android/server/am/veq;->bvj:Lcom/android/server/am/n;
    ...
    invoke-virtual/range {v1 .. v8}, Lcom/android/server/am/n;->bio(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lcom/android/server/am/ServiceRecord;ILandroid/content/Intent;Lcom/android/server/am/StartAppRecorder$zta;)V
...
.method public dispatchBlockedAuthes(Landroid/app/IApplicationThread;Ljava/lang/String;)V
    ...
    :cond_0
    :try_start_0
    invoke-direct {p0, p2}, Lcom/android/server/am/veq;->ear(Ljava/lang/String;)Ljava/util/List;
...
.method protected e(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    iget-object p0, p0, Lcom/android/server/am/veq;->ear:Ljava/util/Map;
...
.method public synthetic g(Lorg/json/JSONArray;)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/android/server/am/veq;->f(Lorg/json/JSONArray;)V
...
.method public getJobTimeout()J
    ...
    iget-boolean p0, p0, Lcom/android/server/am/veq;->zta:Z

    if-eqz p0, :cond_0

    invoke-static {}, Lcom/android/server/am/c;->obl()J
...
.method public handleAppKilledLocked(Lcom/android/server/am/ProcessRecord;)V
    ...
    iget-boolean v0, p0, Lcom/android/server/am/veq;->tsu:Z
    ...
    :cond_0
    iget-object v0, p0, Lcom/android/server/am/veq;->ibl:Lcom/android/server/am/k;

    invoke-virtual {v0, p1}, Lcom/android/server/am/k;->tsu(Lcom/android/server/am/ProcessRecord;)Z
    ...
    iget-object v2, p0, Lcom/android/server/am/veq;->ibl:Lcom/android/server/am/k;

    invoke-virtual {v2, p1, v0, v1}, Lcom/android/server/am/k;->kth(Lcom/android/server/am/ProcessRecord;J)V

    iget-object p0, p0, Lcom/android/server/am/veq;->ibl:Lcom/android/server/am/k;

    invoke-virtual {p0, p1, v0, v1}, Lcom/android/server/am/k;->cno(Lcom/android/server/am/ProcessRecord;J)V
...
.method public initAms(Lcom/android/server/am/ActivityManagerService;)V
    ...
    iput-object p1, p0, Lcom/android/server/am/veq;->cno:Lcom/android/server/am/ActivityManagerService;

    invoke-direct {p0}, Lcom/android/server/am/veq;->k()V
...
.method public initPackages(Lcom/android/server/pm/PackageManagerService;Landroid/util/ArrayMap;)V
    ...
    sget-boolean v0, Lcom/android/server/am/veq;->r:Z
    ...
    :cond_0
    sput-object p1, Lcom/android/server/am/veq;->u:Lcom/android/server/pm/PackageManagerService;
    ...
    invoke-direct {p0, p2}, Lcom/android/server/am/veq;->p(Lcom/android/server/pm/parsing/pkg/AndroidPackage;)V
    ...
    sput-boolean p0, Lcom/android/server/am/veq;->r:Z
...
.method protected irq(Ljava/lang/String;)Z
    ...
    iget-object p0, p0, Lcom/android/server/am/veq;->bio:Lcom/android/server/ear;

    invoke-virtual {p0, p1}, Lcom/android/server/ear;->cjf(Ljava/lang/String;)Z
...
.method public isJobRestrict(Ljava/lang/Object;)Z
    ...
    new-instance p0, Lcom/android/server/am/vdb;

    invoke-direct {p0, p1}, Lcom/android/server/am/vdb;-><init>(Ljava/lang/Object;)V

    :try_start_0
    invoke-static {p0}, Lcom/android/server/am/c;->irq(Lcom/android/server/am/vdb;)Z
...
.method public isOnePixelWindow(Landroid/view/WindowManager$LayoutParams;)Z
    ...
    iget-boolean v0, p0, Lcom/android/server/am/veq;->rtg:Z
    ...
    :cond_0
    iget-object v0, p0, Lcom/android/server/am/veq;->hmo:Ljava/util/List;
    ...
    iget-object v0, p0, Lcom/android/server/am/veq;->ugm:Lcom/android/server/am/p;

    invoke-virtual {v0, p1}, Lcom/android/server/am/p;->sis(Landroid/view/WindowManager$LayoutParams;)Z
    ...
    :cond_2
    invoke-virtual {p0, v0}, Lcom/android/server/am/veq;->a(I)Z
...
.method protected les(Ljava/lang/String;)Z
    ...
    invoke-virtual {p0, p1}, Lcom/android/server/ear;->isOptApp(Ljava/lang/String;)Z
...
.method protected m(Ljava/lang/String;)V
    ...
    iget-object p0, p0, Lcom/android/server/am/veq;->ire:Ljava/util/List;
...
.method public qeg(Ljava/lang/String;)Z
    .locals 0

    invoke-static {p1}, Lcom/android/server/am/n;->oif(Ljava/lang/String;)Z
...
.method public reportRestrictJob(Ljava/lang/Object;J)V
    ...
    :try_start_0
    invoke-static {p0, p2, p3}, Lcom/android/server/am/c;->ivd(Lcom/android/server/am/vdb;J)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public setCurrentIME(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, p1}, Lcom/android/server/am/n;->gwm(Ljava/lang/String;)V
...
.method public setCurrentWallpaper(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, p1}, Lcom/android/server/am/n;->ugm(Ljava/lang/String;)V
...
.method public skipBroadcast(Ljava/lang/String;ILandroid/content/Intent;)Z
    ...
    invoke-direct {p0, p1, p2, v0}, Lcom/android/server/am/veq;->cgv(Ljava/lang/Integer;ILcom/android/server/am/StartAppRecorder$zta;)Ljava/lang/Boolean;
...
.method public startJobMonitoring(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    new-instance p0, Lcom/android/server/am/ugm;

    invoke-direct {p0, p1}, Lcom/android/server/am/ugm;-><init>(Ljava/lang/Object;)V

    new-instance p1, Lcom/android/server/am/vdb;

    invoke-direct {p1, p2}, Lcom/android/server/am/vdb;-><init>(Ljava/lang/Object;)V

    :try_start_0
    invoke-static {p0, p1}, Lcom/android/server/am/c;->b(Lcom/android/server/am/ugm;Lcom/android/server/am/vdb;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public stopJobMonitoring(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    :try_start_0
    invoke-static {p0, p1}, Lcom/android/server/am/c;->c(Lcom/android/server/am/ugm;Lcom/android/server/am/vdb;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public updateAccessibilityService(Ljava/util/Set;)V
    ...
    invoke-virtual {p0, v1}, Lcom/android/server/am/veq;->lqr(Ljava/lang/String;)I
...
.method public updateGMSActionSet(Ljava/util/List;)V
    ...
    invoke-virtual {p0, p1}, Lcom/android/server/am/n;->obl(Ljava/util/List;)V
...
.method public updateGMSRestrict(Z)V
    ...
    invoke-virtual {p0, p1}, Lcom/android/server/am/n;->oxb(Z)V
...
.method public updateHighPowerUsagePackages(Ljava/util/Collection;)V
    ...
    invoke-virtual {p0, v0}, Lcom/android/server/am/veq;->updateHighPowerUsagePackage(Ljava/lang/String;)V
...
.method public updateWidgetComponent(Landroid/content/ComponentName;Z)V
    ...
    iget-object p2, p0, Lcom/android/server/am/veq;->ear:Ljava/util/Map;
...
.method protected vdw(Ljava/lang/String;)Z
    .locals 1

    iget-object v0, p0, Lcom/android/server/am/veq;->cgv:Ljava/util/HashSet;
