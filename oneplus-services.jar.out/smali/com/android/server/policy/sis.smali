...
.method public interceptPowerKeyDown(Landroid/view/KeyEvent;)Z
    ...
    const-string v0, "interceptPowerKeyDown: start voice assist"
    ...
    :cond_2
    sget-boolean p1, Lcom/android/server/policy/sis;->oxb:Z
    ...
    const-string v0, "interceptPowerKeyDown: false, getAvailableAssistantComponent = "
    ...
    const-string v0, ", isVolumeKeyTriggered = "
    ...
    const-string v0, ", mPowerKeyAssistantEnable = "

    invoke-virtual {p1, v0}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-boolean p0, p0, Lcom/android/server/policy/sis;->tsu:Z
