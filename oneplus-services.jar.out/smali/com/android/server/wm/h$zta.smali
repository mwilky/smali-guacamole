.class public Lcom/android/server/wm/h$zta;
...
.annotation system Ldalvik/annotation/EnclosingClass;
    value = Lcom/android/server/wm/h;
.end annotation
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/server/wm/h$zta$rtg;
    }
.end annotation
...
.field private static e:Lcom/android/server/wm/h$zta$rtg; = null
...
.method public constructor <init>()V
    ...
    iput v0, p0, Lcom/android/server/wm/h$zta;->cno:I

    const/4 v1, 0x0

    iput-object v1, p0, Lcom/android/server/wm/h$zta;->kth:Ljava/lang/String;

    iput-boolean v0, p0, Lcom/android/server/wm/h$zta;->bio:Z

    iput-object v1, p0, Lcom/android/server/wm/h$zta;->igw:Ljava/lang/String;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lcom/android/server/wm/h$zta;->wtn:Ljava/util/ArrayList;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lcom/android/server/wm/h$zta;->gck:Ljava/util/ArrayList;

    new-instance v0, Lcom/android/server/wm/h$zta$sis;

    invoke-direct {v0, p0}, Lcom/android/server/wm/h$zta$sis;-><init>(Lcom/android/server/wm/h$zta;)V

    iput-object v0, p0, Lcom/android/server/wm/h$zta;->qbh:Landroid/content/BroadcastReceiver;

    return-void
.end method

.method static synthetic bio(Lcom/android/server/wm/h$zta;)Landroid/content/Intent;
    .locals 0

    iget-object p0, p0, Lcom/android/server/wm/h$zta;->you:Landroid/content/Intent;

    return-object p0
.end method

.method static synthetic cno(Lcom/android/server/wm/h$zta;Ljava/lang/String;I)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/android/server/wm/h$zta;->wtn(Ljava/lang/String;I)V
...
.method private dma(ILjava/lang/String;I)V
    ...
    iget-object v0, p0, Lcom/android/server/wm/h$zta;->ssp:Lcom/android/server/wm/ActivityStackSupervisor;
    ...
    sput-object p1, Lcom/android/server/wm/h$zta;->a:Lcom/android/server/wm/ActivityRecord;

    invoke-virtual {p0, p1, v1}, Lcom/android/server/wm/h$zta;->veq(Lcom/android/server/wm/ActivityRecord;Lcom/android/server/wm/ActivityRecord;)V
...
.method private gck(Ljava/lang/String;)V
    ...
    sget-object v0, Lcom/android/server/wm/h$zta;->vdw:Landroid/app/NotificationManager;

    if-nez v0, :cond_0

    iget-object v0, p0, Lcom/android/server/wm/h$zta;->sis:Landroid/content/Context;
    ...
    sput-object v0, Lcom/android/server/wm/h$zta;->vdw:Landroid/app/NotificationManager;

    :cond_0
    sget-object v0, Lcom/android/server/wm/h$zta;->vdw:Landroid/app/NotificationManager;

    iget-object v1, p0, Lcom/android/server/wm/h$zta;->tsu:Ljava/lang/String;
    ...
    iget-object p0, p0, Lcom/android/server/wm/h$zta;->tsu:Ljava/lang/String;
    ...
    sget-object p0, Lcom/android/server/wm/h$zta;->vdw:Landroid/app/NotificationManager;
...
.method static synthetic igw(Lcom/android/server/wm/h$zta;)Lcom/android/server/wm/ActivityStack;
    .locals 0

    iget-object p0, p0, Lcom/android/server/wm/h$zta;->rtg:Lcom/android/server/wm/ActivityStack;
...
.method private ire(Z)V
    ...
    :try_start_0
    iget-object p0, p0, Lcom/android/server/wm/h$zta;->sis:Landroid/content/Context;
...
.method static synthetic kth(Lcom/android/server/wm/h$zta;ILjava/lang/String;I)V
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lcom/android/server/wm/h$zta;->dma(ILjava/lang/String;I)V

    return-void
.end method

.method static synthetic rtg(Lcom/android/server/wm/h$zta;)Landroid/app/AlertDialog;
    .locals 0

    iget-object p0, p0, Lcom/android/server/wm/h$zta;->zta:Landroid/app/AlertDialog;

    return-object p0
.end method

.method static synthetic sis(Lcom/android/server/wm/h$zta;)Ljava/lang/String;
    .locals 0
...
.method static synthetic ssp(Lcom/android/server/wm/h$zta;Landroid/app/AlertDialog;)Landroid/app/AlertDialog;
    .locals 0

    iput-object p1, p0, Lcom/android/server/wm/h$zta;->zta:Landroid/app/AlertDialog;
...
.method private vdb(II)Z
    ...
    iget-object p2, p0, Lcom/android/server/wm/h$zta;->sis:Landroid/content/Context;
...
.method private wtn(Ljava/lang/String;I)V
    ...
    sget-object p0, Lcom/android/server/wm/h$zta;->qeg:Lcom/android/internal/statusbar/IStatusBarService;
    ...
    sput-object p0, Lcom/android/server/wm/h$zta;->qeg:Lcom/android/internal/statusbar/IStatusBarService;
...
.method static synthetic you(Lcom/android/server/wm/h$zta;)Landroid/content/Context;
    .locals 0
...
.method static synthetic zta()Lcom/android/server/wm/h$zta$rtg;
    .locals 1

    sget-object v0, Lcom/android/server/wm/h$zta;->e:Lcom/android/server/wm/h$zta$rtg;
...
.method public bud(Z)V
    ...
    iget-object p1, p0, Lcom/android/server/wm/h$zta;->gck:Ljava/util/ArrayList;

    iget-object v0, p0, Lcom/android/server/wm/h$zta;->kth:Ljava/lang/String;
    ...
    iput-boolean p1, p0, Lcom/android/server/wm/h$zta;->bio:Z

    iget-object p1, p0, Lcom/android/server/wm/h$zta;->kth:Ljava/lang/String;
    ...
    :goto_0
    iput-object p1, p0, Lcom/android/server/wm/h$zta;->igw:Ljava/lang/String;
...
.method public bvj(I)V
    ...
    sget-boolean p0, Lcom/android/server/wm/h;->zta:Z
...
.method public cgv(Lcom/android/server/wm/ActivityRecord;Lcom/android/server/wm/ActivityRecord;)V
    ...
    invoke-static {}, Lcom/android/server/wm/h;->zta()Z
    ...
    :cond_0
    sget-boolean v0, Lcom/android/server/wm/h;->zta:Z
    ...
    sput-object p1, Lcom/android/server/wm/h$zta;->ivd:Lcom/android/server/wm/ActivityRecord;

    goto :goto_0

    :cond_2
    sput-object v0, Lcom/android/server/wm/h$zta;->ivd:Lcom/android/server/wm/ActivityRecord;

    :goto_0
    invoke-direct {p0, p1, p2}, Lcom/android/server/wm/h$zta;->ugm(Lcom/android/server/wm/ActivityRecord;Lcom/android/server/wm/ActivityRecord;)Z
    ...
    :cond_4
    iget-object p1, p0, Lcom/android/server/wm/h$zta;->rtg:Lcom/android/server/wm/ActivityStack;
    ...
    sput-object v0, Lcom/android/server/wm/h$zta;->a:Lcom/android/server/wm/ActivityRecord;
    ...
    const-string p1, "[scene] Remove message EVALUATE_GAME_MODE_MSG"
...
.method public cjf(Lcom/android/server/wm/ActivityRecord;)V
    ...
    iget-object v4, p0, Lcom/android/server/wm/h$zta;->ssp:Lcom/android/server/wm/ActivityStackSupervisor;
    ...
    iput-object v3, p0, Lcom/android/server/wm/h$zta;->tsu:Ljava/lang/String;
    ...
    iput-object v3, p0, Lcom/android/server/wm/h$zta;->you:Landroid/content/Intent;

    const v4, 0x10008000

    invoke-virtual {v3, v4}, Landroid/content/Intent;->setFlags(I)Landroid/content/Intent;

    iget-object v3, p0, Lcom/android/server/wm/h$zta;->sis:Landroid/content/Context;
    ...
    iget-object v4, p0, Lcom/android/server/wm/h$zta;->sis:Landroid/content/Context;
    ...
    invoke-direct {p0, v3}, Lcom/android/server/wm/h$zta;->gck(Ljava/lang/String;)V
    ...
    iget-object v6, p0, Lcom/android/server/wm/h$zta;->sis:Landroid/content/Context;
    ...
    iget-object v9, p0, Lcom/android/server/wm/h$zta;->sis:Landroid/content/Context;
    ...
    iget-object p1, p0, Lcom/android/server/wm/h$zta;->sis:Landroid/content/Context;
    ...
    iget-object v7, p0, Lcom/android/server/wm/h$zta;->sis:Landroid/content/Context;
    ...
    iget-object v8, p0, Lcom/android/server/wm/h$zta;->tsu:Ljava/lang/String;
    ...
    iget-object v2, p0, Lcom/android/server/wm/h$zta;->sis:Landroid/content/Context;

    iget-object v3, p0, Lcom/android/server/wm/h$zta;->you:Landroid/content/Intent;
    ...
    iget-object v2, p0, Lcom/android/server/wm/h$zta;->rtg:Lcom/android/server/wm/ActivityStack;

    iget-object v2, v2, Lcom/android/server/wm/ActivityStack;->mHandler:Landroid/os/Handler;

    new-instance v3, Lcom/android/server/wm/h$zta$you;

    invoke-direct {v3, p0, p1}, Lcom/android/server/wm/h$zta$you;-><init>(Lcom/android/server/wm/h$zta;Landroid/app/Notification$Builder;)V
...
.method ear(IZ)V
    ...
    :cond_2
    :goto_0
    iget-object p2, p0, Lcom/android/server/wm/h$zta;->rtg:Lcom/android/server/wm/ActivityStack;

    iget-object p2, p2, Lcom/android/server/wm/ActivityStack;->mHandler:Landroid/os/Handler;

    new-instance v0, Lcom/android/server/wm/h$zta$tsu;

    invoke-direct {v0, p0, p1}, Lcom/android/server/wm/h$zta$tsu;-><init>(Lcom/android/server/wm/h$zta;Ljava/lang/String;)V
...
.method public fto(Lcom/android/server/wm/ActivityRecord;Lcom/android/server/wm/ActivityRecord;)V
    ...
    iget-object p1, p0, Lcom/android/server/wm/h$zta;->ssp:Lcom/android/server/wm/ActivityStackSupervisor;
...
.method public gwm(Lcom/android/server/wm/ActivityStack;Lcom/android/server/wm/ActivityStackSupervisor;)V
    ...
    iput-object p1, p0, Lcom/android/server/wm/h$zta;->rtg:Lcom/android/server/wm/ActivityStack;

    iput-object p2, p0, Lcom/android/server/wm/h$zta;->ssp:Lcom/android/server/wm/ActivityStackSupervisor;
    ...
    iput-object p1, p0, Lcom/android/server/wm/h$zta;->sis:Landroid/content/Context;

    sget-object p1, Lcom/android/server/wm/h$zta;->e:Lcom/android/server/wm/h$zta$rtg;

    if-nez p1, :cond_0

    new-instance p1, Lcom/android/server/wm/h$zta$rtg;

    iget-object p2, p0, Lcom/android/server/wm/h$zta;->sis:Landroid/content/Context;

    iget-object v0, p0, Lcom/android/server/wm/h$zta;->rtg:Lcom/android/server/wm/ActivityStack;

    iget-object v0, v0, Lcom/android/server/wm/ActivityStack;->mHandler:Landroid/os/Handler;

    invoke-direct {p1, p0, p2, v0}, Lcom/android/server/wm/h$zta$rtg;-><init>(Lcom/android/server/wm/h$zta;Landroid/content/Context;Landroid/os/Handler;)V

    sput-object p1, Lcom/android/server/wm/h$zta;->e:Lcom/android/server/wm/h$zta$rtg;

    iget-object p1, p0, Lcom/android/server/wm/h$zta;->rtg:Lcom/android/server/wm/ActivityStack;

    iget-object p1, p1, Lcom/android/server/wm/ActivityStack;->mHandler:Landroid/os/Handler;

    new-instance p2, Lcom/android/server/wm/h$zta$zta;

    invoke-direct {p2, p0}, Lcom/android/server/wm/h$zta$zta;-><init>(Lcom/android/server/wm/h$zta;)V
...
.method public hmo(Lcom/android/server/wm/ActivityRecord;Lcom/android/server/wm/ActivityRecord;)V
    ...
    iget-object v3, p0, Lcom/android/server/wm/h$zta;->wtn:Ljava/util/ArrayList;
    ...
    iput-object v2, p0, Lcom/android/server/wm/h$zta;->igw:Ljava/lang/String;
    ...
    iget-boolean v4, p0, Lcom/android/server/wm/h$zta;->bio:Z

    if-eqz v4, :cond_5

    iget-object v4, p0, Lcom/android/server/wm/h$zta;->gck:Ljava/util/ArrayList;
    ...
    invoke-virtual {p0, v4, p1}, Lcom/android/server/wm/h$zta;->ear(IZ)V
    ...
    invoke-virtual {p0, v1, p1}, Lcom/android/server/wm/h$zta;->ear(IZ)V
    ...
    iput-object v0, p0, Lcom/android/server/wm/h$zta;->kth:Ljava/lang/String;

    goto :goto_5

    :cond_9
    iput-object v2, p0, Lcom/android/server/wm/h$zta;->kth:Ljava/lang/String;
    ...
    sget-boolean v2, Lcom/android/server/wm/h;->zta:Z
    ...
    iget-boolean v2, p0, Lcom/android/server/wm/h$zta;->bio:Z
...
.method public ibl()V
    ...
    :cond_0
    iget-boolean v0, p0, Lcom/android/server/wm/h$zta;->ywr:Z

    if-eqz v0, :cond_2

    iput-boolean v2, p0, Lcom/android/server/wm/h$zta;->ywr:Z

    goto :goto_1

    :cond_1
    :goto_0
    iget-boolean v0, p0, Lcom/android/server/wm/h$zta;->dma:Z

    if-eqz v0, :cond_2

    iput-boolean v2, p0, Lcom/android/server/wm/h$zta;->dma:Z

    :goto_1
    invoke-direct {p0, v1}, Lcom/android/server/wm/h$zta;->ire(Z)V

    goto :goto_2

    :cond_2
    invoke-direct {p0, v2}, Lcom/android/server/wm/h$zta;->ire(Z)V
...
.method public irq(Lcom/android/server/am/ActivityManagerService;Lcom/android/server/wm/ActivityRecord;)V
    ...
    invoke-virtual {p0, v2}, Lcom/android/server/wm/h$zta;->les(I)V
...
.method public lqr(Lcom/android/server/wm/ActivityRecord;Lcom/android/server/wm/ActivityRecord;)V
    ...
    iget-object v1, p0, Lcom/android/server/wm/h$zta;->rtg:Lcom/android/server/wm/ActivityStack;
...
.method public oxb(Lcom/android/server/wm/ActivityRecord;Lcom/android/server/wm/ActivityRecord;)V
    ...
    :cond_0
    :goto_0
    iput-boolean v1, p0, Lcom/android/server/wm/h$zta;->bio:Z

    iput-object v3, p0, Lcom/android/server/wm/h$zta;->igw:Ljava/lang/String;
    ...
    :cond_2
    iget-boolean p2, p0, Lcom/android/server/wm/h$zta;->bio:Z

    if-eqz p2, :cond_3

    iget-object p2, p0, Lcom/android/server/wm/h$zta;->igw:Ljava/lang/String;
...
.method public qbh(II)Z
    ...
    invoke-direct {p0, p1, p2}, Lcom/android/server/wm/h$zta;->vdb(II)Z
...
.method public veq(Lcom/android/server/wm/ActivityRecord;Lcom/android/server/wm/ActivityRecord;)V
    ...
    sget-object v1, Lcom/android/server/wm/h$zta;->ivd:Lcom/android/server/wm/ActivityRecord;
    ...
    sget-object v1, Lcom/android/server/wm/h$zta;->a:Lcom/android/server/wm/ActivityRecord;
    ...
    sget-object v0, Lcom/android/server/wm/h$zta;->ivd:Lcom/android/server/wm/ActivityRecord;
    ...
    :try_start_0
    iget-object v1, p0, Lcom/android/server/wm/h$zta;->ssp:Lcom/android/server/wm/ActivityStackSupervisor;
    ...
    sget-object v0, Lcom/android/server/wm/h$zta;->a:Lcom/android/server/wm/ActivityRecord;

    sget-object v1, Lcom/android/server/wm/h$zta;->ivd:Lcom/android/server/wm/ActivityRecord;

    if-eq v0, v1, :cond_c

    invoke-direct {p0, v0, p2}, Lcom/android/server/wm/h$zta;->ugm(Lcom/android/server/wm/ActivityRecord;Lcom/android/server/wm/ActivityRecord;)Z
    ...
    :cond_e
    sput-object p2, Lcom/android/server/wm/h$zta;->a:Lcom/android/server/wm/ActivityRecord;
    ...
    invoke-virtual {p0, p1, p2}, Lcom/android/server/wm/h$zta;->fto(Lcom/android/server/wm/ActivityRecord;Lcom/android/server/wm/ActivityRecord;)V
...
.method public ywr()V
    ...
    iget-object v0, p0, Lcom/android/server/wm/h$zta;->wtn:Ljava/util/ArrayList;

    iget-object v1, p0, Lcom/android/server/wm/h$zta;->kth:Ljava/lang/String;

    invoke-virtual {v0, v1}, Ljava/util/ArrayList;->remove(Ljava/lang/Object;)Z

    iget-object v0, p0, Lcom/android/server/wm/h$zta;->gck:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, Lcom/android/server/wm/h$zta;->igw:Ljava/lang/String;
...
.method public zgw()V
    ...
    :goto_0
    iput-boolean v0, p0, Lcom/android/server/wm/h$zta;->dma:Z
    ...
    iget-boolean v1, p0, Lcom/android/server/wm/h$zta;->dma:Z
    ...
    iget-boolean p0, p0, Lcom/android/server/wm/h$zta;->ywr:Z
