...
.field private static final GAP_OF_EXIT_OPSM:J = 0x2710L
...
.field private static final PROTO_DETAIL_COLLECT_COUNT:I = 0x3
...
.field private mDailyProtoDetailCollectCount:I
...
.field mIOpChargingGuarder:Lcom/android/server/gck;
...
.field mOnePlusSensorManager:Lcom/android/server/bvj;

.field private mOpAlarmAlignment:Lcom/android/server/ugm;

.field private mOpAlarmManager:Lcom/android/server/vdb;
...
.field mOverHeatingDiagnosis:Lcom/android/server/ire;
...
.method public constructor <init>()V
    ...
    iput v2, p0, Lcom/android/server/OpPowerControllerService;->mDailyProtoDetailCollectCount:I
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput v3, p0, Lcom/android/server/OpPowerControllerService;->mDailyProtoDetailCollectCount:I
...
.method private applyIdleWhitelistForSmart()V
    ...
    invoke-virtual {v0, v2}, Lcom/android/server/ear;->isSmartOptApp(Ljava/lang/String;)Z
    ...
    invoke-static {v4, v2}, Lcom/android/server/dma$zta;->zta(Ljava/lang/String;Ljava/lang/String;)I
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-virtual {v0, v1}, Lcom/android/server/ear;->isSmartOptApp(Ljava/lang/String;)Z
    ...
    invoke-static {v4, v1}, Lcom/android/server/dma$zta;->zta(Ljava/lang/String;Ljava/lang/String;)I
    :try_end_1
...
.method private dumpUseSleep(Ljava/io/PrintWriter;)V
    ...
    const-string v1, " DailyProtoDetailCollectCount = "

    invoke-virtual {v0, v1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget v1, p0, Lcom/android/server/OpPowerControllerService;->mDailyProtoDetailCollectCount:I
...
.method private enableDisableData(Z)V
    ...
    invoke-static {v2, v1}, Lcom/android/server/dma$zta;->zta(Ljava/lang/String;Ljava/lang/String;)I
...
.method private parseDailyProtoConfig(Lorg/json/JSONObject;)V
    ...
    iput-boolean v0, p0, Lcom/android/server/OpPowerControllerService;->mDailyProtoReportEnabled:Z
    ...
    iput p1, p0, Lcom/android/server/OpPowerControllerService;->mDailyProtoDetailCollectCount:I

    invoke-static {p1}, Lcom/android/server/am/BatteryStatsServiceInjector;->updateCollectCount(I)V
...
.method private parseOPSM(Lorg/json/JSONObject;)V
    ...
    iget-object v1, p0, Lcom/android/server/OpPowerControllerService;->mOpAlarmManager:Lcom/android/server/vdb;

    invoke-virtual {v1, p1}, Lcom/android/server/vdb;->setDeepSleepWhitelist([I)V
...
.method private resolveConfigFromJSON(Lorg/json/JSONArray;)V
    ...
    :pswitch_3
    iget-object v5, p0, Lcom/android/server/OpPowerControllerService;->mIOpChargingGuarder:Lcom/android/server/gck;

    if-eqz v5, :cond_3

    iget-object v5, p0, Lcom/android/server/OpPowerControllerService;->mIOpChargingGuarder:Lcom/android/server/gck;

    invoke-interface {v5, v4}, Lcom/android/server/gck;->rtg(Lorg/json/JSONObject;)V
...
.method private updateDeepCleanWhitelist()V
    ...
    invoke-static {p0}, Lcom/android/server/wtn;->tsu(Ljava/util/List;)V
...
.method private updateOemDeviceIdleWhitelistMap()V
    ...
    invoke-static {v4, v5}, Lcom/android/server/dma$zta;->zta(Ljava/lang/String;Ljava/lang/String;)I
...
.method public addLevelSteps(IJJ)V
    ...
    invoke-static {p1, p2, p3, p4, p5}, Lcom/android/server/am/BatteryStatsServiceInjector;->addLevelSteps(IJJ)V
...
.method applyEarlyRestriction()V
    ...
    invoke-static {v1, v3}, Lcom/android/server/dma$zta;->zta(Ljava/lang/String;Ljava/lang/String;)I
    ...
    iget-object v1, p0, Lcom/android/server/OpPowerControllerService;->mOpAlarmAlignment:Lcom/android/server/ugm;

    if-eqz v1, :cond_1

    iget-object v1, p0, Lcom/android/server/OpPowerControllerService;->mOpAlarmAlignment:Lcom/android/server/ugm;

    invoke-virtual {v1, v2}, Lcom/android/server/ugm;->dma(Z)V
...
.method public bootCompleted()V
    ...
    iput-object v0, p0, Lcom/android/server/OpPowerControllerService;->mOpAlarmManager:Lcom/android/server/vdb;
    ...
    iput-object v0, p0, Lcom/android/server/OpPowerControllerService;->mOpAlarmAlignment:Lcom/android/server/ugm;
    ...
    iget-object v1, p0, Lcom/android/server/OpPowerControllerService;->mOverHeatingDiagnosis:Lcom/android/server/ire;

    invoke-virtual {v1}, Lcom/android/server/ire;->Y()V
...
.method public clearTime()V
    ...
    invoke-static {}, Lcom/android/server/am/BatteryStatsServiceInjector;->clearTime()V
...
.method dumpInternal(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    iget-object p3, p0, Lcom/android/server/OpPowerControllerService;->mOverHeatingDiagnosis:Lcom/android/server/ire;

    invoke-virtual {p3, p2}, Lcom/android/server/ire;->v(Ljava/io/PrintWriter;)V
...
.method enterOPSMIfAppropriated(Z)V
    ...
    invoke-static {v7, v8, v6}, Lcom/android/server/DeviceIdleControllerInjector;->scheduleAlarm(JZ)V
    ...
    invoke-static {v5, v9}, Lcom/android/server/dma$zta;->zta(Ljava/lang/String;Ljava/lang/String;)I
    ...
    invoke-static {v6}, Lcom/android/server/BatteryServiceInjector;->setDeepSleepMode(Z)V

    iget-object v2, p0, Lcom/android/server/OpPowerControllerService;->mOpAlarmManager:Lcom/android/server/vdb;

    invoke-virtual {v2, v6}, Lcom/android/server/vdb;->setDeepSleepMode(Z)V

    iget-object v2, p0, Lcom/android/server/OpPowerControllerService;->mOpPowerManager:Lcom/android/server/power/sis;

    invoke-virtual {v2, v6}, Lcom/android/server/power/sis;->fto(Z)Z
    ...
    invoke-static {v5, v1}, Lcom/android/server/dma$zta;->zta(Ljava/lang/String;Ljava/lang/String;)I
    ...
    :cond_11
    iput-boolean v6, p0, Lcom/android/server/OpPowerControllerService;->mOPSMActive:Z
    ...
    const-string p1, "op_sleep_mode_telephony"

    invoke-static {p0, p1, v6}, Landroid/provider/Settings$System;->putInt(Landroid/content/ContentResolver;Ljava/lang/String;I)Z

    invoke-static {v6}, Lcom/android/server/am/BatteryStatsServiceInjector;->updateDeepSleepStatus(Z)V

    invoke-static {v6}, Lcom/oneplus/android/server/power/StandbyDetectInjector;->updateDeepSleepStatus(Z)V
...
.method getSleepState(Ljava/time/LocalDateTime;)I
    ...
    invoke-static {p1, p0}, Lcom/android/server/dma$zta;->zta(Ljava/lang/String;Ljava/lang/String;)I
...
.method public init()V
    ...
    new-instance v1, Lcom/android/server/ire;

    iget-object v2, p0, Lcom/android/server/OpPowerControllerService;->mContext:Landroid/content/Context;

    invoke-direct {v1, v2}, Lcom/android/server/ire;-><init>(Landroid/content/Context;)V

    iput-object v1, p0, Lcom/android/server/OpPowerControllerService;->mOverHeatingDiagnosis:Lcom/android/server/ire;
    ...
    invoke-direct {v1, v2, v5, v6}, Lcom/android/server/bvj;-><init>(Landroid/content/Context;Landroid/hardware/SensorManager;Landroid/os/PowerManager;)V

    iput-object v1, p0, Lcom/android/server/OpPowerControllerService;->mOnePlusSensorManager:Lcom/android/server/bvj;
    ...
    invoke-static {v1}, Lcom/android/server/ywr;->y(Landroid/content/Context;)Lcom/android/server/gck;

    move-result-object v1

    iput-object v1, p0, Lcom/android/server/OpPowerControllerService;->mIOpChargingGuarder:Lcom/android/server/gck;
...
.method leaveOPSM()V
    ...
    invoke-static {v0, v3}, Lcom/android/server/dma$zta;->zta(Ljava/lang/String;Ljava/lang/String;)I
    ...
    iget-object v0, p0, Lcom/android/server/OpPowerControllerService;->mOpAlarmManager:Lcom/android/server/vdb;

    invoke-virtual {v0, v5}, Lcom/android/server/vdb;->setDeepSleepMode(Z)V
    ...
    invoke-virtual {v1, v2, v4, v0, v3}, Lnet/oneplus/odm/OpDeviceManagerInjector;->preserveOsData(Landroid/content/Context;Ljava/lang/String;Ljava/util/Map;Ljava/util/Map;)V

    :cond_6
    iget-object p0, p0, Lcom/android/server/OpPowerControllerService;->mResolver:Landroid/content/ContentResolver;

    const-string v0, "op_sleep_mode_telephony"

    invoke-static {p0, v0, v5}, Landroid/provider/Settings$System;->putInt(Landroid/content/ContentResolver;Ljava/lang/String;I)Z

    invoke-static {v5}, Lcom/android/server/am/BatteryStatsServiceInjector;->updateDeepSleepStatus(Z)V

    invoke-static {v5}, Lcom/oneplus/android/server/power/StandbyDetectInjector;->updateDeepSleepStatus(Z)V
...
.method onShellCommand(Lcom/android/server/OpPowerControllerService$gwm;Ljava/lang/String;)I
    ...
    sput-boolean v3, Lcom/android/server/dma$zta;->ssp:Z
    ...
    sput-boolean v4, Lcom/android/server/dma$zta;->ssp:Z
    ...
    iget-object p1, p0, Lcom/android/server/OpPowerControllerService;->mOverHeatingDiagnosis:Lcom/android/server/ire;

    invoke-virtual {p1, v3}, Lcom/android/server/ire;->Q(Z)V
    ...
    invoke-virtual {p1, v4}, Lcom/android/server/ire;->Q(Z)V
    ...
    iget-object p2, p0, Lcom/android/server/OpPowerControllerService;->mOverHeatingDiagnosis:Lcom/android/server/ire;

    invoke-static {p1}, Ljava/lang/Integer;->parseInt(Ljava/lang/String;)I

    move-result p1

    invoke-virtual {p2, p1}, Lcom/android/server/ire;->S(I)V
    ...
    invoke-virtual {p2, p1}, Lcom/android/server/ire;->U(I)V
    ...
    invoke-virtual {p2, v5, v6}, Lcom/android/server/ire;->T(J)V
    ...
    invoke-virtual {p1, v3}, Lcom/android/server/ire;->R(Z)V
    ...
    invoke-virtual {p1, v4}, Lcom/android/server/ire;->R(Z)V
    ...
    invoke-virtual {p1}, Lcom/android/server/ire;->Z()V
    ...
    invoke-virtual {p1}, Lcom/android/server/ire;->b0()V
    ...
    invoke-virtual {p1}, Lcom/android/server/ire;->x()V
    ...
    invoke-virtual {p1, v3}, Lcom/android/server/ire;->V(Z)V
    ...
    invoke-virtual {p1, v4}, Lcom/android/server/ire;->V(Z)V
    ...
    invoke-virtual {p1, v3}, Lcom/android/server/ire;->N(Z)V
    ...
    invoke-virtual {p1, v4}, Lcom/android/server/ire;->N(Z)V
    ...
    invoke-virtual {p1, v3}, Lcom/android/server/ire;->P(Z)V
    ...
    invoke-virtual {p1, v4}, Lcom/android/server/ire;->P(Z)V
    ...
    invoke-virtual {p2, p1}, Lcom/android/server/ire;->O(I)V
    ...
    invoke-virtual {p1, v0}, Lcom/android/server/ire;->v(Ljava/io/PrintWriter;)V
    ...
    :cond_52
    iget-object p1, p0, Lcom/android/server/OpPowerControllerService;->mOnePlusSensorManager:Lcom/android/server/bvj;

    invoke-virtual {p1, v0}, Lcom/android/server/bvj;->qbh(Ljava/io/PrintWriter;)V
    ...
    iget-object p1, p0, Lcom/android/server/OpPowerControllerService;->mIOpChargingGuarder:Lcom/android/server/gck;

    invoke-interface {p1}, Lcom/android/server/gck;->tsu()V
    ...
    invoke-interface {p1}, Lcom/android/server/gck;->kth()V
    ...
    iget-object v0, p0, Lcom/android/server/OpPowerControllerService;->mIOpChargingGuarder:Lcom/android/server/gck;

    invoke-interface {v0, p1, p2}, Lcom/android/server/gck;->cno(J)V
    ...
    invoke-interface {v0, p1, p2}, Lcom/android/server/gck;->you(J)V
    ...
    invoke-interface {p1}, Lcom/android/server/gck;->sis()V
    ...
    invoke-interface {p1, v0}, Lcom/android/server/gck;->zta(Ljava/io/PrintWriter;)V
    ...
    iget-object p2, p0, Lcom/android/server/OpPowerControllerService;->mOpAlarmManager:Lcom/android/server/vdb;

    invoke-virtual {p2, p1}, Lcom/android/server/vdb;->setDeepSleepWhitelist([I)V
    ...
    iget-object p1, p0, Lcom/android/server/OpPowerControllerService;->mOpAlarmManager:Lcom/android/server/vdb;

    new-array p2, v4, [I

    invoke-virtual {p1, p2}, Lcom/android/server/vdb;->setDeepSleepWhitelist([I)V
    ...
    check-cast p0, Lcom/android/server/ear;
    ...
    invoke-virtual {p0, v0}, Lcom/android/server/ear;->kth(Ljava/io/PrintWriter;)V
    ...
    :cond_78
    invoke-virtual {p0, v0}, Lcom/android/server/ear;->shellCommand(Ljava/io/PrintWriter;)Z
    ...
    invoke-static {p0, p1}, Lcom/android/server/am/BatteryStatsServiceInjector;->dumpDetail(Ljava/lang/String;Z)V
...
.method releaseEarlyRestriction()V
    ...
    invoke-static {v1, v2}, Lcom/android/server/dma$zta;->zta(Ljava/lang/String;Ljava/lang/String;)I
...
.method restoreNetwork()V
    ...
    invoke-static {v1, v0}, Lcom/android/server/dma$zta;->zta(Ljava/lang/String;Ljava/lang/String;)I
    ...
    invoke-static {v1, p0}, Lcom/android/server/dma$zta;->zta(Ljava/lang/String;Ljava/lang/String;)I
...
.method restrictNetwork()V
    ...
    :goto_0
    invoke-static {v3, v0}, Lcom/android/server/dma$zta;->zta(Ljava/lang/String;Ljava/lang/String;)I
    ...
    :goto_2
    invoke-static {v3, p0}, Lcom/android/server/dma$zta;->zta(Ljava/lang/String;Ljava/lang/String;)I
