...
# static fields
.field private static volatile sis:Lcom/android/server/wm/ivd; = null

.field private static final you:Ljava/lang/String; = "cpn"
...
.method public static sis()Lcom/android/server/wm/ivd;
    .locals 2

    sget-object v0, Lcom/android/server/wm/ivd;->sis:Lcom/android/server/wm/ivd;

    if-nez v0, :cond_1

    const-class v0, Lcom/android/server/wm/ivd;

    monitor-enter v0

    :try_start_0
    sget-object v1, Lcom/android/server/wm/ivd;->sis:Lcom/android/server/wm/ivd;

    if-nez v1, :cond_0

    new-instance v1, Lcom/android/server/wm/ivd;

    invoke-direct {v1}, Lcom/android/server/wm/ivd;-><init>()V

    sput-object v1, Lcom/android/server/wm/ivd;->sis:Lcom/android/server/wm/ivd;
...
.method public you(Lorg/xmlpull/v1/XmlSerializer;Lcom/oplus/zoomwindow/OplusZoomWindowRUSConfig;Ljava/lang/String;)V
    ...
    const-string v0, "support_zoom_cpn_list"
    ...
    :cond_1
    const-string v0, "unsupport_zoom_cpn_list"
    ...
    :cond_2
    const-string v0, "unreused_zoom_cpn_list"
    ...
    :cond_3
    const-string v0, "unrelaunch_zoom_cpn_list"
    ...
    :cond_4
    const-string v0, "forced_relaunch_zoom_cpn_list"
