...
.field private static gck:Lcom/android/server/am/ire; = null
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/android/server/am/ire;->ssp:Z
    ...
    sput-boolean v0, Lcom/android/server/am/ire;->cno:Z

    const/4 v0, 0x0

    sput-object v0, Lcom/android/server/am/ire;->bio:Lcom/android/server/am/ActivityManagerService;

    sput-object v0, Lcom/android/server/am/ire;->igw:Lcom/android/server/wm/ActivityTaskManagerService;

    sput-object v0, Lcom/android/server/am/ire;->wtn:Lcom/android/server/wm/ActivityTaskManagerInternal;

    sput-object v0, Lcom/android/server/am/ire;->gck:Lcom/android/server/am/ire;
    ...
    sput-boolean v0, Lcom/android/server/am/ire;->dma:Z
...
.method private constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/server/am/ire;->you:Landroid/os/Handler;

    iput-object v0, p0, Lcom/android/server/am/ire;->sis:Landroid/os/HandlerThread;
    ...
    iget-object v1, p0, Lcom/android/server/am/ire;->sis:Landroid/os/HandlerThread;
...
.method private static bvj(Ljava/util/List;Ljava/lang/String;)Z
    ...
    sget-boolean v8, Lcom/android/server/am/ire;->ssp:Z
...
.method private dma()V
    ...
    invoke-direct {p0}, Lcom/android/server/am/ire;->qbh()V

    invoke-static {}, Lcom/android/server/am/ire$zta;->cno()V

    invoke-direct {p0}, Lcom/android/server/am/ire;->wtn()V
...
.method private static gck(Lcom/android/server/am/ProcessRecord;)Z
    ...
    sget-object v0, Lcom/android/server/am/ire;->wtn:Lcom/android/server/wm/ActivityTaskManagerInternal;
...
.method public static declared-synchronized kth()Lcom/android/server/am/ire;
    .locals 2

    const-class v0, Lcom/android/server/am/ire;

    monitor-enter v0

    :try_start_0
    sget-object v1, Lcom/android/server/am/ire;->gck:Lcom/android/server/am/ire;

    if-nez v1, :cond_0

    new-instance v1, Lcom/android/server/am/ire;

    invoke-direct {v1}, Lcom/android/server/am/ire;-><init>()V

    sput-object v1, Lcom/android/server/am/ire;->gck:Lcom/android/server/am/ire;
...
.method private oif(Lorg/json/JSONArray;)V
    ...
    :cond_1
    invoke-static {v3}, Lcom/android/server/am/ire$zta;->dma(Ljava/util/List;)V
    ...
    invoke-static {v3, v2}, Lcom/android/server/am/ire;->bvj(Ljava/util/List;Ljava/lang/String;)Z
    :try_end_0
...
.method private qbh()V
    ...
    invoke-direct {p0, v1, v2}, Lcom/android/server/am/ire;->cno(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_0
...
.method static synthetic rtg()Lcom/android/server/am/ActivityManagerService;
    ...
    sget-object v0, Lcom/android/server/am/ire;->bio:Lcom/android/server/am/ActivityManagerService;
...
.method static synthetic sis()Z
    ...
    sget-boolean v0, Lcom/android/server/am/ire;->cno:Z
...
.method public static ssp(Lcom/android/server/am/ProcessRecord;)Z
    ...
    :cond_2
    invoke-static {p0}, Lcom/android/server/am/ire;->gck(Lcom/android/server/am/ProcessRecord;)Z
...
.method static synthetic tsu()Z
    ...
    sget-boolean v0, Lcom/android/server/am/ire;->dma:Z
...
.method private wtn()V
    ...
    iget-object v1, p0, Lcom/android/server/am/ire;->zta:Landroid/content/Context;

    iget-object v2, p0, Lcom/android/server/am/ire;->you:Landroid/os/Handler;

    new-instance v3, Lcom/android/server/am/ire$tsu;

    invoke-direct {v3, p0}, Lcom/android/server/am/ire$tsu;-><init>(Lcom/android/server/am/ire;)V

    const-string v4, "ProcessFreezer"

    invoke-direct {v0, v1, v2, v3, v4}, Lcom/oneplus/config/ConfigObserver;-><init>(Landroid/content/Context;Landroid/os/Handler;Lcom/oneplus/config/ConfigObserver$ConfigUpdater;Ljava/lang/String;)V

    iput-object v0, p0, Lcom/android/server/am/ire;->tsu:Lcom/oneplus/config/ConfigObserver;
...
.method static synthetic you(Lcom/android/server/am/ire;Lorg/json/JSONArray;)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/android/server/am/ire;->oif(Lorg/json/JSONArray;)V
...
.method public static ywr(Ljava/lang/String;)Ljava/util/List;
    ...
    :cond_3
    :goto_2
    sget-boolean v1, Lcom/android/server/am/ire;->ssp:Z
...
.method static synthetic zta(Lcom/android/server/am/ire;)V
    .locals 0

    invoke-direct {p0}, Lcom/android/server/am/ire;->dma()V
...
.method public bio()Landroid/os/Looper;
    ...
    iget-object p0, p0, Lcom/android/server/am/ire;->sis:Landroid/os/HandlerThread;
...
.method public igw(Landroid/content/Context;Lcom/android/server/am/ActivityManagerService;Lcom/android/server/wm/ActivityTaskManagerService;)V
    ...
    iput-object p1, p0, Lcom/android/server/am/ire;->zta:Landroid/content/Context;

    sput-object p2, Lcom/android/server/am/ire;->bio:Lcom/android/server/am/ActivityManagerService;

    sput-object p3, Lcom/android/server/am/ire;->igw:Lcom/android/server/wm/ActivityTaskManagerService;
    ...
    sput-object p1, Lcom/android/server/am/ire;->wtn:Lcom/android/server/wm/ActivityTaskManagerInternal;
    ...
    iget-object p0, p0, Lcom/android/server/am/ire;->you:Landroid/os/Handler;
