...
.field private final mInstallTask:Lcom/android/server/oif;
...
.method public constructor <init>()V
    ...
    invoke-direct {v2}, Lcom/android/server/oif;-><init>()V

    iput-object v2, p0, Lcom/android/server/OnePlusExService;->mInstallTask:Lcom/android/server/oif;
...
.method private getBuildFlag()I
    .locals 2

    :try_start_0
    invoke-direct {p0}, Lcom/android/server/OnePlusExService;->getParamService()Lcom/oneplus/os/IParamService;
    ...
    invoke-interface {p0, v0}, Lcom/oneplus/os/IParamService;->getParamIntSYNC(I)I
    ...
    const-string v1, "Exception while getting build flag value: "
...
.method private getParamService()Lcom/oneplus/os/IParamService;
    ...
    invoke-static {p0}, Lcom/oneplus/os/IParamService$Stub;->asInterface(Landroid/os/IBinder;)Lcom/oneplus/os/IParamService;
    ...
    const-string v1, "Exception while getting param service: "
...
.method private isMCLDevice(I)Z
    .locals 0
...
.method private onSystemReady()V
    ...
    sput-object v1, Lcom/android/server/OnePlusExService;->mDropbox:Landroid/os/DropBoxManager;
    ...
    iput-object v1, p0, Lcom/android/server/OnePlusExService;->mNotificationManager:Landroid/app/NotificationManager;
    ...
    iget-object v3, p0, Lcom/android/server/OnePlusExService;->mCarModeReceiver:Landroid/content/BroadcastReceiver;
    ...
    iput-object v1, p0, Lcom/android/server/OnePlusExService;->mHandlerCarMode:Landroid/os/Handler;

    invoke-direct {p0}, Lcom/android/server/OnePlusExService;->getBuildFlag()I
    ...
    invoke-direct {p0, v1}, Lcom/android/server/OnePlusExService;->isMCLDevice(I)Z
...
.method public startApkInstall(Ljava/lang/String;)V
    ...
    iget-object p0, p0, Lcom/android/server/OnePlusExService;->mInstallTask:Lcom/android/server/oif;

    invoke-virtual {p0, v0, p1}, Lcom/android/server/oif;->ywr(Landroid/content/Context;Ljava/lang/String;)V
