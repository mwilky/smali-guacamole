...
.field private static irq:Lcom/android/server/ear; = null
...
# instance fields
.field private final bio:Lcom/android/server/ear$you;
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/android/server/ear;->gwm:Z

    sget-boolean v0, Landroid/os/Build;->DEBUG_ONEPLUS:Z

    sput-boolean v0, Lcom/android/server/ear;->ugm:Z

    const-wide/16 v0, 0x0

    sput-wide v0, Lcom/android/server/ear;->oxb:J

    const/4 v0, 0x0

    sput-object v0, Lcom/android/server/ear;->cjf:Ljava/lang/String;

    sput-object v0, Lcom/android/server/ear;->ear:Ljava/lang/String;

    sput-object v0, Lcom/android/server/ear;->ire:Ljava/lang/String;

    sput-object v0, Lcom/android/server/ear;->hmo:Ljava/lang/String;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcom/android/server/ear;->igw:Landroid/util/ArrayMap;

    new-instance v0, Landroid/util/ArrayMap;

    invoke-direct {v0}, Landroid/util/ArrayMap;-><init>()V

    iput-object v0, p0, Lcom/android/server/ear;->wtn:Landroid/util/ArrayMap;

    new-instance v0, Landroid/util/SparseBooleanArray;

    invoke-direct {v0}, Landroid/util/SparseBooleanArray;-><init>()V

    iput-object v0, p0, Lcom/android/server/ear;->gck:Landroid/util/SparseBooleanArray;

    new-instance v0, Landroid/util/SparseBooleanArray;

    invoke-direct {v0}, Landroid/util/SparseBooleanArray;-><init>()V

    iput-object v0, p0, Lcom/android/server/ear;->dma:Landroid/util/SparseBooleanArray;

    const/4 v0, 0x0

    new-array v1, v0, [I

    iput-object v1, p0, Lcom/android/server/ear;->ywr:[I

    new-array v0, v0, [I

    iput-object v0, p0, Lcom/android/server/ear;->qbh:[I

    new-instance v0, Lcom/android/server/ear$zta;

    invoke-direct {v0, p0}, Lcom/android/server/ear$zta;-><init>(Lcom/android/server/ear;)V

    iput-object v0, p0, Lcom/android/server/ear;->bvj:Landroid/content/BroadcastReceiver;
    ...
    invoke-static {}, Lcom/android/server/ear;->qbh()Ljava/io/File;
    ...
    iput-object p1, p0, Lcom/android/server/ear;->oif:Landroid/util/AtomicFile;

    new-instance p1, Lcom/android/server/ear$you;
    ...
    invoke-direct {p1, p0, v0}, Lcom/android/server/ear$you;-><init>(Lcom/android/server/ear;Landroid/os/Looper;)V

    iput-object p1, p0, Lcom/android/server/ear;->bio:Lcom/android/server/ear$you;
...
.method private bio()Ljava/lang/String;
    ...
    iget-object p0, p0, Lcom/android/server/ear;->cno:Landroid/view/inputmethod/InputMethodManager;
...
.method private cno(Ljava/lang/String;)Z
    ...
    sget-object v0, Lcom/android/server/ear;->cjf:Ljava/lang/String;

    if-nez v0, :cond_0

    invoke-direct {p0}, Lcom/android/server/ear;->bio()Ljava/lang/String;
    ...
    :cond_0
    sget-object v0, Lcom/android/server/ear;->ear:Ljava/lang/String;

    if-nez v0, :cond_1

    invoke-direct {p0}, Lcom/android/server/ear;->igw()Ljava/lang/String;
    ...
    :cond_1
    sget-object v0, Lcom/android/server/ear;->ire:Ljava/lang/String;

    if-nez v0, :cond_2

    invoke-direct {p0}, Lcom/android/server/ear;->oif()Ljava/lang/String;
    ...
    :cond_2
    invoke-static {p1}, Lcom/android/server/wtn;->sis(Ljava/lang/String;)Z
    ...
    :cond_6
    sget-object v0, Lcom/android/server/ear;->hmo:Ljava/lang/String;
    ...
    :cond_7
    iget-object p0, p0, Lcom/android/server/ear;->tsu:Ljava/util/List;
...
.method private gwm()V
    ...
    iget-object v0, p0, Lcom/android/server/ear;->ssp:Landroid/appwidget/AppWidgetManager;
    ...
    iput-object v0, p0, Lcom/android/server/ear;->tsu:Ljava/util/List;
...
.method private hmo()V
    ...
    sget-wide v2, Lcom/android/server/ear;->oxb:J
    ...
    :cond_1
    sget-boolean v0, Lcom/android/server/ear;->ugm:Z
    ...
    sput-object v2, Lcom/android/server/ear;->cjf:Ljava/lang/String;
    ...
    sput-object v2, Lcom/android/server/ear;->ear:Ljava/lang/String;
    ...
    sput-object v2, Lcom/android/server/ear;->ire:Ljava/lang/String;
    ...
    :cond_5
    sput-object v1, Lcom/android/server/ear;->hmo:Ljava/lang/String;

    iget-object v1, p0, Lcom/android/server/ear;->rtg:Landroid/app/ActivityManager;
    ...
    sput-object v2, Lcom/android/server/ear;->hmo:Ljava/lang/String;
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    :cond_8
    invoke-direct {p0}, Lcom/android/server/ear;->gwm()V
...
.method private igw()Ljava/lang/String;
    ...
    iget-object p0, p0, Lcom/android/server/ear;->you:Landroid/content/pm/PackageManager;
...
.method private irq()V
    ...
    :try_start_0
    iget-object v0, p0, Lcom/android/server/ear;->igw:Landroid/util/ArrayMap;

    iget-object v1, p0, Lcom/android/server/ear;->gck:Landroid/util/SparseBooleanArray;

    const/4 v2, 0x0

    invoke-static {v2, v0, v1}, Lcom/android/server/ear;->ssp(Landroid/util/ArrayMap;Landroid/util/ArrayMap;Landroid/util/SparseBooleanArray;)[I

    move-result-object v0

    iput-object v0, p0, Lcom/android/server/ear;->ywr:[I

    iget-object v0, p0, Lcom/android/server/ear;->wtn:Landroid/util/ArrayMap;

    iget-object v1, p0, Lcom/android/server/ear;->dma:Landroid/util/SparseBooleanArray;
...
.method private les(ILjava/lang/String;I)V
    ...
    invoke-direct {p0, p2}, Lcom/android/server/ear;->vdb(Ljava/lang/String;)Z

    move-result v0

    if-eqz v0, :cond_0

    iget-object v0, p0, Lcom/android/server/ear;->sis:Landroid/app/AppOpsManager;
    ...
    :cond_0
    iget-object p0, p0, Lcom/android/server/ear;->sis:Landroid/app/AppOpsManager;
...
.method private lqr(Lorg/xmlpull/v1/XmlPullParser;)V
    ...
    iget-object v2, p0, Lcom/android/server/ear;->zta:Landroid/content/Context;
    ...
    invoke-virtual {p0, v3}, Lcom/android/server/ear;->tsu(Ljava/lang/String;)Z
    ...
    invoke-virtual {p0, v3}, Lcom/android/server/ear;->sis(Ljava/lang/String;)Z
...
.method private oif()Ljava/lang/String;
    ...
    :try_start_0
    iget-object v1, p0, Lcom/android/server/ear;->kth:Landroid/app/WallpaperManager;
    ...
    iget-object p0, p0, Lcom/android/server/ear;->kth:Landroid/app/WallpaperManager;
...
.method private rtg(Ljava/lang/String;)V
    ...
    sget-object p0, Lcom/android/server/ear;->zgw:Lcom/android/server/OpPowerControllerService;
...
.method private vju()V
    ...
    iget-object p0, p0, Lcom/android/server/ear;->zta:Landroid/content/Context;
...
.method public static wtn(Landroid/content/Context;)Lcom/android/server/ear;
    .locals 1

    sget-object v0, Lcom/android/server/ear;->irq:Lcom/android/server/ear;

    if-nez v0, :cond_0

    new-instance v0, Lcom/android/server/ear;

    invoke-direct {v0, p0}, Lcom/android/server/ear;-><init>(Landroid/content/Context;)V

    sput-object v0, Lcom/android/server/ear;->irq:Lcom/android/server/ear;

    :cond_0
    sget-object p0, Lcom/android/server/ear;->irq:Lcom/android/server/ear;

    return-object p0
.end method

.method static synthetic you(Lcom/android/server/ear;)V
    .locals 0

    invoke-direct {p0}, Lcom/android/server/ear;->irq()V
...
.method public bud(Ljava/lang/String;I)Z
    ...
    :try_start_0
    invoke-virtual {p0, p1}, Lcom/android/server/ear;->veq(Ljava/lang/String;)Z

    move-result p2

    invoke-virtual {p0, p1}, Lcom/android/server/ear;->cgv(Ljava/lang/String;)Z

    move-result v0

    or-int/2addr p2, v0

    invoke-direct {p0, p1}, Lcom/android/server/ear;->rtg(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, p1}, Lcom/android/server/ear;->sis(Ljava/lang/String;)Z
    ...
    invoke-virtual {p0, p1}, Lcom/android/server/ear;->tsu(Ljava/lang/String;)Z
    ...
    invoke-virtual {p0}, Lcom/android/server/ear;->vdw()V

    invoke-direct {p0}, Lcom/android/server/ear;->vju()V

    :cond_3
    sget-boolean p0, Lcom/android/server/ear;->ugm:Z
...
.method public bvj()Landroid/util/ArrayMap;
    ...
    iget-object p0, p0, Lcom/android/server/ear;->wtn:Landroid/util/ArrayMap;
...
.method public cjf(Ljava/lang/String;)Z
    ...
    sget-boolean v0, Lcom/android/server/ear;->gwm:Z
...
.method public dma()[I
    ...
    :try_start_0
    iget-object v0, p0, Lcom/android/server/ear;->ywr:[I
...
.method ear()V
    ...
    sget-boolean v1, Lcom/android/server/ear;->fto:Z
    ...
    :try_start_1
    iget-object v5, p0, Lcom/android/server/ear;->you:Landroid/content/pm/PackageManager;
    ...
    iget-object v6, p0, Lcom/android/server/ear;->wtn:Landroid/util/ArrayMap;
...
.method fto()V
    ...
    sget-boolean v1, Lcom/android/server/ear;->ugm:Z
    ...
    iget-object v3, p0, Lcom/android/server/ear;->oif:Landroid/util/AtomicFile;
    ...
    :cond_0
    iget-object v1, p0, Lcom/android/server/ear;->igw:Landroid/util/ArrayMap;

    invoke-virtual {v1}, Landroid/util/ArrayMap;->clear()V

    :try_start_0
    iget-object v1, p0, Lcom/android/server/ear;->oif:Landroid/util/AtomicFile;
    ...
    sput-boolean v3, Lcom/android/server/ear;->fto:Z
    :try_end_0
    ...
    invoke-direct {p0, v3}, Lcom/android/server/ear;->lqr(Lorg/xmlpull/v1/XmlPullParser;)V
    :try_end_1
...
.method public gck()[I
    ...
    :try_start_0
    iget-object v0, p0, Lcom/android/server/ear;->qbh:[I
...
.method public getForcedOptApps()Landroid/util/ArrayMap;
    ...
    iget-object p0, p0, Lcom/android/server/ear;->igw:Landroid/util/ArrayMap;
...
.method ibl()V
    ...
    invoke-virtual {p0, v1}, Lcom/android/server/ear;->qeg(Lorg/xmlpull/v1/XmlSerializer;)V
    ...
    iget-object v0, p0, Lcom/android/server/ear;->oif:Landroid/util/AtomicFile;
    ...
    iget-object p0, p0, Lcom/android/server/ear;->oif:Landroid/util/AtomicFile;
...
.method public ire()V
    ...
    :try_start_0
    iget-object v0, p0, Lcom/android/server/ear;->zta:Landroid/content/Context;
    ...
    iput-object v0, p0, Lcom/android/server/ear;->you:Landroid/content/pm/PackageManager;
    ...
    iput-object v0, p0, Lcom/android/server/ear;->sis:Landroid/app/AppOpsManager;
    ...
    iput-object v0, p0, Lcom/android/server/ear;->rtg:Landroid/app/ActivityManager;
    ...
    iput-object v0, p0, Lcom/android/server/ear;->cno:Landroid/view/inputmethod/InputMethodManager;
    ...
    iput-object v0, p0, Lcom/android/server/ear;->ssp:Landroid/appwidget/AppWidgetManager;
    ...
    iput-object v0, p0, Lcom/android/server/ear;->kth:Landroid/app/WallpaperManager;

    invoke-virtual {p0}, Lcom/android/server/ear;->fto()V

    invoke-virtual {p0}, Lcom/android/server/ear;->ear()V
    ...
    iget-object v1, p0, Lcom/android/server/ear;->zta:Landroid/content/Context;

    iget-object v2, p0, Lcom/android/server/ear;->bvj:Landroid/content/BroadcastReceiver;
    ...
    sput-object v0, Lcom/android/server/ear;->zgw:Lcom/android/server/OpPowerControllerService;

    const/4 v0, 0x1

    sput-boolean v0, Lcom/android/server/ear;->lqr:Z
...
.method public isDeepClean(Ljava/lang/String;)Z
    ...
    invoke-direct {p0}, Lcom/android/server/ear;->hmo()V

    invoke-direct {p0, p1}, Lcom/android/server/ear;->cno(Ljava/lang/String;)Z
...
.method public isInitial()Z
    ...
    sget-boolean p0, Lcom/android/server/ear;->lqr:Z
...
.method public kth(Ljava/io/PrintWriter;)V
    ...
    sget-object v1, Lcom/android/server/ear;->cjf:Ljava/lang/String;
    ...
    sget-object v1, Lcom/android/server/ear;->ear:Ljava/lang/String;
    ...
    sget-object v1, Lcom/android/server/ear;->ire:Ljava/lang/String;
    ...
    sget-object v1, Lcom/android/server/ear;->hmo:Ljava/lang/String;
    ...
    :goto_0
    iget-object v1, p0, Lcom/android/server/ear;->tsu:Ljava/util/List;
    ...
    iget-object v2, p0, Lcom/android/server/ear;->tsu:Ljava/util/List;
    ...
    :cond_0
    invoke-static {p1}, Lcom/android/server/wtn;->zta(Ljava/io/PrintWriter;)V
...
.method qeg(Lorg/xmlpull/v1/XmlSerializer;)V
    ...
    :goto_0
    iget-object v4, p0, Lcom/android/server/ear;->igw:Landroid/util/ArrayMap;
    ...
    iget-object v6, p0, Lcom/android/server/ear;->igw:Landroid/util/ArrayMap;
    ...
    :cond_0
    :goto_1
    iget-object v3, p0, Lcom/android/server/ear;->wtn:Landroid/util/ArrayMap;
    ...
    iget-object v4, p0, Lcom/android/server/ear;->wtn:Landroid/util/ArrayMap;
...
.method public setPowerSaveWhitelistAppIds([I[I)V
    ...
    sget-boolean p2, Lcom/android/server/ear;->ugm:Z
    ...
    :try_start_0
    iput-object p1, p0, Lcom/android/server/ear;->qbh:[I
...
.method public shellCommand(Ljava/io/PrintWriter;)Z
    ...
    new-instance v3, Lcom/android/server/ear$sis;

    iget-object v4, p0, Lcom/android/server/ear;->igw:Landroid/util/ArrayMap;

    invoke-direct {v3, p0, v4}, Lcom/android/server/ear$sis;-><init>(Lcom/android/server/ear;Ljava/util/Map;)V
...
.method public sis(Ljava/lang/String;)Z
    ...
    :try_start_0
    iget-object v2, p0, Lcom/android/server/ear;->you:Landroid/content/pm/PackageManager;
    ...
    invoke-direct {p0, v2}, Lcom/android/server/ear;->zgw(Landroid/content/pm/ApplicationInfo;)Z

    move-result v3

    if-nez v3, :cond_4

    invoke-direct {p0, v2}, Lcom/android/server/ear;->obl(Landroid/content/pm/ApplicationInfo;)Z
    ...
    sget-boolean v4, Lcom/android/server/ear;->ugm:Z
    ...
    invoke-direct {p0, v1, p1, v4}, Lcom/android/server/ear;->les(ILjava/lang/String;I)V
...
.method public tsu(Ljava/lang/String;)Z
    ...
    invoke-direct {p0, v1, p1, v0}, Lcom/android/server/ear;->les(ILjava/lang/String;I)V
    :try_end_2
...
.method vdw()V
    ...
    iget-object v0, p0, Lcom/android/server/ear;->bio:Lcom/android/server/ear$you;

    const/4 v1, 0x1

    invoke-virtual {v0, v1}, Landroid/os/Handler;->removeMessages(I)V

    iget-object p0, p0, Lcom/android/server/ear;->bio:Lcom/android/server/ear$you;
...
.method public veq(Ljava/lang/String;)Z
    ...
    sget-boolean v3, Lcom/android/server/ear;->ugm:Z
    ...
    invoke-direct {p0, v0, p1, v2}, Lcom/android/server/ear;->les(ILjava/lang/String;I)V
