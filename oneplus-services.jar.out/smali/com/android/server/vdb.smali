...
# static fields
.field private static final bud:I = 0x18

.field private static final cgv:Ljava/lang/String; = "ProcessManagement_IN"

.field private static cjf:Z = false

.field private static final ear:I = 0x0

.field private static final fto:I = 0x3

.field private static final gwm:Ljava/lang/String; = "OpAlarmManager"
...
.field static irq:Ljava/util/List; = null
...
.field private static final les:[Ljava/lang/String;

.field private static final lqr:I = -0x1

.field public static final obl:I = 0x8

.field private static oxb:Lcom/android/server/AlarmManagerService; = null

.field public static final ugm:I = 0x1

.field public static final vdb:I = 0x2

.field private static final veq:Ljava/lang/String; = "ProcessManagement"
...
.field bvj:Lcom/android/server/ugm;
...
.field private oif:Lcom/oneplus/config/ConfigObserver;

.field private qbh:Lcom/android/server/AlarmManagerService$AmsInner;
...
.field final ssp:Lcom/android/server/vdb$zta;
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/android/server/vdb;->ibl:Z

    const/4 v0, 0x0

    sput-boolean v0, Lcom/android/server/vdb;->cjf:Z

    sput-boolean v0, Lcom/android/server/vdb;->vju:Z
    ...
    sput-object v0, Lcom/android/server/vdb;->les:[Ljava/lang/String;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    sput-object v0, Lcom/android/server/vdb;->irq:Ljava/util/List;
...
.method public constructor <init>()V
    ...
    iput-boolean v0, p0, Lcom/android/server/vdb;->you:Z

    new-array v1, v0, [I

    iput-object v1, p0, Lcom/android/server/vdb;->sis:[I

    new-instance v1, Ljava/util/ArrayList;

    invoke-direct {v1}, Ljava/util/ArrayList;-><init>()V

    iput-object v1, p0, Lcom/android/server/vdb;->rtg:Ljava/util/List;
    ...
    invoke-direct {v1, p0, v2}, Lcom/android/server/vdb$zta;-><init>(Lcom/android/server/vdb;Landroid/os/Looper;)V

    iput-object v1, p0, Lcom/android/server/vdb;->ssp:Lcom/android/server/vdb$zta;

    new-instance v1, Ljava/util/HashMap;

    invoke-direct {v1}, Ljava/util/HashMap;-><init>()V

    iput-object v1, p0, Lcom/android/server/vdb;->kth:Ljava/util/HashMap;

    const/high16 v1, -0x80000000

    iput v1, p0, Lcom/android/server/vdb;->bio:I

    new-instance v1, Ljava/util/HashMap;

    invoke-direct {v1}, Ljava/util/HashMap;-><init>()V

    iput-object v1, p0, Lcom/android/server/vdb;->igw:Ljava/util/HashMap;

    new-instance v1, Ljava/util/ArrayList;

    invoke-direct {v1}, Ljava/util/ArrayList;-><init>()V

    iput-object v1, p0, Lcom/android/server/vdb;->wtn:Ljava/util/List;

    iput-boolean v0, p0, Lcom/android/server/vdb;->gck:Z

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lcom/android/server/vdb;->dma:Ljava/util/HashMap;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lcom/android/server/vdb;->ywr:Ljava/util/List;

    return-void
.end method

.method private bio()Lcom/oneplus/os/IParamService;
    .locals 3
...
.method private bvj(Lorg/json/JSONArray;)V
    ...
    iget-object p0, p0, Lcom/android/server/vdb;->cno:Ljava/util/List;
    ...
    iget-object v4, p0, Lcom/android/server/vdb;->cno:Ljava/util/List;
    ...
    :try_start_1
    iget-object v6, p0, Lcom/android/server/vdb;->cno:Ljava/util/List;
    ...
    iget-object v7, p0, Lcom/android/server/vdb;->cno:Ljava/util/List;
    ...
    sget-object v6, Lcom/android/server/vdb;->irq:Ljava/util/List;
    ...
    :try_start_3
    sget-object v7, Lcom/android/server/vdb;->irq:Ljava/util/List;
    ...
    sget-object v8, Lcom/android/server/vdb;->irq:Ljava/util/List;
    ...
    iget-object v6, p0, Lcom/android/server/vdb;->wtn:Ljava/util/List;
    ...
    :try_start_5
    iget-object v7, p0, Lcom/android/server/vdb;->wtn:Ljava/util/List;
    ...
    sget-boolean v8, Lcom/android/server/vdb;->ibl:Z
    ...
    :cond_5
    iget-object v8, p0, Lcom/android/server/vdb;->wtn:Ljava/util/List;
    ...
    :cond_6
    iget-object v4, p0, Lcom/android/server/vdb;->igw:Ljava/util/HashMap;

    iget-object v7, p0, Lcom/android/server/vdb;->wtn:Ljava/util/List;

    invoke-direct {p0, v4, v7, v0}, Lcom/android/server/vdb;->gck(Ljava/util/HashMap;Ljava/util/List;Z)V
    ...
    iget-object v6, p0, Lcom/android/server/vdb;->ywr:Ljava/util/List;
    ...
    :try_start_7
    iget-object v7, p0, Lcom/android/server/vdb;->ywr:Ljava/util/List;
    ...
    :cond_8
    iget-object v8, p0, Lcom/android/server/vdb;->ywr:Ljava/util/List;
    ...
    :cond_9
    iget-object v4, p0, Lcom/android/server/vdb;->dma:Ljava/util/HashMap;

    iget-object v7, p0, Lcom/android/server/vdb;->ywr:Ljava/util/List;

    invoke-direct {p0, v4, v7, v5}, Lcom/android/server/vdb;->gck(Ljava/util/HashMap;Ljava/util/List;Z)V
    ...
    iget-object v4, p0, Lcom/android/server/vdb;->rtg:Ljava/util/List;
    ...
    :try_start_9
    iget-object v5, p0, Lcom/android/server/vdb;->rtg:Ljava/util/List;
    ...
    sget-boolean v6, Lcom/android/server/vdb;->ibl:Z
    ...
    :cond_b
    iget-object v6, p0, Lcom/android/server/vdb;->rtg:Ljava/util/List;
    ...
    iget-object v1, p0, Lcom/android/server/vdb;->cno:Ljava/util/List;
    ...
    sget-object v1, Lcom/android/server/vdb;->irq:Ljava/util/List;
    ...
    iget-object v1, p0, Lcom/android/server/vdb;->rtg:Ljava/util/List;
    ...
    iget-object p1, p0, Lcom/android/server/vdb;->cno:Ljava/util/List;

    invoke-direct {p0, p1}, Lcom/android/server/vdb;->ywr(Ljava/util/List;)V
    :try_end_a
...
.method private cno(Ljava/util/HashMap;Ljava/io/PrintWriter;Z)V
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method private dma()V
    ...
    iget-object p0, p0, Lcom/android/server/vdb;->rtg:Ljava/util/List;
...
.method private gck(Ljava/util/HashMap;Ljava/util/List;Z)V
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    sget-boolean v3, Lcom/android/server/vdb;->ibl:Z
...
.method private igw(Ljava/util/HashMap;Lcom/android/server/AlarmManagerService$Alarm;ZZ)Z
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :cond_2
    sget-boolean p0, Lcom/android/server/vdb;->ibl:Z
...
.method private kth()Ljava/lang/String;
    ...
    iget p0, p0, Lcom/android/server/vdb;->bio:I

    if-ltz p0, :cond_0

    sget-object v0, Lcom/android/server/vdb;->les:[Ljava/lang/String;
...
.method private oif(Ljava/lang/String;Landroid/app/PendingIntent;I)J
    .locals 1

    if-eqz p2, :cond_2

    iget-object p0, p0, Lcom/android/server/vdb;->kth:Ljava/util/HashMap;
    ...
    check-cast p3, Lcom/android/server/vdb$you;

    if-eqz p3, :cond_1

    iget-object v0, p3, Lcom/android/server/vdb$you;->sis:Ljava/lang/String;
    ...
    :cond_0
    iget-wide p0, p3, Lcom/android/server/vdb$you;->you:J
...
.method static synthetic sis()Z
    ...
    sget-boolean v0, Lcom/android/server/vdb;->vju:Z
...
.method private wtn()V
    ...
    :try_start_0
    invoke-direct {p0}, Lcom/android/server/vdb;->bio()Lcom/oneplus/os/IParamService;
    ...
    iget v2, p0, Lcom/android/server/vdb;->bio:I
    ...
    invoke-direct {p0}, Lcom/android/server/vdb;->kth()Ljava/lang/String;
...
.method static synthetic you(Lcom/android/server/vdb;)Landroid/content/Context;
    .locals 0
...
.method private ywr(Ljava/util/List;)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object v0, p0, Lcom/android/server/vdb;->kth:Ljava/util/HashMap;
    ...
    new-instance v3, Lcom/android/server/vdb$you;

    invoke-direct {v3, v2, v1, v0}, Lcom/android/server/vdb$you;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v1, p0, Lcom/android/server/vdb;->kth:Ljava/util/HashMap;
...
.method static synthetic zta(Lcom/android/server/vdb;Lorg/json/JSONArray;)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/android/server/vdb;->bvj(Lorg/json/JSONArray;)V
...
.method public alleviateFirePendingLocked(Ljava/util/ArrayList;)Z
    ...
    iget-object v1, v0, Lcom/android/server/vdb;->qbh:Lcom/android/server/AlarmManagerService$AmsInner;
    ...
    :cond_3
    iget-object v4, v0, Lcom/android/server/vdb;->qbh:Lcom/android/server/AlarmManagerService$AmsInner;
    ...
    iget-object v4, v0, Lcom/android/server/vdb;->bvj:Lcom/android/server/ugm;
    ...
    check-cast v4, Lcom/android/server/ugm;

    iput-object v4, v0, Lcom/android/server/vdb;->bvj:Lcom/android/server/ugm;
    ...
    invoke-virtual {v4, v3}, Lcom/android/server/ugm;->rtg(Ljava/lang/String;)Z
    ...
    invoke-static {v5, v6}, Lcom/android/server/vdb;->rtg(J)J
    ...
    iget-object v5, v0, Lcom/android/server/vdb;->qbh:Lcom/android/server/AlarmManagerService$AmsInner;
    ...
    :goto_9
    sget-boolean v5, Lcom/android/server/vdb;->ibl:Z
...
.method public dumpNextWakeFromIdleInfo()V
    ...
    sget-object p0, Lcom/android/server/vdb;->oxb:Lcom/android/server/AlarmManagerService;
    ...
    sget-object v0, Lcom/android/server/vdb;->oxb:Lcom/android/server/AlarmManagerService;
    ...
    :cond_0
    sget-boolean v0, Lcom/android/server/vdb;->ibl:Z
    ...
    sget-object v5, Lcom/android/server/vdb;->oxb:Lcom/android/server/AlarmManagerService;
    ...
    sget-object v4, Lcom/android/server/vdb;->oxb:Lcom/android/server/AlarmManagerService;
    ...
    sget-object v3, Lcom/android/server/vdb;->oxb:Lcom/android/server/AlarmManagerService;
    ...
    sget-object v2, Lcom/android/server/vdb;->oxb:Lcom/android/server/AlarmManagerService;
...
.method public ifDropPkgAlarm(Lcom/android/server/AlarmManagerService$Alarm;Z)Z
    ...
    iget-object v0, p0, Lcom/android/server/vdb;->igw:Ljava/util/HashMap;

    const/4 v1, 0x0

    invoke-direct {p0, v0, p1, v1, p2}, Lcom/android/server/vdb;->igw(Ljava/util/HashMap;Lcom/android/server/AlarmManagerService$Alarm;ZZ)Z
    ...
    :cond_0
    iget-boolean v0, p0, Lcom/android/server/vdb;->gck:Z

    if-eqz v0, :cond_1

    iget-object v0, p0, Lcom/android/server/vdb;->dma:Ljava/util/HashMap;

    invoke-direct {p0, v0, p1, v2, p2}, Lcom/android/server/vdb;->igw(Ljava/util/HashMap;Lcom/android/server/AlarmManagerService$Alarm;ZZ)Z
...
.method public ifEnableLogDump()Z
    ...
    iget-boolean p0, p0, Lcom/android/server/vdb;->you:Z
...
.method public ifHandleCommand(Ljava/io/PrintWriter;[Ljava/lang/String;)Z
    ...
    sget-boolean v4, Lcom/android/server/vdb;->ibl:Z

    if-ne v4, v3, :cond_2

    iget-object p2, p0, Lcom/android/server/vdb;->igw:Ljava/util/HashMap;

    invoke-direct {p0, p2, p1, v0}, Lcom/android/server/vdb;->cno(Ljava/util/HashMap;Ljava/io/PrintWriter;Z)V

    iget-object p2, p0, Lcom/android/server/vdb;->dma:Ljava/util/HashMap;

    invoke-direct {p0, p2, p1, v3}, Lcom/android/server/vdb;->cno(Ljava/util/HashMap;Ljava/io/PrintWriter;Z)V
    ...
    invoke-virtual {p0, p1, p2, v1}, Lcom/android/server/vdb;->ssp(Ljava/io/PrintWriter;[Ljava/lang/String;I)V
...
.method public ifNeedPending(Lcom/android/server/AlarmManagerService$Alarm;)Z
    ...
    sget-boolean v0, Lcom/android/server/vdb;->cjf:Z
    ...
    iget-object v0, p0, Lcom/android/server/vdb;->bvj:Lcom/android/server/ugm;
    ...
    iput-object v0, p0, Lcom/android/server/vdb;->bvj:Lcom/android/server/ugm;
    ...
    :cond_1
    invoke-virtual {v0, p1}, Lcom/android/server/ugm;->gck(Lcom/android/server/AlarmManagerService$Alarm;)Z
    ...
    invoke-virtual {p0, p1}, Lcom/android/server/vdb;->qbh(Ljava/lang/String;)Z
...
.method public initInstance(Lcom/android/server/AlarmManagerService;Landroid/content/Context;)V
    ...
    :cond_0
    sput-object p1, Lcom/android/server/vdb;->oxb:Lcom/android/server/AlarmManagerService;

    iput-object p2, p0, Lcom/android/server/vdb;->zta:Landroid/content/Context;
...
.method public modifyMinTrigger(JJJILandroid/app/PendingIntent;ILjava/lang/String;J)[J
    ...
    invoke-direct {p0, v0, p8, p7}, Lcom/android/server/vdb;->oif(Ljava/lang/String;Landroid/app/PendingIntent;I)J
...
.method public onStart(Lcom/android/server/AlarmManagerService$AmsInner;)V
    ...
    :cond_0
    iput-object p1, p0, Lcom/android/server/vdb;->qbh:Lcom/android/server/AlarmManagerService$AmsInner;
    ...
    :cond_1
    iput-boolean p1, p0, Lcom/android/server/vdb;->gck:Z
    ...
    iget-object v2, p0, Lcom/android/server/vdb;->dma:Ljava/util/HashMap;

    invoke-direct {p0, v2, v0, p1}, Lcom/android/server/vdb;->gck(Ljava/util/HashMap;Ljava/util/List;Z)V
    ...
    iput-object p1, p0, Lcom/android/server/vdb;->cno:Ljava/util/List;
    ...
    iget-object v0, p0, Lcom/android/server/vdb;->cno:Ljava/util/List;
    ...
    invoke-direct {p0}, Lcom/android/server/vdb;->wtn()V

    invoke-virtual {p0}, Lcom/android/server/vdb;->tsu()V

    new-instance p1, Lcom/oneplus/config/ConfigObserver;

    iget-object v0, p0, Lcom/android/server/vdb;->zta:Landroid/content/Context;

    iget-object v1, p0, Lcom/android/server/vdb;->ssp:Lcom/android/server/vdb$zta;

    new-instance v2, Lcom/android/server/vdb$sis;

    invoke-direct {v2, p0}, Lcom/android/server/vdb$sis;-><init>(Lcom/android/server/vdb;)V

    sget-boolean v4, Lcom/android/server/vdb;->vju:Z

    if-eqz v4, :cond_4

    const-string v4, "ProcessManagement_IN"
    ...
    iput-object p1, p0, Lcom/android/server/vdb;->oif:Lcom/oneplus/config/ConfigObserver;
    ...
    iput-object p1, p0, Lcom/android/server/vdb;->tsu:Ljava/util/List;

    invoke-direct {p0}, Lcom/android/server/vdb;->dma()V

    sget-object p1, Lcom/android/server/vdb;->irq:Ljava/util/List;
    ...
    iget-object p0, p0, Lcom/android/server/vdb;->ssp:Lcom/android/server/vdb$zta;
...
.method public qbh(Ljava/lang/String;)Z
    .locals 3

    sget-object p0, Lcom/android/server/vdb;->irq:Ljava/util/List;
    ...
    :goto_0
    :try_start_0
    sget-object v2, Lcom/android/server/vdb;->irq:Ljava/util/List;
...
.method public setDeepSleepMode(Z)V
    ...
    :cond_0
    sput-boolean p1, Lcom/android/server/vdb;->cjf:Z
...
.method public setDeepSleepWhitelist([I)V
    ...
    iput-object p1, p0, Lcom/android/server/vdb;->sis:[I
...
.method public setPkgNetworkAlarmRestriction(Z)V
    ...
    :cond_0
    iput-boolean v3, p0, Lcom/android/server/vdb;->gck:Z
...
.method protected ssp(Ljava/io/PrintWriter;[Ljava/lang/String;I)V
    .locals 4
    ...
    iput-boolean p1, p0, Lcom/android/server/vdb;->you:Z

    if-eqz v0, :cond_3

    :goto_0
    invoke-virtual {v0, p1}, Lcom/android/server/ugm;->bio(Z)Z
...
.method public tsu()V
    ...
    sput-boolean p0, Lcom/android/server/vdb;->vju:Z
...
.method public updateFlag(Ljava/lang/String;ILandroid/app/AlarmManager$AlarmClockInfo;Ljava/lang/String;)I
    ...
    iget-object p3, p0, Lcom/android/server/vdb;->tsu:Ljava/util/List;
