...
.method public zta(Ljava/lang/String;Ljava/lang/String;II)V
    ...
    invoke-static {p3, p4}, Lcom/android/server/am/AppRecordManager;->zta(II)Lcom/android/server/am/gck;

    move-result-object p1

    if-eqz p1, :cond_7

    invoke-virtual {p1, p4}, Lcom/android/server/am/gck;->ssp(I)Lcom/android/server/am/j;

    move-result-object p1

    if-eqz p1, :cond_7

    iget-object v2, p1, Lcom/android/server/am/j;->sis:Ljava/lang/String;
    ...
    invoke-virtual {p1, v1}, Lcom/android/server/am/j;->zta(I)V

    invoke-virtual {p1, v0}, Lcom/android/server/am/j;->zta(I)V

    invoke-virtual {p1}, Lcom/android/server/am/j;->tsu()I
    ...
    invoke-static {p1, v2}, Lcom/android/server/am/AppRecordManager;->zta(II)Lcom/android/server/am/gck;
    ...
    invoke-virtual {p1, v2}, Lcom/android/server/am/gck;->ssp(I)Lcom/android/server/am/j;
    ...
    invoke-virtual {p1, v1}, Lcom/android/server/am/j;->qbh(I)V

    invoke-virtual {p1, v0}, Lcom/android/server/am/j;->qbh(I)V
    ...
    invoke-static {p1, p4}, Lcom/android/server/am/AppRecordManager;->zta(II)Lcom/android/server/am/gck;
