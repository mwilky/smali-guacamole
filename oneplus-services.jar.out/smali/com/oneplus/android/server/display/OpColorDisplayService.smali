...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/oneplus/android/server/display/OpColorDisplayService$sis;
    }
.end annotation
...
.field private static final OP_DISABLE_SENSOR:I = 0x30
...
.field private final mCDHHandler:Lcom/oneplus/android/server/display/OpColorDisplayService$sis;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcom/oneplus/android/server/display/OpColorDisplayService;->mDaemon:Lvendor/oneplus/hardware/display/V1_0/IOneplusDisplay;
    ...
    invoke-direct {v0, p0, v1}, Lcom/oneplus/android/server/display/OpColorDisplayService$sis;-><init>(Lcom/oneplus/android/server/display/OpColorDisplayService;Landroid/os/Looper;)V

    iput-object v0, p0, Lcom/oneplus/android/server/display/OpColorDisplayService;->mCDHHandler:Lcom/oneplus/android/server/display/OpColorDisplayService$sis;
...
.method static synthetic access$1100(Lcom/oneplus/android/server/display/OpColorDisplayService;)V
    .locals 0
...
.method static synthetic access$1400(Lcom/oneplus/android/server/display/OpColorDisplayService;)Lcom/oneplus/android/server/display/OpColorModeManager;
    .locals 0
...
.method static synthetic access$1500(Lcom/oneplus/android/server/display/OpColorDisplayService;Z)V
    .locals 0
...
.method static synthetic access$400(Lcom/oneplus/android/server/display/OpColorDisplayService;)Z
    .locals 0
...
.method static synthetic access$500(Lcom/oneplus/android/server/display/OpColorDisplayService;)I
    .locals 0
...
.method static synthetic access$600(Lcom/oneplus/android/server/display/OpColorDisplayService;Z)V
    .locals 0
...
.method static synthetic access$700(Lcom/oneplus/android/server/display/OpColorDisplayService;)V
    .locals 0
...
.method static synthetic access$900(Lcom/oneplus/android/server/display/OpColorDisplayService;)V
    .locals 0
...
.method private processScreenOn(Z)V
    ...
    iget-object v0, p0, Lcom/oneplus/android/server/display/OpColorDisplayService;->mDaemon:Lvendor/oneplus/hardware/display/V1_0/IOneplusDisplay;
    ...
    :try_start_0
    invoke-interface {v0, v3, v2}, Lvendor/oneplus/hardware/display/V1_0/IOneplusDisplay;->setMode(II)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    :cond_0
    const-string v0, "can get IOneplusService"
    ...
    invoke-virtual {v0, v3}, Lcom/oneplus/android/server/display/tsu;->fto(Z)V

    const-wide/16 v3, 0xfa

    :try_start_1
    invoke-static {v3, v4}, Landroid/os/HandlerThread;->sleep(J)V
    :try_end_1
    ...
    :goto_2
    iget-object v4, p0, Lcom/oneplus/android/server/display/OpColorDisplayService;->mFpm:Landroid/hardware/fingerprint/FingerprintManager;
    ...
    iput-object v4, p0, Lcom/oneplus/android/server/display/OpColorDisplayService;->mFpm:Landroid/hardware/fingerprint/FingerprintManager;
    ...
    const-string v4, "mHasFingerprint = "

    invoke-virtual {v0, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-boolean v4, p0, Lcom/oneplus/android/server/display/OpColorDisplayService;->mHasFingerprint:Z
    ...
    invoke-static {v1, v0, v2}, Lcom/oneplus/server/you;->rtg(Ljava/lang/String;II)V
...
.method private setUp()V
    ...
    new-instance v1, Lcom/oneplus/android/server/display/tsu;

    iget-object v2, p0, Lcom/oneplus/android/server/display/OpColorDisplayService;->mContext:Landroid/content/Context;

    iget v3, p0, Lcom/oneplus/android/server/display/OpColorDisplayService;->mCurrentUser:I

    invoke-direct {v1, v2, v3}, Lcom/oneplus/android/server/display/tsu;-><init>(Landroid/content/Context;I)V

    iput-object v1, p0, Lcom/oneplus/android/server/display/OpColorDisplayService;->mColorTintManager:Lcom/oneplus/android/server/display/tsu;
    ...
    iput-object v1, p0, Lcom/oneplus/android/server/display/OpColorDisplayService;->mDaemon:Lvendor/oneplus/hardware/display/V1_0/IOneplusDisplay;
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-virtual {v0, v1}, Lcom/oneplus/android/server/display/OpColorModeManager;->ssp(I)Z
...
.method public resetStatus(I)V
    ...
    :goto_2
    invoke-virtual {p1, v2, v1}, Lcom/oneplus/android/server/display/OpColorModeManager;->wtn(IZ)V
    ...
    invoke-virtual {p1, v2, v0}, Lcom/oneplus/android/server/display/OpColorModeManager;->wtn(IZ)V
...
.method public sendMsg(I)V
    ...
    iget-object v1, p0, Lcom/oneplus/android/server/display/OpColorDisplayService;->mCDHHandler:Lcom/oneplus/android/server/display/OpColorDisplayService$sis;

    if-eqz v1, :cond_0

    invoke-virtual {v1, p1}, Landroid/os/Handler;->removeMessages(I)V

    iget-object p0, p0, Lcom/oneplus/android/server/display/OpColorDisplayService;->mCDHHandler:Lcom/oneplus/android/server/display/OpColorDisplayService$sis;
...
.method public systemReady()V
    ...
    const-string v2, "oem_screen_saturation_value"
