...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/server/pm/rtg$zta;
    }
.end annotation
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/android/server/pm/rtg;->gck:Z

    new-instance v0, Ljava/lang/Object;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lcom/android/server/pm/rtg;->d:Ljava/lang/Object;

    sput v1, Lcom/android/server/pm/rtg;->f:I

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    sput-object v0, Lcom/android/server/pm/rtg;->g:Ljava/util/Map;
    ...
    sget-object v0, Lcom/android/server/pm/rtg;->g:Ljava/util/Map;
    ...
    sput-object v0, Lcom/android/server/pm/rtg;->h:Ljava/util/Map;

    invoke-interface {v0, v1, v3}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    sget-object v0, Lcom/android/server/pm/rtg;->h:Ljava/util/Map;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/server/pm/rtg;->zta:Landroid/util/SparseArray;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lcom/android/server/pm/rtg;->you:Ljava/util/Map;
...
.method private bio(Ljava/lang/String;)Z
    ...
    iget-object p1, p0, Lcom/android/server/pm/rtg;->you:Ljava/util/Map;
    ...
    iget-object p0, p0, Lcom/android/server/pm/rtg;->you:Ljava/util/Map;
    ...
    :cond_3
    iget-object v3, p0, Lcom/android/server/pm/rtg;->you:Ljava/util/Map;
    ...
    iget-object v4, p0, Lcom/android/server/pm/rtg;->you:Ljava/util/Map;
...
.method private dma(Ljava/lang/String;)V
    ...
    iget-object v6, p0, Lcom/android/server/pm/rtg;->you:Ljava/util/Map;
...
.method private igw()V
    ...
    :goto_0
    invoke-direct {p0, v0}, Lcom/android/server/pm/rtg;->gck(Ljava/io/File;)Ljava/lang/String;
    ...
    :cond_2
    sget-object v3, Lcom/android/server/pm/rtg;->d:Ljava/lang/Object;
    ...
    :try_start_0
    iget-object v5, p0, Lcom/android/server/pm/rtg;->zta:Landroid/util/SparseArray;
    ...
    :cond_4
    invoke-direct {p0, v0}, Lcom/android/server/pm/rtg;->tsu([C)I
    ...
    :cond_5
    iget-object v4, p0, Lcom/android/server/pm/rtg;->zta:Landroid/util/SparseArray;
    ...
    iget-object v7, p0, Lcom/android/server/pm/rtg;->zta:Landroid/util/SparseArray;
    ...
    :goto_2
    sget v0, Lcom/android/server/pm/rtg;->f:I

    add-int/2addr v0, v2

    sput v0, Lcom/android/server/pm/rtg;->f:I
    ...
    sget-object v0, Lcom/android/server/pm/rtg;->d:Ljava/lang/Object;
    ...
    iget-object v2, p0, Lcom/android/server/pm/rtg;->zta:Landroid/util/SparseArray;

    invoke-direct {p0, v1, v2}, Lcom/android/server/pm/rtg;->oif(Ljava/lang/String;Landroid/util/SparseArray;)V
...
.method private oif(Ljava/lang/String;Landroid/util/SparseArray;)V
    ...
    invoke-direct {p0, v9}, Lcom/android/server/pm/rtg;->kth(I)Ljava/lang/String;
...
.method private sis(Ljava/util/List;Ljava/lang/String;Z)V
    ...
    :goto_1
    invoke-virtual {p0, v2, v1}, Lcom/android/server/pm/rtg;->isInConfigList(ILjava/lang/String;)Z
...
.method private wtn()V
    ...
    iget-object v0, p0, Lcom/android/server/pm/rtg;->you:Ljava/util/Map;
    ...
    invoke-direct {p0, v0}, Lcom/android/server/pm/rtg;->dma(Ljava/lang/String;)V
    ...
    invoke-direct {p0}, Lcom/android/server/pm/rtg;->ibl()V
...
.method private ywr(Lorg/json/JSONArray;)V
    ...
    invoke-direct {p0, v10}, Lcom/android/server/pm/rtg;->tsu([C)I
    ...
    invoke-direct {p0, v9}, Lcom/android/server/pm/rtg;->qbh(Ljava/lang/String;)Z

    move-result v10

    if-eqz v10, :cond_5

    invoke-direct {p0, v9}, Lcom/android/server/pm/rtg;->bvj(Ljava/lang/String;)Z
    ...
    invoke-virtual {p0, v10, v9}, Lcom/android/server/pm/rtg;->isInConfigList(ILjava/lang/String;)Z
    ...
    :cond_7
    sget p1, Lcom/android/server/pm/rtg;->f:I
    ...
    sget-boolean v1, Lcom/android/server/pm/rtg;->gck:Z
    ...
    invoke-direct {p0, p1, v0}, Lcom/android/server/pm/rtg;->oif(Ljava/lang/String;Landroid/util/SparseArray;)V

    sget-object p1, Lcom/android/server/pm/rtg;->d:Ljava/lang/Object;
    ...
    sput v4, Lcom/android/server/pm/rtg;->f:I
...
.method static synthetic zta(Lcom/android/server/pm/rtg;Lorg/json/JSONArray;)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/android/server/pm/rtg;->ywr(Lorg/json/JSONArray;)V
...
.method public abiOverride(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p0, v0, p2}, Lcom/android/server/pm/rtg;->isInConfigList(ILjava/lang/String;)Z
...
.method public cno(Lcom/android/server/pm/parsing/pkg/ParsedPackage;)V
    ...
    invoke-virtual {p0, v1, v0}, Lcom/android/server/pm/rtg;->isInConfigList(ILjava/lang/String;)Z
    ...
    :goto_0
    invoke-direct {p0, v0, p1, v1}, Lcom/android/server/pm/rtg;->sis(Ljava/util/List;Ljava/lang/String;Z)V
    ...
    invoke-virtual {p0, v0, v1}, Lcom/android/server/pm/rtg;->isInConfigList(ILjava/lang/String;)Z
...
.method public customizeHardwareAccelerateIfNeeded(Landroid/content/pm/parsing/ParsingPackage;)V
    ...
    invoke-static {p0, p1}, Lcom/android/server/pm/rtg;->you(Ljava/util/List;Z)V
...
.method public customizePackageIfNeeded(Lcom/android/server/pm/parsing/pkg/ParsedPackage;)V
    ...
    invoke-virtual {p0, v0, v1}, Lcom/android/server/pm/rtg;->abiOverride(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p0, p1}, Lcom/android/server/pm/rtg;->cno(Lcom/android/server/pm/parsing/pkg/ParsedPackage;)V
    :try_end_0
...
.method public dumpToString()Ljava/lang/String;
    ...
    sget-object v1, Lcom/android/server/pm/rtg;->d:Ljava/lang/Object;
    ...
    :try_start_1
    iget-object v1, p0, Lcom/android/server/pm/rtg;->you:Ljava/util/Map;
...
.method public getCompatConfigString(ILjava/lang/String;)Ljava/lang/String;
    ...
    iget-object p0, p0, Lcom/android/server/pm/rtg;->zta:Landroid/util/SparseArray;
...
.method public initCompatOnlineConfig()V
    ...
    sget-object v1, Lcom/android/server/pm/rtg;->tsu:Landroid/content/Context;

    new-instance v2, Lcom/android/server/pm/rtg$zta;

    invoke-direct {v2, p0}, Lcom/android/server/pm/rtg$zta;-><init>(Lcom/android/server/pm/rtg;)V
    ...
    iput-object v0, p0, Lcom/android/server/pm/rtg;->sis:Lcom/oneplus/config/ConfigObserver;
...
.method public initInstance(Landroid/content/Context;)V
    ...
    sput-object p1, Lcom/android/server/pm/rtg;->tsu:Landroid/content/Context;

    invoke-direct {p0}, Lcom/android/server/pm/rtg;->igw()V
    ...
    invoke-direct {p0}, Lcom/android/server/pm/rtg;->wtn()V

    :cond_0
    sget-boolean p1, Lcom/android/server/pm/rtg;->gck:Z

    if-eqz p1, :cond_1

    invoke-virtual {p0}, Lcom/android/server/pm/rtg;->dumpToString()Ljava/lang/String;
...
.method public isInConfigList(ILjava/lang/String;)Z
    ...
    invoke-direct {p0, p2}, Lcom/android/server/pm/rtg;->bio(Ljava/lang/String;)Z
    ...
    :try_start_0
    iget-object v1, p0, Lcom/android/server/pm/rtg;->zta:Landroid/util/SparseArray;
...
.method public rtg(Ljava/lang/String;)I
    ...
    sget-object p0, Lcom/android/server/pm/rtg;->g:Ljava/util/Map;
...
.method public ssp(I)Ljava/lang/String;
    ...
    sget-object p0, Lcom/android/server/pm/rtg;->h:Ljava/util/Map;
