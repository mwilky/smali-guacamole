...
.method public static sis()Lcom/android/server/am/a;
    .locals 1

    invoke-static {}, Lcom/android/server/am/a$you;->zta()Lcom/android/server/am/a;
...
.method public rtg(Lcom/android/server/am/ActivityManagerService;Lcom/android/server/am/BroadcastRecord;I)V
    ...
    invoke-virtual {v8, v9}, Lcom/android/server/am/oxb;->dma(Landroid/content/pm/ApplicationInfo;)Z
    ...
    invoke-virtual {v9, v8, v10}, Lcom/android/server/am/oxb;->cjf(ZLandroid/content/pm/ApplicationInfo;)V
    ...
    invoke-virtual {v8, v9}, Lcom/android/server/am/oxb;->ywr(Ljava/lang/String;)Z
    ...
    invoke-virtual {v8, v9}, Lcom/android/server/am/oxb;->gck(Ljava/lang/String;)Z
    ...
    invoke-virtual {v8, v7}, Lcom/android/server/am/oxb;->dma(Landroid/content/pm/ApplicationInfo;)Z
    ...
    invoke-direct {p0, p1, v1}, Lcom/android/server/am/a;->tsu(Ljava/lang/String;Ljava/util/List;)V

    const-string p1, "highUsedList"

    invoke-direct {p0, p1, v2}, Lcom/android/server/am/a;->tsu(Ljava/lang/String;Ljava/util/List;)V

    const-string p1, "systemList"

    invoke-direct {p0, p1, v3}, Lcom/android/server/am/a;->tsu(Ljava/lang/String;Ljava/util/List;)V

    const-string p1, "otherList"

    invoke-direct {p0, p1, v4}, Lcom/android/server/am/a;->tsu(Ljava/lang/String;Ljava/util/List;)V
...
.method protected you(Ljava/util/List;Landroid/content/Intent;)Ljava/util/List;
    ...
    invoke-virtual {v5, v9}, Lcom/android/server/am/oxb;->dma(Landroid/content/pm/ApplicationInfo;)Z

    move-result v5

    if-nez v5, :cond_2

    sget-boolean v5, Lcom/android/server/am/cjf;->ear:Z
...
.method public zta(Ljava/util/List;Landroid/content/Intent;)Ljava/util/List;
    ...
    invoke-virtual {p0, p1, p2}, Lcom/android/server/am/a;->you(Ljava/util/List;Landroid/content/Intent;)Ljava/util/List;
