...
.method private constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/server/am/oxb;->igw:Ljava/lang/String;

    new-instance v0, Ljava/util/HashSet;

    invoke-direct {v0}, Ljava/util/HashSet;-><init>()V

    iput-object v0, p0, Lcom/android/server/am/oxb;->wtn:Ljava/util/HashSet;
    ...
    iput-object v0, p0, Lcom/android/server/am/oxb;->gck:Lcom/android/server/am/OPSystemCpuLoadMonitor$SystemLoadType;
    ...
    iput-object v0, p0, Lcom/android/server/am/oxb;->dma:Lcom/android/server/am/OPBRPorcessSpeedMonitor$ProcessBRSpeedType;

    return-void
.end method

.method synthetic constructor <init>(Lcom/android/server/am/oxb$zta;)V
    .locals 0

    invoke-direct {p0}, Lcom/android/server/am/oxb;-><init>()V

    return-void
.end method

.method public static cno()Lcom/android/server/am/oxb;
    .locals 1

    invoke-static {}, Lcom/android/server/am/oxb$you;->zta()Lcom/android/server/am/oxb;
...
.method private igw(Lcom/android/server/am/ActivityManagerService;Landroid/os/Handler;)V
    ...
    iput-object v8, p0, Lcom/android/server/am/oxb;->tsu:Lcom/android/server/am/BroadcastQueue;
    ...
    iput-object v2, p0, Lcom/android/server/am/oxb;->rtg:Lcom/android/server/am/BroadcastQueue;
    ...
    iput-object v8, p0, Lcom/android/server/am/oxb;->ssp:Lcom/android/server/am/BroadcastQueue;
    ...
    iput-object v2, p0, Lcom/android/server/am/oxb;->cno:Lcom/android/server/am/BroadcastQueue;
    ...
    iput-object v8, p0, Lcom/android/server/am/oxb;->kth:Lcom/android/server/am/BroadcastQueue;
    ...
    iput-object v0, p0, Lcom/android/server/am/oxb;->bio:Lcom/android/server/am/BroadcastQueue;

    iget-object v0, p0, Lcom/android/server/am/oxb;->zta:Lcom/android/server/am/ActivityManagerService;
    ...
    iget-object v3, p0, Lcom/android/server/am/oxb;->tsu:Lcom/android/server/am/BroadcastQueue;
    ...
    iget-object v3, p0, Lcom/android/server/am/oxb;->rtg:Lcom/android/server/am/BroadcastQueue;
    ...
    iget-object v3, p0, Lcom/android/server/am/oxb;->ssp:Lcom/android/server/am/BroadcastQueue;
    ...
    iget-object v3, p0, Lcom/android/server/am/oxb;->cno:Lcom/android/server/am/BroadcastQueue;
    ...
    iget-object v3, p0, Lcom/android/server/am/oxb;->kth:Lcom/android/server/am/BroadcastQueue;
    ...
    iget-object p0, p0, Lcom/android/server/am/oxb;->bio:Lcom/android/server/am/BroadcastQueue;

    aput-object p0, v1, v2

    sget-boolean p0, Lcom/android/server/am/cjf;->gck:Z
    ...
    invoke-virtual {p0, p2, p1}, Lcom/android/server/am/ivd;->cno(Landroid/os/Handler;Lcom/android/server/am/ActivityManagerService;)V
...
.method public static obl(Lcom/android/server/am/BroadcastQueue;Lcom/android/server/am/ProcessRecord;Lcom/android/server/am/BroadcastRecord;)Z
    ...
    invoke-static {}, Lcom/android/server/am/cjf;->cjf()Z

    move-result v1

    if-eqz v1, :cond_0

    invoke-static {p0, p1, p2}, Lcom/android/server/am/b$you;->bio(Lcom/android/server/am/BroadcastQueue;Lcom/android/server/am/ProcessRecord;Lcom/android/server/am/BroadcastRecord;)Z
...
.method private tsu(Ljava/io/PrintWriter;)V
    ...
    :goto_0
    iget-object v3, p0, Lcom/android/server/am/oxb;->zta:Lcom/android/server/am/ActivityManagerService;
    ...
    iget-object v4, p0, Lcom/android/server/am/oxb;->zta:Lcom/android/server/am/ActivityManagerService;
    ...
    iget-object v6, p0, Lcom/android/server/am/oxb;->zta:Lcom/android/server/am/ActivityManagerService;
    ...
    invoke-static {}, Lcom/android/server/am/cjf;->ugm()Z
    ...
    invoke-static {}, Lcom/android/server/am/cjf;->oxb()Z
...
.method public static vdb()V
    ...
    invoke-virtual {v0}, Lcom/android/server/am/vdw;->tsu()V
...
.method public static zgw(Lcom/android/server/am/BroadcastFilter;Lcom/android/server/am/BroadcastRecord;Z)Z
    ...
    sget-boolean v1, Lcom/android/server/am/cjf;->wtn:Z

    if-eqz v1, :cond_0

    invoke-static {p0, p1, p2}, Lcom/android/server/am/b$you;->kth(Lcom/android/server/am/BroadcastFilter;Lcom/android/server/am/BroadcastRecord;Z)Z
...
.method public bio(Lcom/android/server/am/ActivityManagerService;)V
    ...
    sget-object v1, Lcom/android/server/am/zgw;->you:Lcom/android/server/ServiceThread;
    ...
    iput-object p1, p0, Lcom/android/server/am/oxb;->zta:Lcom/android/server/am/ActivityManagerService;

    invoke-direct {p0, p1, v0}, Lcom/android/server/am/oxb;->igw(Lcom/android/server/am/ActivityManagerService;Landroid/os/Handler;)V

    sget-boolean p0, Lcom/android/server/am/cjf;->wtn:Z

    if-eqz p0, :cond_0

    invoke-static {}, Lcom/android/server/am/b;->tsu()Lcom/android/server/am/b;

    move-result-object p0

    invoke-virtual {p0, p1}, Lcom/android/server/am/b;->rtg(Lcom/android/server/am/ActivityManagerService;)V

    :cond_0
    invoke-static {}, Lcom/android/server/am/h;->zta()Lcom/android/server/am/h;

    move-result-object p0

    invoke-virtual {p0}, Lcom/android/server/am/h;->you()V
...
.method public bvj(Lcom/android/server/am/OPBRPorcessSpeedMonitor$ProcessBRSpeedType;)V
    ...
    iget-object v1, p0, Lcom/android/server/am/oxb;->dma:Lcom/android/server/am/OPBRPorcessSpeedMonitor$ProcessBRSpeedType;
    ...
    iput-object p1, p0, Lcom/android/server/am/oxb;->dma:Lcom/android/server/am/OPBRPorcessSpeedMonitor$ProcessBRSpeedType;
    ...
    iget-object v1, p0, Lcom/android/server/am/oxb;->gck:Lcom/android/server/am/OPSystemCpuLoadMonitor$SystemLoadType;

    iget-object p0, p0, Lcom/android/server/am/oxb;->dma:Lcom/android/server/am/OPBRPorcessSpeedMonitor$ProcessBRSpeedType;

    const/4 v2, 0x0

    invoke-virtual {p1, v0, v1, p0, v2}, Lcom/android/server/am/ivd;->wtn(Lcom/android/server/am/ActivityManagerService;Lcom/android/server/am/OPSystemCpuLoadMonitor$SystemLoadType;Lcom/android/server/am/OPBRPorcessSpeedMonitor$ProcessBRSpeedType;Z)V
...
.method cjf(ZLandroid/content/pm/ApplicationInfo;)V
    ...
    invoke-virtual {p0, v0}, Lcom/android/server/am/oxb;->gck(Ljava/lang/String;)Z
    ...
    invoke-virtual {p0, p1}, Lcom/android/server/am/oxb;->ywr(Ljava/lang/String;)Z
...
.method public gck(Ljava/lang/String;)Z
    ...
    iget-object v0, p0, Lcom/android/server/am/oxb;->wtn:Ljava/util/HashSet;

    monitor-enter v0

    :try_start_0
    iget-object p0, p0, Lcom/android/server/am/oxb;->wtn:Ljava/util/HashSet;
...
.method public gwm(Lcom/android/server/am/BroadcastRecord;I)V
    ...
    invoke-static {}, Lcom/android/server/am/a;->sis()Lcom/android/server/am/a;

    move-result-object v0

    iget-object p0, p0, Lcom/android/server/am/oxb;->zta:Lcom/android/server/am/ActivityManagerService;

    invoke-virtual {v0, p0, p1, p2}, Lcom/android/server/am/a;->rtg(Lcom/android/server/am/ActivityManagerService;Lcom/android/server/am/BroadcastRecord;I)V
...
.method public ibl(Lcom/android/server/am/OPSystemCpuLoadMonitor$SystemLoadType;)V
    ...
    iput-object p1, p0, Lcom/android/server/am/oxb;->gck:Lcom/android/server/am/OPSystemCpuLoadMonitor$SystemLoadType;
...
.method public oif(Ljava/lang/String;Z)V
    ...
    :cond_0
    iget-object p2, p0, Lcom/android/server/am/oxb;->wtn:Ljava/util/HashSet;
...
.method public oxb(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lcom/android/server/am/oxb;->sis:Landroid/content/Context;

    invoke-static {}, Lcom/android/server/am/cjf;->ear()Z
    ...
    iget-object p0, p0, Lcom/android/server/am/oxb;->sis:Landroid/content/Context;

    invoke-virtual {v0, p0}, Lcom/android/server/am/obl;->ywr(Landroid/content/Context;)V

    :cond_0
    invoke-static {}, Lcom/android/server/am/cjf;->igw()Lcom/android/server/am/cjf;

    move-result-object p0

    invoke-virtual {p0, p1}, Lcom/android/server/am/cjf;->bvj(Landroid/content/Context;)V
...
.method public qbh(Ljava/lang/String;IILjava/lang/String;II)V
    ...
    iget-object v0, p0, Lcom/android/server/am/oxb;->igw:Ljava/lang/String;
    ...
    :cond_0
    iget-object p2, p0, Lcom/android/server/am/oxb;->igw:Ljava/lang/String;

    if-eq p2, p1, :cond_1

    iput-object p1, p0, Lcom/android/server/am/oxb;->igw:Ljava/lang/String;
    ...
    iget-object p1, p0, Lcom/android/server/am/oxb;->zta:Lcom/android/server/am/ActivityManagerService;
    ...
    invoke-virtual {p2, p0}, Lcom/android/server/am/ivd;->dma(Lcom/android/server/am/ActivityManagerService;)V
...
.method public rtg(Ljava/lang/String;Ljava/io/PrintWriter;)V
    ...
    sget-boolean v1, Lcom/android/server/am/cjf;->kth:Z
    ...
    :pswitch_0
    invoke-direct {p0, p2}, Lcom/android/server/am/oxb;->tsu(Ljava/io/PrintWriter;)V

    goto/16 :goto_6

    :pswitch_1
    sput-boolean v5, Lcom/android/server/am/cjf;->ear:Z
    ...
    :pswitch_2
    sput-boolean v6, Lcom/android/server/am/cjf;->ear:Z
    ...
    :pswitch_3
    sput-boolean v5, Lcom/android/server/am/cjf;->dma:Z
    ...
    :pswitch_4
    sput-boolean v6, Lcom/android/server/am/cjf;->dma:Z
    ...
    :pswitch_5
    sput-boolean v5, Lcom/android/server/am/cjf;->gck:Z
    ...
    :pswitch_6
    sput-boolean v6, Lcom/android/server/am/cjf;->gck:Z
    ...
    :pswitch_7
    sput-boolean v5, Lcom/android/server/am/cjf;->qbh:Z
    ...
    :pswitch_8
    sput-boolean v6, Lcom/android/server/am/cjf;->qbh:Z
    ...
    :pswitch_9
    sput-boolean v5, Lcom/android/server/am/cjf;->wtn:Z
    ...
    :pswitch_a
    sput-boolean v6, Lcom/android/server/am/cjf;->wtn:Z
    ...
    :pswitch_b
    sput-boolean v5, Lcom/android/server/am/cjf;->ywr:Z

    invoke-static {}, Lcom/android/server/am/vdw;->you()V
    ...
    :pswitch_c
    sput-boolean v6, Lcom/android/server/am/cjf;->ywr:Z

    invoke-static {}, Lcom/android/server/am/vdw;->zta()V
    ...
    invoke-virtual {p0, p2}, Lcom/android/server/am/obl;->cno(Ljava/io/PrintWriter;)V

    goto :goto_6

    :pswitch_e
    invoke-static {p2}, Lcom/android/server/am/oxb;->kth(Ljava/io/PrintWriter;)V
...
.method sis(IZ)Lcom/android/server/am/BroadcastQueue;
    ...
    iget-object p0, p0, Lcom/android/server/am/oxb;->tsu:Lcom/android/server/am/BroadcastQueue;

    goto :goto_0

    :cond_0
    iget-object p0, p0, Lcom/android/server/am/oxb;->rtg:Lcom/android/server/am/BroadcastQueue;
    ...
    iget-object p0, p0, Lcom/android/server/am/oxb;->ssp:Lcom/android/server/am/BroadcastQueue;

    goto :goto_0

    :cond_2
    iget-object p0, p0, Lcom/android/server/am/oxb;->cno:Lcom/android/server/am/BroadcastQueue;
    ...
    iget-object p0, p0, Lcom/android/server/am/oxb;->kth:Lcom/android/server/am/BroadcastQueue;
...
.method public ssp(ZLcom/android/server/am/BroadcastRecord;)V
    ...
    invoke-direct {v0, v2}, Lcom/android/server/am/oxb;->wtn(I)Z
    ...
    invoke-virtual {v0, v6}, Lcom/android/server/am/oxb;->dma(Landroid/content/pm/ApplicationInfo;)Z
    ...
    invoke-virtual {v0, v4}, Lcom/android/server/am/oxb;->dma(Landroid/content/pm/ApplicationInfo;)Z
    ...
    invoke-virtual {v0, v6, v4}, Lcom/android/server/am/oxb;->cjf(ZLandroid/content/pm/ApplicationInfo;)V
    ...
    :cond_3
    invoke-virtual {v0, v8, v2}, Lcom/android/server/am/oxb;->sis(IZ)Lcom/android/server/am/BroadcastQueue;
...
.method public ugm()V
    ...
    iget-object v1, p0, Lcom/android/server/am/oxb;->zta:Lcom/android/server/am/ActivityManagerService;

    iget-object v2, p0, Lcom/android/server/am/oxb;->gck:Lcom/android/server/am/OPSystemCpuLoadMonitor$SystemLoadType;

    iget-object p0, p0, Lcom/android/server/am/oxb;->dma:Lcom/android/server/am/OPBRPorcessSpeedMonitor$ProcessBRSpeedType;

    const/4 v3, 0x1

    invoke-virtual {v0, v1, v2, p0, v3}, Lcom/android/server/am/ivd;->wtn(Lcom/android/server/am/ActivityManagerService;Lcom/android/server/am/OPSystemCpuLoadMonitor$SystemLoadType;Lcom/android/server/am/OPBRPorcessSpeedMonitor$ProcessBRSpeedType;Z)V
...
.method public you(Ljava/util/List;Landroid/content/Intent;)Ljava/util/List;
    ...
    invoke-virtual {p0, p1, p2}, Lcom/android/server/am/a;->zta(Ljava/util/List;Landroid/content/Intent;)Ljava/util/List;
...
.method public ywr(Ljava/lang/String;)Z
    ...
    :try_start_0
    iget-object p0, p0, Lcom/android/server/am/oxb;->igw:Ljava/lang/String;
...
.method public zta(Lcom/android/server/am/BroadcastRecord;)V
    ...
    invoke-static {}, Lcom/android/server/am/cjf;->vdb()Z
    ...
    invoke-static {}, Lcom/android/server/am/qeg;->you()Lcom/android/server/am/qeg;
    ...
    invoke-virtual {v0, p0, p1, v1}, Lcom/android/server/am/qeg;->zta(Lcom/android/server/am/ActivityManagerService;Lcom/android/server/am/BroadcastRecord;I)V
