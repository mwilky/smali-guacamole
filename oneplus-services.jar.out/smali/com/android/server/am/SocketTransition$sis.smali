...
.method public dma(IIZ)V
    ...
    invoke-static {p3}, Lcom/android/server/am/oif;->sis(Ljava/lang/String;)V

    sget-boolean p3, Lcom/android/server/am/oif;->kth:Z
...
.method public noteBluetoothConnectedChanged(Ljava/lang/String;Z)V
    ...
    invoke-static {v0}, Lcom/android/server/am/oif;->sis(Ljava/lang/String;)V

    sget-boolean v0, Lcom/android/server/am/oif;->kth:Z
    ...
    invoke-static {p2}, Lcom/android/server/am/AppRecordManager;->sis(Ljava/lang/String;)Lcom/android/server/am/gck;

    move-result-object v2

    invoke-virtual {v2, v1}, Lcom/android/server/am/gck;->u(I)V
    ...
    :cond_2
    invoke-static {p1}, Lcom/android/server/am/AppRecordManager;->sis(Ljava/lang/String;)Lcom/android/server/am/gck;

    move-result-object p2

    invoke-virtual {p2, v1}, Lcom/android/server/am/gck;->u(I)V
...
.method public noteFreezeStateChange(IZ)V
    ...
    invoke-static {p2}, Lcom/android/server/am/oif;->sis(Ljava/lang/String;)V

    sget-boolean p2, Lcom/android/server/am/oif;->kth:Z
...
.method public noteFrontPackageChanged(Ljava/lang/String;IILjava/lang/String;II)V
    ...
    invoke-static {p4}, Lcom/android/server/am/oif;->sis(Ljava/lang/String;)V

    sget-boolean p4, Lcom/android/server/am/oif;->kth:Z
    ...
    invoke-static {p4, p3}, Lcom/android/server/am/AppRecordManager;->zta(II)Lcom/android/server/am/gck;

    move-result-object p5

    invoke-virtual {p5, p3}, Lcom/android/server/am/gck;->ssp(I)Lcom/android/server/am/j;
    ...
    iget-object v3, p6, Lcom/android/server/am/j;->sis:Ljava/lang/String;
    ...
    iget-object p6, p6, Lcom/android/server/am/j;->sis:Ljava/lang/String;

    invoke-interface {v2, p6}, Ljava/util/Set;->add(Ljava/lang/Object;)Z

    invoke-virtual {p5, v1}, Lcom/android/server/am/gck;->zta(I)V
    ...
    invoke-virtual {p5}, Lcom/android/server/am/gck;->tsu()I
    ...
    invoke-virtual {p5, v1}, Lcom/android/server/am/gck;->u(I)V
...
.method public notePSSChanged(IIJ)V
    ...
    invoke-virtual {v0, p2}, Lcom/android/server/am/gck;->ssp(I)Lcom/android/server/am/j;
    ...
    iget-object v2, v0, Lcom/android/server/am/j;->sis:Ljava/lang/String;
    ...
    iget-object v0, v0, Lcom/android/server/am/j;->sis:Ljava/lang/String;
...
.method public noteProcessStateChanged(IILjava/lang/String;Ljava/lang/String;ZII)V
    ...
    sget-boolean v5, Lcom/android/server/am/oif;->kth:Z
    ...
    invoke-virtual {v5, p2}, Lcom/android/server/am/gck;->ssp(I)Lcom/android/server/am/j;
    ...
    invoke-virtual {v5, v6}, Lcom/android/server/am/j;->zta(I)V

    :cond_2
    invoke-virtual {v5}, Lcom/android/server/am/j;->tsu()I
    ...
    invoke-static {v7}, Lcom/android/server/am/oif;->igw(Ljava/lang/String;)V
...
.method public wtn(ILjava/lang/String;Z)V
    ...
    sget-boolean p0, Lcom/android/server/am/oif;->kth:Z
