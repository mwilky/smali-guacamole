.class public Lcom/android/server/wm/k;
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/android/server/wm/k;->cno:Z

    const/4 v0, 0x0

    sput-object v0, Lcom/android/server/wm/k;->bio:Lcom/android/server/wm/ActivityRecord;

    sput-object v0, Lcom/android/server/wm/k;->igw:Lcom/android/server/wm/ActivityRecord;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/server/wm/k;->rtg:Landroid/view/SurfaceSession;

    const/4 v0, 0x0

    iput-object v0, p0, Lcom/android/server/wm/k;->ssp:Landroid/view/SurfaceControl;
...
.method public static you()Lcom/android/server/wm/ActivityRecord;
    ...
    sget-object v0, Lcom/android/server/wm/k;->igw:Lcom/android/server/wm/ActivityRecord;
...
.method public static zta()Lcom/android/server/wm/ActivityRecord;
    ...
    sget-object v0, Lcom/android/server/wm/k;->bio:Lcom/android/server/wm/ActivityRecord;
...
.method public handleAppTransitionReady()I
    ...
    iget-object p0, p0, Lcom/android/server/wm/k;->tsu:Lcom/android/server/wm/DisplayContent;
...
.method public init(Lcom/android/server/wm/WindowManagerService;Landroid/view/Display;Lcom/android/server/wm/DisplayContent;)V
    ...
    iput-object p1, p0, Lcom/android/server/wm/k;->zta:Lcom/android/server/wm/WindowManagerService;

    iput-object p2, p0, Lcom/android/server/wm/k;->you:Landroid/view/Display;

    invoke-virtual {p2}, Landroid/view/Display;->getDisplayId()I

    move-result p1

    iput p1, p0, Lcom/android/server/wm/k;->sis:I

    iput-object p3, p0, Lcom/android/server/wm/k;->tsu:Lcom/android/server/wm/DisplayContent;
...
.method public makeCovered()Landroid/view/SurfaceControl$Builder;
    ...
    iget-object v0, p0, Lcom/android/server/wm/k;->zta:Lcom/android/server/wm/WindowManagerService;

    iget-object v1, p0, Lcom/android/server/wm/k;->rtg:Landroid/view/SurfaceSession;
...
.method public removeImmediately()V
    ...
    iget-object v0, p0, Lcom/android/server/wm/k;->ssp:Landroid/view/SurfaceControl;

    if-eqz v0, :cond_1

    sget-boolean v0, Lcom/android/server/wm/k;->cno:Z
    ...
    :cond_0
    iget-object p0, p0, Lcom/android/server/wm/k;->ssp:Landroid/view/SurfaceControl;
...
.method public setBooleanNotificationRemoteInputeDraft(Z)V
    ...
    iget-object v0, p0, Lcom/android/server/wm/k;->tsu:Lcom/android/server/wm/DisplayContent;
    ...
    :cond_0
    sget-boolean p0, Lcom/android/server/wm/k;->cno:Z
...
.method public setFocusedApp(Lcom/android/server/wm/ActivityRecord;)V
    ...
    sput-object p0, Lcom/android/server/wm/k;->igw:Lcom/android/server/wm/ActivityRecord;
...
.method public setSourceBoundFromIntent(Landroid/content/Intent;)V
    ...
    iget-object v1, p0, Lcom/android/server/wm/k;->tsu:Lcom/android/server/wm/DisplayContent;
    ...
    :cond_2
    sget-boolean v1, Lcom/android/server/wm/k;->cno:Z
