...
.method public lingerRequest(Landroid/net/NetworkRequest;JJ)V
    ...
    check-cast v2, Lcom/android/server/connectivity/NetworkAgentInfo$LingerTimer;

    iget-wide v2, v2, Lcom/android/server/connectivity/NetworkAgentInfo$LingerTimer;->expiryMs:J

    :goto_0
    iget-object v4, p0, Lcom/android/server/connectivity/NetworkAgentInfo;->mConnService:Lcom/android/server/ConnectivityService;

    iget-object v5, p0, Lcom/android/server/connectivity/NetworkAgentInfo;->networkCapabilities:Landroid/net/NetworkCapabilities;

    invoke-virtual {v4, v5}, Lcom/android/server/ConnectivityService;->satisfiesMobileNetworkDataCheck(Landroid/net/NetworkCapabilities;)Z
    ...
    iget-object v4, p0, Lcom/android/server/connectivity/NetworkAgentInfo;->mLingerTimers:Ljava/util/SortedSet;

    invoke-interface {v4}, Ljava/util/SortedSet;->clear()V

    :cond_2
    new-instance v4, Lcom/android/server/connectivity/NetworkAgentInfo$LingerTimer;

    invoke-direct {v4, p1, v0, v1}, Lcom/android/server/connectivity/NetworkAgentInfo$LingerTimer;-><init>(Landroid/net/NetworkRequest;J)V

    iget-object v5, p0, Lcom/android/server/connectivity/NetworkAgentInfo;->mLingerTimers:Ljava/util/SortedSet;

    invoke-interface {v5, v4}, Ljava/util/SortedSet;->add(Ljava/lang/Object;)Z

    iget-object v5, p0, Lcom/android/server/connectivity/NetworkAgentInfo;->mLingerTimerForRequest:Landroid/util/SparseArray;
