.class public Lcom/android/server/am/lqr;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/server/am/lqr$sis;,
        Lcom/android/server/am/lqr$tsu;,
        Lcom/android/server/am/lqr$rtg;,
        Lcom/android/server/am/lqr$you;
    }
.end annotation
...
.field private static o:Lcom/android/server/am/lqr; = null
...
.field private dma:Lcom/android/server/am/f;
...
.field private you:Lcom/android/server/am/lqr$rtg;

.field private ywr:Lcom/android/server/am/lqr$sis;
...
.method static constructor <clinit>()V
    ...
    sput-boolean v1, Lcom/android/server/am/lqr;->gwm:Z

    sput-boolean v1, Lcom/android/server/am/lqr;->ugm:Z

    sput-boolean v1, Lcom/android/server/am/lqr;->vdb:Z

    sput-boolean v0, Lcom/android/server/am/lqr;->zgw:Z

    sput-boolean v3, Lcom/android/server/am/lqr;->obl:Z

    sput-boolean v1, Lcom/android/server/am/lqr;->oxb:Z
    ...
    :cond_0
    sput v3, Lcom/android/server/am/lqr;->h:I

    const/4 v0, 0x0

    sput-object v0, Lcom/android/server/am/lqr;->o:Lcom/android/server/am/lqr;

    const-string v0, "sys/module/memplus_core/parameters/memory_plus_wake_gcd"

    sput-object v0, Lcom/android/server/am/lqr;->q:Ljava/lang/String;

    const-string v0, "ro.boot.vbmeta.device_state"

    sput-object v0, Lcom/android/server/am/lqr;->r:Ljava/lang/String;

    const-string v0, "/sys/module/proc/parameters/dbg_buf"

    sput-object v0, Lcom/android/server/am/lqr;->s:Ljava/lang/String;

    const-string v0, "314572800 12 10485760 7 262144 4096 76546048 33554432"

    sput-object v0, Lcom/android/server/am/lqr;->t:Ljava/lang/String;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/server/am/lqr;->zta:Landroid/os/HandlerThread;

    iput-object v0, p0, Lcom/android/server/am/lqr;->you:Lcom/android/server/am/lqr$rtg;

    iput-object v0, p0, Lcom/android/server/am/lqr;->sis:Lcom/oneplus/config/ConfigObserver;

    iput-object v0, p0, Lcom/android/server/am/lqr;->tsu:Landroid/content/Context;

    new-instance v1, Ljava/util/HashMap;

    invoke-direct {v1}, Ljava/util/HashMap;-><init>()V

    iput-object v1, p0, Lcom/android/server/am/lqr;->cno:Ljava/util/HashMap;

    new-instance v1, Ljava/util/ArrayList;

    invoke-direct {v1}, Ljava/util/ArrayList;-><init>()V

    iput-object v1, p0, Lcom/android/server/am/lqr;->kth:Ljava/util/ArrayList;

    new-instance v1, Ljava/util/ArrayList;

    invoke-direct {v1}, Ljava/util/ArrayList;-><init>()V

    iput-object v1, p0, Lcom/android/server/am/lqr;->bio:Ljava/util/ArrayList;

    new-instance v1, Ljava/util/ArrayList;

    invoke-direct {v1}, Ljava/util/ArrayList;-><init>()V

    iput-object v1, p0, Lcom/android/server/am/lqr;->igw:Ljava/util/ArrayList;

    new-instance v1, Ljava/util/HashMap;

    invoke-direct {v1}, Ljava/util/HashMap;-><init>()V

    iput-object v1, p0, Lcom/android/server/am/lqr;->wtn:Ljava/util/HashMap;

    new-instance v1, Ljava/util/ArrayList;

    invoke-direct {v1}, Ljava/util/ArrayList;-><init>()V

    iput-object v1, p0, Lcom/android/server/am/lqr;->gck:Ljava/util/ArrayList;

    iput-object v0, p0, Lcom/android/server/am/lqr;->dma:Lcom/android/server/am/f;

    new-instance v1, Lcom/android/server/am/lqr$sis;

    invoke-direct {v1, v0}, Lcom/android/server/am/lqr$sis;-><init>(Lcom/android/server/am/lqr$zta;)V

    iput-object v1, p0, Lcom/android/server/am/lqr;->ywr:Lcom/android/server/am/lqr$sis;

    const/4 v0, 0x1

    iput v0, p0, Lcom/android/server/am/lqr;->qbh:I
    ...
    iput-object v0, p0, Lcom/android/server/am/lqr;->oif:Ljava/util/List;

    const-string v0, ""

    iput-object v0, p0, Lcom/android/server/am/lqr;->bvj:Ljava/lang/String;

    sget-boolean v0, Lcom/android/server/am/lqr;->gwm:Z
    ...
    new-instance v0, Lcom/android/server/am/lqr$rtg;

    iget-object v1, p0, Lcom/android/server/am/lqr;->zta:Landroid/os/HandlerThread;

    invoke-virtual {v1}, Landroid/os/HandlerThread;->getLooper()Landroid/os/Looper;

    move-result-object v1

    invoke-direct {v0, p0, v1}, Lcom/android/server/am/lqr$rtg;-><init>(Lcom/android/server/am/lqr;Landroid/os/Looper;)V

    iput-object v0, p0, Lcom/android/server/am/lqr;->you:Lcom/android/server/am/lqr$rtg;

    sget-boolean v0, Lcom/android/server/am/lqr;->ugm:Z
    ...
    sput-boolean v0, Lcom/android/server/am/lqr;->ugm:Z

    sget-boolean v0, Lcom/android/server/am/lqr;->vdb:Z
    ...
    sput-boolean v0, Lcom/android/server/am/lqr;->vdb:Z

    sget-boolean v0, Lcom/android/server/am/lqr;->obl:Z
    ...
    sput-boolean v0, Lcom/android/server/am/lqr;->obl:Z

    :cond_0
    sget-object v0, Lcom/android/server/am/lqr;->r:Ljava/lang/String;
    ...
    sget-object v0, Lcom/android/server/am/lqr;->s:Ljava/lang/String;

    sget-object v1, Lcom/android/server/am/lqr;->t:Ljava/lang/String;

    invoke-direct {p0, v0, v1}, Lcom/android/server/am/lqr;->bvj(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    iget-object p0, p0, Lcom/android/server/am/lqr;->ywr:Lcom/android/server/am/lqr$sis;
...
.method private a(J)V
    ...
    :cond_0
    iget-object v0, p0, Lcom/android/server/am/lqr;->kth:Ljava/util/ArrayList;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Lcom/android/server/am/lqr;->kth:Ljava/util/ArrayList;

    invoke-virtual {v1}, Ljava/util/ArrayList;->clear()V

    iget-object v1, p0, Lcom/android/server/am/lqr;->kth:Ljava/util/ArrayList;

    iget-object v2, p0, Lcom/android/server/am/lqr;->dma:Lcom/android/server/am/f;

    const/4 v3, 0x0

    invoke-virtual {v2, v3}, Lcom/android/server/am/f;->irq(Z)Ljava/util/ArrayList;
    ...
    iget-object p0, p0, Lcom/android/server/am/lqr;->you:Lcom/android/server/am/lqr$rtg;
...
.method private b()V
    ...
    iget-object v1, p0, Lcom/android/server/am/lqr;->tsu:Landroid/content/Context;
    ...
    invoke-direct {p0, v0}, Lcom/android/server/am/lqr;->cgv(Lorg/json/JSONArray;)V

    return-void
.end method

.method static synthetic bio(Lcom/android/server/am/lqr;)I
    .locals 0

    invoke-direct {p0}, Lcom/android/server/am/lqr;->bud()I
...
.method private bud()I
    ...
    :cond_0
    invoke-direct {p0}, Lcom/android/server/am/lqr;->obl()Ljava/lang/String;
    ...
    invoke-direct {p0}, Lcom/android/server/am/lqr;->oif()Landroid/net/LocalSocket;
    ...
    sget-boolean v4, Lcom/android/server/am/lqr;->obl:Z
    ...
    invoke-static {v0}, Lcom/android/server/am/lqr;->ivd(S)[B
...
.method private bvj(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    sget-boolean v3, Lcom/android/server/am/lqr;->obl:Z
...
.method private c(Z)V
    ...
    sget-boolean v0, Lcom/android/server/am/lqr;->oxb:Z
    ...
    sget-boolean v2, Lcom/android/server/am/lqr;->oxb:Z

    :cond_2
    sput-boolean v2, Lcom/android/server/am/lqr;->vdb:Z
    ...
    :cond_3
    sput v2, Lcom/android/server/am/lqr;->h:I
    ...
    invoke-direct {p0, v2, v0}, Lcom/android/server/am/lqr;->vdw(Ljava/lang/String;Ljava/lang/String;)V
    ...
    sget v0, Lcom/android/server/am/lqr;->h:I
    ...
    sget-boolean p1, Lcom/android/server/am/lqr;->ugm:Z
    ...
    invoke-direct {p0, v4, p1}, Lcom/android/server/am/lqr;->bvj(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    sget-boolean v4, Lcom/android/server/am/lqr;->ugm:Z
    ...
    :goto_2
    sget-boolean p1, Lcom/android/server/am/lqr;->oxb:Z
    ...
    invoke-direct {p0, p1, v0}, Lcom/android/server/am/lqr;->bvj(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    :goto_4
    sget p1, Lcom/android/server/am/lqr;->h:I
...
.method private cgv(Lorg/json/JSONArray;)V
    ...
    iget-object v5, p0, Lcom/android/server/am/lqr;->cno:Ljava/util/HashMap;
    ...
    :try_start_1
    iget-object v6, p0, Lcom/android/server/am/lqr;->cno:Ljava/util/HashMap;

    invoke-virtual {v6}, Ljava/util/HashMap;->clear()V

    sget-boolean v6, Lcom/android/server/am/lqr;->obl:Z
    ...
    iget-object v9, p0, Lcom/android/server/am/lqr;->cno:Ljava/util/HashMap;
    ...
    :try_start_3
    iget-object v10, p0, Lcom/android/server/am/lqr;->cno:Ljava/util/HashMap;

    invoke-virtual {v10, v8, v7}, Ljava/util/HashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    sget-boolean v10, Lcom/android/server/am/lqr;->obl:Z
    ...
    iget-object v5, p0, Lcom/android/server/am/lqr;->gck:Ljava/util/ArrayList;
    ...
    :try_start_7
    iget-object v6, p0, Lcom/android/server/am/lqr;->gck:Ljava/util/ArrayList;
    ...
    iget-object v8, p0, Lcom/android/server/am/lqr;->gck:Ljava/util/ArrayList;
    ...
    :try_start_9
    iget-object v9, p0, Lcom/android/server/am/lqr;->gck:Ljava/util/ArrayList;

    invoke-virtual {v9, v7}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    sget-boolean v9, Lcom/android/server/am/lqr;->obl:Z
    ...
    iget-object v5, p0, Lcom/android/server/am/lqr;->bio:Ljava/util/ArrayList;
    ...
    :try_start_d
    iget-object v6, p0, Lcom/android/server/am/lqr;->bio:Ljava/util/ArrayList;
    ...
    iget-object v8, p0, Lcom/android/server/am/lqr;->bio:Ljava/util/ArrayList;
    ...
    :try_start_f
    iget-object v9, p0, Lcom/android/server/am/lqr;->bio:Ljava/util/ArrayList;
    ...
    iget-object v5, p0, Lcom/android/server/am/lqr;->igw:Ljava/util/ArrayList;
    ...
    :try_start_13
    iget-object v6, p0, Lcom/android/server/am/lqr;->igw:Ljava/util/ArrayList;
    ...
    iget-object v8, p0, Lcom/android/server/am/lqr;->igw:Ljava/util/ArrayList;
    ...
    :try_start_15
    iget-object v9, p0, Lcom/android/server/am/lqr;->igw:Ljava/util/ArrayList;
    ...
    invoke-direct {p0, v6, v5}, Lcom/android/server/am/lqr;->vdw(Ljava/lang/String;Ljava/lang/String;)V
    ...
    sput-boolean v5, Lcom/android/server/am/lqr;->zgw:Z
    ...
    sget-boolean v7, Lcom/android/server/am/lqr;->zgw:Z
    ...
    invoke-direct {p0, v6, v5}, Lcom/android/server/am/lqr;->qeg(Ljava/lang/String;Lorg/json/JSONArray;)V
    ...
    invoke-direct {p0, v5, v6}, Lcom/android/server/am/lqr;->bvj(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    iget-object v6, p0, Lcom/android/server/am/lqr;->ywr:Lcom/android/server/am/lqr$sis;

    invoke-virtual {v6, v5}, Lcom/android/server/am/lqr$sis;->tsu(I)V
    ...
    iget-object v5, p0, Lcom/android/server/am/lqr;->ywr:Lcom/android/server/am/lqr$sis;

    invoke-virtual {v5}, Lcom/android/server/am/lqr$sis;->you()V
    ...
    iget-object v8, p0, Lcom/android/server/am/lqr;->ywr:Lcom/android/server/am/lqr$sis;

    invoke-virtual {v8, v7}, Lcom/android/server/am/lqr$sis;->zta(Ljava/lang/String;)V

    sget-boolean v8, Lcom/android/server/am/lqr;->obl:Z
    ...
    const-string v8, "[OnlineConfig] fuse_boost "
    ...
    const-string v5, "/sys/module/houston/parameters/fuse_boost"
    ...
    const-string v8, "[OnlineConfig] fuse_sct_mode "
    ...
    const-string v5, "/sys/module/fuse/parameters/sct_mode"
    ...
    const-string v6, "fuse_shortcircuit"
    ...
    const-string v8, "[OnlineConfig] fuse_shortcircuit "
    ...
    const-string v5, "/sys/module/fuse/parameters/shortcircuit"
    ...
    const-string v6, "persist.sys.hwui.skia.enhance.online.config"
    ...
    const-string v8, "[OnlineConfig] hwui enhance: "
    ...
    const-string v5, "persist.vendor.zwriteback.mem_limit"
    ...
    const-string v5, "[OnlineConfig] zramWB memLimitInMB is changed"
    ...
    const-string v6, "[OnlineConfig] zramWB memLimitInMB:"
    ...
    :cond_2d
    invoke-direct {p0, v0}, Lcom/android/server/am/lqr;->c(Z)V
...
.method static synthetic cno(Lcom/android/server/am/lqr;Lorg/json/JSONArray;)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/android/server/am/lqr;->cgv(Lorg/json/JSONArray;)V
...
.method private d(Ljava/lang/String;Ljava/lang/String;I)Z
    ...
    invoke-direct {p0, p3}, Lcom/android/server/am/lqr;->gwm(I)Ljava/lang/String;

    move-result-object v0

    invoke-direct {p0, v0, p2}, Lcom/android/server/am/lqr;->bvj(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    sget-boolean v2, Lcom/android/server/am/lqr;->obl:Z
    ...
    iget-object v0, p0, Lcom/android/server/am/lqr;->wtn:Ljava/util/HashMap;

    monitor-enter v0

    :try_start_0
    iget-object v2, p0, Lcom/android/server/am/lqr;->wtn:Ljava/util/HashMap;

    invoke-static {p3}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;

    move-result-object v3

    new-instance v4, Lcom/android/server/am/lqr$you;

    invoke-direct {v4, p0, p1, p2, p3}, Lcom/android/server/am/lqr$you;-><init>(Lcom/android/server/am/lqr;Ljava/lang/String;Ljava/lang/String;I)V
...
.method static synthetic dma(Lcom/android/server/am/lqr;)I
    .locals 0

    invoke-direct {p0}, Lcom/android/server/am/lqr;->veq()I
...
.method private e(III)Z
    ...
    invoke-direct {p0, p2, v1}, Lcom/android/server/am/lqr;->bvj(Ljava/lang/String;Ljava/lang/String;)Z

    sget-boolean p0, Lcom/android/server/am/lqr;->obl:Z
...
.method private ear(Ljava/lang/String;)Z
    ...
    :try_start_0
    iget-object p0, p0, Lcom/android/server/am/lqr;->kth:Ljava/util/ArrayList;
...
.method private f(IILjava/lang/String;)Z
    ...
    invoke-direct {p0, p3, p1, v0}, Lcom/android/server/am/lqr;->zgw(Ljava/lang/String;IZ)I

    move-result v0

    invoke-direct {p0, p1, p2, v0}, Lcom/android/server/am/lqr;->e(III)Z
...
.method static synthetic gck(Lcom/android/server/am/lqr;I)Z
    .locals 0

    invoke-direct {p0, p1}, Lcom/android/server/am/lqr;->vju(I)Z
...
.method private ibl(Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object p0, p0, Lcom/android/server/am/lqr;->oif:Ljava/util/List;
...
.method static synthetic igw(Lcom/android/server/am/lqr;J)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/android/server/am/lqr;->a(J)V
...
.method private irq(ILjava/lang/String;Ljava/lang/String;)I
    ...
    iget-object v0, p0, Lcom/android/server/am/lqr;->gck:Ljava/util/ArrayList;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Lcom/android/server/am/lqr;->gck:Ljava/util/ArrayList;
    ...
    invoke-static {v3}, Lcom/android/server/am/lqr;->ivd(S)[B
    ...
    iput-object p1, p0, Lcom/android/server/am/lqr;->bvj:Ljava/lang/String;

    iget-object p1, p0, Lcom/android/server/am/lqr;->you:Lcom/android/server/am/lqr$rtg;
...
.method static synthetic kth(Lcom/android/server/am/lqr;)V
    .locals 0

    invoke-direct {p0}, Lcom/android/server/am/lqr;->b()V
...
.method private les(Ljava/lang/String;)I
    ...
    invoke-static {p1}, Lcom/android/server/am/lqr;->ivd(S)[B
...
.method private obl()Ljava/lang/String;
    ...
    :try_start_0
    iget-object v2, p0, Lcom/android/server/am/lqr;->gck:Ljava/util/ArrayList;
    ...
    iget-object p0, p0, Lcom/android/server/am/lqr;->gck:Ljava/util/ArrayList;
...
.method static synthetic qbh(Lcom/android/server/am/lqr;ILjava/lang/String;Ljava/lang/String;)I
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lcom/android/server/am/lqr;->irq(ILjava/lang/String;Ljava/lang/String;)I
...
.method private qeg(Ljava/lang/String;Lorg/json/JSONArray;)V
    ...
    invoke-direct {p0, p1, v3}, Lcom/android/server/am/lqr;->vdw(Ljava/lang/String;Ljava/lang/String;)V
...
.method static synthetic rtg(Lcom/android/server/am/lqr;III)Z
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lcom/android/server/am/lqr;->e(III)Z
...
.method static synthetic sis(Lcom/android/server/am/lqr;Ljava/lang/String;)I
    .locals 0

    invoke-direct {p0, p1}, Lcom/android/server/am/lqr;->les(Ljava/lang/String;)I
...
.method static synthetic ssp(Lcom/android/server/am/lqr;IILjava/lang/String;)Z
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lcom/android/server/am/lqr;->f(IILjava/lang/String;)Z
...
.method static synthetic tsu(Lcom/android/server/am/lqr;Ljava/lang/String;IZ)I
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lcom/android/server/am/lqr;->zgw(Ljava/lang/String;IZ)I
...
.method private ugm(Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v0, p0, Lcom/android/server/am/lqr;->bio:Ljava/util/ArrayList;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Lcom/android/server/am/lqr;->bio:Ljava/util/ArrayList;
...
.method public static final vdb()Lcom/android/server/am/lqr;
    .locals 2

    sget-object v0, Lcom/android/server/am/lqr;->o:Lcom/android/server/am/lqr;

    if-nez v0, :cond_0

    new-instance v0, Lcom/android/server/am/lqr;

    invoke-direct {v0}, Lcom/android/server/am/lqr;-><init>()V

    sput-object v0, Lcom/android/server/am/lqr;->o:Lcom/android/server/am/lqr;

    new-instance v0, Ljava/io/File;

    sget-object v1, Lcom/android/server/am/lqr;->q:Ljava/lang/String;

    invoke-direct {v0, v1}, Ljava/io/File;-><init>(Ljava/lang/String;)V

    sput-object v0, Lcom/android/server/am/lqr;->p:Ljava/io/File;
...
.method private veq()I
    ...
    iget-object v7, p0, Lcom/android/server/am/lqr;->cno:Ljava/util/HashMap;
    ...
    :try_start_1
    iget-object v8, p0, Lcom/android/server/am/lqr;->cno:Ljava/util/HashMap;
    ...
    :try_start_2
    sget-boolean v7, Lcom/android/server/am/lqr;->obl:Z
    ...
    sget-boolean v5, Lcom/android/server/am/lqr;->obl:Z
...
.method private vju(I)Z
    ...
    :try_start_0
    iget-object p0, p0, Lcom/android/server/am/lqr;->wtn:Ljava/util/HashMap;
...
.method static synthetic wtn(Lcom/android/server/am/lqr;Ljava/lang/String;Ljava/lang/String;I)Z
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lcom/android/server/am/lqr;->d(Ljava/lang/String;Ljava/lang/String;I)Z
...
.method static synthetic ywr(Lcom/android/server/am/lqr;Z)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/android/server/am/lqr;->c(Z)V
...
.method public cjf(Landroid/content/Context;)V
    ...
    :cond_1
    iget-object v0, p0, Lcom/android/server/am/lqr;->tsu:Landroid/content/Context;

    if-nez v0, :cond_2

    iput-object p1, p0, Lcom/android/server/am/lqr;->tsu:Landroid/content/Context;
    ...
    iget-object v1, p0, Lcom/android/server/am/lqr;->you:Lcom/android/server/am/lqr$rtg;

    new-instance v2, Lcom/android/server/am/lqr$tsu;

    invoke-direct {v2, p0}, Lcom/android/server/am/lqr$tsu;-><init>(Lcom/android/server/am/lqr;)V
    ...
    iput-object p1, p0, Lcom/android/server/am/lqr;->sis:Lcom/oneplus/config/ConfigObserver;
...
.method public hmo(ILjava/lang/String;Ljava/lang/String;)V
    ...
    iput-object p2, p0, Lcom/android/server/am/lqr;->bvj:Ljava/lang/String;

    goto :goto_0

    :cond_1
    iget-object v0, p0, Lcom/android/server/am/lqr;->bvj:Ljava/lang/String;
    ...
    :cond_2
    :goto_0
    iget-object v0, p0, Lcom/android/server/am/lqr;->igw:Ljava/util/ArrayList;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Lcom/android/server/am/lqr;->igw:Ljava/util/ArrayList;
...
.method public lqr()V
    ...
    sget-boolean v0, Lcom/android/server/am/lqr;->zgw:Z
    ...
    iput v1, p0, Lcom/android/server/am/lqr;->qbh:I
    ...
    sget-boolean v2, Lcom/android/server/am/lqr;->zgw:Z
    ...
    iget v2, p0, Lcom/android/server/am/lqr;->qbh:I
    ...
    iget v0, p0, Lcom/android/server/am/lqr;->qbh:I
    ...
    :try_start_0
    sget-object p0, Lcom/android/server/am/lqr;->p:Ljava/io/File;
    ...
    sget-object v0, Lcom/android/server/am/lqr;->p:Ljava/io/File;
...
.method public oxb(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lcom/android/server/am/lqr;->rtg:Landroid/content/ContentResolver;
    ...
    iput-object p1, p0, Lcom/android/server/am/lqr;->ssp:Landroid/net/Uri;

    invoke-static {}, Lcom/android/server/am/f;->vdw()Lcom/android/server/am/f;

    move-result-object p1

    iput-object p1, p0, Lcom/android/server/am/lqr;->dma:Lcom/android/server/am/f;
