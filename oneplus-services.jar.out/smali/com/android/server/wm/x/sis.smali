.class public Lcom/android/server/wm/x/sis;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/server/wm/x/sis$tsu;
    }
.end annotation
...
.field private sis:Lcom/android/server/wm/x/sis$tsu;

.field private final ssp:Lcom/android/server/wm/x/tsu;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/server/wm/x/sis;->kth:Ljava/lang/Object;

    return-void
.end method

.method public constructor <init>(Lcom/android/server/wm/WindowManagerService;Lcom/android/server/wm/x/tsu;)V
    .locals 5
    ...
    iput-object v0, p0, Lcom/android/server/wm/x/sis;->zta:Landroid/util/ArrayMap;

    new-instance v0, Lcom/android/server/wm/x/sis$zta;
    ...
    invoke-direct {v0, p0, v1}, Lcom/android/server/wm/x/sis$zta;-><init>(Lcom/android/server/wm/x/sis;I)V

    iput-object v0, p0, Lcom/android/server/wm/x/sis;->rtg:Landroid/util/LruCache;

    iput-object p2, p0, Lcom/android/server/wm/x/sis;->ssp:Lcom/android/server/wm/x/tsu;

    invoke-static {}, Ljava/util/concurrent/Executors;->newSingleThreadExecutor()Ljava/util/concurrent/ExecutorService;

    move-result-object p2

    iput-object p2, p0, Lcom/android/server/wm/x/sis;->you:Ljava/util/concurrent/ExecutorService;

    iput-object p1, p0, Lcom/android/server/wm/x/sis;->tsu:Lcom/android/server/wm/WindowManagerService;
...
.method private igw(ILjava/lang/String;)V
    ...
    invoke-direct {p0, p1, p2}, Lcom/android/server/wm/x/sis;->oif(ILjava/lang/String;)Landroid/graphics/Bitmap;
    ...
    invoke-virtual {p0, p2, v0}, Lcom/android/server/wm/x/sis;->sis(Ljava/lang/String;Landroid/graphics/drawable/BitmapDrawable;)V
    ...
    iget-object p0, p0, Lcom/android/server/wm/x/sis;->sis:Lcom/android/server/wm/x/sis$tsu;

    if-eqz p0, :cond_0

    invoke-interface {p0, p2}, Lcom/android/server/wm/x/sis$tsu;->zta(Ljava/lang/String;)V
...
.method private oif(ILjava/lang/String;)Landroid/graphics/Bitmap;
    ...
    iget-object p0, p0, Lcom/android/server/wm/x/sis;->ssp:Lcom/android/server/wm/x/tsu;

    invoke-virtual {p0, p1, p2}, Lcom/android/server/wm/x/tsu;->zta(ILjava/lang/String;)Landroid/graphics/Bitmap;
...
.method private wtn(Ljava/lang/String;Landroid/content/Context;I)V
    ...
    invoke-virtual {v0, v1, v2}, Lcom/android/server/wm/x/sis;->sis(Ljava/lang/String;Landroid/graphics/drawable/BitmapDrawable;)V
    ...
    iget-object v0, v0, Lcom/android/server/wm/x/sis;->sis:Lcom/android/server/wm/x/sis$tsu;

    if-eqz v0, :cond_0

    invoke-interface {v0, v1}, Lcom/android/server/wm/x/sis$tsu;->zta(Ljava/lang/String;)V
    ...
    iget-object v5, v0, Lcom/android/server/wm/x/sis;->tsu:Lcom/android/server/wm/WindowManagerService;
    ...
    invoke-virtual {v2, v1, v0}, Lcom/android/server/wm/x/sis;->sis(Ljava/lang/String;Landroid/graphics/drawable/BitmapDrawable;)V
    ...
    iget-object v0, v2, Lcom/android/server/wm/x/sis;->sis:Lcom/android/server/wm/x/sis$tsu;
...
.method static synthetic you(Lcom/android/server/wm/x/sis;ILjava/lang/String;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/android/server/wm/x/sis;->igw(ILjava/lang/String;)V
...
.method static synthetic zta(Lcom/android/server/wm/x/sis;Ljava/lang/String;Landroid/content/Context;I)V
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lcom/android/server/wm/x/sis;->wtn(Ljava/lang/String;Landroid/content/Context;I)V
...
.method public bvj()V
    ...
    iput-object v0, p0, Lcom/android/server/wm/x/sis;->sis:Lcom/android/server/wm/x/sis$tsu;
...
.method public cno(Ljava/lang/String;)Landroid/graphics/drawable/BitmapDrawable;
    ...
    sget-object v0, Lcom/android/server/wm/x/sis;->kth:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    iget-object p0, p0, Lcom/android/server/wm/x/sis;->zta:Landroid/util/ArrayMap;
...
.method public dma(ILjava/lang/String;Landroid/graphics/Bitmap;)V
    ...
    iget-object v0, p0, Lcom/android/server/wm/x/sis;->rtg:Landroid/util/LruCache;

    invoke-direct {p0, p1, p2}, Lcom/android/server/wm/x/sis;->ywr(ILjava/lang/String;)Ljava/lang/String;
...
.method public gck(ILandroid/content/Context;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1, p4}, Lcom/android/server/wm/x/sis;->ywr(ILjava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p0, p3, p1}, Lcom/android/server/wm/x/sis;->sis(Ljava/lang/String;Landroid/graphics/drawable/BitmapDrawable;)V
    ...
    iget-object p1, p0, Lcom/android/server/wm/x/sis;->you:Ljava/util/concurrent/ExecutorService;

    new-instance v0, Lcom/android/server/wm/x/sis$you;

    invoke-direct {v0, p0, p3, p2, p4}, Lcom/android/server/wm/x/sis$you;-><init>(Lcom/android/server/wm/x/sis;Ljava/lang/String;Landroid/content/Context;I)V
    ...
    :cond_1
    iget-object p2, p0, Lcom/android/server/wm/x/sis;->you:Ljava/util/concurrent/ExecutorService;

    new-instance p4, Lcom/android/server/wm/x/sis$sis;

    invoke-direct {p4, p0, p1, p3}, Lcom/android/server/wm/x/sis$sis;-><init>(Lcom/android/server/wm/x/sis;ILjava/lang/String;)V
...
.method public kth(ILjava/lang/String;Ljava/lang/String;Z)Landroid/graphics/drawable/BitmapDrawable;
    ...
    invoke-direct {p0, p1, p3}, Lcom/android/server/wm/x/sis;->ywr(ILjava/lang/String;)Ljava/lang/String;
    ...
    :cond_3
    invoke-virtual {p0, p1, p2}, Lcom/android/server/wm/x/sis;->bio(ILjava/lang/String;)Landroid/graphics/drawable/BitmapDrawable;
...
.method public qbh(Lcom/android/server/wm/x/sis$tsu;)V
    .locals 0

    iput-object p1, p0, Lcom/android/server/wm/x/sis;->sis:Lcom/android/server/wm/x/sis$tsu;
...
.method public ssp(ILjava/lang/String;Ljava/lang/String;)Landroid/graphics/drawable/BitmapDrawable;
    ...
    invoke-virtual {p0, p2}, Lcom/android/server/wm/x/sis;->cno(Ljava/lang/String;)Landroid/graphics/drawable/BitmapDrawable;
...
.method public tsu()V
    ...
    iget-object p0, p0, Lcom/android/server/wm/x/sis;->rtg:Landroid/util/LruCache;
