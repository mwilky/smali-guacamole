.class public Lcom/android/server/wm/q;
...
.field private gck:Lcom/android/server/wm/x/rtg;

.field private gwm:Landroid/graphics/drawable/Drawable;

.field private ibl:Ljava/lang/String;

.field private igw:Lcom/android/server/wm/x/sis;
...
.field private wtn:Lcom/android/server/wm/x/tsu;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/server/wm/q;->vdb:Ljava/lang/Object;
...
.method public constructor <init>()V
    ...
    iput v0, p0, Lcom/android/server/wm/q;->zta:I

    const/4 v1, -0x1

    iput v1, p0, Lcom/android/server/wm/q;->you:I

    iput-boolean v0, p0, Lcom/android/server/wm/q;->sis:Z

    iput-boolean v0, p0, Lcom/android/server/wm/q;->tsu:Z

    iput-boolean v0, p0, Lcom/android/server/wm/q;->ssp:Z

    iput-boolean v0, p0, Lcom/android/server/wm/q;->kth:Z

    const/4 v1, 0x1

    iput-boolean v1, p0, Lcom/android/server/wm/q;->dma:Z

    const/4 v1, 0x0

    iput-object v1, p0, Lcom/android/server/wm/q;->ywr:Ljava/lang/String;

    iput-object v1, p0, Lcom/android/server/wm/q;->qbh:Lcom/android/server/wm/ActivityRecord;

    iput-boolean v0, p0, Lcom/android/server/wm/q;->oif:Z

    iput-boolean v0, p0, Lcom/android/server/wm/q;->bvj:Z

    const-string v0, "init"

    iput-object v0, p0, Lcom/android/server/wm/q;->ibl:Ljava/lang/String;
...
.method private bio(Lcom/android/server/wm/ActivityRecord;)Landroid/graphics/Bitmap;
    ...
    :goto_0
    invoke-static {p0}, Lcom/android/server/wm/x/cno;->ssp(Ljava/lang/String;)V
    ...
    invoke-static {v3}, Lcom/android/server/wm/x/cno;->ssp(Ljava/lang/String;)V
    ...
    invoke-static {p1}, Lcom/android/server/wm/x/cno;->you(Landroid/graphics/Bitmap;)Z
...
.method private cno()V
    ...
    sget-object v0, Lcom/android/server/wm/q;->vdb:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Lcom/android/server/wm/q;->igw:Lcom/android/server/wm/x/sis;

    invoke-virtual {v1}, Lcom/android/server/wm/x/sis;->tsu()V

    iget-object v1, p0, Lcom/android/server/wm/q;->gck:Lcom/android/server/wm/x/rtg;

    iget-object p0, p0, Lcom/android/server/wm/q;->bio:Lcom/android/server/wm/WindowManagerService;

    iget p0, p0, Lcom/android/server/wm/WindowManagerService;->mCurrentUserId:I

    invoke-virtual {v1, p0}, Lcom/android/server/wm/x/rtg;->igw(I)V
...
.method private gck()Z
    ...
    invoke-static {}, Lcom/android/server/wm/x/you;->bio()Z
...
.method private igw(Lcom/android/internal/policy/PhoneWindow;)Landroid/graphics/drawable/BitmapDrawable;
    ...
    invoke-direct {p0}, Lcom/android/server/wm/q;->gck()Z
    ...
    invoke-static {v2}, Lcom/android/server/wm/x/cno;->kth(Ljava/lang/String;)Z
    ...
    :cond_4
    sget-object v3, Lcom/android/server/wm/x/zta;->bio:Landroid/util/ArrayMap;
    ...
    sget-object v0, Lcom/android/server/wm/x/zta;->bio:Landroid/util/ArrayMap;
    ...
    iget-boolean v0, p0, Lcom/android/server/wm/q;->sis:Z
    ...
    :cond_6
    sget-object v0, Lcom/android/server/wm/x/zta;->wtn:Landroid/util/ArrayMap;
    ...
    invoke-static {v0}, Lcom/android/server/wm/x/cno;->ssp(Ljava/lang/String;)V

    :cond_7
    invoke-virtual {p0}, Lcom/android/server/wm/q;->checkSplashWindowFlag()Z

    move-result v0

    if-eqz v0, :cond_9

    iget-object v0, p0, Lcom/android/server/wm/q;->igw:Lcom/android/server/wm/x/sis;

    iget-object v1, p0, Lcom/android/server/wm/q;->bio:Lcom/android/server/wm/WindowManagerService;

    iget v1, v1, Lcom/android/server/wm/WindowManagerService;->mCurrentUserId:I

    invoke-virtual {v0, v1, v7, v2}, Lcom/android/server/wm/x/sis;->ssp(ILjava/lang/String;Ljava/lang/String;)Landroid/graphics/drawable/BitmapDrawable;
    ...
    new-instance v2, Lcom/android/server/wm/q$you;
    ...
    invoke-direct/range {v4 .. v10}, Lcom/android/server/wm/q$you;-><init>(Lcom/android/server/wm/q;Landroid/graphics/drawable/BitmapDrawable;Ljava/lang/String;JLcom/android/internal/policy/PhoneWindow;)V

    invoke-virtual {v1, v2}, Lcom/android/server/wm/x/sis;->qbh(Lcom/android/server/wm/x/sis$tsu;)V

    goto :goto_0

    :cond_8
    iget-object p0, p0, Lcom/android/server/wm/q;->igw:Lcom/android/server/wm/x/sis;

    invoke-virtual {p0}, Lcom/android/server/wm/x/sis;->rtg()V
...
.method private kth(Lcom/android/server/wm/WindowState;)Landroid/view/animation/Animation;
    ...
    invoke-static {p1}, Lcom/android/server/wm/x/cno;->ssp(Ljava/lang/String;)V
...
.method private qbh(Z)V
    ...
    :cond_0
    iput-boolean p1, p0, Lcom/android/server/wm/q;->ssp:Z

    if-nez p1, :cond_1

    invoke-direct {p0}, Lcom/android/server/wm/q;->ywr()V
...
.method private rtg(Lcom/android/server/wm/ActivityRecord;Ljava/lang/String;)V
    ...
    invoke-static {v0}, Lcom/android/server/wm/x/cno;->kth(Ljava/lang/String;)Z
    ...
    :cond_1
    :try_start_0
    invoke-direct {p0, p1}, Lcom/android/server/wm/q;->bio(Lcom/android/server/wm/ActivityRecord;)Landroid/graphics/Bitmap;
    ...
    iget-object v2, p0, Lcom/android/server/wm/q;->bio:Lcom/android/server/wm/WindowManagerService;

    iget v2, v2, Lcom/android/server/wm/WindowManagerService;->mCurrentUserId:I

    invoke-virtual {v1, v2, p2, v0}, Lcom/android/server/wm/x/sis;->dma(ILjava/lang/String;Landroid/graphics/Bitmap;)V

    iget-object p1, p1, Lcom/android/server/wm/ActivityRecord;->packageName:Ljava/lang/String;

    iget-object p2, p0, Lcom/android/server/wm/q;->gck:Lcom/android/server/wm/x/rtg;

    iget-object p0, p0, Lcom/android/server/wm/q;->bio:Lcom/android/server/wm/WindowManagerService;

    iget p0, p0, Lcom/android/server/wm/WindowManagerService;->mCurrentUserId:I

    invoke-virtual {p2, p1, p0, v0}, Lcom/android/server/wm/x/rtg;->ibl(Ljava/lang/String;ILandroid/graphics/Bitmap;)V
    :try_end_0
    ...
    invoke-static {p0}, Lcom/android/server/wm/x/cno;->cno(Ljava/lang/String;)V
...
.method static synthetic sis(Lcom/android/server/wm/q;)Lcom/android/server/wm/x/sis;
    .locals 0
...
.method private ssp()V
    ...
    iget-object v0, p0, Lcom/android/server/wm/q;->rtg:Ljava/util/concurrent/ExecutorService;
    ...
    iput-object v0, p0, Lcom/android/server/wm/q;->rtg:Ljava/util/concurrent/ExecutorService;

    :cond_0
    return-void
.end method

.method static synthetic tsu(Lcom/android/server/wm/q;)Lcom/android/server/wm/WindowManagerService;
    .locals 0
...
.method static synthetic you(Lcom/android/server/wm/q;Lcom/android/server/wm/ActivityRecord;Ljava/lang/String;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/android/server/wm/q;->rtg(Lcom/android/server/wm/ActivityRecord;Ljava/lang/String;)V
...
.method public checkSplashWindowFlag()Z
    ...
    :cond_0
    iget p0, p0, Lcom/android/server/wm/q;->zta:I
...
.method public checkStartingWindowDrawable(Landroid/graphics/drawable/Drawable;Landroid/content/res/TypedArray;Landroid/content/Context;Ljava/lang/String;)Z
    ...
    :cond_1
    invoke-static {p4}, Lcom/android/server/wm/x/cno;->kth(Ljava/lang/String;)Z
    ...
    invoke-static {p2}, Lcom/android/server/wm/x/cno;->ssp(Ljava/lang/String;)V
    ...
    invoke-direct {p0, p3}, Lcom/android/server/wm/q;->wtn(Landroid/content/Context;)Z
    ...
    invoke-static {p1}, Lcom/android/server/wm/q;->dma(I)I

    move-result p1

    invoke-direct {p2, p1}, Landroid/graphics/drawable/ColorDrawable;-><init>(I)V

    iput-object p2, p0, Lcom/android/server/wm/q;->gwm:Landroid/graphics/drawable/Drawable;

    goto :goto_1

    :cond_3
    iput-object p1, p0, Lcom/android/server/wm/q;->gwm:Landroid/graphics/drawable/Drawable;
...
.method public checkoutWindowNeedHide(Lcom/android/server/wm/WindowState;I)I
    ...
    :cond_3
    sget-object v0, Lcom/android/server/wm/x/zta;->gck:Landroid/util/ArrayMap;
    ...
    iget-object v0, p0, Lcom/android/server/wm/q;->ibl:Ljava/lang/String;

    if-eqz v0, :cond_4

    sget-object v1, Lcom/android/server/wm/x/zta;->gck:Landroid/util/ArrayMap;
    ...
    :cond_4
    iput-object p1, p0, Lcom/android/server/wm/q;->ibl:Ljava/lang/String;

    :cond_5
    sget-object v0, Lcom/android/server/wm/x/zta;->cno:Ljava/util/Set;
...
.method public clearCacheWhenOnConfigurationChange(I)V
    ...
    invoke-direct {p0}, Lcom/android/server/wm/q;->cno()V
...
.method public getAppTransit(I)I
    ...
    :cond_0
    iget p1, p0, Lcom/android/server/wm/q;->you:I

    const/4 v0, -0x1

    iput v0, p0, Lcom/android/server/wm/q;->you:I
...
.method public handleDestroySurfaces(Ljava/lang/String;I)Z
    ...
    sget-object p0, Lcom/android/server/wm/x/zta;->igw:Ljava/util/Map;
...
.method public handleStartingWindow(Lcom/android/internal/policy/PhoneWindow;Landroid/content/Context;Ljava/lang/String;)V
    ...
    :cond_0
    invoke-static {p3}, Lcom/android/server/wm/x/cno;->kth(Ljava/lang/String;)Z
    ...
    invoke-static {v0}, Lcom/android/server/wm/x/cno;->igw(Ljava/lang/String;)V
    ...
    iget-object v3, p0, Lcom/android/server/wm/q;->gwm:Landroid/graphics/drawable/Drawable;
    ...
    :cond_3
    invoke-direct {p0, p2}, Lcom/android/server/wm/q;->wtn(Landroid/content/Context;)Z
    ...
    :cond_5
    :goto_1
    iget-object p2, p0, Lcom/android/server/wm/q;->gwm:Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {p0, v4}, Lcom/android/server/wm/q;->qbh(Z)V
    ...
    invoke-direct {p0, p1}, Lcom/android/server/wm/q;->igw(Lcom/android/internal/policy/PhoneWindow;)Landroid/graphics/drawable/BitmapDrawable;
    ...
    invoke-static {}, Lcom/android/server/wm/x/cno;->wtn()V
...
.method public handleStatusbarForStartingWindow(Landroid/view/View;Ljava/lang/String;)V
    ...
    :cond_0
    invoke-static {p2}, Lcom/android/server/wm/x/cno;->kth(Ljava/lang/String;)Z
...
.method public init(Lcom/android/server/wm/WindowManagerService;)V
    ...
    iput-object p1, p0, Lcom/android/server/wm/q;->bio:Lcom/android/server/wm/WindowManagerService;
    ...
    :cond_0
    new-instance p1, Lcom/android/server/wm/x/rtg;

    sget-object v0, Lcom/android/server/wm/hmo;->zta:Lcom/android/server/wm/hmo;

    invoke-direct {p1, v0}, Lcom/android/server/wm/x/rtg;-><init>(Lcom/android/server/wm/x/rtg$tsu;)V

    iput-object p1, p0, Lcom/android/server/wm/q;->gck:Lcom/android/server/wm/x/rtg;

    new-instance v0, Lcom/android/server/wm/x/tsu;

    invoke-direct {v0, p1}, Lcom/android/server/wm/x/tsu;-><init>(Lcom/android/server/wm/x/rtg;)V

    iput-object v0, p0, Lcom/android/server/wm/q;->wtn:Lcom/android/server/wm/x/tsu;

    new-instance p1, Lcom/android/server/wm/x/sis;

    iget-object v0, p0, Lcom/android/server/wm/q;->bio:Lcom/android/server/wm/WindowManagerService;

    iget-object v1, p0, Lcom/android/server/wm/q;->wtn:Lcom/android/server/wm/x/tsu;

    invoke-direct {p1, v0, v1}, Lcom/android/server/wm/x/sis;-><init>(Lcom/android/server/wm/WindowManagerService;Lcom/android/server/wm/x/tsu;)V

    iput-object p1, p0, Lcom/android/server/wm/q;->igw:Lcom/android/server/wm/x/sis;

    iget-object p1, p0, Lcom/android/server/wm/q;->gck:Lcom/android/server/wm/x/rtg;

    invoke-virtual {p1}, Lcom/android/server/wm/x/rtg;->vdb()V

    invoke-static {}, Lcom/android/server/wm/x/you;->rtg()Lcom/android/server/wm/x/you;
    ...
    invoke-virtual {p1, p0}, Lcom/android/server/wm/x/you;->cno(Landroid/content/Context;)V
...
.method public interceptRemoveStartingWindow(Ljava/lang/String;Landroid/os/Handler;Lcom/android/server/policy/WindowManagerPolicy$StartingSurface;)Z
    ...
    :cond_1
    sget-object v0, Lcom/android/server/wm/x/zta;->igw:Ljava/util/Map;
    ...
    iget-object p1, p0, Lcom/android/server/wm/q;->cno:Ljava/lang/Runnable;

    invoke-virtual {p2, p1}, Landroid/os/Handler;->removeCallbacks(Ljava/lang/Runnable;)V

    new-instance p1, Lcom/android/server/wm/x/ssp;

    invoke-direct {p1, p3}, Lcom/android/server/wm/x/ssp;-><init>(Lcom/android/server/policy/WindowManagerPolicy$StartingSurface;)V

    iput-object p1, p0, Lcom/android/server/wm/q;->cno:Ljava/lang/Runnable;
...
.method public preloadAppSplash(ILandroid/content/pm/ActivityInfo;Ljava/lang/String;)V
    ...
    iput-object v0, p0, Lcom/android/server/wm/q;->ywr:Ljava/lang/String;
    ...
    :goto_0
    invoke-static {p1}, Lcom/android/server/wm/x/cno;->bio(Ljava/lang/String;)Z
    ...
    invoke-static {p1}, Lcom/android/server/wm/x/cno;->kth(Ljava/lang/String;)Z
    ...
    iput-object p2, p0, Lcom/android/server/wm/q;->ywr:Ljava/lang/String;
    ...
    invoke-virtual {v0, v1, p0, p1, p2}, Lcom/android/server/wm/x/sis;->gck(ILandroid/content/Context;Ljava/lang/String;Ljava/lang/String;)V
...
.method public putSnapshot(Lcom/android/server/wm/ActivityRecord;)V
    ...
    :cond_0
    iget-boolean v0, p0, Lcom/android/server/wm/q;->ssp:Z

    const/4 v1, 0x1

    iput-boolean v1, p0, Lcom/android/server/wm/q;->ssp:Z

    iget-boolean v2, p0, Lcom/android/server/wm/q;->oif:Z
    ...
    iput-boolean v3, p0, Lcom/android/server/wm/q;->oif:Z
    ...
    :cond_5
    sget-object v1, Lcom/android/server/wm/x/zta;->bio:Landroid/util/ArrayMap;
    ...
    :cond_8
    iget-boolean v1, p0, Lcom/android/server/wm/q;->tsu:Z
    ...
    iput v3, p0, Lcom/android/server/wm/q;->zta:I

    const/4 p1, 0x0

    iput-object p1, p0, Lcom/android/server/wm/q;->ywr:Ljava/lang/String;

    return-void

    :cond_9
    :goto_0
    sget-object v1, Lcom/android/server/wm/x/zta;->wtn:Landroid/util/ArrayMap;
    ...
    invoke-direct {p0}, Lcom/android/server/wm/q;->ssp()V
    ...
    iget-object v1, p0, Lcom/android/server/wm/q;->rtg:Ljava/util/concurrent/ExecutorService;

    new-instance v2, Lcom/android/server/wm/q$zta;

    invoke-direct {v2, p0, p1, v0}, Lcom/android/server/wm/q$zta;-><init>(Lcom/android/server/wm/q;Lcom/android/server/wm/ActivityRecord;Ljava/lang/String;)V
...
.method public reviseWindowFlagsForStarting(Lcom/android/server/wm/ActivityRecord;ZZZZ)V
    ...
    invoke-static {v2}, Lcom/android/server/wm/x/cno;->ssp(Ljava/lang/String;)V

    iput-boolean v0, p0, Lcom/android/server/wm/q;->tsu:Z

    iput-boolean v0, p0, Lcom/android/server/wm/q;->sis:Z

    iget-boolean v2, p0, Lcom/android/server/wm/q;->kth:Z
    ...
    :cond_1
    iget-boolean v0, p0, Lcom/android/server/wm/q;->bvj:Z
    ...
    invoke-static {p5}, Lcom/android/server/wm/x/cno;->bio(Ljava/lang/String;)Z
    ...
    iget-boolean v2, p0, Lcom/android/server/wm/q;->sis:Z
    ...
    invoke-static {p5}, Lcom/android/server/wm/x/cno;->ssp(Ljava/lang/String;)V

    iget-boolean p5, p0, Lcom/android/server/wm/q;->sis:Z

    const/4 v0, 0x1

    if-nez p5, :cond_6

    iget-object p5, p0, Lcom/android/server/wm/q;->ywr:Ljava/lang/String;
    ...
    invoke-static {p5}, Lcom/android/server/wm/x/cno;->kth(Ljava/lang/String;)Z
    ...
    invoke-static {p5}, Lcom/android/server/wm/x/cno;->sis(Ljava/lang/String;)Z
    ...
    :cond_9
    iget-object p5, p0, Lcom/android/server/wm/q;->qbh:Lcom/android/server/wm/ActivityRecord;

    if-nez p5, :cond_a

    const-string p3, "special \tmTopFocusedActivity == null;  modify taskSwitch = true"

    invoke-static {p3}, Lcom/android/server/wm/x/cno;->ssp(Ljava/lang/String;)V
    ...
    invoke-static {p1}, Lcom/android/server/wm/x/cno;->zta(Ljava/lang/String;)Z
...
.method public setAppTransit(I)V
    ...
    :cond_0
    iput p1, p0, Lcom/android/server/wm/q;->you:I
...
.method public setFocusedTopActivity(Lcom/android/server/wm/ActivityRecord;)V
    ...
    :cond_0
    iput-object p1, p0, Lcom/android/server/wm/q;->qbh:Lcom/android/server/wm/ActivityRecord;
...
.method public setFromRecentState(Z)V
    ...
    iput-boolean p1, p0, Lcom/android/server/wm/q;->bvj:Z
...
.method public setStartingWindowExitAnimation(Lcom/android/server/wm/WindowState;)Z
    ...
    :cond_1
    invoke-direct {p0, p1}, Lcom/android/server/wm/q;->kth(Lcom/android/server/wm/WindowState;)Landroid/view/animation/Animation;
