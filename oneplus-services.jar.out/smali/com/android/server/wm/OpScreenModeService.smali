...
# static fields
.field static final ADFR_OFF:I = 0x0

.field static final ADFR_ON:I = 0x1

.field private static final CONFIG_NAME_SCREEN_MODE:Ljava/lang/String; = "ScreenMode"

.field static final CONTENT_TYPE_DEFAULT:I = 0x0

.field static final CONTENT_TYPE_GAME:I = 0x1

.field static final CONTENT_TYPE_VIEDO:I = 0x2
...
.field public static final REFRESH_RATE_ID_120:I = 0x3

.field public static final REFRESH_RATE_ID_60:I = 0x2

.field public static final REFRESH_RATE_ID_90:I = 0x1

.field public static final REFRESH_RATE_SAVEPOWER:I = 0x1

.field private static final RESOLUTION_2K:I = 0x3

.field private static final RESOLUTION_720:I = 0x4

.field private static final RESOLUTION_AUTO:I = 0x2

.field private static final RESOLUTION_FHD:I = 0x2

.field private static final RESOLUTION_HIGH:I = 0x0

.field private static final RESOLUTION_LOW:I = 0x1

.field static final TAG:Ljava/lang/String; = "OpScreenModeService"
...
.field private mADFRpkgs:Ljava/util/ArrayList;
...
.field mContentTypePkgs:Ljava/util/HashMap;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/HashMap<",
            "Ljava/lang/String;",
...
.field mLowResolution:I

.field mLowResolutionId:I
...
.method public constructor <init>()V
    ...
    iput v2, p0, Lcom/android/server/wm/OpScreenModeService;->mScreenRateSettings:I

    iput v0, p0, Lcom/android/server/wm/OpScreenModeService;->mResolotionSettings:I

    const/4 v2, 0x3

    iput v2, p0, Lcom/android/server/wm/OpScreenModeService;->mResolotionId:I
    ...
    iput v3, p0, Lcom/android/server/wm/OpScreenModeService;->mLowResolution:I

    const/high16 v3, -0x40800000    # -1.0f

    iput v3, p0, Lcom/android/server/wm/OpScreenModeService;->mHighRate:F

    const v3, 0x47c35000    # 100000.0f

    iput v3, p0, Lcom/android/server/wm/OpScreenModeService;->mLowRate:F

    iput v2, p0, Lcom/android/server/wm/OpScreenModeService;->mHighResolutionId:I

    iput v2, p0, Lcom/android/server/wm/OpScreenModeService;->mLowResolutionId:I

    iput v2, p0, Lcom/android/server/wm/OpScreenModeService;->mHighRateId:I

    iput v2, p0, Lcom/android/server/wm/OpScreenModeService;->mLowRateId:I
    ...
    iput v0, p0, Lcom/android/server/wm/OpScreenModeService;->mADFRState:I

    new-instance v3, Ljava/util/ArrayList;

    invoke-direct {v3}, Ljava/util/ArrayList;-><init>()V

    iput-object v3, p0, Lcom/android/server/wm/OpScreenModeService;->mADFRpkgs:Ljava/util/ArrayList;

    iput v0, p0, Lcom/android/server/wm/OpScreenModeService;->mContentType:I

    new-instance v3, Ljava/util/HashMap;

    invoke-direct {v3}, Ljava/util/HashMap;-><init>()V

    iput-object v3, p0, Lcom/android/server/wm/OpScreenModeService;->mContentTypePkgs:Ljava/util/HashMap;
    ...
    const-string v0, "OpScreenModeService"
...
.method private handleUpdateScenario(I)V
    ...
    const-string p1, "OpScreenModeService"
...
.method private invokeGameSpeedLogic(Lcom/android/server/wm/ActivityRecord;II)I
    ...
    const-string p0, "OpScreenModeService"
...
.method private resolveConfigFromJSON(Lorg/json/JSONArray;)V
    ...
    const-string v1, "OpScreenModeService"
    ...
    iget-object v0, p0, Lcom/android/server/wm/OpScreenModeService;->mADFRpkgs:Ljava/util/ArrayList;

    invoke-virtual {v0}, Ljava/util/ArrayList;->clear()V

    iget-object v0, p0, Lcom/android/server/wm/OpScreenModeService;->mContentTypePkgs:Ljava/util/HashMap;
    ...
    const-string v3, "OpScreenModeService"
    ...
    const-string v2, "OpScreenModeService"
    ...
    iget-object v4, p0, Lcom/android/server/wm/OpScreenModeService;->mADFRpkgs:Ljava/util/ArrayList;
    ...
    :try_start_9
    iget-object v5, p0, Lcom/android/server/wm/OpScreenModeService;->mADFRpkgs:Ljava/util/ArrayList;
    ...
    const-string v4, "After update mADFRpkgs # "
    ...
    iget-object v6, p0, Lcom/android/server/wm/OpScreenModeService;->mContentTypePkgs:Ljava/util/HashMap;
    ...
    :try_start_b
    iget-object v7, p0, Lcom/android/server/wm/OpScreenModeService;->mContentTypePkgs:Ljava/util/HashMap;
...
.method private updateDynamicVsync(I)V
    ...
    :goto_0
    invoke-virtual {p1, p0}, Lcom/oneplus/server/zta;->G(Z)V
...
.method private updateRefreshRate(Lcom/android/server/wm/ActivityRecord;)V
    ...
    iget v2, p0, Lcom/android/server/wm/OpScreenModeService;->mLowRateId:I
...
.method adjustDensityForResolution(III)I
    ...
    iget v0, p0, Lcom/android/server/wm/OpScreenModeService;->mHighRateId:I
...
.method public adjustDensityForUser(II)I
    ...
    const-string v1, " mResolotionId "

    invoke-virtual {v0, v1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget v1, p0, Lcom/android/server/wm/OpScreenModeService;->mResolotionId:I
    ...
    :cond_1
    iget v0, p0, Lcom/android/server/wm/OpScreenModeService;->mResolotionId:I
...
.method adjustRate(I)I
    ...
    iget p0, p0, Lcom/android/server/wm/OpScreenModeService;->mHighRateId:I

    return p0

    :cond_0
    iget p0, p0, Lcom/android/server/wm/OpScreenModeService;->mLowRateId:I

    return p0
.end method

.method adjustResolution(I)I
    .locals 1
    ...
    iget p0, p0, Lcom/android/server/wm/OpScreenModeService;->mHighResolutionId:I

    return p0

    :cond_0
    iget p0, p0, Lcom/android/server/wm/OpScreenModeService;->mLowResolutionId:I

    return p0
.end method

.method dismissADFR(Lcom/android/server/wm/WindowState;)Z
    .locals 0
    ...
    invoke-virtual {p1}, Lcom/android/server/wm/WindowState;->inSplitScreenPrimaryWindowingMode()Z

    move-result p0

    if-nez p0, :cond_1

    invoke-virtual {p1}, Lcom/android/server/wm/WindowState;->inSplitScreenSecondaryWindowingMode()Z
...
.method getModeRecord(II)Lcom/android/server/wm/OpScreenModeService$sis;
    ...
    invoke-virtual {p0, v0}, Lcom/android/server/wm/OpScreenModeService;->adjustRate(I)I
...
.method getPackageRate(ILcom/android/server/wm/ActivityRecord;)I
    ...
    iget p1, p2, Lcom/android/server/wm/ActivityRecord;->mTmpRefreshRate:I

    iget v1, p0, Lcom/android/server/wm/OpScreenModeService;->mLowRateId:I
    ...
    :cond_1
    :goto_0
    iget-object v1, p0, Lcom/android/server/wm/OpScreenModeService;->mFixedRatePackage:Ljava/util/HashMap;

    iget-object v2, p2, Lcom/android/server/wm/ActivityRecord;->mActivityName:Ljava/lang/String;
    ...
    iget-object v2, p2, Lcom/android/server/wm/ActivityRecord;->mPackageName:Ljava/lang/String;
    ...
    invoke-virtual {p0, p1}, Lcom/android/server/wm/OpScreenModeService;->adjustRate(I)I
    ...
    :cond_3
    iput-boolean v0, p2, Lcom/android/server/wm/ActivityRecord;->mFixedRate:Z
    ...
    iget p2, p0, Lcom/android/server/wm/OpScreenModeService;->mLowRate:F
    ...
    iget p2, p0, Lcom/android/server/wm/OpScreenModeService;->mHighRate:F
    ...
    invoke-virtual {p0, p1}, Lcom/android/server/wm/OpScreenModeService;->refreshRateToId(F)I
...
.method public getPreferredModeId(Lcom/android/server/wm/WindowState;I)I
    ...
    :cond_0
    invoke-virtual {p0, p1}, Lcom/android/server/wm/OpScreenModeService;->dismissADFR(Lcom/android/server/wm/WindowState;)Z

    move-result v0

    if-eqz v0, :cond_1

    iput v1, p0, Lcom/android/server/wm/OpScreenModeService;->mADFRState:I
    ...
    sget-boolean p2, Lcom/android/server/wm/WindowManagerDebugConfig;->DEBUG_LAYOUT:Z
    ...
    :cond_4
    :goto_2
    iget p1, p0, Lcom/android/server/wm/OpScreenModeService;->mHighRateId:I

    iget p2, p0, Lcom/android/server/wm/OpScreenModeService;->mResolotionId:I
    ...
    iget v4, p0, Lcom/android/server/wm/OpScreenModeService;->mLowRateId:I
    ...
    :cond_6
    :goto_5
    iget p1, p0, Lcom/android/server/wm/OpScreenModeService;->mLowRateId:I

    iget p2, p0, Lcom/android/server/wm/OpScreenModeService;->mResolotionId:I

    invoke-virtual {p0, p1, p2}, Lcom/android/server/wm/OpScreenModeService;->getModeRecord(II)Lcom/android/server/wm/OpScreenModeService$sis;
    ...
    const-string p1, " use candidate modeId="
    ...
    invoke-virtual {p0, v1, p2}, Lcom/android/server/wm/OpScreenModeService;->getModeRecord(II)Lcom/android/server/wm/OpScreenModeService$sis;
    ...
    iget-object p1, p2, Lcom/android/server/wm/OpScreenModeService$sis;->zta:Landroid/view/Display$Mode;

    invoke-virtual {v0, p1}, Ljava/lang/StringBuilder;->append(Ljava/lang/Object;)Ljava/lang/StringBuilder;

    const-string p1, " rateId "

    invoke-virtual {v0, p1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v0, v1}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    const-string p1, " resolutionId "

    invoke-virtual {v0, p1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget p0, p0, Lcom/android/server/wm/OpScreenModeService;->mResolotionId:I
    ...
    :cond_10
    iget-object p0, p2, Lcom/android/server/wm/OpScreenModeService$sis;->zta:Landroid/view/Display$Mode;
...
.method idToRefreshRate(I)F
    ...
    iget p0, p0, Lcom/android/server/wm/OpScreenModeService;->mLowRate:F
...
.method public init(Lcom/android/server/wm/WindowManagerService;Landroid/content/Context;)V
    ...
    :cond_0
    iget p1, p0, Lcom/android/server/wm/OpScreenModeService;->mHighResolution:I

    invoke-virtual {p0, p1}, Lcom/android/server/wm/OpScreenModeService;->resolutionToId(I)I

    move-result p1

    iput p1, p0, Lcom/android/server/wm/OpScreenModeService;->mHighResolutionId:I

    iget p1, p0, Lcom/android/server/wm/OpScreenModeService;->mLowResolution:I

    invoke-virtual {p0, p1}, Lcom/android/server/wm/OpScreenModeService;->resolutionToId(I)I

    move-result p1

    iput p1, p0, Lcom/android/server/wm/OpScreenModeService;->mLowResolutionId:I

    iget p1, p0, Lcom/android/server/wm/OpScreenModeService;->mHighRate:F

    invoke-virtual {p0, p1}, Lcom/android/server/wm/OpScreenModeService;->refreshRateToId(F)I

    move-result p1

    iput p1, p0, Lcom/android/server/wm/OpScreenModeService;->mHighRateId:I

    iget p1, p0, Lcom/android/server/wm/OpScreenModeService;->mLowRate:F

    invoke-virtual {p0, p1}, Lcom/android/server/wm/OpScreenModeService;->refreshRateToId(F)I

    move-result p1

    iput p1, p0, Lcom/android/server/wm/OpScreenModeService;->mLowRateId:I

    new-instance p1, Ljava/lang/StringBuilder;

    invoke-direct {p1}, Ljava/lang/StringBuilder;-><init>()V

    const-string v0, "init: high rate "

    invoke-virtual {p1, v0}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget v0, p0, Lcom/android/server/wm/OpScreenModeService;->mHighRate:F
    ...
    iget v1, p0, Lcom/android/server/wm/OpScreenModeService;->mHighRateId:I

    invoke-virtual {p1, v1}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    const-string v1, " low rate "

    invoke-virtual {p1, v1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget v1, p0, Lcom/android/server/wm/OpScreenModeService;->mLowRate:F
    ...
    const-string v1, " high resolution "
    ...
    iget v1, p0, Lcom/android/server/wm/OpScreenModeService;->mHighResolutionId:I

    invoke-virtual {p1, v1}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    const-string v1, " low resolution "

    invoke-virtual {p1, v1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget v1, p0, Lcom/android/server/wm/OpScreenModeService;->mLowResolution:I

    invoke-virtual {p1, v1}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    invoke-virtual {p1, v0}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget v0, p0, Lcom/android/server/wm/OpScreenModeService;->mLowResolutionId:I
...
.method initOnlineConfig()V
    ...
    new-instance v1, Lcom/android/server/wm/obl;

    invoke-direct {v1, p0}, Lcom/android/server/wm/obl;-><init>(Lcom/android/server/wm/OpScreenModeService;)V
...
.method public onRecordingConfigChanged(Ljava/util/List;)V
    ...
    invoke-static {}, Lcom/android/server/am/cgv;->bvj()Lcom/android/server/am/cgv;
    ...
    invoke-virtual {v0, p1}, Lcom/android/server/am/cgv;->a(Ljava/util/List;)V
    ...
    invoke-direct {v1, p0}, Lcom/android/server/wm/zgw;-><init>(Lcom/android/server/wm/OpScreenModeService;)V
...
.method public setRefreshRate(Lcom/android/server/wm/ActivityRecord;I)V
    ...
    const-string v4, " request refresh rate="

    invoke-virtual {v2, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v2, v1}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    const-string v4, " tmpRate "
    ...
    const-string v4, "OpScreenModeService"
    ...
    const-string v2, " app request rateid="

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget v2, p1, Lcom/android/server/wm/ActivityRecord;->mTmpRefreshRate:I
    ...
    invoke-virtual {p0, v2}, Lcom/android/server/wm/OpScreenModeService;->idToRefreshRate(I)F
    ...
    iget v2, p0, Lcom/android/server/wm/OpScreenModeService;->mHighRateId:I
...
.method setResolution()V
    ...
    iput v4, p0, Lcom/android/server/wm/OpScreenModeService;->mResolotionSettings:I
    ...
    invoke-virtual {p0, v1}, Lcom/android/server/wm/OpScreenModeService;->adjustResolution(I)I

    move-result v1

    iput v1, p0, Lcom/android/server/wm/OpScreenModeService;->mResolotionId:I

    iget v5, p0, Lcom/android/server/wm/OpScreenModeService;->mHighResolutionId:I

    const-string v6, "persist.sys.resolution_change"
    ...
    :goto_2
    sput-boolean v5, Lcom/android/server/wm/OpScreenModeService;->sIsResolution2K:Z
    ...
    sput-boolean v4, Lcom/android/server/wm/OpScreenModeService;->sIsResolutionAuto:Z
...
.method public updateGlobalModeId(I)I
    ...
    const-string v4, "may updateGlobalModeId: new mode="
    ...
    iget v4, v2, Lcom/android/server/wm/OpScreenModeService$sis;->sis:I

    iget v5, p0, Lcom/android/server/wm/OpScreenModeService;->mResolotionId:I
    ...
    const-string v4, "request resolution "
    ...
    const-string v4, " not equal with setting "

    invoke-virtual {p1, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget v4, p0, Lcom/android/server/wm/OpScreenModeService;->mResolotionId:I
    ...
    iget v2, p0, Lcom/android/server/wm/OpScreenModeService;->mResolotionId:I
    ...
    iget-object v4, p0, Lcom/android/server/wm/OpScreenModeService;->mDisplayContent:Lcom/android/server/wm/DisplayContent;

    iget-object v4, v4, Lcom/android/server/wm/DisplayContent;->mFocusedApp:Lcom/android/server/wm/ActivityRecord;

    if-eqz v4, :cond_7

    iget-object v4, v4, Lcom/android/server/wm/ActivityRecord;->mPackageName:Ljava/lang/String;
    ...
    const-string v4, "use tgpa refresh rate="

    invoke-virtual {v2, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget v4, p0, Lcom/android/server/wm/OpScreenModeService;->mTgpaFrameRate:I
    ...
    const-string v4, "updateGlobalModeId  new mode="

    invoke-virtual {v2, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v2, v0}, Ljava/lang/StringBuilder;->append(Ljava/lang/Object;)Ljava/lang/StringBuilder;

    const-string v0, " new ModeId="

    invoke-virtual {v2, v0}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v2, p1}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    const-string p1, " old ModeId="
...
.method public updateKeepHighVsync(Z)V
    ...
    invoke-virtual {v1, p1}, Lcom/oneplus/server/zta;->M(Z)V
