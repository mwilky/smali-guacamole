...
.field private static final OPPERF_FILE:Ljava/lang/String; = "/system_ext/etc/opperf.xml"
...
.method private constructor <init>()V
    ...
    new-instance v2, Lcom/android/server/wm/OnePlusPerfManager$rtg;
    ...
    invoke-direct {v2, v4, v0, v5, v3}, Lcom/android/server/wm/OnePlusPerfManager$rtg;-><init>(Ljava/lang/String;ILjava/lang/String;I)V

    iput-object v2, p0, Lcom/android/server/wm/OnePlusPerfManager;->currentSPI:Lcom/android/server/wm/OnePlusPerfManager$rtg;
    ...
    iput-object v1, p0, Lcom/android/server/wm/OnePlusPerfManager;->mPerfHandler:Lcom/android/server/wm/OnePlusPerfManager$tsu;
    ...
    invoke-direct {v0, p0, v1}, Lcom/android/server/wm/OnePlusPerfManager$tsu;-><init>(Lcom/android/server/wm/OnePlusPerfManager;Landroid/os/Looper;)V
...
.method static synthetic access$400(Lcom/android/server/wm/OnePlusPerfManager;Ljava/lang/String;)Z
    .locals 0
...
.method static synthetic access$500(Lcom/android/server/wm/OnePlusPerfManager;IZ)V
    .locals 0
...
.method static synthetic access$600(Lcom/android/server/wm/OnePlusPerfManager;Z)V
    .locals 0
...
.method static synthetic access$800(Lcom/android/server/wm/OnePlusPerfManager;Lorg/json/JSONArray;)V
    .locals 0
...
.method private finishSpeedSchedtune(Ljava/lang/String;)V
    ...
    invoke-virtual {v1, p1}, Lcom/android/server/wm/OnePlusPerfManager$ssp;->you(Ljava/lang/String;)Z
...
.method private getPkgPerfLock(Ljava/lang/String;)I
    ...
    iget-object v2, p0, Lcom/android/server/wm/OnePlusPerfManager$you;->sis:Ljava/lang/String;
    ...
    iget p0, p0, Lcom/android/server/wm/OnePlusPerfManager$you;->you:I
...
.method private mayPerfRelease()Z
    ...
    iget-object v1, v1, Lcom/android/server/wm/OnePlusPerfManager$rtg;->zta:Ljava/lang/String;
    ...
    iget v1, v1, Lcom/android/server/wm/OnePlusPerfManager$rtg;->you:I
    ...
    invoke-virtual {p0}, Lcom/android/server/wm/OnePlusPerfManager$rtg;->zta()V
    ...
    iget-object v4, v4, Lcom/android/server/wm/OnePlusPerfManager$rtg;->sis:Ljava/lang/String;
    ...
    iget-object v1, v1, Lcom/android/server/wm/OnePlusPerfManager$rtg;->sis:Ljava/lang/String;

    invoke-virtual {v2, v1}, Lcom/android/server/wm/OnePlusPerfManager$ssp;->you(Ljava/lang/String;)Z
...
.method private perfAcquire(Lcom/android/server/wm/OnePlusPerfManager$rtg;I)Z
    ...
    iget p2, p1, Lcom/android/server/wm/OnePlusPerfManager$rtg;->you:I
    ...
    iget-object p2, p2, Lcom/android/server/wm/OnePlusPerfManager$rtg;->sis:Ljava/lang/String;

    iget-object v1, p1, Lcom/android/server/wm/OnePlusPerfManager$rtg;->sis:Ljava/lang/String;
    ...
    iget-object v4, p1, Lcom/android/server/wm/OnePlusPerfManager$rtg;->sis:Ljava/lang/String;
    ...
    invoke-virtual {v1}, Lcom/android/server/wm/OnePlusPerfManager$sis;->zta()[I
    ...
    :try_start_6
    iget-object p2, p1, Lcom/android/server/wm/OnePlusPerfManager$rtg;->sis:Ljava/lang/String;

    invoke-virtual {v1, p2}, Lcom/android/server/wm/OnePlusPerfManager$ssp;->sis(Ljava/lang/String;)Z
    ...
    invoke-virtual {p0, p1}, Lcom/android/server/wm/OnePlusPerfManager$rtg;->you(Lcom/android/server/wm/OnePlusPerfManager$rtg;)V
...
.method private readXml()I
    ...
    const-string v1, "/system_ext/etc/opperf.xml"
...
.method private resolvePerfConfigFromJSON(Lorg/json/JSONArray;)V
    ...
    :cond_4
    iput v6, v8, Lcom/android/server/wm/OnePlusPerfManager$you;->you:I

    iput-object v4, v8, Lcom/android/server/wm/OnePlusPerfManager$you;->sis:Ljava/lang/String;
    ...
    iput v4, v9, Lcom/android/server/wm/OnePlusPerfManager$rtg;->tsu:I
...
.method private startSpeedSchedtune(Ljava/lang/String;)V
    ...
    iget v1, p1, Lcom/android/server/wm/OnePlusPerfManager$rtg;->you:I
    ...
    invoke-virtual {v1, v0}, Lcom/android/server/wm/OnePlusPerfManager$ssp;->sis(Ljava/lang/String;)Z
...
.method public acquirePccore()V
    ...
    check-cast p0, Lcom/android/server/wm/OnePlusPerfManager$ssp;
    ...
    invoke-virtual {p0, v0}, Lcom/android/server/wm/OnePlusPerfManager$ssp;->sis(Ljava/lang/String;)Z
...
.method public autoAcquireOrRelease(Z)Z
    ...
    iget-object v0, v0, Lcom/android/server/wm/OnePlusPerfManager$rtg;->zta:Ljava/lang/String;
...
.method public frontPackageChanged(Ljava/lang/String;IILjava/lang/String;II)V
    ...
    new-instance p3, Lcom/android/server/wm/ibl;

    invoke-direct {p3, p0, p1}, Lcom/android/server/wm/ibl;-><init>(Lcom/android/server/wm/OnePlusPerfManager;Ljava/lang/String;)V
...
.method public isUsingPccore(Ljava/lang/String;)Z
    ...
    iget p0, p1, Lcom/android/server/wm/OnePlusPerfManager$rtg;->you:I

    const/4 v2, 0x5

    if-ne p0, v2, :cond_1

    iget-object p0, p1, Lcom/android/server/wm/OnePlusPerfManager$rtg;->sis:Ljava/lang/String;
...
.method public mayChangeInodeIndex(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object p1, p1, Lcom/android/server/wm/OnePlusPerfManager$you;->sis:Ljava/lang/String;
...
.method public releasePccore()V
    ...
    invoke-virtual {p0, v0}, Lcom/android/server/wm/OnePlusPerfManager$ssp;->you(Ljava/lang/String;)Z
...
.method public screenFrozenBoost(Z)V
    ...
    new-instance v1, Lcom/android/server/wm/gwm;

    invoke-direct {v1, p0}, Lcom/android/server/wm/gwm;-><init>(Lcom/android/server/wm/OnePlusPerfManager;)V
