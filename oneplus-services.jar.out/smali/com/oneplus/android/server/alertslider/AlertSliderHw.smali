...
.method private static igw(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Z
    .locals 7
...
.method private static kth(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    .locals 6
...
.method private rtg()Z
    ...
    const-string v0, "/mnt/vendor/persist/engineermode/tri_state_hall_data"

    invoke-static {p0, v0}, Lcom/oneplus/android/server/alertslider/AlertSliderHw;->kth(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p0, v2, v0}, Lcom/oneplus/android/server/alertslider/AlertSliderHw;->igw(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Z
...
.method static synthetic tsu(Lcom/oneplus/android/server/alertslider/AlertSliderHw;I)V
    ...
    invoke-direct {p0, p1}, Lcom/oneplus/android/server/alertslider/AlertSliderHw;->bio(I)V
...
.method public cno()Z
    ...
    iget-object v0, p0, Lcom/oneplus/android/server/alertslider/AlertSliderHw;->you:Lcom/oneplus/android/server/alertslider/AlertSliderHw$zta;

    invoke-virtual {v0}, Lcom/oneplus/android/server/alertslider/AlertSliderHw$zta;->zta()V

    invoke-direct {p0}, Lcom/oneplus/android/server/alertslider/AlertSliderHw;->rtg()Z

    :try_start_0
    invoke-virtual {p0}, Lcom/oneplus/android/server/alertslider/AlertSliderHw;->ssp()I
    ...
    :try_start_1
    iget-object v1, p0, Lcom/oneplus/android/server/alertslider/AlertSliderHw;->tsu:Lcom/oneplus/android/server/alertslider/zta;

    invoke-virtual {v1, v0}, Lcom/oneplus/android/server/alertslider/zta;->you(I)V
    :try_end_1
    ...
    iput-object v1, p0, Lcom/oneplus/android/server/alertslider/AlertSliderHw;->tsu:Lcom/oneplus/android/server/alertslider/zta;
    ...
    :cond_0
    invoke-direct {p0, v0}, Lcom/oneplus/android/server/alertslider/AlertSliderHw;->bio(I)V
