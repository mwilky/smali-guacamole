.class public final Lcom/android/server/oif;
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/android/server/oif;->wtn:Z
    ...
    sput-boolean v0, Lcom/android/server/oif;->gck:Z
    ...
    const-string v8, "/mnt/vendor/op1/"

    filled-new-array/range {v1 .. v8}, [Ljava/lang/String;

    move-result-object v0

    sput-object v0, Lcom/android/server/oif;->oif:[Ljava/lang/String;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/server/oif;->zta:Ljava/util/HashMap;

    const/4 v0, 0x0

    iput v0, p0, Lcom/android/server/oif;->rtg:I

    iput v0, p0, Lcom/android/server/oif;->ssp:I

    iput-boolean v0, p0, Lcom/android/server/oif;->cno:Z

    new-instance v1, Lcom/android/server/oif$zta;

    invoke-direct {v1, p0}, Lcom/android/server/oif$zta;-><init>(Lcom/android/server/oif;)V

    iput-object v1, p0, Lcom/android/server/oif;->bio:Landroid/content/BroadcastReceiver;
...
.method static synthetic bio()[Ljava/lang/String;
    ...
    sget-object v0, Lcom/android/server/oif;->oif:[Ljava/lang/String;
...
.method private bvj()V
    ...
    sget-boolean v0, Lcom/android/server/oif;->gck:Z
    ...
    :cond_0
    iget-boolean v0, p0, Lcom/android/server/oif;->cno:Z

    if-eqz v0, :cond_2

    :try_start_0
    iget-object v0, p0, Lcom/android/server/oif;->kth:Landroid/content/Context;

    iget-object v2, p0, Lcom/android/server/oif;->bio:Landroid/content/BroadcastReceiver;
    ...
    :goto_0
    iget-object v0, p0, Lcom/android/server/oif;->tsu:Landroid/content/pm/PackageInstaller$Session;
    ...
    iget-boolean p0, p0, Lcom/android/server/oif;->cno:Z
...
.method static synthetic cno(Lcom/android/server/oif;)V
    .locals 0

    invoke-direct {p0}, Lcom/android/server/oif;->bvj()V
...
.method private dma(Ljava/lang/String;)V
    ...
    iget p1, p0, Lcom/android/server/oif;->ssp:I

    if-nez p1, :cond_3

    iget-object p1, p0, Lcom/android/server/oif;->kth:Landroid/content/Context;

    invoke-virtual {p1}, Landroid/content/Context;->getPackageManager()Landroid/content/pm/PackageManager;

    move-result-object p1

    iput-object p1, p0, Lcom/android/server/oif;->you:Landroid/content/pm/PackageManager;

    invoke-virtual {p1}, Landroid/content/pm/PackageManager;->getPackageInstaller()Landroid/content/pm/PackageInstaller;

    move-result-object p1

    iput-object p1, p0, Lcom/android/server/oif;->sis:Landroid/content/pm/PackageInstaller;
    ...
    sget-boolean v4, Lcom/android/server/oif;->gck:Z
    ...
    :cond_1
    invoke-direct {p0, v3}, Lcom/android/server/oif;->gck(Ljava/io/File;)V
...
.method private gck(Ljava/io/File;)V
    ...
    iget-object v1, p0, Lcom/android/server/oif;->kth:Landroid/content/Context;
    ...
    iget-object v2, p0, Lcom/android/server/oif;->you:Landroid/content/pm/PackageManager;
    ...
    :cond_1
    iget-object v1, p0, Lcom/android/server/oif;->you:Landroid/content/pm/PackageManager;
    ...
    :cond_2
    invoke-direct {p0, v2}, Lcom/android/server/oif;->oif(Landroid/content/pm/PackageInfo;)Z
    ...
    iget-object v2, p0, Lcom/android/server/oif;->zta:Ljava/util/HashMap;
    ...
    sget-boolean p0, Lcom/android/server/oif;->wtn:Z
    ...
    :cond_5
    sget-boolean v2, Lcom/android/server/oif;->wtn:Z
    ...
    :try_start_0
    invoke-direct {p0}, Lcom/android/server/oif;->qbh()V

    iget v2, p0, Lcom/android/server/oif;->ssp:I

    const/4 v4, 0x1

    add-int/2addr v2, v4

    iput v2, p0, Lcom/android/server/oif;->ssp:I

    iget-object v5, p0, Lcom/android/server/oif;->zta:Ljava/util/HashMap;
    ...
    iget-object v4, p0, Lcom/android/server/oif;->sis:Landroid/content/pm/PackageInstaller;
    ...
    iput-object v4, p0, Lcom/android/server/oif;->tsu:Landroid/content/pm/PackageInstaller$Session;
    ...
    :try_start_1
    iget-object v5, p0, Lcom/android/server/oif;->tsu:Landroid/content/pm/PackageInstaller$Session;
    ...
    :cond_7
    iget-object p1, p0, Lcom/android/server/oif;->tsu:Landroid/content/pm/PackageInstaller$Session;
    ...
    invoke-direct {p0, v2, v1}, Lcom/android/server/oif;->wtn(ILjava/lang/String;)Landroid/content/IntentSender;

    move-result-object v0

    invoke-virtual {p1, v0}, Landroid/content/pm/PackageInstaller$Session;->commit(Landroid/content/IntentSender;)V

    iget-object p0, p0, Lcom/android/server/oif;->tsu:Landroid/content/pm/PackageInstaller$Session;
...
.method private ibl()V
    ...
    sget-boolean v1, Lcom/android/server/oif;->gck:Z
    ...
    sget-boolean v1, Lcom/android/server/oif;->wtn:Z
    ...
    :cond_6
    :goto_1
    sget-boolean p0, Lcom/android/server/oif;->gck:Z
    ...
    :goto_2
    sget-boolean v4, Lcom/android/server/oif;->wtn:Z
...
.method static synthetic igw(Lcom/android/server/oif;Ljava/lang/String;)V
    .locals 0
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/Exception;
    ...
    invoke-direct {p0, p1}, Lcom/android/server/oif;->dma(Ljava/lang/String;)V

    return-void
.end method

.method static synthetic kth(Lcom/android/server/oif;)V
    .locals 0

    invoke-direct {p0}, Lcom/android/server/oif;->ibl()V
...
.method private oif(Landroid/content/pm/PackageInfo;)Z
    ...
    iget-object v3, p0, Lcom/android/server/oif;->you:Landroid/content/pm/PackageManager;
    ...
    iget-object p0, p0, Lcom/android/server/oif;->you:Landroid/content/pm/PackageManager;
    ...
    :cond_0
    sget-boolean v3, Lcom/android/server/oif;->gck:Z
...
.method private qbh()V
    ...
    iget-object v2, p0, Lcom/android/server/oif;->kth:Landroid/content/Context;

    iget-object v3, p0, Lcom/android/server/oif;->bio:Landroid/content/BroadcastReceiver;
...
.method static synthetic rtg(Lcom/android/server/oif;)Ljava/util/HashMap;
    .locals 0

    iget-object p0, p0, Lcom/android/server/oif;->zta:Ljava/util/HashMap;

    return-object p0
.end method

.method static synthetic sis(Lcom/android/server/oif;)I
    .locals 0

    iget p0, p0, Lcom/android/server/oif;->ssp:I
...
.method static synthetic tsu(Lcom/android/server/oif;)I
    .locals 2

    iget v0, p0, Lcom/android/server/oif;->ssp:I

    add-int/lit8 v1, v0, -0x1

    iput v1, p0, Lcom/android/server/oif;->ssp:I
...
.method private wtn(ILjava/lang/String;)Landroid/content/IntentSender;
    ...
    iget-object p0, p0, Lcom/android/server/oif;->kth:Landroid/content/Context;
...
.method static synthetic you()Z
    ...
    sget-boolean v0, Lcom/android/server/oif;->wtn:Z

    return v0
.end method

.method static synthetic zta(Lcom/android/server/oif;)Landroid/content/Context;
    .locals 0
...
.method public ywr(Landroid/content/Context;Ljava/lang/String;)V
    ...
    :cond_0
    iput-object p1, p0, Lcom/android/server/oif;->kth:Landroid/content/Context;
    ...
    invoke-direct {v0, p0, p2}, Lcom/android/server/oif$you;-><init>(Lcom/android/server/oif;Ljava/lang/String;)V
