.class public Lcom/android/server/wm/x/zta;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/server/wm/x/zta;->tsu:Ljava/util/Set;
    ...
    sput-object v3, Lcom/android/server/wm/x/zta;->rtg:Ljava/util/Set;
    ...
    sput-object v0, Lcom/android/server/wm/x/zta;->ssp:Ljava/util/Set;
    ...
    sput-object v4, Lcom/android/server/wm/x/zta;->cno:Ljava/util/Set;
    ...
    sput-object v4, Lcom/android/server/wm/x/zta;->kth:Ljava/util/Set;

    new-instance v4, Landroid/util/ArrayMap;

    invoke-direct {v4}, Landroid/util/ArrayMap;-><init>()V

    sput-object v4, Lcom/android/server/wm/x/zta;->bio:Landroid/util/ArrayMap;
    ...
    sget-object v4, Lcom/android/server/wm/x/zta;->bio:Landroid/util/ArrayMap;
    ...
    sput-object v4, Lcom/android/server/wm/x/zta;->igw:Ljava/util/Map;
    ...
    sget-object v3, Lcom/android/server/wm/x/zta;->igw:Ljava/util/Map;

    invoke-interface {v3, v1, v6}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    sget-object v1, Lcom/android/server/wm/x/zta;->igw:Ljava/util/Map;
    ...
    sput-object v1, Lcom/android/server/wm/x/zta;->wtn:Landroid/util/ArrayMap;
    ...
    sput-object v1, Lcom/android/server/wm/x/zta;->gck:Landroid/util/ArrayMap;
