...
.field public static remapAction:Ljava/lang/String;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/server/policy/OpPhoneWindowManager;->mFocusedWindow:Lcom/android/server/policy/WindowManagerPolicy$WindowState;
...
.method static synthetic access$1700(Lcom/android/server/policy/OpPhoneWindowManager;)V
    .locals 0
...
.method static synthetic access$1800(Lcom/android/server/policy/OpPhoneWindowManager;)Lcom/android/server/policy/ssp;
    .locals 0
...
.method static synthetic access$1900(Lcom/android/server/policy/OpPhoneWindowManager;)Z
    .locals 0
...
.method static synthetic access$1902(Lcom/android/server/policy/OpPhoneWindowManager;Z)Z
    .locals 0
...
.method static synthetic access$2000(Lcom/android/server/policy/OpPhoneWindowManager;)Lcom/android/server/policy/OpPhoneWindowManager$dma;
    .locals 0
...
.method public finishedGoingToSleep(I)V
    ...
    invoke-static {}, Lcom/android/server/am/hmo;->lqr()Lcom/android/server/am/hmo;
    ...
    invoke-virtual {p1, v0}, Lcom/android/server/am/hmo;->x(Z)V
    ...
    invoke-virtual {p0}, Lcom/android/server/policy/DeviceKeyHandler;->ire()V
...
.method public finishedWakingUp(I)V
    ...
    invoke-virtual {p0, p1}, Lcom/android/server/am/hmo;->x(Z)V
...
.method public init(Landroid/content/Context;Landroid/view/IWindowManager;Lcom/android/server/policy/WindowManagerPolicy$WindowManagerFuncs;)V
    ...
    iget p2, p0, Lcom/android/server/policy/PhoneWindowManager;->mVeryLongPressTimeout:I

    div-int/lit8 p3, p2, 0x6

    sub-int/2addr p2, p3

    iput p2, p0, Lcom/android/server/policy/OpPhoneWindowManager;->mHwShutdownTimeout:I
...
.method public interceptKeyBeforeDispatching(Landroid/os/IBinder;Landroid/view/KeyEvent;I)J
    ...
    sput-object v2, Lcom/android/server/policy/OpPhoneWindowManager;->remapAction:Ljava/lang/String;
    ...
    sget-boolean v14, Lcom/android/server/policy/OpPhoneWindowManager;->sDebugInput:Z
    ...
    const-string v11, " ++++++++++ interceptKeyBeforeDispatching "
    ...
    sget-object v11, Lcom/android/server/policy/OpPhoneWindowManager$zta;->zta:[I
    ...
    iget-object v4, v0, Lcom/android/server/policy/OpPhoneWindowManager;->mFocusedWindow:Lcom/android/server/policy/WindowManagerPolicy$WindowState;

    if-eqz v4, :cond_12

    invoke-interface {v4}, Lcom/android/server/policy/WindowManagerPolicy$WindowState;->getWindowingMode()I
    ...
    iget-object v9, v0, Lcom/android/server/policy/OpPhoneWindowManager;->mFocusedWindow:Lcom/android/server/policy/WindowManagerPolicy$WindowState;

    invoke-interface {v9}, Lcom/android/server/policy/WindowManagerPolicy$WindowState;->getStack()Lcom/android/server/wm/ActivityStack;

    move-result-object v9

    invoke-virtual {v4, v9}, Lcom/android/server/wm/ColorZoomWindowManagerService;->isMiniStack(Lcom/android/server/wm/ActivityStack;)Z
    ...
    const-string v1, "Skip back key when focus window in minizoom mode"
    ...
    iget-object v11, v0, Lcom/android/server/policy/OpPhoneWindowManager;->mUnpinRunnable:Ljava/lang/Runnable;
    ...
    const-string v2, "mDoubleTapOnHomeBehavior"
    ...
    const-string v2, "mDoubleTapOnBackBehavior"
    ...
    const-string v2, "mLongPressOnBackBehavior"
    ...
    const-string v2, "mDoubleTapOnAppSwitchBehavior"
    ...
    const-string v2, "mLongPressOnAppSwitchBehavior"
...
.method public interceptKeyBeforeQueueing(Landroid/view/KeyEvent;I)I
    ...
    invoke-virtual {v0, v3}, Lcom/android/server/policy/DeviceKeyHandler;->k(Lcom/android/server/policy/keyguard/KeyguardServiceDelegate;)V

    iget-object v0, v1, Lcom/android/server/policy/OpPhoneWindowManager;->mDeviceKeyHandler:Lcom/android/server/policy/DeviceKeyHandler;

    invoke-virtual {v0, v2}, Lcom/android/server/policy/DeviceKeyHandler;->cgv(Landroid/view/KeyEvent;)Z
...
.method public onDefaultDisplayFocusChangedLw(Lcom/android/server/policy/WindowManagerPolicy$WindowState;)V
    ...
    iput-object p1, p0, Lcom/android/server/policy/OpPhoneWindowManager;->mFocusedWindow:Lcom/android/server/policy/WindowManagerPolicy$WindowState;
...
.method public onKeyguardDone()V
    ...
    invoke-virtual {p0}, Lcom/android/server/policy/DeviceKeyHandler;->irq()V
...
.method public onKeyguardOccludedChangedLw(Z)V
    ...
    invoke-virtual {p0, p1}, Lcom/android/server/policy/DeviceKeyHandler;->vdw(Z)V
...
.method protected performKeyAction(ILandroid/view/KeyEvent;)V
    ...
    :pswitch_customapp
    invoke-direct {p0}, Lcom/android/server/policy/OpPhoneWindowManager;->launchCustomApp()V
    ...
    :pswitch_torch
    invoke-virtual {p0}, Lcom/android/server/policy/PhoneWindowManager;->toggleTorchMode()V
...
.method public screenTurnedOff()V
    ...
    invoke-virtual {p0}, Lcom/android/server/policy/DeviceKeyHandler;->qeg()V
...
.method public startedWakingUp(I)V
    ...
    invoke-virtual {p0}, Lcom/android/server/policy/DeviceKeyHandler;->a()V
...
.method public systemReady()V
    ...
    invoke-virtual {v0}, Lcom/android/server/policy/DeviceKeyHandler;->p()V
...
.method private launchCustomApp()V
    .registers 5
    ...
    sget-object v1, Lcom/android/server/policy/OpPhoneWindowManager;->remapAction:Ljava/lang/String;
    ...
    sget-object v3, Lcom/android/server/policy/OpPhoneWindowManager;->mLongPressBackCustomApp:Ljava/lang/String;
    ...
    .line 114
    .local v1, "launchIntentForPackage":Landroid/content/Intent;
    if-eqz v1, :cond_28
    ...
    .line 116
    iget-object v2, p0, Lcom/android/server/policy/OpPhoneWindowManager;->mContext:Landroid/content/Context;

    invoke-virtual {v2, v1}, Landroid/content/Context;->startActivity(Landroid/content/Intent;)V

    .line 118
    .end local v1    # "launchIntentForPackage":Landroid/content/Intent;
    :cond_28
    goto/16 :goto_d1
    ...
    const-string v3, "mDoubleTapOnBackBehavior"
    ...
    sget-object v3, Lcom/android/server/policy/OpPhoneWindowManager;->mDoublePressBackCustomApp:Ljava/lang/String;
    ...
    .line 120
    .restart local v1    # "launchIntentForPackage":Landroid/content/Intent;
    if-eqz v1, :cond_4a
    ...
    const-string v3, "mLongPressOnHomeBehavior"
    ...
    sget-object v3, Lcom/android/server/policy/OpPhoneWindowManager;->mLongPressHomeCustomApp:Ljava/lang/String;
    ...
    const-string v3, "mDoubleTapOnHomeBehavior"
    ...
    sget-object v3, Lcom/android/server/policy/OpPhoneWindowManager;->mDoublePressHomeCustomApp:Ljava/lang/String;
    ...
    const-string v3, "mLongPressOnAppSwitchBehavior"
    ...
    sget-object v3, Lcom/android/server/policy/OpPhoneWindowManager;->mLongPressRecentCustomApp:Ljava/lang/String;
    ...
    const-string v3, "mDoubleTapOnAppSwitchBehavior"
    ...
    sget-object v3, Lcom/android/server/policy/OpPhoneWindowManager;->mDoublePressRecentCustomApp:Ljava/lang/String;
