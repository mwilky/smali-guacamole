...
.field private static ssp:Lcom/android/server/am/k; = null

.field protected static wtn:J = 0xea60L


# instance fields
.field private rtg:Lcom/android/server/am/k$zta;
...
.method private constructor <init>(Lcom/android/server/am/ActivityManagerService;)V
    ...
    iput-object p1, p0, Lcom/android/server/am/k;->zta:Lcom/android/server/am/ActivityManagerService;

    new-instance p1, Ljava/util/ArrayList;

    invoke-direct {p1}, Ljava/util/ArrayList;-><init>()V

    iput-object p1, p0, Lcom/android/server/am/k;->you:Ljava/util/ArrayList;

    new-instance p1, Lcom/android/internal/app/ProcessMap;

    invoke-direct {p1}, Lcom/android/internal/app/ProcessMap;-><init>()V

    iput-object p1, p0, Lcom/android/server/am/k;->sis:Lcom/android/internal/app/ProcessMap;

    new-instance p1, Lcom/android/internal/app/ProcessMap;

    invoke-direct {p1}, Lcom/android/internal/app/ProcessMap;-><init>()V

    iput-object p1, p0, Lcom/android/server/am/k;->tsu:Lcom/android/internal/app/ProcessMap;
...
.method private synthetic rtg(Ljava/lang/String;)V
    ...
    iget-object p0, p0, Lcom/android/server/am/k;->zta:Lcom/android/server/am/ActivityManagerService;
...
.method private sis(Lcom/android/server/am/ProcessRecord;)Z
    ...
    sget v0, Lcom/android/server/am/k;->dma:I
    ...
    sget p1, Lcom/android/server/am/k;->dma:I
...
.method private you(Lcom/android/server/am/ProcessRecord;Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1}, Lcom/android/server/am/k;->sis(Lcom/android/server/am/ProcessRecord;)Z
    ...
    sget-boolean v0, Lcom/android/server/am/veq;->s:Z

    if-eqz v0, :cond_0

    sget-object v0, Lcom/android/server/am/veq;->t:Landroid/os/Handler;

    new-instance v1, Lcom/android/server/am/cno;

    invoke-direct {v1, p0, p1}, Lcom/android/server/am/cno;-><init>(Lcom/android/server/am/k;Ljava/lang/String;)V
...
.method public static zta(Lcom/android/server/am/ActivityManagerService;)Lcom/android/server/am/k;
    .locals 1

    sget-object v0, Lcom/android/server/am/k;->ssp:Lcom/android/server/am/k;

    if-nez v0, :cond_0

    new-instance v0, Lcom/android/server/am/k;

    invoke-direct {v0, p0}, Lcom/android/server/am/k;-><init>(Lcom/android/server/am/ActivityManagerService;)V

    sput-object v0, Lcom/android/server/am/k;->ssp:Lcom/android/server/am/k;

    :cond_0
    sget-object p0, Lcom/android/server/am/k;->ssp:Lcom/android/server/am/k;
...
.method protected cno(Lcom/android/server/am/ProcessRecord;J)V
    ...
    iget-object v0, p0, Lcom/android/server/am/k;->rtg:Lcom/android/server/am/k$zta;

    if-nez v0, :cond_0

    new-instance v0, Lcom/android/server/am/k$zta;

    invoke-direct {v0, p0}, Lcom/android/server/am/k$zta;-><init>(Lcom/android/server/am/k;)V

    iput-object v0, p0, Lcom/android/server/am/k;->rtg:Lcom/android/server/am/k$zta;

    :cond_0
    iget-object v0, p0, Lcom/android/server/am/k;->rtg:Lcom/android/server/am/k$zta;

    iget-object v0, v0, Lcom/android/server/am/k$zta;->you:Ljava/lang/String;
    ...
    iget v1, v0, Lcom/android/server/am/k$zta;->sis:I
    ...
    invoke-static {v0, v1, v2, p2, p3}, Lcom/android/server/am/k$zta;->you(Lcom/android/server/am/k$zta;Ljava/lang/String;IJ)Z
    ...
    invoke-static {v0, p2, p3}, Lcom/android/server/am/k$zta;->sis(Lcom/android/server/am/k$zta;J)V

    iget-object p2, p0, Lcom/android/server/am/k;->rtg:Lcom/android/server/am/k$zta;

    invoke-static {p2}, Lcom/android/server/am/k$zta;->tsu(Lcom/android/server/am/k$zta;)Z
    ...
    invoke-direct {p0, p1, p2}, Lcom/android/server/am/k;->you(Lcom/android/server/am/ProcessRecord;Ljava/lang/String;)V

    goto :goto_1

    :cond_2
    :goto_0
    iget-object p0, p0, Lcom/android/server/am/k;->rtg:Lcom/android/server/am/k$zta;

    iget-object v0, p1, Lcom/android/server/am/ProcessRecord;->processName:Ljava/lang/String;

    iget p1, p1, Lcom/android/server/am/ProcessRecord;->uid:I

    invoke-static {p0, v0, p1, p2, p3}, Lcom/android/server/am/k$zta;->zta(Lcom/android/server/am/k$zta;Ljava/lang/String;IJ)V
...
.method protected kth(Lcom/android/server/am/ProcessRecord;J)V
    ...
    iget-object v0, p0, Lcom/android/server/am/k;->sis:Lcom/android/internal/app/ProcessMap;
    ...
    iget-object v1, p0, Lcom/android/server/am/k;->tsu:Lcom/android/internal/app/ProcessMap;
    ...
    sget-wide v7, Lcom/android/server/am/k;->wtn:J
    ...
    sget v2, Lcom/android/server/am/k;->gck:I

    if-lt v0, v2, :cond_1

    iget-object p2, p0, Lcom/android/server/am/k;->sis:Lcom/android/internal/app/ProcessMap;
    ...
    iget-object p2, p0, Lcom/android/server/am/k;->tsu:Lcom/android/internal/app/ProcessMap;
    ...
    iget-object p0, p0, Lcom/android/server/am/k;->tsu:Lcom/android/internal/app/ProcessMap;
    ...
    sget-wide v3, Lcom/android/server/am/k;->wtn:J
...
.method public synthetic ssp(Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1}, Lcom/android/server/am/k;->rtg(Ljava/lang/String;)V
...
.method protected tsu(Lcom/android/server/am/ProcessRecord;)Z
    ...
    invoke-virtual {v1, v2}, Lcom/android/server/am/veq;->irq(Ljava/lang/String;)Z
    ...
    :cond_5
    iget-object v1, p0, Lcom/android/server/am/k;->you:Ljava/util/ArrayList;

    monitor-enter v1

    :try_start_0
    iget-object p0, p0, Lcom/android/server/am/k;->you:Ljava/util/ArrayList;
    ...
    sget v1, Lcom/android/server/am/k;->dma:I
