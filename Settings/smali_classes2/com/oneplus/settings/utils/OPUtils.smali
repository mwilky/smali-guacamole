...
.method public static is7TProTMOProducts()Z
    .locals 2
...
.method public static isLaboratoryFeatureExist()Z
    ...
    invoke-static {}, Lcom/oneplus/settings/utils/OPUtils;->isSupportAodAlwaysOnInLaboratory()Z

    move-result v10

    if-nez v10, :cond_4

    const-string v10, "AOD_ALWAYS_ON_SCHEDULE"
    ...
    invoke-static {v8}, Lcom/oneplus/settings/utils/OPUtils;->isSurportSimNfc(Landroid/content/Context;)Z

    move-result v8

    if-nez v8, :cond_5

    const-string v8, "oneplus_nfc_security_module_key"
    ...
    :cond_5
    const-string v8, "OPLabFeatureActivity"
    ...
    const-string v8, "op_iris_video_memc_extreme_status"
    ...
    :cond_6
    const-string v8, "oneplus_dc_dimming_value"
...
.method public static isOakProducts()Z
    .locals 3
    ...
    sget v2, Lcom/android/settings/R$string;->op_oak_product:I
...
.method public static isRealVersion()Z
    .locals 2

    const-string v0, "ro.build.real_device"
...
.method public static isSupportAodAlwaysOnInLaboratory()Z
    .locals 1

    const-string v0, "OP_FEATURE_AOD_ALWAYS_ON_IN_LABORATORY"
...
.method public static isSupportC303()Ljava/lang/Boolean;
    .locals 2
...
.method public static isSupportColorSaturationAdjustment()Z
    .locals 1

    const-string v0, "OP_FEATURE_MM_COLOR_SATURATION_ADJUSTMENT"
...
.method public static isSupportUSKU()Z
    .locals 1

    const-string v0, "OP_FEATURE_USKU"
...
.method public static isSupportUstMode()Z
    ...
    invoke-static {}, Lcom/oneplus/settings/utils/OPUtils;->isSupportC303()Ljava/lang/Boolean;
